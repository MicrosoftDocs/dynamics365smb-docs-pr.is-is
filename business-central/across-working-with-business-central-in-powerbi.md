...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>Vinna með [!INCLUDE [prod_short](includes/prod_short.md)] gögn í Power BI
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>Fá nýjustu gögnin
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a>Uppfæra handvirkt

Í skoðunarrúðunni, undir **Gagnasafn**, skal velja **Fleiri valkostir (...)** við hliðina á gagnasafni og velja svo **Uppfæra núna**.

### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Áætla uppfærslu
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Hlaða upp skýrslum úr skrám
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Deila skýrslum með öðrum
