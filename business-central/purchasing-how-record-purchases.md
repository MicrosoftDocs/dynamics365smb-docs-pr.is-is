...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Skrá innkaup með innkaupareikningum og pöntunum
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Skrá innkaup með innkaupareikningum
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Stofna og bóka innkaupareikning
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a>Bókaðir reikningar
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Vöruinnkaup á öðru en birgðavörum
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Hvenær á að nota innkaupapantanir
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Taka á móti vörum með innkaupapöntun
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Taka á móti fleiri vörum en pantað er
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Setja upp umframmóttöku
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Úthluta vörukvittunarkóta til vöru
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Yfir-taka við pöntun
...
## <a name="posting-purchases"></a><a name="posting-purchases"></a>Bókun innkaupa
...
## <a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a>Fjárhagsfærslur skoðaðar
...
## <a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a>Breyta fjárhagsfærslum
...
## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Sjá tengda [Microsoft þjálfun](/training/modules/processing-invoices-dynamics-365-business-central/index)
