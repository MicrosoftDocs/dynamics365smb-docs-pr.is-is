...
### <a name="create-a-and-post-purchase-invoice"></a>Stofna og bóka innkaupareikning
...
### <a name="assign-the-over-receipt-code-to-an-item"></a>Úthluta vörukvittunarkóta til vöru
...
### <a name="over-receive-an-order"></a>Yfir-taka við pöntun
...
## <a name="see-related-microsoft-training-1"></a>Sjá tengda [Microsoft þjálfun](/training/modules/processing-invoices-dynamics-365-business-central/index)
