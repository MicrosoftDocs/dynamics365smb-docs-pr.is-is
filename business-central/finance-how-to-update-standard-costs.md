...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a>Uppfæra staðlaðan kostnað
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>að uppfæra staðlað kostnaðarverð
