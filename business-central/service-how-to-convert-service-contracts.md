...
description: Í þessari grein er lýst ýmsum öðrum aðferðum sem hægt er að nota til að breyta þjónustusamningum með VSK-upphæðum.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
> [!NOTE]  
> Þessi grein veitir verkflæði á háu stigi.  
