...
## <a name="add-context-to-general-journal-transactions"></a>Bæta við samhengi við almennar færslubókarfærslur

Þegar færslubók er stofnuð er hægt að bæta við tenglum sem gefa samhengi við færslurnar. Þegar færslubókin er bókuð skal  [!INCLUDE [prod_short](includes/prod_short.md)]  Afrita tenglana í bókuðu færslubókina og færslurnar sem færslubókin stofnar til. Til dæmis geta tenglar gert lífið auðveldara fyrir endurskoðanda. Ef þú heldur myndum af kostnaðarkvittunum þínum á SharePoint setri fyrirtækisins getur þú bætt tenglum við skrárnar. Þegar færslubókin er bókuð til að senda inn útgjöldin kemst endurskoðandinn fljótt í móttökuskrárnar.
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a>Skilningur á aðalreikningum og mótreikningum
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Upphæðum ítrekaðra bóka úthlutað á nokkra lykla
...
### <a name="calculate-the-reversal-date"></a>Reikna dagsetningu bakfærslunnar
