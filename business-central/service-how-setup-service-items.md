...
ms.author: edupont
---
# <a name="set-up-service-items-and-service-item-components" />Setja upp þjónustuvörur og íhluti þjónustuvara
Áður en þú vinnur með þjónustuvörur verður þú að setja upp eftirfarandi:

* Þjónustuvöruflokkar
* Valfrjálst

## <a name="to-set-up-service-item-groups" />Setja upp þjónustuvöruflokka
...
## <a name="to-set-up-service-item-components" />Uppsetning þjónustuvöruíhluta
...
## <a name="to-set-up-service-item-components-from-a-bom" />Uppsetning þjónustuvöruíhluta út frá uppskriftum
1.  Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Þjónustuvörur** og svo velja viðeigandi tengil.  
...
## <a name="to-set-up-a-service-shelf" />Uppsetning þjónustuhillu
