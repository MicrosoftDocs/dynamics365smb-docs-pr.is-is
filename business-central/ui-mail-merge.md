...
# <a name="use-word-templates-for-bulk-communication"></a><a name="use-word-templates-for-bulk-communication"></a>Nota Word-notuð fyrir mörg samskipti í einu
...
## <a name="set-up-the-source-of-data"></a><a name="set-up-the-source-of-data"></a>Setja upp uppruna gagna
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a><a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a>Bæta við færslum sem eru tengdar eða ótengdar upprunaeiningunni
...
### <a name="select-the-fields-to-include"></a><a name="select-the-fields-to-include"></a>Velja svæðin sem eiga að vera með
...
## <a name="to-create-a-word-template-in-business-central"></a><a name="to-create-a-word-template-in-business-central"></a>Búa til Word-sniðmát í Business Central
...
## <a name="set-up-the-template-in-word"></a><a name="set-up-the-template-in-word"></a>Sniðmát sett upp í Word
...
## <a name="apply-a-template"></a><a name="apply-a-template"></a>Nota sniðmát
...
## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Notaðu Word sniðmát með tölvupósti
...
## <a name="edit-a-word-template"></a><a name="edit-a-word-template"></a>Ritfærslusniðmáti breytt
