...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a>Setja upp Envestnet Yodlee Bank Feeds þjónustu
...
> Aðeins bankar sem eru búsettir í þessum löndum eru studdir, jafnvel þó að bankar frá öðrum löndum kunni að birtast í Envestnet Yodlee Bank Feeds valglugga banka í [!INCLUDE[prod_short](includes/prod_short.md)].
...
Envestnet Yodlee Bank Feeds Þjónustan er sett upp sem viðbót við [!INCLUDE[prod_short](includes/prod_short.md)] á netinu og er tilbúin til að verða virkjuð í studdum löndum. Frekari upplýsingar skoða [Sérstilla [!INCLUDE[prod_short](includes/prod_short.md)] Nota viðbætur](ui-extensions.md).
...
## <a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a>Til að virkja bankastreymisþjónustu
...
## <a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a>Stofna nýjan tengdan bankareikning
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Bankareikningar** og velja síðan viðkomandi tengil.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a>Til að tengja bankareikning í netbankareikning
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Bankareikningar** og velja síðan viðkomandi tengil.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a>Að breyta innskráningarupplýsingum fyrir netbankareikning
...
## <a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a>Að Aftengja bankareikningi
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Bankareikningar** og velja síðan viðkomandi tengil.  
...
## <a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a>Uppfæra tengla bankareikninga
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Bankareikningar** og velja síðan viðkomandi tengil.
...
## <a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a>Til að virkja sjálfvirkan innflutning bankayfirlits
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Bankareikningar** og velja síðan viðkomandi tengil.
