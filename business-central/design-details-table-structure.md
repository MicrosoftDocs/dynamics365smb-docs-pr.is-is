...
## <a name="transaction-and-budget-tables" />Færslu- og fjárhagsáætlunartöflur
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Töflur sem innihalda reit fyrir auðkenni víddasamstæðu
