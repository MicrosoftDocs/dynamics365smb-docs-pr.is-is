...
ms.author: edupont
---
# <a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a>Magnreikningsfærsla fyrir Microsoft Bookings í [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="connect-to-bookings"></a><a name="connect-to-bookings"></a>Tengjast Bookings
...
## <a name="invoice-appointments"></a><a name="invoice-appointments"></a>Reikningsfæra fundi
