...
### <a name="enabling-or-disabling-the-vat-date-feature"></a>VSK-Dagsetningaraðgerðin gera virkjun óvirka eða óvirk
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date"></a>Takmarka tímabil fyrir bókanir og breytingar á VSK-dagsetningunni
...
#### <a name="to-limit-posting-based-on-vat-return-period"></a>Bókun að takmarka bókanir á skilatímabili VSK
...
#### <a name="to-limit-posting-based-on-allow-fromto-period"></a>Bókun takmarkað miðað við leyfilegt frá/til-tímabil
