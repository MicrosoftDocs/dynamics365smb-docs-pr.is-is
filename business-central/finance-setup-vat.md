...
#### <a name="limit-posting-based-on-allow-fromto-period"></a>Tímamörk bókunar miðast við leyfilegt frá/til tímabils
...
##### <a name="versions-before-231"></a>Útgáfur áður 23,1
