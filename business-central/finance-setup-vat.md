...
> [!NOTE]
> Þegar skjalið eða færslubókin hefur verið bókuð mun **VSK-dagsetningin** birtast í **VSK-færslum** og **Fjárhagsfærslum** ásamt bókaða skjalinu ef það er til.
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 3.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **VSK-viðskiptabókunarflokka** og velja síðan viðkomandi tengil.  
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 8.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Vara** eða **Tilfang** og velja síðan viðkomandi tengil.  
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 9.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **VSK-ákvæði** og velja síðan viðkomandi tengil.  
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 10.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **VSK-bókunargrunnur** og velja síðan viðkomandi tengil.  
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 11.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **VSK-ákvæði** og velja síðan viðkomandi tengil.  
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 12.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **VSK-vörubókunarflokk** og velja síðan viðkomandi tengil.  
2. Á síðunni VSK-vörubókunarflokkar, skal setja upp nýja VSK-vörubókunarflokkur fyrir VSK vegna innflutnings.  
3. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 13.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **VSK-bókunargrunnur** og velja síðan viðkomandi tengil.  
