...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a><a name="available-fonts"></a>Tiltækar leturgerðir
...
## <a name="document-fonts"></a><a name="document-fonts"></a><a name="document-fonts"></a>Leturgerð skjals
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Leturgerðir fyrir ávísanir
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Leturgerðir fyrir strikamerki
