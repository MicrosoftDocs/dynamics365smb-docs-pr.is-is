...
ms.author: edupont
---
# <a name="available-fonts" />Tiltækar leturgerðir
...
## <a name="document-fonts" />Leturgerð skjals
...
## <a name="fonts-for-checks" />Leturgerðir fyrir ávísanir
...
## <a name="fonts-for-barcodes" />Leturgerðir fyrir strikamerki
