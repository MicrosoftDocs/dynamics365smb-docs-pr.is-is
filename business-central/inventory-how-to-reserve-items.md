...
ms.author: edupont
---
# <a name="reserve-items" />Taka frá vörur
...
## <a name="reserve-items-for-sales" />Taka frá vörur fyrir sölu
...
## <a name="reserve-an-item-for-a-production-order-line" />Taka frá vörur fyrir framleiðslupöntunarlínur
...
## <a name="reserve-items-for-production-order-components" />Taka frá vörur fyrir íhluti framleiðslupöntunar
...
## <a name="change-a-reservation" />Breyta frátekningu
...
## <a name="cancel-a-reservation" />Hætta við frátekningu
...
## <a name="reserve-a-specific-serial-or-lot-number" />Taka frá tiltekið rað- eða lotunúmer
