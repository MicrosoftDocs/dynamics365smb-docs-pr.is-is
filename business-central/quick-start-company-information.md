...
# <a name="company-information-quick-start"></a><a name="company-information-quick-start"></a>Stuttur leiðarvísir um fyrirtækjaupplýsingar
...
## <a name="to-set-up-company-information"></a><a name="to-set-up-company-information"></a>Að setja upp upplýsingar fyrirtækis
