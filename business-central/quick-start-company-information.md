...
# <a name="company-information-quick-start" />Stuttur leiðarvísir um fyrirtækjaupplýsingar
...
## <a name="to-set-up-company-information" />Að setja upp upplýsingar fyrirtækis
