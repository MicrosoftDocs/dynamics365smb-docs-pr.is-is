...
ms.author: edupont
---
# <a name="update-currency-exchange-rates"></a><a name="update-currency-exchange-rates"></a>Uppfæra gengi
...
## <a name="currencies"></a><a name="currencies"></a>Gjaldmiðlar
...
### <a name="effect-on-customers-and-vendors"></a><a name="effect-on-customers-and-vendors"></a>Áhrif á viðskiptamenn og lánardrottna
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries"></a><a name="dimensions-on-customer-and-vendor-ledger-entries"></a>Víddir í fjárhagsfærslum viðskiptavina og lánardrottna
...
### <a name="effect-on-bank-accounts"></a><a name="effect-on-bank-accounts"></a>Áhrif á bankareikninga
...
#### <a name="dimensions-on-bank-account-entries"></a><a name="dimensions-on-bank-account-entries"></a>Víddir í bankareikningsfærslum
...
### <a name="effect-on-gl-accounts"></a><a name="effect-on-gl-accounts"></a>Áhrif á fjárhagsreikninga
...
##### <a name="dimensions-on-gl-account-entries"></a><a name="dimensions-on-gl-account-entries"></a>Víddir í fjárhagsreikningsfærslum
...
## <a name="to-set-up-a-currency-exchange-rate-service"></a><a name="to-set-up-a-currency-exchange-rate-service"></a>Setja upp þjónustu um gengi gjaldmiðils
...
## <a name="to-update-currency-exchange-rates-through-a-service"></a><a name="to-update-currency-exchange-rates-through-a-service"></a>Til að uppfæra gengi í gegnum þjónustu
