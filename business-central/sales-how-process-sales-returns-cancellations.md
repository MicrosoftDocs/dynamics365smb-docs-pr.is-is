...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Vinna söluskil eða afturkallanir
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Að stofna nýjan sölukreditreikning úr bókuðum sölureikningi.
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Að stofna sölukreditreikning með því að afrita bókuðum sölureikningi
...
## <a name="to-create-a-sales-allowance" />Til að bóka söluuppbót:
...
## <a name="to-combine-return-receipts" />Hvernig á að sameina vöruskilamóttökur
...
### <a name="to-manually-combine-return-receipts" />Til að sameina vöruskilamóttökur handvirkt:
...
### <a name="to-automatically-combine-return-receipts" />Til að sameina vöruskilamóttökur sjálfvirkt
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Mótteknar og reikningsfærðar vöruskilamóttökur fjarlægðar
