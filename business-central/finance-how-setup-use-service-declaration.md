...
---
# <a name="the-service-declaration-extension"></a><a name="the-service-declaration-extension"></a>Framlenging á Þjónustuskýrslu
...
## <a name="enable-the-service-declaration-extension"></a><a name="enable-the-service-declaration-extension"></a>Gera viðauka Þjónustuskýrslu virka
...
## <a name="set-up-the-service-declaration-extension"></a><a name="set-up-the-service-declaration-extension"></a>Setja upp viðauka Þjónustuskýrslu

Hægt er að setja upp viðauka handvirkt eða með því að nota skýrslugerðarskrá í skilgreiningum á gögnum.

### <a name="to-set-up-service-declaration-manually"></a><a name="to-set-up-service-declaration-manually"></a>Að setja upp Þjónustuskýrslu handvirkt
...
### <a name="items"></a><a name="items"></a>Vörur
...
### <a name="resources"></a><a name="resources"></a>Forðar
...
### <a name="item-charges"></a><a name="item-charges"></a>Kostnaðaraukar
...
## <a name="create-new-service-declaration"></a><a name="create-new-service-declaration"></a>Stofna nýja þjónustuskýrslu
...
## <a name="modify-a-service-declaration"></a><a name="modify-a-service-declaration"></a>Breyta þjónustuskýrslu
...
## <a name="overview-the-service-declaration-lines"></a><a name="overview-the-service-declaration-lines"></a>Yfirlit yfir línur þjónustuskýrslu
...
## <a name="report-service-declaration-in-a-file"></a><a name="report-service-declaration-in-a-file"></a>Skýrsluþjónustuskýrsla í skrá
...
## <a name="other-considerations"></a><a name="other-considerations"></a>Önnur atriði
...
### <a name="grouping-lines"></a><a name="grouping-lines"></a>Flokkunarlínur
...
### <a name="using-services-in-document-lines"></a><a name="using-services-in-document-lines"></a>Notkun þjónustu í skjalalínum
