...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Rekstrarreikningum lokað
...
## <a name="to-run-the-close-income-statement-batch-job" />Til að keyra Runuvinnslan Loka rekstrarreikningi
...
## <a name="about-the-close-income-statement-batch-job" />Um Runuvinnslan Loka rekstrarreikningi
