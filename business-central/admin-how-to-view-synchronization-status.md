...
# <a name="view-the-status-of-synchronization-jobs" />Skoða stöðu samstillingarverka
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Skoða og leysa úr samstillingarvillum fyrir tengdar færslur
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Að skoða samstillingarkladdann fyrir tiltekna (handvirkt samstillta) færslu
...
## <a name="remove-couplings-between-records" />Fjarlægja tengingu milli færslna
