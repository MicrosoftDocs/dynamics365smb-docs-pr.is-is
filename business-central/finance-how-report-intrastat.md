...
---
# <a name="work-with-intrastat-reporting"></a>Vinna við Intrastat-skýrslugerð
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") Táknmynd, færa inn **Intrastat-skýrslulista** og velja viðeigandi tengja.
...
### <a name="locations-in-intrastat-reporting"></a>Birgðageymslur í Intrastat-skýrslugerð
...
### <a name="triangular-trade-in-intrastat"></a>Þríhyrningsviðskipti í Intrastat
