...
---
# <a name="work-with-intrastat-reporting" /><a name="work-with-intrastat-reporting"></a>Vinna með Intrastat-skýrslur
...
## <a name="fill-in-the-intrastat-report" /><a name="fill-in-the-intrastat-report"></a>Fylltu út Intrastat-skýrsluna
...
## <a name="modify-the-intrastat-report" /><a name="modify-the-intrastat-report"></a>Breyta Intrastat-skýrslunni
...
## <a name="validate-intrastat-lines" /><a name="validate-intrastat-lines"></a>Staðfesta Intrastat-línur
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" /><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Endurútreikningur þyngdar eða viðbótarmælieiningar
...
## <a name="intrastat-rules" /><a name="intrastat-rules"></a>Intrastat-reglur

### <a name="grouping-lines" /><a name="grouping-lines"></a>Flokkunarlínur
...
### <a name="fixed-assets-reporting" /><a name="fixed-assets-reporting"></a>Skýrslugjöf eigna
...
### <a name="intrastat-report-statuses" /><a name="intrastat-report-statuses"></a>Stöður Intrastat-skýrslu
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesprocess-intrastat-dynamics--business-centralindex" /><a name="see-related-training-at-microsoft-learn"></a>Sjá tengda þjálfun á [Microsoft Learn](/learn/modules/process-intrastat-dynamics-365-business-central/index).
