...
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Vinna með Intrastat-skýrslur
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Fylltu út Intrastat-skýrsluna
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Breyta Intrastat-skýrslunni
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Staðfesta Intrastat-línur
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Endurútreikningur þyngdar eða viðbótarmælieiningar
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a>Intrastat-reglur
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Skýrslugjöf eigna
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Stöður Intrastat-skýrslu
