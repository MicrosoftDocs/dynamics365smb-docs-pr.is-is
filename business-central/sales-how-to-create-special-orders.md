...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a><a name="create-special-orders"></a>Sérstakar pantanir stofnaðar
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Stofnuð sérpöntun:
