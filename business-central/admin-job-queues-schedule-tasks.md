...
---
# <a name="use-job-queues-to-schedule-tasks" />Nota verkraðir til að tímaraða verkhlutum
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Fylgjast með stöðu eða villum í verkröð
...
### <a name="to-view-status-for-any-job" />Til að skoða stöðu fyrir hvaða verk sem er
...
## <a name="view-scheduled-tasks" />Skoða áætluð verk
...
## <a name="the-my-job-queue-part" />Hluti Starfraðarhlutans
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />Til að skoða villu ú hlutanum Mín verkröð

1. Í færslu með stöðuna **Villa** skal velja aðgerðina **Sýna villu**.
2. Fara skal yfir villuboðin og leysa vandann.

## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Dæmi um það sem hægt er að áætla með notkun vinnsluraðarfærslna

### <a name="schedule-reports" />Áætla skýrslur
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Áætla hvenær bóka á sölu-og innkaupapantanir
...
## <a name="handle-job-queue-entry-issues" />Afgreiðsla úthreyfingar vinnslustöðvar færslu
...
## <a name="monitor-the-job-queue-with-telemetry" />Fylgjast með verkröðinni með fjarmælingu
