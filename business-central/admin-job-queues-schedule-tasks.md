...
> [!TIP]
> Með [!INCLUDE [prod_short](includes/prod_short.md)] á netinu er einnig hægt að skoða stöðu verkraðarfærslna með því að nota Application Insights í Microsoft Azure. Frekari upplýsingar er að finna [Greining á líftíma fjarmælingarrakningar verkraðar](/dynamics365smb-devitpro\dev-itpro\administration\telemetry-job-queue-lifecycle-trace) í [!INCLUDE [prod_short](includes/prod_short.md)] Developer and IT Pro Help.
