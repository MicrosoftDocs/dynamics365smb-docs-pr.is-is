...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data" />Stjórna geymslu með því að eyða skjölum eða þjappa gögnum
...
## <a name="delete-documents" />Eyða skjölum.
...
## <a name="compress-data-with-date-compression" />Þjappa gögnum með dagsetningarþjöppun
...
## <a name="posting-compressed-entries" />Bókun þjappaðra færslna
...
### <a name="to-run-a-date-compression" />Að keyra gagnaþjöppun
