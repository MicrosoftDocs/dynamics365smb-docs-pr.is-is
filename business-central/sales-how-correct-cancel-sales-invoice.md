...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-sales-invoices" />Ógreiddir sölureikningar leiðréttir eða afturkallaðir
...
## <a name="to-cancel-a-posted-sales-invoice" />Bókaður sölureikningur afturkallaður
...
## <a name="to-correct-a-posted-sales-invoice" />Bókaður sölureikningur leiðréttur
