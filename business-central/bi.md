---
title: Financial Analytics í Business Central
...
| Nota tölfræðilega reikninga til viðbótarupplýsinga í fjárhagsskýrslum. Með tölfræðilegum reikningum er hægt að bæta við mælieiningum sem byggðar eru á gögnum sem ekki tengjast viðskiptum. Hægt er að bæta við gögnum sem ekki eru í færslum eins og einingum sem byggðar eru á númerum, svo sem höfuðstól starfsmanns, fermetrafjölda eða fjölda viðskiptamanna með reikninga sem eru gjaldfallnir. | [Greina gögn með tölfræðilegum lyklum](bi-use-statistical-accounts.md) |
| Fræðast um hvernig á að setja upp nýja fjárhagsskýrslu með dæmum. | [Kynning: Nota fjárhagsskýrslugerð til að gera sjóðsstreymisspár](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md) |
...
Hægt er að fá yfirlit yfir tiltækar skýrslur með því að smella á **Allar skýrslur** efst á heimasíðunni. Þetta fer í hlutverkavafrann sem er afmarkaður við aðgerðirnar í valkostinum **Skýrsla & Greining** . Nánari upplýsingar eru í [Finna skýrslur með hlutverkavafranum](ui-role-explorer.md).

:::image type="content" source="media/report-explorer-finance.png" alt-text="Dæmi um skýrslur um fjármálahlutverkið." lightbox="media/report-explorer-finance.png":::
...
- [Innbyggðar fjármál Excel skýrslur](finance-analyze-excel.md)
- [Innbyggðar lykilfólksskýrslur](finance-reports.md)
- [Innbyggðar eignaskýrslur](fa-reports.md)
- [Innbyggðar skýrslur útistandandi reikninga](receivables-reports.md)
- [Innbyggðar skýrslur fyrir gjaldfallna reikninga](payables-reports.md)
