...
---
# <a name="collect-payments-with-sepa-direct-debit"></a>Innheimta greiðslur með SEPA beingreiðslu
...
## <a name="how-to-set-up-sepa-direct-debit"></a>Hvernig sePA-beingreiðslur eru settar upp
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit"></a>Bankareikningur settur upp fyrir SEPA-beingreiðslu
...
3. Á flýtiflipanum **Almennt** í reitnum **SEPA-beingreiðslusnið** er valinn kostur fyrir SEPA-beingreiðslu.  

### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit"></a>Til að setja upp greiðsluhátt viðskiptamanns fyrir SEPA-beingreiðslu
...
3. Setjið upp greiðsluaðferð. Fylla inn í reitina eins\- og lýst er í eftirfarandi töflu.  
    ...
    |---------------------------------|---------------------------------------|  
    |**Bein skuldfærsla**|Tilgreina skal hvort greiðsluaðferðin sé fyrir SEPA-beingreiðslusöfnun.|  
    |**Greiðsluskilmálakóti beinnar skuldfærslu**|Tilgreina greiðsluskilmála, svo sem EKKI BORGA, sem eru birtir á sölureikningum sem eru greiddir með SEPA-beingreiðslu til að gefa viðskiptavininum til kynna að greiðslna verði innheimt sjálfkrafa. Einnig er hægt að skilja þennan reit eftir auðan.|  
...
6. Opna skal viðskiptamannaspjald viðskiptamannsins sem setja á upp fyrir SEPA-beingreiðslusafn.  
7. Veljið **Kóði greiðslumáta** reitinn og svo kóðann fyrir greiðslumátann sem var tilgreindur í skrefi 3.  
8. Þrep 6 og 7 eru endurtekin fyrir alla viðskiptamenn sem á að setja upp fyrir SEPA-beingreiðslusöfnun.  
...
2. Opna skal spjald viðskiptamannsins sem á að setja upp fyrir SEPA-beingreiðslur.  
3. Veldu aðgerðina **Bankareikningar**.  
4. Á síðunni **Bankareikningalisti** viðskiptamanns skal velja bankareikning viðskiptamanns sem notar bein debet og velja svo aðgerðina Bein **debet áskilin** úr **Ný**.  
5. Á síðunni **SEPA-umboð fyrir beint debet** þarf að fylla reitina út eins og lýst er í eftirfarandi töflu.  
    ...
    |**Tegund greiðslu**|Tilgreina ef samkomulag nær yfir nokkrar (**Ítrekað**) eða eina (**Stakt**)innheimtur beingreiðslu.|  
    ...
    |**Lokað**|Tilgreina að ekki er hægt að nota beingreiðslusöfn með þessu beina\- debetákni.|  

6. Þrep 1 til 5 eru endurtekin fyrir alla viðskiptamenn sem á að setja upp fyrir SEPA-beingreiðslur.  
...
### <a name="to-create-a-direct-debit-collection"></a>Til að stofna innheimtu beingreiðslu
 ...
 3. Á síðunni **Stofna innheimtu beingreiðslu** þarf að fylla reitina út eins og lýst er í eftirfarandi töflu.  
    ...
    |**Aðeins viðskiptamenn með gilt umboð**|Tilgreina ef innheimta beingreiðslu er stofnuð fyrir viðskiptamenn sem hafa gilt umboð fyrir beingreiðslu. **Til athugunar:**  Beingreiðslusafn er stofnað jafnvel þótt reiturinn **Kenni beingreiðslu** sé ekki fylltur út á sölureikningnum.|  
...
4. Á síðunni **bóka innheimtu beingreiðslu** þarf að fylla reitina út eins og lýst er í eftirfarandi töflu.  
    ...
    |**Stofna aðeins færslubók**|Þessi gátreitur er valinn ef ekki á að bóka greiðslukvittun þegar hnappurinn **Í lagi** er valinn. Greiðslumóttakan verður útbúin í tilgreindri færslubók og verður ekki bókuð fyrr en einhver bókar viðkomandi færslubókarlínur.|  
