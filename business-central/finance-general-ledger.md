...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Að skilja fjárhag og bókhaldslykil
...
## <a name="general-ledger-setup-and-general-posting-setup" />Uppsetning Uppsetning fjárhags og uppsetning almenns bókunargrunnur
...
## <a name="account-categories" />tegundir lykla
...
## <a name="get-a-quick-overview" />Yfirsýn yfir efni vörulistans
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Aðgangur til að stofna og breyta reikningum og reikningsflokkum
