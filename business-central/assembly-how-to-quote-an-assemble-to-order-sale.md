...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale" />Búa til tilboð með samsetningarpöntun
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item" />Til að stofna sölutilboð fyrir vöru sem setja skal saman í pöntun
