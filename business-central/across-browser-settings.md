...
ms.author: jswymer
---
# <a name="setting-up-and-troubleshooting-your-browser-to-work-with-business-central-web-client" />Uppsetning og úrræðaleit vafrans til að vinna með Business Central-vefbiðlara
...
## <a name="allow-javascript-from-business-central" />Leyfa JavaScript úr Business Central
...
## <a name="allow-cookies-from-business-central" />Leyfa kökur úr Business Central
