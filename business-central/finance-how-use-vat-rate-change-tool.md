...
# <a name="managing-vat-rate-changes" />Stjórna breytingum VSK-hlutfalls
...
## <a name="changing-vat-rates" />Breyta VSK-hlutfalli
...
## <a name="the-vat-rate-change-tool" />Notkun breytingaverkfæris VSK-hlutfalls
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Að skilja umbreytingarferli VSK-hlutfalls og takmarkanir þess
...
### <a name="to-prepare-vat-rate-change-conversions" />Til að undirbúa umreikning VSK-hlutfalls
...
### <a name="to-set-up-the-vat-rate-change-tool" />Til að setja upp breytingaverkfæri VSK-hlutfalls
...
### <a name="to-set-up-product-posting-group-conversion" />Til að setja upp vörubókunarflokksumbreytingar
...
### <a name="to-perform-vat-rate-change-conversion" />Til að umreikna VSK-hlutfall
...
## <a name="see-related-microsoft-trainingtrainingmodulesrate-change-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/rate-change-dynamics-365-business-central/)
