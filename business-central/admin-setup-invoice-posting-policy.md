...
# <a name="define-an-invoice-posting-policy-for-users"></a><a name="define-an-invoice-posting-policy-for-users"></a>Skilgreinið bókunarreglur reiknings fyrir notendur
...
## <a name="to-specify-a-posting-policy"></a><a name="to-specify-a-posting-policy"></a>Bókunarregla tilgreind
...
## <a name="effect-on-documents"></a><a name="effect-on-documents"></a>Áhrif á kjör
