...
# <a name="basic-reports-and-documents-output-quick-start"></a><a name="basic-reports-and-documents-output-quick-start"></a>Flýtiræsing á grunnskýrslum og frálagsskjölum
...
## <a name="add-your-company-logo-to-documents"></a><a name="add-your-company-logo-to-documents"></a>Bæta fyrirtækjamerki við skjöl
...
## <a name="run-reports"></a><a name="run-reports"></a>Keyra skýrslur
...
## <a name="save-reports-as-pdf-excel-or-word-documents"></a><a name="save-reports-as-pdf-excel-or-word-documents"></a>Vista skýrslur sem PDF-, Excel- eða Word-skjöl
...
### <a name="change-report-and-document-layouts"></a><a name="change-report-and-document-layouts"></a>Breyta útliti skýrslna og skjala
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Sjá tengda þjálfun á [Microsoft Learn](/learn/modules/work-with-reports/).
