...
ms.author: kepontop
---
# <a name="report-overview" />Skýrsluyfirlit
...
## <a name="key-financial-reports" />Mikilvægustu fjárhagsskýrslurnar

[!INCLUDE [finance_reports](includes/finance-reports-include.md)]

Frekari upplýsingar er að finna í [Fjárhagsskýrslur og greiningar í Business Central](finance-reports.md)

## <a name="accounts-receivable-reports" />Skýrslur viðskiptavina
...
## <a name="accounts-payable-reports" />Skýrslur í Viðskiptavinir
...
## <a name="production-reports" />Framleiðsluskýrslur
