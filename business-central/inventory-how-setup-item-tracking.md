...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a><a name="set-up-item-tracking-with-serial-lot-and-package-numbers"></a>Setja upp vörurakningu með raðnúmer, lotu og pakkanúmer
...
## <a name="numbers-and-item-tracking"></a><a name="numbers-and-item-tracking"></a>Númer og vörurakning
...
## <a name="to-set-up-item-tracking-codes"></a><a name="to-set-up-item-tracking-codes"></a>Til að setja upp vörurakningarkóða
...
## <a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a><a name="to-set-up-expiration-rules-for-serial-or-lot-numbers"></a>Uppsetning gildistíma fyrir rað- og lotunúmer
...
## <a name="to-set-up-warranties-for-serial-or-lot-numbers"></a><a name="to-set-up-warranties-for-serial-or-lot-numbers"></a>Uppsetning ábyrgðar fyrir rað- og lotunúmer
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a><a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes"></a>Til að setja upp vörur fyrir rakningu með réttum vörurakningarkóðum
...
## <a name="to-specify-opening-balances-for-the-items-you-track"></a><a name="to-specify-opening-balances-for-the-items-you-track"></a>Tilgreina opnunarstöður fyrir vörurnar sem fylgst er með
...
### <a name="item-journals"></a><a name="item-journals"></a>Birgðabækur
...
### <a name="warehouse-physical-inventory-journal-for-locations-where-directed-pick-and-put-away-is-turned-on"></a><a name="warehouse-physical-inventory-journal-for-locations-where-directed-pick-and-put-away-is-turned-on"></a>Raunbirgðabók vöruhúss fyrir staðsetningar þar sem beinar tínsla og frágangur er kveikt
