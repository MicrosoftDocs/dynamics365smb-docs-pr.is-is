...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Búa til eftirspurnarspá
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Söluspár og Framleiðsluspár
...
## <a name="component-forecast"></a><a name="component-forecast"></a><a name="component-forecast"></a>Íhlutaspá
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a><a name="forecasting-periods"></a>Spártímabil
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Spá eftir birgðageymslum
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Nota spá eftir staðsetningum
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Ekki nota spá eftir staðsetningum
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Til að búa til eftirspurnarspá
