...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Búa til eftirspurnarspá
...
## <a name="sales-forecasts-and-production-forecasts" />Söluspár og Framleiðsluspár
...
## <a name="component-forecast" />Íhlutaspá
...
## <a name="forecasting-periods" />Spártímabil
...
## <a name="forecast-by-locations" />Spá eftir birgðageymslum
...
### <a name="use-forecast-by-locations" />Nota spá eftir staðsetningum
...
### <a name="do-not-use-forecast-by-locations" />Ekki nota spá eftir staðsetningum
...
## <a name="to-create-a-demand-forecast" />Til að búa til eftirspurnarspá
