...
# <a name="inspecting-pages-in-business-central" />Skoðun á Síðum í Business Central
...
## <a name="work-with-page-inspection" />Vinna með síðueftirlit
...
## <a name="controlling-access-to-page-inspection-details" />Upplýsingar um stjórnun á aðgangi að síðueftirliti
