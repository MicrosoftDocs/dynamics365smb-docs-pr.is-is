...
ms.author: edupont
---
# <a name="setting-up-warehouse-management" />Vöruhúsastjórnun sett upp
...
## <a name="see-related-microsoft-trainingtrainingpathsset-up-warehouse-management" />Sjá tengda [Microsoft þjálfun](/training/paths/set-up-warehouse-management/)
