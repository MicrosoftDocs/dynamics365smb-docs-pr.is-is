...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms"></a><a name="set-up-finance-charge-terms"></a>Setja upp vaxtaskilmála
...
## <a name="finance-charge-terms"></a><a name="finance-charge-terms"></a>Vaxtaskilmálar
...
### <a name="to-set-up-finance-charge-terms"></a><a name="to-set-up-finance-charge-terms"></a>Setja upp vaxtaskilmála
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/send-memos-dynamics-365-business-central/)
