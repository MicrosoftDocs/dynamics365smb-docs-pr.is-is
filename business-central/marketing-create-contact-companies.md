...
ms.author: edupont
---
# <a name="create-contacts" />Stofna tengiliði
...
## <a name="to-create-a-contact-manually" />Að búa til tengilið handvirkt
...
## <a name="to-create-a-contact-from-a-customer-vendor-or-bank-account" />Tengiliðir stofnaðir úr viðskiptamanni, lánadrottni eða bankareikning:
...
## <a name="to-create-a-customer-vendor-employee-or-bank-account-from-a-contact" />Að stofna viðskiptamann, lánardrottin, starfsmann eða bankareikning úr tengilið
...
## <a name="to-link-a-contact-to-an-existing-customer-vendor-employee-or-bank-account" />Til að tengja tengilið við viðskiptamann, lánardrottin, starfsmann eða bankareikning sem þegar er til
...
## <a name="to-remove-a-link-between-a-contact-and-an-existing-customer-vendor-employee-or-bank-account" />Að fjarlægja tengil milli tengiliðar og fyrirliggjandi viðskiptamanns, lánardrottins, starfsmanns eða bankareiknings
...
## <a name="synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts" />Samstilla tengiliði við viðskiptamenn, lánardrottna, starfsmenn og bankareikninga
...
## <a name="to-view-which-customer-vendor-employee-or-bank-account-a-contact-is-related-to" />Til að skoða hvaða viðskiptavin, lánardrottin, starfsmann eða bankareikning tengiliður er tengdur við
