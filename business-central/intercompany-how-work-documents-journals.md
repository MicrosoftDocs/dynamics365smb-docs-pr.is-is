...
---
# <a name="work-with-intercompany-documents-and-journals" />Unnið með samstæðuskjöl og færslubækur
...
## <a name="fill-in-and-send-an-intercompany-sales-order" />Fylla út og senda samstæðusölupöntun
...
## <a name="fill-in-and-post-an-intercompany-journal" />Færa inn og bóka samstæðufærslubók
