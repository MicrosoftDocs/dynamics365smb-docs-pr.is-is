...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Skilgreina varðveislureglur
...
## <a name="required-setups-and-permissions" />Áskildar uppsetningar og heimildir
...
### <a name="to-create-retention-periods" />Varðveislutímar búnir til
...
### <a name="set-up-a-retention-policy" />Setja upp varðveislureglu
...
## <a name="applying-retention-policies" />Varðveislureglur settar á
...
## <a name="viewing-retention-policy-log-entries" />Kladdafærslur varðveislureglu skoðaðar
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Hafa með viðbótina í varðveislureglu (krefst aðstoðar frá þróunaraðila)
