...
# <a name="set-up-company-consolidation" />Setja upp sameiningu fyrirtækis
...
## <a name="simple-consolidation-setup" />Einföld uppsetning sameiningar
...
## <a name="advanced-consolidation-setup" />Ítarleg uppsetning sameiningar
...
### <a name="set-up-the-consolidated-company" />Setja upp fyrirtæki í samstæðu
