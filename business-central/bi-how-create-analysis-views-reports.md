...
ms.author: edupont
---
# <a name="create-analysis-reports" />Stofna greiningarskýrslur
...
## <a name="setting-up-line-and-column-layouts" />Uppsetning á útliti lína og dálka
...
## <a name="set-up-analysis-column-templates" />Seta upp greiningardálkssniðmát
...
## <a name="set-up-analysis-line-templates" />Setja upp greiningarlínusniðmát
...
## <a name="create-a-new-sales-analysis-report" />Stofna nýjar sölugreiningarskýrslur
