...
|**Til að**|**Sjá**|  
|------------|-------------|  
|Skilja aðferðir í kostnaðarvélinni, svo sem kostnaðaraðferð og kostnaðaraðlögun, og hvaða bókhaldsreglur þær eru hannaðar fyrir.|[Hönnunarupplýsingar: Birgðakostnaður](design-details-inventory-costing.md)|  
...
|Lærðu hvernig kerfið heldur stöðugri stjórn á framboði vara í vöruhúsinu, þannig að pantanir á útleið geti streymt á skilvirkan hátt og veitt bestu afhendingu.|[Hönnunarupplýsingar: Framboð í vöruhúsi](design-details-availability-in-the-warehouse.md)|
...
[Setja upp flókin umsóknarsvæði með því að nota bestu starfsvenjur](set-up-complex-application-areas-using-best-practices.md)    
