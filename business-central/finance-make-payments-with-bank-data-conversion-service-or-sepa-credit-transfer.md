...
## <a name="setting-up-sepa-credit-transfer" />Uppsetning SEPA-kreditfærslna
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer" />Að setja upp bankareikning fyrir SEPA-kreditfærslu
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer" />Að setja upp lánardrottin fyrir SEPA-kreditfærslu
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files" />Að stilla greiðslubók upp til að flytja greiðsluskrár
...
### <a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods" />Tengja gagnaskiptaskilgreiningu fyrir eina eða fleiri greiðslugerðir með viðeigandi greiðslumáta.
...
## <a name="preparing-the-payment-journal" />Greiðslubók undirbúin
...
## <a name="exporting-payments-to-a-bank-file" />Greiðslur fluttar út í bankaskrá
...
### <a name="to-export-payments-to-a-bank-file" />Til að flytja út greiðslur í bankaskrá
...
### <a name="to-plan-when-to-post-exported-payments" />Til að áætla hvenær á að bóka útfluttar greiðslur
...
### <a name="to-re-export-payments-to-a-bank-file" />Að endurútflytja greiðslur í bankaskrá
...
## <a name="posting-the-payments" />Bókun greiðslna
