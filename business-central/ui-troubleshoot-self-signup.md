...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Úrræðaleit innskráning í sjálfsafgreiðslu
...
## <a name="what-email-address-can-i-use-with-business-central" />Hvaða netfang get ég notað með Business Central?
...
## <a name="regional-availability" />Svæði í boði
