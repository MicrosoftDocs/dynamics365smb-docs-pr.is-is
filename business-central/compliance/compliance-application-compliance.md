...
# <a name="application-compliance" />Reglufylgni forrits
...
## <a name="data-privacy" />Gagnavernd
...
## <a name="accounting-processes-and-controls-to-aid-compliance" />Bókhaldsferli og stýringar til að stuðla að reglufylgni
...
## <a name="enhance-people-practices-with-technology" />Bæta venjur fólks í tæknimálum
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution" />Gera sér grein fyrir ávinningi af samþættri lausn í fyrirtækjarekstri
...
## <a name="gain-control-of-critical-information-processes-and-reports" />Fá stjórn á mikilvægum upplýsingum, ferlum og skýrslum
...
### <a name="manage-compliance-to-the-standards-that-matter" />Stjórna reglufylgni við staðla sem skipta máli
...
### <a name="tailor-financial-reports-to-your-needs" />Sérsníða fjárhagsskýrslur að þínum þörfum
...
### <a name="improve-information-validity" />Bæta upplýsingar um gildistíma
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands" />Framfylgja fljótt leitarbeiðnum og skýrslukröfum
...
### <a name="help-ensure-clear-audit-trails" />Hjálpa til við að tryggja skýra slóð færslna
...
## <a name="compliance-and-local-functionality" />Reglufylgni og staðbundin virkni
