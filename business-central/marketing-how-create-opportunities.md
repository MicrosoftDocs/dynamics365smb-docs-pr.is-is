...
ms.author: jswymer
---
# <a name="create-sales-opportunities" />Stofna sölutækifæri
...
## <a name="to-create-an-opportunity-from-a-salesperson" />Að búa til tækifæri hjá sölumanni
...
## <a name="to-create-an-opportunity-from-a-contact" />Að búa til tækifæri hjá tengilið
