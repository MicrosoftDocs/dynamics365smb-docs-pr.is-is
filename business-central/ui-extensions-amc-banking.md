...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a><a name="use-the-amc-banking-365-fundamentals-extension"></a>Nota AMC Banking 365 Fundamentals viðbótina
...
## <a name="use-our-demonstration-account"></a><a name="use-our-demonstration-account"></a>Nota sýnireikning okkar
...
## <a name="setting-up-the-extension"></a><a name="setting-up-the-extension"></a>Uppsetning viðbótarinnar
...
### <a name="to-set-up-the-required-permission-sets"></a><a name="to-set-up-the-required-permission-sets"></a>Til að setja upp áskildar heimildasamstæður
...
### <a name="to-connect-the-extension-to-amc-banking"></a><a name="to-connect-the-extension-to-amc-banking"></a>Til að tengja viðbótina við AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension"></a><a name="to-connect-bank-accounts-to-the-extension"></a>Til að tengja bankareikninga við viðbótina
...
## <a name="use-the-extension"></a><a name="use-the-extension"></a>Nota viðbótina
...
### <a name="to-export-data-and-submit-it-to-your-bank"></a><a name="to-export-data-and-submit-it-to-your-bank"></a>Til að flytja út gögn og senda þau í bankann þinn
...
### <a name="to-import-and-apply-the-converted-file"></a><a name="to-import-and-apply-the-converted-file"></a>Til að flytja inn og nota umbreyttu skrána
