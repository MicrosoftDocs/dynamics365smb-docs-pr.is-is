...
# <a name="use-the-amc-banking-365-fundamentals-extension" />Nota AMC Banking 365 Fundamentals viðbótina
...
## <a name="use-our-demonstration-account" />Nota sýnireikning okkar
...
## <a name="setting-up-the-extension" />Uppsetning viðbótarinnar
...
### <a name="to-set-up-the-required-permission-sets" />Til að setja upp áskildar heimildasamstæður
...
### <a name="to-connect-the-extension-to-amc-banking" />Til að tengja viðbótina við AMC Banking
...
### <a name="to-connect-bank-accounts-to-the-extension" />Til að tengja bankareikninga við viðbótina
...
## <a name="use-the-extension" />Nota viðbótina
...
### <a name="to-export-data-and-submit-it-to-your-bank" />Til að flytja út gögn og senda þau í bankann þinn
...
### <a name="to-import-and-apply-the-converted-file" />Til að flytja inn og nota umbreyttu skrána
