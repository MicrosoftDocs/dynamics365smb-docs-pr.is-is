...
ms.service: dynamics-365-business-central
---
# <a name="create-incoming-document-records-directly-from-documents-and-entries"></a>Stofna færslur skjala á innleið beint úr skjölum og færslum
...
## <a name="create-and-connect-an-incoming-document-record-from-a-purchase-invoice"></a>Stofna og tengja færslu skjals á innleið úr innkaupareikningi
...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry"></a>Stofna og tengja skjalafærslu á innleið úr lánardrottnafærslu
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document"></a>Fjarlægja tengingu úr færslu skjals á innleið til bókaðs skjals
