...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Greina listagögn með gagnamagniðmáti
...
## <a name="prerequisite" />Frumskilyrði
...
## <a name="work-with-data-analysis-mode" />Vinna við gagnagreiningarham
...
## <a name="pivot-mode" />Völvustilling
...
## <a name="limitations" />Takmarkanir
