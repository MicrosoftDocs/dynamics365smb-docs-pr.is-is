...
---
# <a name="set-up-email-printers" />Setja upp email prentara
...
## <a name="add-an-email-printer" />Bæta við tölvupóstprentara
...
## <a name="privacy-notice" />Tilkynning um persónuvernd
