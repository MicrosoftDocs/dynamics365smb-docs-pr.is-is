...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse" />Samstilling gagna í Business Central með Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization" />Stöðluð töfluvörpun fyrir samstilling
...
### <a name="tip-for-admins-viewing-table-mappings" />Ábending fyrir stjórnendur: Skoðun töfluvarpana
