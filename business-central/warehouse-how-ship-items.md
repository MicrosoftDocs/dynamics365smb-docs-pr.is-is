...
# <a name="ship-items-with-a-warehouse-shipment" />Senda vörur með vöruhúsaafhendingu
...
## <a name="to-ship-items-using-a-warehouse-shipment-document" />Vörur sendingar með vöruhúsaafhendingarskjali
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments" />Meðhöndlun íhluta pantanasamsetninga við vöruhúsaafhendingu
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/ship-invoice-items-dynamics-365-business-central/).
