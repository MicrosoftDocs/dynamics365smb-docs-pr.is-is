...
# <a name="manage-work-across-multiple-companies-in-the-company-hub" />Stjórna vinnu yfir mörg fyrirtæki í fyrirtækjamiðstöðinni
...
## <a name="company-hub-home-page" />Heimasíða fyrirtækjamiðstöðvar
...
## <a name="assigned-tasks" />Úthlutuð verkefni
...
### <a name="my-user-tasks" />Notandaverkefnin mín
...
## <a name="access-the-company-hub" />Aðgangur að fyrirtækjamiðstöðinni
...
## <a name="set-up-the-company-hub" />Setja upp fyrirtækjamiðstöðina
