...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook" />Nota Business Central sem fyrirtækjainnhólf í Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in" />Nýttu þér tengiliði og skjöl með því að nota innbót tengiliðainnsýnar
...
### <a name="look-up-a-business-contact-when-composing-an-email" />Fletta upp á viðskiptatengilið þegar tölvupóstur er skrifaður
...
### <a name="view-and-change-the-contact-details-or-switch-company" />Skoða og breyta samskiptaupplýsingum eða skipta um fyrirtæki
...
### <a name="track-incoming-documents" />Fylgjast með skjölum á innleið
...
### <a name="create-and-send-new-document-to-a-contact" />Búa til og senda nýtt skjal til tengiliðar
...
### <a name="attach-files-to-records" />Hengja skrár við færslur
...
#### <a name="how-to-attach-a-file" />Hvernig á að hengja við skrá
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />Skoða skjal úr tölvupósti með því að nota innbót skjalaskoðunar
