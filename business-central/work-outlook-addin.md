...
description: Þessi þjónusta hefur djúpa samþættingu við Microsoft 365 að gera þér kleift að stjórna öllum samskiptum þínum og pósti við viðskiptavini og lánardrottna beint í Outlook.
author: jswymer
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
