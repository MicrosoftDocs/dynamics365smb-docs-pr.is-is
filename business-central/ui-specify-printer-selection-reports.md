...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs" />Stilla prentara sem sjálfgefinn prentara fyrir öll prentverk
...
## <a name="set-a-default-printer-for-specific-reports" />Stilla sjálfgefinn prentara fyrir tilteknar skýrslur
...
## <a name="choosing-the-printer-when-running-a-report" />Val á prentara þegar skýrsla er keyrð
...
## <a name="sizing-print-jobs" />Stærð prentverka stillt
