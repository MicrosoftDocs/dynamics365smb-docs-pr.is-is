...
description: Kynntu þér hvernig á að setja upp prentara fyrir skýrslur og skjöl og mismunandi prenteiginleika sem eru í boði í Business Central.
author: jswymer
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
Að prenta skjöl og skýrslur úr [!INCLUDE[prod_short](includes/prod_short.md)] er mikilvægt verk fyrir fyrirtækjanotendur. Þú vilt gjarnan senda prentverk beint í einn prentara fyrirtækisins&mdash;sama hvaða [!INCLUDE[prod_short](includes/prod_short.md)] biðlara eða forrit þú ert að nota. Vegna þess að [!INCLUDE[prod_short](includes/prod_short.md)] á netinu er skýjaþjónusta getur það ekki náð beint til prentara á staðnum sem tengjast tækjum notendum, en það getur tengst við prentara í skýinu.
...
- Þú ert með hlutverkin **Prentarastjórnun** og **Altækur stjórnandi** í Azure.
    ...
    Til að stjórna skýjaprentun verður reikningurinn þinn að vera með hlutverkin **Prentarastjórnun** og **Altækur stjórnandi** í Azure AD. Þessi hlutverk eru aðeins nauðsynleg til að stjórna skýjaprentun. Þetta er ekki nauðsynlegt fyrir þá sem nota prentarana frá [!INCLUDE[prod_short](includes/prod_short.md)].
...
5. Deilið prenturunum.
    ...
    Frekari upplýsingar má finna á [Deila prentara](/universal-print/portal/share-printers).
...
6. Veita notendum heimild fyrir samnýtta prentara.
    ...
    Frekari upplýsingar eru í [Prentheimildir](/universal-print/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
### <a name="add-universal-print-printers-to-business-central"></a>Bæta prenturum skýjaprentunar við Business Central
...
3. Fylgdu leiðbeiningunum á skjánum.
    ...
    Þessar aðgerðir staðfesta Azure AD uppsetninguna (fyrir á staðnum), athuga leyfi skýjaprentunar og að lokum bætir við prenturum.
...
- Viðbótin **Senda á tölvupóstsprentara** er uppsett
    ...
    Þessi viðbót er uppsett sjálfgefið Fáðu frekari upplýsingar um uppsetningu viðbóta, sjá<!--see what?--> 
