...
ms.author: jswymer
---
# <a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="default"></a> Tilgreina sjálfgefinn prentara
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a>Stilla prentara sem sjálfgefinn prentara fyrir öll prentverk
...
## <a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a>Stilla sjálfgefinn prentara fyrir tilteknar skýrslur
...
## <a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a>Val á prentara þegar skýrsla er keyrð
...
## <a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a>Stærð prentverka stillt
...
[Microsoft þjálfun](/training/modules/change-documents-dynamics-365-business-central/)
