...
> [!NOTE]
> Að senda tilkynningu í tölvupósti krefst þess að eiginleiki tölvupósts verði settur upp í [!INCLUDE[prodshort](includes/prodshort.md)]. Frekari upplýsingar eru í [Setja upp tölvupóst](admin-how-setup-email.md).
...
> [!NOTE]
> Þegar búið er að skrá einn eða fleiri rieti og hefja vöktun þarf að skrá sig út úr [!INCLUDE[prodshort](includes/prodshort.md)] og skrá sig inn aftur til að stillingarnar taki gildi.
