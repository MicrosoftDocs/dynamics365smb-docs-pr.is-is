...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a>Þjónustubókun
...
## <a name="ship"></a><a name="ship"></a>Afhenda
...
## <a name="invoice"></a><a name="invoice"></a>Reikningsfæra
...
## <a name="ship-and-invoice"></a><a name="ship-and-invoice"></a>Afhenda og reikningsfæra
Valkosturinn afhenda og reikningsfæra gerir kleift að gefa út þjónustuafhendingu og reikning á sama tíma.  

## <a name="ship-and-consume"></a><a name="ship-and-consume"></a>Afhenda og nota
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>Viðbótarupplýsingar um bókuð þjónustuskjöl skoðaðar
