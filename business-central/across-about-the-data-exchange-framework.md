...
description: Þetta efnisatriði útskýrir hvernig á að nota gagnaskiptarammann til að hafa umsjón með skiptingu gagna í viðskiptaskjölum eins og reikningum með viðskiptafélögum þínum.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a>Um gagnaskiptaramma
...
## <a name="electronic-documents"></a><a name="electronic-documents"></a><a name="electronic-documents"></a>Rafræn skjöl
...
## <a name="bank-files"></a><a name="bank-files"></a><a name="bank-files"></a>Bankaskrár
...
## <a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a>Gengi gjaldmiðla
