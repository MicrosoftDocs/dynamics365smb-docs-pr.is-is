...
description: Þessi grein útskýrir hvernig á að nota Data Exchange Framework til að stjórna gagnaskiptum í viðskiptaskjölum eins og reikningum við viðskiptafélaga þína.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
[!INCLUDE[prod_short](includes/prod_short.md)] notar Data Exchange Framework fyrir Intrastat-skýrslugerð þar sem þú getur auðveldlega búið til tímastimplaðar skrár á mismunandi sniði fyrir útflutning. [!INCLUDE[prod_short](includes/prod_short.md)] inniheldur tilbúið snið fyrir staðbundin lönd/svæði og fyrir sjálfgefna útgáfu. En þú getur breytt tilbúinni skýrslu eða gert þína eigin.
