...
* Hvernig á að afskrifa eignir.  
* Hvernig stofnkostnaður, afskriftir og önnur gildi eru skráð í fjárhag.  
* Valfrjálst er hvernig á að skrá vátryggingu og viðhald eigna.

Hlutarnir í greininni tengja við nánari upplýsingar um hvernig eignir eru settar upp. Þegar uppsetningunni er lokið er hægt að byrja að vinna með eignir. Nánari upplýsingar [eru í Notkun eigna](fa-manage.md).  

> [!NOTE]  
> Hægt er að skrá eignafærslur á síðunum **Fjárhagsbók eigna** eða í **Færslubók eigna**, allt eftir því hvort færslurnar eru fyrir fjárhagsskýrslugerð eða fyrir innri stjórnun. Hjálpargreinar eigna lýsa aðeins notkun síðunnar **Eignafjárhagsbók** .  
