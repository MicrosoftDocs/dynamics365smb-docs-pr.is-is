...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>[!INCLUDE [prod_short.md](includes/prod_short.md)] Er App fyrir hópa það sama og  [!INCLUDE [prod_short.md](includes/prod_short.md)]  App fyrir  iOS  og Android?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Af hverju Sýna kort ekki meiri upplýsingar í staðinn fyrir bara hnapp síðunnar og nánar?
