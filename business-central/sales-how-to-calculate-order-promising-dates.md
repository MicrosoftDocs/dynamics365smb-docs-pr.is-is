...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Reikna dagsetningar pöntunarloforða
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>Um pöntun lofað
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>Tiltækt að lofa
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>Hægt að lofa
...
### <a name="calculations"></a><a name="calculations"></a>Útreikningar
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Uppsetning pöntunarloforðs
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Afgreiðslutímar vöruhúss fyrir inn- og útleið í pöntun lofað
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a><a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a>Til að færa inn afgreiðslutíma vöruhús á inn- og útleið fyrir sölu- og innkaupaskjöl
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>Að færa inn afgreiðslutíma vöruhúss fyrir inn- og útleið í birgðageymslum
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Varan bundin:
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Dagsetning pöntunarloforðs reiknuð:
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
