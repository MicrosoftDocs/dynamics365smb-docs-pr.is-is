...
ms.author: bholtorf
---
# <a name="register-new-vendors"></a><a name="register-new-vendors"></a>Skráning nýrra lánardrottna
...
## <a name="adding-new-vendors"></a><a name="adding-new-vendors"></a>Nýjum lánardrottnum bætt við
...
### <a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a>Að búa til nýjan lánardrottinn
...
### <a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a>Að eyða og breyta lánardrottnaupplýsingum
...
## <a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a>Að vista lánardrottnaspjaldið sem sniðmát
