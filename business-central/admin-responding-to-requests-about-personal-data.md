...
# <a name="responding-to-requests-about-users-personal-data"></a>Svara beiðnum um persónugögn notenda
...
## <a name="restrict-data-processing-for-a-data-subject"></a>Takmarka vinnslu gagna fyrir gagnaaðila
...
## <a name="handling-data-subject-requests-when-using-a-trial-version"></a>Meðhöndlun efnisbeiðna gagna þegar prufuútgáfa er notuð
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject"></a>Útflutningur gagna úr töflum sem ekki eru flokkaðar eftir gögnum
...
## <a name="handling-data-about-minors"></a>Meðferð gagna um minnihlutahópa
