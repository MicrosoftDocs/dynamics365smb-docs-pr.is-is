...
# Að bregðast við beiðnum um persónuupplýsingar notenda
...
## Takmarka gagnavinnslu fyrir skráðan einstakling
...
## Meðhöndlun beiðna skráðra einstaklinga þegar prufuútgáfa er notuð
...
## Flytja út gögn úr töflum sem ekki eru flokkaðar eftir skráðum einstaklingi
...
## Meðhöndlun gagna um ólögráða börn
