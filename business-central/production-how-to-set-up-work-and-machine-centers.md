...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Setja upp vinnu- og vélastöðvar
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>Vinnustöð sett upp
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Hvað skal hafa í huga varðandi afkastagetu
...
### <a name="run-time"></a><a name="run-time"></a><a name="run-time"></a>Keyrslutími
...
### <a name="setup-time"></a><a name="setup-time"></a><a name="setup-time"></a>Uppsetningartími
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Vinnustöð sem vinnur úr mörgum pöntunum samtímis
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Skilvirkt tilfang getur úthlutað aðeins hluta af vinnudagsetningu þeirra í framleiðsluvinnu
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Sameinað dagtal
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Dæmi - Mismunandi vélastöðvum úthlutað á vinnustöð
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>Vinnu- eða vélastöð með takmarkaða afkastagetu sett upp
