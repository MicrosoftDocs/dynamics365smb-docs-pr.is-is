...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Setja upp vinnu- og vélastöðvar
...
## <a name="to-set-up-a-work-center" />Vinnustöð sett upp
...
## <a name="considerations-about-capacity" />Hvað skal hafa í huga varðandi afkastagetu
...
### <a name="setup-time" />Uppsetningartími
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Vinnustöð sem vinnur úr mörgum pöntunum samtímis
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Skilvirkt tilfang getur úthlutað aðeins hluta af vinnudagsetningu þeirra í framleiðsluvinnu
...
### <a name="consolidated-calendar" />Sameinað dagtal
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Dæmi - Mismunandi vélastöðvum úthlutað á vinnustöð
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Vinnu- eða vélastöð með takmarkaða afkastagetu sett upp
