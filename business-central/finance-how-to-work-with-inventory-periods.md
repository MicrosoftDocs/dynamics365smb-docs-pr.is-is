...
ms.author: edupont
---
# <a name="work-with-inventory-periods" />Vinna við birgðatímabil
...
## <a name="to-create-an-inventory-period" />Til að stofna birgðatímabil
...
## <a name="closing-inventory-periods" />Lokun birgðatímabila
...
### <a name="to-close-an-inventory-period" />Til að loka birgðatímabili
...
## <a name="reopening-inventory-periods" />Enduropnun birgðatímabila
...
### <a name="to-reopen-an-inventory-period" />Til að enduropna birgðatímabil
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Birgðatímabil** og velja síðan viðkomandi tengil.  
