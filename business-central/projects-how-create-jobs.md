...
ms.author: edupont
---
# <a name="create-jobs" />Stofna verk
...
## <a name="to-create-a-job-card" />Til að stofna verkspjald
...
## <a name="to-create-tasks-for-a-job" />Til að búa til verkhluta fyrir verk
...
## <a name="to-create-planning-lines-for-a-job" />Til að stofna verkáætlunarlínu fyrir verk
