...
ms.author: edupont
---
# <a name="analyzing-financial-statements-in-microsoft-excel"></a><a name="analyzing-financial-statements-in-microsoft-excel"></a>Greina fjárhagsskýrslur í Excel Microsoft Excel.
...
## <a name="getting-the-overview-and-the-details-in-excel"></a><a name="getting-the-overview-and-the-details-in-excel"></a>Fá yfirlit og upplýsingar í Excel
...
### <a name="understanding-the-excel-templates"></a><a name="understanding-the-excel-templates"></a>Að skilja Excel-sniðmátin
...
## <a name="the--excel-add-in"></a><a name="the--excel-add-in"></a>[!INCLUDE [prod_short](includes/prod_short.md)] Excel-innbótin
