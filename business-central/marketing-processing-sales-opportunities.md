...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Meðhöndla sölutækifæri
Þegar tækifæri er stofnað eru margar aðgerðir til að stjórna tækifæri og vinna það til enda.

## <a name="to-view-opportunities" />Skoða tækifæri
...
## <a name="to-close-opportunities" />Tækifærum lokað
...
## <a name="to-create-quotes-for-opportunities" />Tilboð stofnuð fyrir tækifæri
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />Sölupantanir stofnaðar fyrir tækifæri
...
## <a name="to-delete-opportunities" />Tækifærum eytt
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />Færa tækifæri gegnum þrep söluferlis
