...
Til að eyða lokuðum tækifærum með því að nota **Eyða tækifæri** lotuvinnunni skaltu fylgja þessum skrefum:

1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") Táknið, sláðu inn **Gagnastjórnun** og veldu síðan tengda tengilinn.
2. Veldu **Eyða tækifæri** aðgerðina og stilltu síðan síurnar sem tilgreina lokuð tækifæri til að eyða.
