...
---
# <a name="pick-items-with-inventory-picks" />Vörur tíndar með birgðatínslu
...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Fleiri en ein birgðatínsla stofnuð með keyrslu
...
## <a name="to-create-the-pick-in-two-steps" />Tínslan stofnuð í tveimur skrefum

### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />Til að biðja um birgðatínslu með því að gefa út upprunaskjalið
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />Birgðatínsla stofnaður á grundvelli upprunaskjals
...
## <a name="to-record-inventory-picks" />Birgðatínsla skráð
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Meðhöndlun á saman vörum í birgðum með birgðatínslu
