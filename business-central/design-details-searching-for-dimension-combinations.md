...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Hönnunarupplýsingar Leitað að víddarsamsetningum
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a>Byggir leitartré
...
### <a name="example-1"></a><a name="example-1"></a>Dæmi 1
...
### <a name="example-2"></a><a name="example-2"></a>Dæmi 2
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Finna auðkenni víddasamstæðu
