...
ms.author: edupont
---
# <a name="set-up-document-sending-profiles" />Setja upp sendisnið skjala
...
## <a name="to-set-up-a-document-sending-profile" />Að setja upp sendingarsnið skjala
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Til að tilgreina sendingarsnið á viðskiptamannaspjaldi
