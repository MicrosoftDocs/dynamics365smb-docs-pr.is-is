...
* Velja **Samskiptaskráningarfærslur** aðgerð á tengilið eða hluta.
   **Á síðunni Samskiptaskráningarfærsla**  eru samskipti sem búin eru til handvirkt og samskiptin sem  [!INCLUDE [prod_short](includes/prod_short.md)]  skráir sjálfkrafa.

Notaðu síðuna Samskiptaskráningarfærslur til að skoða stöðu samskipta og hætta við samskipti.
