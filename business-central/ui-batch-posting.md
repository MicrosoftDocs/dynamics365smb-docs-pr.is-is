...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Bóka mörg skjöl samtímis
...
## <a name="to-post-multiple-purchase-orders-immediately" />Til að bóka margar innkaupapantanir strax
...
## <a name="to-batch-post-multiple-purchase-orders" />Til að runubóka marga innkaupapantanir
...
## <a name="to-set-up-background-posting-with-job-queues" />Að setja upp bókun í bakgrunni með verkraðir
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Til að skoða stöðu úr sölu- eða innkaupaskjali
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Til að stofna færslu verkraðar fyrir bókun runu á sölupöntunum
...
## <a name="monitor-the-job-queue" />Fylgjast með verkröðinni
