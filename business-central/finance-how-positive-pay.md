...
ms.author: edupont
---
# <a name="export-a-positive-pay-file" />Flytja út jákvæða greiðsluskrá
...
## <a name="to-set-up-a-bank-account-for-positive-pay" />Að setja upp bankareikning fyrir Positive Pay
...
## <a name="to-export-a-positive-pay-file" />Til að flytja út jákvæða greiðsluskrá
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Bankareikningar** og velja síðan viðkomandi tengil.
