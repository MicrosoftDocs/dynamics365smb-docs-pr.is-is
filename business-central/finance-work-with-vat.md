...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a>Útreikningur og Birting VSK-upphæða í sölu-og innkaupaskjölum
...
> [!IMPORTANT]
> Byrja í útgáfu 23,1, hægt er að koma í veg fyrir eða leyfa bókun á  **VSK-dagsetningu**  fyrir tiltekið gagnassvið með því  **að nota Allow VSK-dagsetningu frá**  og  **Leyfa VSK-dagsetningu að**  reitum í  **VSK-uppsetningu**  og  **uppsetningu** notandans. Ef verið er að nota eldri útgáfur er hægt að koma í veg fyrir eða leyfa bókun á  **VSK-dagsetningunni**  fyrir tiltekin gagnabil með því  **að nota bókun leyfð**  í  **og**  Bóka í  **svæði fjárhags**  og  **uppsetningu** notanda.  
...
### <a name="modifying-the-vat-date-in-posted-entries"></a>Breyta VSK-dagsetningunni í bókuðum færslum
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a>Upphæð VSK leiðrétt handvirkt í sölu-og innkaupaskjölum
...
## <a name="calculating-vat-manually-using-journals"></a>VSK er reiknaður með handvirkt færslubókum
...
## <a name="processing-certificates-of-supply"></a>Unnið með vottorð um framboð
