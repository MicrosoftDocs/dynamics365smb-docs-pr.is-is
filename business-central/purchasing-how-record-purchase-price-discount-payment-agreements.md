...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Skrá sérstakt söluverð og sérstaka afslætti
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Að setja upp sérstakt innkaupsverð fyrir lánardrottin
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Að setja upp línuafslátt fyrir lánardrottin
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Að setja upp reikningsafslátt fyrir lánardrottin
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Regla valin fyrir bókun á innkaupaafslætti:
...
## <a name="purchase-invoice-discounts-and-service-charges" />Afslættir Innkaupareiknings og Þjónustugjöld
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics-365-business-centralindex" />Sjá tengda [Microsoft þjálfun](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index)
