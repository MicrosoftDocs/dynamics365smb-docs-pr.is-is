---
title: Um útreikning á stöðluðu kostnaðarverði
...
# <a name="about-calculating-standard-cost"></a>Um útreikning á stöðluðu kostnaðarverði
...
## <a name="set-up-standard-costs"></a>Setja upp staðlað kostnaðarverð
...
**Staðlað kostn.verð**: Færður er inn leiðréttingarstuðullinn sem á að nota til að uppfæra staðlað kostnaðarverð. Einnig er hægt að velja sléttun aðferð fyrir nýja staðlaða kostnaðarverðið. Fylla þarf út reitinn með aukastöfum fyrir prósentuhækkunina, til dæmis 1,1.
...
Ef gátreiturinn **Sjálfvirk kostnaðarbókun** hefur ekki verið valinn í **glugganum Birgðagrunnur** er birgðakostnaður ekki skráður kviklega í fjárhagur og KSV er ekki reiknaður með sölu. Þess vegna verður að bóka á fjárhagur handvirkt með því að keyra **keyrsluna Bóka birgðabreytingar** til að uppfæra fjárhagur og prenta skýrslu um virðisfærslurnar sem eru bókaðar.

Keyrslan notar virðisfærslur sem grunn. Til að reikna gildið sem á að bóka er notaður mismunurinn á reitunum **Kostnaðarupphæð (raunverul.)** og **Kostnaðarbókað í fjárhag** í virðisfærslunum. Ef gátreiturinn **Væntanl. kostn. bók. í fjárhag** hefur verið valinn í **glugganum Birgðagrunnur** bókar keyrslan einnig mismuninn á reitunum **Kostnaðarupphæð (væntanl.)** og Reitnum **Væntanl. kostn. bókaður í fjárhag** til bráðabirgðareikninga í fjárhagur.
...
> [!NOTE] 
> Ef keyrslan rekst á villu vegna vídda eða víddaruppsetningar hnekkir keyrslan villunni og bókar færsluna á fjárhagur með því að nota víddir virðisfærslunnar.
...
|--------------|---------|
|**Bókunaraðferð**|Keyrslan getur bókað birgðavirði í fjárhagur eftir bókunarflokki eða á hverja bókaða færslu. Ef bókað er á hverja færslu fæst nákvæm sundurliðun á því hvaða áhrif birgðir hafa á fjárhag, en einnig margar fjárhagsfærslur. Ef bókað er á hvern bókunarflokk býr keyrslan til fjárhagur færslu fyrir hverja bókunardagsetningu fyrir hvern bókunarflokk. Það merkir að fjárhagsfærslan er stofnuð fyrir hverja samsetningu bókunardagsetninga, almenna viðskiptabókunarflokka, almenna framleiðslubókunarflokka, birgðabókunarflokka og staðsetningarkóta. Auk þess býr keyrslan til sérstakar fjárhagur færslur fyrir kostnað með mismunandi merkjum.|
...
|**Færsla**|Þessi reitur er valinn eigi keyrslan að bókast sjálfkrafa í fjárhagur. Ef ekki er valið að bóka birgðakostnað í fjárhag prentar keyrslan aðeins prófunarskýrslu sem sýnir virði sem hægt er að bóka á fjárhagur og í skýrslunni birtist **prófunarskýrsla (óbókuð)**.|

### <a name="roll-up-standard-cost"></a>Leggja saman staðlað kostnaðarverð
