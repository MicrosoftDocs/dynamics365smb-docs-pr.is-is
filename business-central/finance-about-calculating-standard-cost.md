...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />Um umreikning staðalkostnaðar
...
## <a name="setting-up-standard-costs" />Uppsetning staðlaðs kostnaðarverðs
...
### <a name="material-costs" />Efniskostnaður
...
### <a name="capacity-costs" />Getukostnaður
...
### <a name="subcontractor-costs" />Undirverktakakostnaður
...
## <a name="updating-standard-costs" />Uppfærsla staðlaðs kostnaðarverðs
