...
> [!NOTE]
> Ferlið við að stjórna notendum og leyfum er mismunandi eftir því hvort [!INCLUDE[d365fin](includes/d365fin_md.md)] er sett upp á netinu eða innanhúss. Fyrir [!INCLUDE [prodshort](includes/prodshort.md)] á netinu þarf að bæta við notendum úr Office 365. Í uppsetningum á staðnum er hægt að búa til, breyta og eyða notendum beint.  
...
Þegar notendum er úthlutað [!INCLUDE[d365fin](includes/d365fin_md.md)] leyfi í Office 365 er hægt að flytja þá inn í **Notendur** síðuna í [!INCLUDE[d365fin](includes/d365fin_md.md)] með því að nota aðgerðina **Sækja nýja notendur úr Office 365**.
...
2. Veldu aðgerðina **Uppfæra notendur úr Office 365**.
    ...
    Ef þetta er í fyrsta skipti sem þú bætir við notendum úr Office 365, skaltu velja aðgerðina **Ná í nýja notendur úr Office 365**.  
3. Fylgdu skrefunum í leiðarvísinum sem birtist.

Nýjum notendum og notandaupplýsingum í Office 365 áskriftinni þinni verður bætt við á síðunni **Notendur** í [!INCLUDE[d365fin](includes/d365fin_md.md)]. Nú geturðu úthlutað notendaflokkum og heimildum. Frekari upplýsingar eru í [Úthluta leyfum til notenda og hópa](ui-define-granular-permissions.md).  

Frekari upplýsingar um samstillingu notandaupplýsinga við Office 365 er að finna í hlutanum [Samstilling við Office 365](#synchronization-with-office-365).
