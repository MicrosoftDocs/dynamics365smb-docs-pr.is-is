...
> [!IMPORTANT]  
> Með því að keyra samstillingu notenda með Microsoft 365 því að nota **leiðbeiningarnar Uppfæra notendur úr Microsoft 365** leiðsagnarforritinu þarf SUPER heimildasamstæða.

> [!NOTE]
> Uppfærir **notendur úr Microsoft 365** handbókinni uppfærir ekki notendur sem ekki hafa fengið leyfi, t.d. einhver sem er [kerfisstjóri](/entra/identity/role-based-access-control/permissions-reference#dynamics-365-administrator) Dynamics 365. Þessir notendur uppfærast næst þegar þeir skrá sig inn í umhverfið.

Næsta skref fyrir nýstofnaða notendur er að úthluta notendaflokkum og heimildum. Farið í [Úthlutun heimilda til notenda og hópa](ui-define-granular-permissions.md) fyrir upplýsingar. Ef notandi er uppfærður með leyfisbreytingu [!INCLUDE [prod_short](includes/prod_short.md)]  úthlutar notendum viðeigandi notendaflokkur og uppfærir heimildasafn þeirra. Frekari upplýsingar er að finna á[Til að stjórna heimildum í gegnum notendaflokka](ui-define-granular-permissions.md).  
