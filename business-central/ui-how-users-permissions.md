...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses" />Búa til notendur samkvæmt leyfum
...
## <a name="manage-users-and-licenses-in-online-tenants" />Stjórna notendum og leyfum í leigjendum á netinu
...
### <a name="to-remove-a-users-access-to-the-system" />Til að fjarlægja aðgang notanda að kerfinu
...
### <a name="a-namemasynchronization-with-microsoft-" /><a name="m365"></a>Samstilling við Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments" />Umsjón með notendum og leyfum í uppsetningu innanhúss
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment" />Til að breyta eða eyða notanda í uppsetningu á staðnum
