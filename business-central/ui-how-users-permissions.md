...
> [!NOTE]
> Ferlið við að stjórna notendum og leyfum er mismunandi eftir því hvort [!INCLUDE[prod_short](includes/prod_short.md)] er sett upp á netinu eða innanhúss. [!INCLUDE [prod_short](includes/prod_short.md)] Það þarf að bæta notendum við á netinu Microsoft 365. Í uppsetningum á staðnum er hægt að búa til, breyta og eyða notendum beint.  
...
- Microsoft 365 Kerfisstjóri fyrirtækisins getur gert það í [Microsoft 365 stjórnendamiðstöð](https://admin.microsoft.com). Nánari upplýsingar eru í [Bæta við notendum sérstaklega eða að magni til Microsoft 365](/microsoft-365/admin/add-users/add-users).  
...
Nánari upplýsingar um samstillingu notendaupplýsinga með Microsoft 365 er að finna í [Microsoft 365](#m365) samstillingarhlutanum.
...
Þegar leyfi er úthlutað [!INCLUDE[prod_short](includes/prod_short.md)] til notanda í Microsoft 365 eru tvær leiðir til að stofna notandann í [!INCLUDE[prod_short](includes/prod_short.md)].  
...
Ef notendaupplýsingum er breytt í Microsoft 365 er hægt [!INCLUDE[prod_short](includes/prod_short.md)] að uppfæra til samræmis við breytinguna. Eftir því hvað á að uppfæra er hægt að velja eina af aðgerðunum á síðunni **Notendur**. Aðgerðunum er lýst í síðustu þremur dálkunum í töflunni hér að neðan.
...
|Samstilla notendáætlanir (leyfi) með leyfum og hlutverkum sem þeim er úthlutað Microsoft 365.<!--<br /><br />Codeunit "Azure AD   Graph User".UpdateUserPlans-->|**X**|**X**|**X**|**X**|**X**| |
