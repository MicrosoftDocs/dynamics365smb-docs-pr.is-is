...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central fyrir fyrirtæki á mörgum stöðum og alþjóðlegar stofnanir
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Samþætting höfuðstöðvarfyrirtækisins og svæða
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Uppfylla þarfir innlendra og alþjóðlegra vefsvæða
...
## <a name="consolidate-financial-data" />Sameina fjárhagsgögn
...
## <a name="share-business-insight-with-integrated-analytics" />Deildu viðskiptainnsýn með samþættri greiningu
...
## <a name="exchange-data-using-apis-and-xmlports" />Gagnaskipti með API og XMLports
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Kynna skilvirka framboðskeðju samstæðu
...
## <a name="respond-quickly-to-new-business-conditions" />Bregðast hratt við nýjum viðskiptaaðstæðum
