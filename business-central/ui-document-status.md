...
ms.author: bholtorf
---
# <a name="status-field-on-documents"></a><a name="status-field-on-documents"></a>Stöðureitur á skjölum
...
## <a name="release-process"></a><a name="release-process"></a>Útgáfuferli
...
### <a name="approval-procedures"></a><a name="approval-procedures"></a>Samþykktarferli
...
### <a name="warehouse-activities"></a><a name="warehouse-activities"></a>Vöruhúsaaðgerðir
...
## <a name="reopen-a-released-order"></a><a name="reopen-a-released-order"></a>Enduropna útgefna pöntun
