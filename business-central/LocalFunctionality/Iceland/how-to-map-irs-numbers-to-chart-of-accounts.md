...
ms.author: edupont
---
# <a name="map-irs-numbers-to-chart-of-accounts-in-the-icelandic-version"></a><a name="map-irs-numbers-to-chart-of-accounts-in-the-icelandic-version"></a>Varpa skattstofunúmerum í bókhaldslykla í íslenskri útgáfu
...
## <a name="to-create-an-internal-revenue-service-number"></a><a name="to-create-an-internal-revenue-service-number"></a>Til að stofna skattstofunúmer
...
## <a name="to-map-an-irs-number-to-a-general-ledger-account"></a><a name="to-map-an-irs-number-to-a-general-ledger-account"></a>Til að varpa skattstofunúmeri í fjárhagsreikning
