...
ms.author: edupont
---
# <a name="map-irs-numbers-to-chart-of-accounts-in-the-icelandic-version" />Varpa skattstofunúmerum í bókhaldslykla í íslenskri útgáfu
...
## <a name="to-create-an-internal-revenue-service-number" />Til að stofna skattstofunúmer
...
## <a name="to-map-an-irs-number-to-a-general-ledger-account" />Til að varpa skattstofunúmeri í fjárhagsreikning
