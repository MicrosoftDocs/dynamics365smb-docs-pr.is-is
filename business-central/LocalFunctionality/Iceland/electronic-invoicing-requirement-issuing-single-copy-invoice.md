---
title: Krafa um rafræna reikningagerð fyrir útgáfu einstaks reiknings
description: Á Íslandi þarf að senda skýrslu til ríkisins ef reikningur er prentaður oftar en einu sinni með rafrænum reikningum.
author: brentholtorf
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: bholtorf
---
# <a name="electronic-invoicing-requirement-issuing-single-copy-invoice"></a>Krafa um rafræna reikning: Gefa út eintaksreikning

Á Íslandi þarf að senda skýrslu til ríkisins ef reikningur er prentaður oftar en einu sinni. Skýrslan inniheldur lagalegan texta þar sem staðfest er að reikningurinn sé búinn til í bókhalds- og áætlunarkerfi sem samræmist lögum.  
