...
ms.author: bholtorf
---
# <a name="iceland-local-functionality"></a><a name="iceland-local-functionality"></a><a name="iceland-local-functionality"></a>Staðbundnar aðgerðir fyrir Ísland
...
## <a name="feature-availability"></a><a name="feature-availability"></a><a name="feature-availability"></a>Framboð á eiginleika
...
## <a name="future-legislation-requirements-being-investigated"></a><a name="future-legislation-requirements-being-investigated"></a><a name="future-legislation-requirements-being-investigated"></a>Síðari löggæslukröfur verið rannsakaðar
