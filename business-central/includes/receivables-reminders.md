...
### <a name="to-create-a-reminder-automatically" />Innheimtubréf búin til sjálfvirkt:
...
### <a name="to-create-a-reminder-manually" />Innheimtubréf búin til handvirkt:
...
### <a name="to-replace-reminder-texts" />Texta innheimtubréfs skipt út.
...
### <a name="to-issue-a-reminder" />Gefa út innheimtubréf
...
### <a name="to-cancel-an-issued-reminder" />Hætta við útgefið innheimtubréf
