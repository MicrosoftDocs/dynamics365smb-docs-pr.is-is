...
### <a name="create-an-admin-role-group" />Stofna stjórnandahlutverkhóp
...
### <a name="create-a-new-public-folder-mailbox" />Stofna nýja almenna möppu í pósthólfi
...
### <a name="create-new-public-folders" />Stofna nýjar almenningsmöppur
...
### <a name="set-public-folder-ownership" />Setja eignarhald á opna möppu
...
### <a name="mail-enable-the-queue-public-folder" />Virkja tölvupóst fyrir *biðröð* opinnar möppu
...
### <a name="mail-enable-sending-emails-to-the-queue-public-folder" />Þegar tölvupóstur er virkjaður er hægt að senda tölvupóst á *biðröð* opnu möppunnar
