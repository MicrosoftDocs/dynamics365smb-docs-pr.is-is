...
Í stað þess að slá inn upplýsingar um SMTP-miðlara geturðu notað **Nota Microsoft 365 Server stillingar** aðgerð til að slá þær inn með upplýsingum frá Microsoft 365 áskriftinni þinni.
...
2. Fyllið inn reitina eftir þörfum. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
    ...
    > [!NOTE]
    > Ef verið er að nota lykil sem krefst tveggja þátta sannvottunar, verður aðgangsorðið sem fært er inn í reitinn **Aðgangsorð** að vera það sama og notað er fyrir þessa Microsoft 365 áskrift og verður að vera af gerðinni **Forritsaðgangsorð** . Frekari upplýsingar er að finna í [Stjórna aðgangsorðum forrita fyrir tvíþætta staðfestingu](/azure/active-directory/user-help/multi-factor-authentication-end-user-app-passwords).
3. Þú getur einnig valið **Nota stillingar Microsoft 365 Server** aðgerðina til að setja inn upplýsingar sem eru þegar skilgreindar fyrir Microsoft 365 áskriftina þína.
