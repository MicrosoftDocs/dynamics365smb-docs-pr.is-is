...
> [!NOTE]
> Viðbætur **Microsoft 365 Tengils** og **Tengils núverandi notanda** nota reikningana til að setja upp fyrir notendur í Microsoft 365 stjórnendamiðstöðinni fyrir Microsoft 365-áskriftina. Til að senda tölvupóst með viðbótunum verða notendur að vera með gilt leyfi fyrir Exchange Online. Auk þess krefjast þessar viðbætur, í sandkassaumhverfi, þar á meðal **Viðbót Outlook REST API** viðbót við **að stillingin Leyfa httpClient beiðnir** sé virk. Til að athuga hvort hún sé virk fyrir þessar viðbætur skal fara á síðuna **Viðbótastjórnun**, velja viðbótina og síðan velja valkostinn **Grunnstilla**.
...
> [!IMPORTANT]
> Ef þú notar [!INCLUDE[prod_short](includes/prod_short.md)] á staðnum getur þú notað OAuth 2.0 samskiptareglur til sannvottunar. Ef nota á OAuth fyrir SMTP verða allir notendur að vera á sama Microsoft Entra leigjanda. 
> 
...
Nánari upplýsingar um almennar leiðbeiningar um skráningu forrits á [Quickstart: Skráðu forrit á auðkennisvettvang Microsoft](/azure/active-directory/develop/quickstart-register-app).
...
1. Í [!INCLUDE[prod_short](includes/prod_short.md)] skal velja ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") Táknmynd, sláðu inn **Email Application Microsoft Entra ID Skráning** og veldu svo viðeigandi tengil.
2. Fyllið inn reitina eftir þörfum. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
