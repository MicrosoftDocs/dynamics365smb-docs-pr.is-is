...
# <a name="set-up-email" />Setja upp tölvupóst
...
## <a name="adding-email-accounts" />Bæta við tölvupóstreikningum
...
## <a name="add-email-accounts" />Bæta tölvupóstreikningum við
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Tengja tölvupóstaðstæður við tölvupóstreikninga
...
## <a name="set-up-view-policies" />Setja upp skoðunarreglur
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Tilgreina hversu mörg boð geta sent reikning á mínútu
...
## <a name="set-up-reusable-email-texts-and-layouts" />Setja upp endurnýtanlegan senditexta og skipulag
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Nota vistfang staðgengils sendanda á útleið í tölvupósti
...
## <a name="set-up-document-sending-profiles" />Setja upp forstillingar fyrir sendingu skjals
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Valfrjálst: setja upp tölvupóstskráningu í Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Uppsetning tölvupósts fyrir fyrirtæki Aðalskipulagstillagan innanhúss
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Búa til App skráning fyrir viðskipti Miðbær í Azure Portal
