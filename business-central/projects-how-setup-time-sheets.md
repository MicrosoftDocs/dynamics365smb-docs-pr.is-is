...
ms.author: edupont
---
# <a name="set-up-time-sheets" />Setja upp vinnuskýrslur
...
## <a name="set-up-time-sheets-with-the-assisted-setup-guide" />Setja upp vinnuskýrslur með leiðbeiningum um uppsetningu
...
## <a name="set-up-time-sheets-manually" />Setja upp vinnuskýrslur handvirkt
...
### <a name="to-set-up-general-information-for-time-sheets-manually" />Að setja upp almennar upplýsingar fyrir vinnuskýrslur handvirkt
...
### <a name="to-assign-a-time-sheet-administrator-manually" />Að úthluta stjórnanda vinnuskýrslu handvirkt
...
### <a name="to-assign-a-time-sheets-owner-and-approver-manually" />Að úthluta eiganda og samþykktaraðila vinnuskýrslna handvirkt
