...
Þegar búið er að setja upp vinnuskýrslur er hægt að búa til vinnuskýrslur fyrir forða og forðarnir geta bókað vinnuskýrslulínur. Einnig er hægt að úthluta vinnuskýrslum á verkáætlunarlínur. Nánari upplýsingar eru notaðar með því að fara í [Nota vinnuskýrslur](projects-how-use-time-sheets.md).  
