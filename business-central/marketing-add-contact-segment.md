...
ms.author: jswymer
---
# <a name="add-contacts-to-segments" />Bæta tengiliðum við hluta
...
## <a name="to-add-a-contact-to-a-segment" />Til að bæta tengilið við hluta
...
## <a name="to-refine-the-number-of-contacts" />Til að fínstilla fjölda tengiliða
...
## <a name="to-reduce-the-number-of-contacts" />Til að minnka fjölda tengiliða
