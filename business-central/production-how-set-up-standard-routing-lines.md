...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a><a name="set-up-standard-routing-lines"></a>Setja upp staðlaðar leiðarlínur

Notkun staðalverka einfaldar gerð og viðhald leiða. Gera þér kleift að bæta aukaupplýsingum fljótt við ítrekuð ferli.

## <a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a><a name="to-set-up-a-standard-task"></a>Setja upp staðlaðan verkhluta
...
## <a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a><a name="to-add-a-standard-task-to-an-operation"></a>Bæta stöðluðum verkhluta við aðgerð
