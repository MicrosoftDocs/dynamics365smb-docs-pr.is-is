---
title: Stjórnun VSK-flokka fyrir Bretland
...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a>Stjórnun VSK-flokka fyrir Bretland
...
3. Stofna notendur sem meðlimir VSK-flokks nota til að sannvotta þegar þeir tengjast tengingu við fulltrúa VSK-flokksins [!INCLUDE[prod_short](includes/prod_short.md)]. Notendurnir verða að hafa fullgilt notendaleyfi fyrir [!INCLUDE[prod_short](includes/prod_short.md)].
...
4. Í reitinn **OAuth Endastöð** 2.0 er fært inn `https://login.microsoftonline.com/common/oauth2`.
5. Í reitinn **OAuth 2.0 Forðaslóð** er fært inn `https://api.businesscentral.dynamics.com/`.
6. Í reitinn **OAuth 2.0 Bein URL** er fært inn `https://businesscentral.dynamics.com/OAuthLanding.htm`.
...
8. Í reitnum **Samþykktir meðlimir** kemur fram fjöldi hópmeðlima sem stofnaðir eru til að skila VSK-framtölum til fulltrúa hópsins. Til að bæta við nýjum meðlimum velur þú númerið til að opna síðuna **Samþykktir meðlimir VSK-hóps** og bætir við eftirfarandi upplýsingum:
    ...
    3. Í reitnum **Fyrirtæki er tilgreint það fyrirtæki sem meðlimur hópsins sendir VSK skil í**, t.d [!INCLUDE[prod_short](includes/prod_short.md)]. Bretland hf **CRONUS**.
