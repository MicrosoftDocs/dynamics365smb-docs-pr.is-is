...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>Viðbót fyrir stjórnun VSK-hóps fyrir Bretland
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Mynda VSK-flokk
...
### <a name="license-requirements"></a><a name="license-requirements"></a><a name="license-requirements"></a>Leyfiskröfur
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Setja upp VSK hóp

Eftirfarandi er ráðlögð röð skrefa sem stjórnandi notar til að setja upp VSK-hóp:

1. Búa til uppsetninguna [Azure Active Directory fyrir meðlimi hópsins](#azure-active-directory-setup-for-group-members).
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory uppstilling fyrir hópmeðlimi
...
Meðlimir VSK-hóps sem eru með [!INCLUDE[prod_short](includes/prod_short.md)] á staðnum verða að setja upp skráningu forrits í Azure Active Directory fyrir VSK-hópinn í [!INCLUDE[prod_short](includes/prod_short.md)]-leigjanda fulltrúans. Skráning forritsins gerir fulltrúa VSK-hópsins [!INCLUDE[prod_short](includes/prod_short.md)] netinu kleift að sannvotta meðlim hópsins. Frekari upplýsingar er að finna hér [Stuttar leiðbeiningar: Skráið forrit með auðkenningarverkvangi Microsoft](/azure/active-directory/develop/quickstart-register-app).

Þegar stjórnandi meðlims VSK-hópsins býr til skráninguna í Azure Active Directory forritinu verður hann að tilgreina eftirfarandi upplýsingar.
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a><a name="group-api-setup"></a>Uppsetning API-hóps

Fulltrúi VSK-hópsins útbýr og afhendir API til meðlima hópsins. Meðlimirnir nota þetta API til að tengjast [!INCLUDE[prod_short](includes/prod_short.md)] leigjanda fulltrúans og skila VSK-framtölum. Meðlimir VSK-hóps nota oft [!INCLUDE[prod_short](includes/prod_short.md)] í aðskildum Azure Active Directory-leigjendum. Þess vegna þarf að setja upp uppsetningu til að tengja meðlim VSK-hópsins og [!INCLUDE[prod_short](includes/prod_short.md)] fulltrúans.
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Setja upp meðlimi VSK-hópa
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>Fulltrúi VSK-hóps notar Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>Fulltrúi VSK-hóps notar Business Central innanhúss

1. Sláðu inn notendaskilríkin sem fulltrúi VSK-hópsins lét í té og veldu **Áfram**.
2. Í reitnum **Biðlarakenni** skal tilgreina biðlarakenni frá skráningu forritsins í [Azure Active Directory](#azure-active-directory-setup-for-group-members).
3. Í reitnum **Leyniorð biðlara** skal tilgreina leyniorð biðlara frá skráningu forritsins í Azure Active Directory.
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Setja upp fulltrúa VSK-hópsins
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>Að nota stjórnunareiginleika VSK-hóps
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Skoða innsendar VSK-umsóknir meðlima
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Stofna VSK-skil fyrir hóp
