...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Kynning: Sjálfvirk áætlun birgða
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>Stofna birgðahaldseiningu
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>Til að breyta völdum áætlunarfæribreytum
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Stofna birgðaáætlun með endurgerð
...
### <a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a>Stofna sölupöntun
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Stofna endurgerðaráætlun til að uppfylla eftirspurn í birgðageymslunni EAST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>Til að reikna MRP svo það taki undirliggjandi íhlutaþarfir með
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Greining á áætlunarniðurstöðunum
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>Til að skoða pöntunarrakningarfærslur fyrir vöru 1300
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>Til að athuga áætlunarfæribreytuna
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>Til að skoða fleiri pantanarakningarfærslur
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Framkvæmd aðgerðarboða
...
### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>Til að stofna sjálfkrafa þær birgðapantanir sem lagðar voru til
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Stofnun áætlunar hreyfingar
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>Til að stofna nýja sölueftirspurn og enduráætla eftir því
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Greining á hreyfingaáætlunarniðurstöðunum
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>Til að skoða pöntunarrakningarfærslur fyrir vöru 1250
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>Fyrirliggjandi pöntun skoðuð
