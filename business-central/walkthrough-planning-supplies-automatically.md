...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Kynning: Sjálfvirk áætlun birgða
...
### <a name="to-create-stockkeeping-units" />Stofna birgðahaldseiningu
...
### <a name="to-change-selected-planning-parameters" />Til að breyta völdum áætlunarfæribreytum
...
## <a name="creating-a-regenerative-supply-plan" />Stofna birgðaáætlun með endurgerð
...
### <a name="to-create-the-sales-order" />Stofna sölupöntun
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Stofna endurgerðaráætlun til að uppfylla eftirspurn í birgðageymslunni EAST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Til að reikna MRP svo það taki undirliggjandi íhlutaþarfir með
...
## <a name="analyzing-the-planning-result" />Greining á áætlunarniðurstöðunum
...
### <a name="to-check-the-planning-parameter" />Til að athuga áætlunarfæribreytuna
...
### <a name="to-view-more-order-tracking-entries" />Til að skoða fleiri pantanarakningarfærslur
...
## <a name="carrying-out-action-messages" />Framkvæmd aðgerðarboða
...
### <a name="to-automatically-create-the-suggested-supply-orders" />Til að stofna sjálfkrafa þær birgðapantanir sem lagðar voru til
...
## <a name="creating-a-net-change-plan" />Stofnun áætlunar hreyfingar
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />Til að stofna nýja sölueftirspurn og enduráætla eftir því
...
## <a name="analyzing-the-changed-planning-result" />Greining á hreyfingaáætlunarniðurstöðunum
...
### <a name="to-view-an-existing-order" />Fyrirliggjandi pöntun skoðuð
