...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes" />Notaðu Power Automate flæði fyrir viðvaranir vegna Dataverse breytinga á einingum
...
## <a name="import-the-flow-template" />Flytja inn sniðmát flæðis
...
## <a name="define-the-flow-trigger" />Skilgreina kveikju flæðis
...
## <a name="define-the-flow-condition" />Skilgreina skilyrði flæðis
...
## <a name="notify-business-central-about-a-change" />Tilkynna Business Central um breytingu
