...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a><a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a>Notaðu Power Automate flæði fyrir viðvaranir vegna Dataverse breytinga á einingum
...
## <a name="import-the-flow-template"></a><a name="import-the-flow-template"></a>Flytja inn sniðmát flæðis
...
## <a name="define-the-flow-trigger"></a><a name="define-the-flow-trigger"></a>Skilgreina kveikju flæðis
...
## <a name="define-the-flow-condition"></a><a name="define-the-flow-condition"></a>Skilgreina skilyrði flæðis
...
## <a name="notify-business-central-about-a-change"></a><a name="notify-business-central-about-a-change"></a>Tilkynna Business Central um breytingu
