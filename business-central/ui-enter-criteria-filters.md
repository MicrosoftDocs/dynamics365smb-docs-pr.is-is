...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Röðun, leit og síun
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Fínstilla leitina með síuskilyrði
...
### <a name="filtering-with-option-fields" />Sía með valsvæðum
...
### <a name="setting-filters-on-lists" />Afmarkanir stilltar á lista
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Afmarkanir stilltar í skýrslum, runuvinnslum og XMLports
...
## <a name="entering-filter-criteria" />Færa inn síuskilyrði
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators" /><a name="FilterCriteria"> </a>Síuskilyrði og virkni
...
#### <a name="-not-equal-to" />(<>) Ekki jafnt og
...
#### <a name="-greater-than" />(>) Meira en

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`>1200`|Tölur hærri en 1200|  

#### <a name="-greater-than-or-equal-to" />(>=) Hærra en eða jafnt og

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`>=1200`|Tölur hærri en eða jafnar 1200|  

#### <a name="-less-than" />(<) Minna en

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`<1200`|Tölur lægri en 1200|  

#### <a name="-less-than-or-equal-to" />(<=) Lægra en eða jafnt og
...
#### <a name="-an-exact-character-match" />('') Nákvæm stafasamsvörun
...
#### <a name="-case-insensitive" />(@) Stafrétt

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`@man*`|Texti sem byrjar á **man** og er ekki stafréttur.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Ótilgreindur fjöldi óþekktra staftákna
...
#### <a name="-one-unknown-character" />(?) eitt óþekkt stafatákn

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`Hans?n`|Texti eins og **Hansen** eða **Hanson**|  

#### <a name="combined-format-expressions" />Sameinað framsetningarsnið
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Síumerki
...
#### <a name="me-or-userid-records-assigned-to-you" />(%me eða %userid) Skrám úthlutað til þín
...
#### <a name="mycustomers-customers-in-my-customers" />(%mycustomers) Viðskiptamenn í Mínir viðskiptamenn
...
#### <a name="myitems-items-in-my-items" />(%mytems) Atriði í Mínum atriðum
...
#### <a name="myvendors-vendors-in-my-vendors" />(%myvendors) Lánardrottnar í Mínir lánardrottnar
