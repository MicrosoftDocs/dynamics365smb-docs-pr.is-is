...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a>Röðun, leit og síun
...
## <a name="sorting"></a><a name="sorting"></a><a name="sorting"></a>Röðun
...
## <a name="searching"></a><a name="searching"></a><a name="searching"></a>Leit
...
### <a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a>Fínstilla leitina með síuskilyrði
...
## <a name="filtering"></a><a name="filtering"></a><a name="filtering"></a><a name="filtering"></a>Afmörkun
...
### <a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a>Sía með valsvæðum
...
### <a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a>Afmarkanir stilltar á lista
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Afmarkanir stilltar í skýrslum, runuvinnslum og XMLports
...
## <a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a>Færa inn síuskilyrði
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Síuskilyrði og virkni
...
#### <a name="-interval"></a><a name="-interval"></a><a name="-interval"></a>(..) Bil
...
#### <a name="124-eitheror"></a><a name="124-eitheror"></a><a name="124-eitheror"></a>(&#124;) Annaðhvort eða

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`1200|1300`|Tölur með 1200 eða 1300|  

#### <a name="-not-equal-to"></a><a name="-not-equal-to"></a><a name="-not-equal-to"></a>(<>) Ekki jafnt og
...
#### <a name="-greater-than"></a><a name="-greater-than"></a><a name="-greater-than"></a>(>) Meira en

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`>1200`|Tölur hærri en 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Hærra en eða jafnt og

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`>=1200`|Tölur hærri en eða jafnar 1200|  

#### <a name="-less-than"></a><a name="-less-than"></a><a name="-less-than"></a>(<) Minna en

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`<1200`|Tölur lægri en 1200|  

#### <a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a>(<=) Lægra en eða jafnt og
...
#### <a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a>('') Nákvæm stafasamsvörun
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Stafrétt

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`@man*`|Texti sem byrjar á **man** og er ekki stafréttur.|  

#### <a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a>(*) Ótilgreindur fjöldi óþekktra staftákna
...
#### <a name="-one-unknown-character"></a><a name="-one-unknown-character"></a><a name="-one-unknown-character"></a>(?) eitt óþekkt stafatákn

|Dæmi|Sýndar færslur|  
|-----------------------|-----------------------|  
|`Hans?n`|Texti eins og **Hansen** eða **Hanson**|  

#### <a name="combined-format-expressions"></a><a name="combined-format-expressions"></a><a name="combined-format-expressions"></a>Sameinað framsetningarsnið
...
### <a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="symbols"></a>Gildi síuð sem innihalda tákn
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Síumerki
...
#### <a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a>(%me eða %userid) Skrám úthlutað til þín
...
#### <a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a>(%mycustomers) Viðskiptamenn í Mínir viðskiptamenn
...
#### <a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a>(%mytems) Atriði í Mínum atriðum
...
#### <a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a>(%myvendors) Lánardrottnar í Mínir lánardrottnar
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
