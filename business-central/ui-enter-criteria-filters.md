...
> [!TIP]
> Þú getur ýtt á **F3** til að virkja og slökkva á leitarreitnum. Frekari upplýsingar, sjá [Flýtilyklar](keyboard-shortcuts.md#KeyboardFilter).
...
### <a name="filter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Síuskilyrði og virkni
...
## <a name="see-related-training-at-microsoft-learn"></a>Sjá tengdar þjálfun hjá [Microsoft Learn](/learn/modules/search-filter-sort-data-dynamics-365-business-central/)
