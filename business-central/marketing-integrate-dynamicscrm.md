...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central" />Nota Dynamics 365 Sales úr Business Central
...
## <a name="coupling-records" />Tengja skrár
...
## <a name="fully-synchronizing-records" />Færslur fyrir fulla samstillingu
...
## <a name="handling-sales-order-data" />Meðhöndlun gagna sölupöntunar
...
## <a name="handling-sales-quotes-data" />Meðhöndlun á gögnum sölutilboða
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Meðhöndlun bókaðra sölureikninga, greiðslna viðskiptamanna og talnaupplýsinga
...
## <a name="handling-sales-prices" />Umsjón með söluverðum
> [!NOTE]
