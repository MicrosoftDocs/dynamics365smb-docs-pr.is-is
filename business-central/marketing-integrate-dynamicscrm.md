...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Nota Dynamics 365 Sales úr Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Tengja skrár
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Færslur fyrir fulla samstillingu
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Meðhöndlun gagna sölupöntunar
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Meðhöndlun á gögnum sölutilboða
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Meðhöndlun bókaðra sölureikninga, greiðslna viðskiptamanna og talnaupplýsinga
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Umsjón með söluverðum
> [!NOTE]
