...
## <a name="couple-records"></a>Tengja skrár
...
## <a name="fully-synchronize-records"></a>Færslur fyrir fulla samstillingu
...
## <a name="handle-sales-order-data"></a>Meðhöndlun gagna sölupöntunar
...
## <a name="handle-sales-quotes-data"></a>Meðhöndlun á gögnum sölutilboða
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Meðhöndlun bókaðra sölureikninga, greiðslna viðskiptamanna og talnaupplýsinga
...
## <a name="handle-sales-prices"></a>Umsjón með söluverðum
> [!NOTE]
