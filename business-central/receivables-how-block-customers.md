...
ms.author: edupont
---
# <a name="block-customers"></a><a name="block-customers"></a>Loka á viðskiptamenn
...
## <a name="to-block-a-customer"></a><a name="to-block-a-customer"></a>Til að loka á viðskiptamann
