...
## <a name="to-set-up-bank-accounts" />Bankareikningar settir upp
...
## <a name="to-enter-an-opening-balance" />Að færa inn opnunarstöðu
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Til að setja upp bankareikning þinn til að flytja inn eða flytja út bankaskrár
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Til að setja upp bankareikninga lánardrottna fyrir útflutning bankaskráa
...
## <a name="changing-your-bank-account" />Bankareikningnum breytt
