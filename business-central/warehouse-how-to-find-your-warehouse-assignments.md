...
ms.author: edupont
---
# <a name="find-your-warehouse-assignments"></a><a name="find-your-warehouse-assignments"></a><a name="find-your-warehouse-assignments"></a>Finna vöruhúsaúthlutanir
...
## <a name="to-find-an-instruction-assigned-to-you"></a><a name="to-find-an-instruction-assigned-to-you"></a><a name="to-find-an-instruction-assigned-to-you"></a>Leitað að leiðbeiningum sem úthlutað hefur verið:
