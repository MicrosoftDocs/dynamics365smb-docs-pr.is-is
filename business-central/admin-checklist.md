...
ms.author: edupont
---
# <a name="onboard-users-with-checklists"></a><a name="onboard-users-with-checklists"></a>Innleiða notendur með gátlistum
...
## <a name="to-add-an-item-to-the-checklist"></a><a name="to-add-an-item-to-the-checklist"></a>Að bæta vöru við gátlistann
