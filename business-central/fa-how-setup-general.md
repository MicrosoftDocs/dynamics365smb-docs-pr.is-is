...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Uppsetning almennra eignaupplýsinga
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />Uppsetning almennra sjálfgilda fyrir eignir
...
## <a name="to-set-up-fixed-asset-posting-groups" />Setja upp bókunarflokka eigna
...
## <a name="to-set-up-fixed-asset-allocation-keys" />Úthlutunarlyklar eigna eru settir þannig upp:
...
## <a name="to-set-up-fixed-asset-journal-templates" />Setja upp sniðmát eignabóka
...
## <a name="to-set-up-fixed-asset-journal-batches" />Setja upp keyrslur eignabóka
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Setja upp keyrslur endurflokkunarsniðmáta
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Setja upp endurflokkunarkeyrslur eignabóka
...
## <a name="to-set-up-fixed-asset-class-codes" />Uppsetning eignaflokkskóða
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Uppsetning eignaundirflokkskóða
...
## <a name="to-set-up-fixed-asset-location-codes" />Staðsetningarkóðar eigna eru settir þannig upp:
...
## <a name="to-register-opening-entries" />Skráning opnunarfærslna
