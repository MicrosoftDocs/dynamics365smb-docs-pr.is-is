...
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the-prod_short-apps-in-power-bi"></a>Nota [!INCLUDE [prod_short](includes/prod_short.md)]-forrit í Power BI
...
## <a name="get-ready"></a><a name="get-ready"></a>Vertu með allt á tæru
...
## <a name="install-a--app-in-power-bi"></a><a name="install-a-prod_short-app-in-power-bi"></a>Setja upp [!INCLUDE[prod_short](includes/prod_short.md)]-forrit í Power BI
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the-prod_short-app-to-your-data"></a>Tengdu [!INCLUDE[prod_short](includes/prod_short.md)]-forritið við gögnin þín
...
## <a name="fixing-problems"></a><a name="fixing-problems"></a>Vandamál lagfærð
...
### <a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a>Þú ert ekki með Power BI reikning
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Skilaboð: Engar skýrslur eru virkar. Veljið Velja skýrslu til að sjá hvaða skýrslur er hægt að birta.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the-prod_short-app-in-power-bi"></a>Þú þarft Power BI-leyfi fagmanns til að setja upp [!INCLUDE[prod_short](includes/prod_short.md)]-forritið í Power BI
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a><a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a>„Sannprófun færibreyta tókst ekki, vinsamlegast vertu viss um að allar færibreytur séu gildar“
...
### <a name="cant-sign-in"></a><a name="cant-sign-in"></a>Innskráning tókst ekki
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Rangt fyrirtækjaheiti
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>Lykillinn passaði ekki við neinar línur í töflunni
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Eldri gögn virðist vanta
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>Ég sé bara gögn fyrir eitt fyrirtæki
...
### <a name="what-now"></a><a name="what-now"></a>Hvað núna?
