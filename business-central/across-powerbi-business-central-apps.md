...
## <a name="overview" /><a name="overview"></a>Yfirlit
...
## <a name="prerequisites" /><a name="prerequisites"></a>Frumskilyrði
...
## <a name="get-ready" /><a name="get-ready"></a>Vertu með allt á tæru
...
## <a name="fixing-problems" /><a name="fixing-problems"></a>Vandamál lagfærð
...
### <a name="you-dont-have-a-power-bi-account" /><a name="you-dont-have-a-power-bi-account"></a>Þú ert ekki með Power BI reikning
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" /><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Skilaboð: Engar skýrslur eru virkar. Veljið Velja skýrslu til að sjá hvaða skýrslur er hægt að birta.
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid" /><a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a>„Sannprófun færibreyta tókst ekki, vinsamlegast vertu viss um að allar færibreytur séu gildar“
...
### <a name="cant-sign-in" /><a name="cant-sign-in"></a>Innskráning tókst ekki
...
### <a name="incorrect-company-name" /><a name="incorrect-company-name"></a>Rangt fyrirtækjaheiti
...
### <a name="the-key-didnt-match-any-rows-in-the-table" /><a name="the-key-didnt-match-any-rows-in-the-table"></a>Lykillinn passaði ekki við neinar línur í töflunni
...
### <a name="historical-data-appears-to-be-missing" /><a name="historical-data-appears-to-be-missing"></a>Eldri gögn virðist vanta
...
### <a name="i-only-see-data-for-a-single-company" /><a name="i-only-see-data-for-a-single-company"></a>Ég sé bara gögn fyrir eitt fyrirtæki
...
### <a name="what-now" /><a name="what-now"></a>Hvað núna?
...
## <a name="see-related-microsoft-trainingtrainingmodulesconfigure-powerbi-excel-dynamics--business-centralindex" /><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/configure-powerbi-excel-dynamics-365-business-central/index)
