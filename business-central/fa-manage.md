...
Til að rekja eignaafskriftir og aðrar fjárhagslegar færslur fyrir eignir er sett upp ein eða fleiri afskriftabækur fyrir hverja þeirra. Afskriftir eru gerðar með því að keyra skýrslu til að reikna tímabilsafskriftir, færa færslurnar sem verða til í færslubókinni og bóka síðan bókina. [!INCLUDE[prod_short](includes/prod_short.md)] styður nokkrar afskriftaraðferðir. Frekari upplýsingar eru í [afskriftaaðferðir](fa-depreciation-methods.md) Hægt er að setja upp margar afskriftabækur fyrir hverja eign í mismunandi tilgangi, eins og eina fyrir skattaskýrsla og annað til innri skýrslugerð.

Hægt er að skrá viðhaldskostnað fyrir hverja eign og næstu þjónustudagsetningu. Rakning viðhaldskostnaðar getur skipt máli vegna fjárhagsáætlunar og ákveðið hvort skipta skuli um eign.

Hægt er að tengja hverja eign einum eða fleiri vátryggingarskilmálum og sannreyna að iðgjöld vegna iðgjalda séu samræmd verðmæti eignanna.
