...
ms.author: edupont
---
# <a name="managing-fixed-assets"></a><a name="managing-fixed-assets"></a><a name="managing-fixed-assets"></a>Eignaumsjón
...
## <a name="video-overview"></a><a name="video-overview"></a><a name="video-overview"></a>Yfirlit myndbands

Eftirfarandi myndband fjallar um grunnatriði eigna.

> [!Video https://www.microsoft.com/en-us/videoplayer/embed/RE4AegS?rel=0]

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/manage-fixed-assets-transactions/)
