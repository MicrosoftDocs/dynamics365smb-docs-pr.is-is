...
ms.author: edupont
---
# <a name="revalue-inventory"></a><a name="revalue-inventory"></a><a name="revalue-inventory"></a>Endurmat birgða
...
## <a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a>Að endurmeta birgðir
