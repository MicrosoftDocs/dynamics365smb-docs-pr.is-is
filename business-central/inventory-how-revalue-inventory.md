...
description: Lýsir því hvernig á að meta eða afskrifa virðisfærslur einnar eða fleiri vara í birgðum með því að bóka núverandi, reiknað virði.
documentationcenter: ''
author: SorenGP
ms.topic: conceptual
ms.devlang: na
