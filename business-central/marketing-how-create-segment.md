...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Stofna hluta
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Hlutar stofnaðir:
...
3. Í hlutanum **Almennt** , í á reitnum **númer** er fært inn númer fyrir hlutann.
    ...
    Hafi númeraröð fyrir hluta á  **síðunni Uppsetning**  markaðssetningar verið sett upp er hægt að velja  <kbd>Enter</kbd>  til að velja næsta tiltæka hlutanúmer.
