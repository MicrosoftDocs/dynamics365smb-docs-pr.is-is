...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Setja upp eignir með afskriftaaðferðum sem notandi skilgreinir
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Að úthluta afskriftabók á eign með notandaskilgreindri afskriftaaðferð
...
## <a name="to-set-up-user-defined-depreciation-methods" />Uppsetning afskriftaaðferða sem notandi skilgreinir
...
### <a name="depreciation-based-on-number-of-units" />Afskriftir miðaðar við fjölda eininga
...
### <a name="example---user-defined-depreciation" />Dæmi - Notandaskilgreindar afskriftaraðferð
