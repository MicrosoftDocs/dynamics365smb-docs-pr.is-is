...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Meðhöndlun innkaupaskila eða afturkallana
...
## <a name="inventory-costing" />Birgðakostnaður
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Stofna nýjan innkaupakreditreikning úr bókaðan innkaupareikningur.
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Til að stofna nýjan innkaupakreditreikning með því að afrita bókaðan innkaupareikningur.
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Til að stofna vöruskilapöntun innkaupa byggða á einu eða fleiri bókuðu innkaupaskjali
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />Innkaupapöntun fyrir skiptivöru stofnuð úr vöruskilapöntun innkaupa.
...
## <a name="to-create-a-purchase-allowance" />Innkaupaheimild stofnuð:
...
## <a name="to-combine-return-shipments" />Sameining endursendra afhendinga:
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Til að fjarlægja opnar vöruskilapantanir innkaupa eftir bókun sameinaðrar afhendingar
...
## <a name="see-related-microsoft-trainingtrainingpathsreturn-items-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/paths/return-items-dynamics-365-business-central/)
