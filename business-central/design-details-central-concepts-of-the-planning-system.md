...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Hönnunarupplýsingar: Miðlægar hugmyndir áætlanakerfis
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a>Áætlunarfæribreytur
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a>Upphafsdagsetning áætlunar
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Breytilegar pöntunarrakningar (vörpum)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Breytilegar pöntunarrakningar vs. áætlanakerfi
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Röð og forgangur í áætlun
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Vöruforgangur / Lægra stigs kóði
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Fínstilla afköst fyrir lágstigsútreikninga
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Birgðageymslur / Forgangur millifærslustigs
...
### <a name="order-priority"></a><a name="order-priority"></a>Forgangur pöntunar
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Eftirspurnarspá og standandi pantanir
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a>Úthlutað á áætlun
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a>Vöruvíddir
...
## <a name="item-attributes"></a><a name="item-attributes"></a>Vörueigindir
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a>Tilgreindir eiginleikar
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Ótilgreindar eigindir
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a>Tenglar á milli pantana
...
## <a name="reservations"></a><a name="reservations"></a>Bókanir
...
## <a name="warnings"></a><a name="warnings"></a>Viðvaranir
...
### <a name="emergency"></a><a name="emergency"></a>Neyð
...
### <a name="exception"></a><a name="exception"></a>Frávik
...
### <a name="attention"></a><a name="attention"></a>Athugið
...
## <a name="error-logs"></a><a name="error-logs"></a>Villulogs
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a>Sveigjanleiki áætlunar
...
## <a name="order-planning"></a><a name="order-planning"></a>Áætlun pöntunar
...
## <a name="finite-loading"></a><a name="finite-loading"></a>Takmarkað álag
