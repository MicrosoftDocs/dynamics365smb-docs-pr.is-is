...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Hönnunarupplýsingar: Miðlægar hugmyndir áætlanakerfis
...
## <a name="planning-parameters" />Áætlunarfæribreytur
...
## <a name="planning-starting-date" />Upphafsdagsetning áætlunar
...
## <a name="dynamic-order-tracking-pegging" />Breytilegar pöntunarrakningar (vörpum)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Breytilegar pöntunarrakningar vs. áætlanakerfi
...
## <a name="sequence-and-priority-in-planning" />Röð og forgangur í áætlun
...
### <a name="item-priority--low-level-code" />Vöruforgangur / Lægra stigs kóði
...
#### <a name="optimizing-performance-for-low-level-calculations" />Fínstilla afköst fyrir lágstigsútreikninga
...
### <a name="locations--transfer-level-priority" />Birgðageymslur / Forgangur millifærslustigs
...
### <a name="order-priority" />Forgangur pöntunar
...
## <a name="demand-forecasts-and-blanket-orders" />Eftirspurnarspá og standandi pantanir
...
## <a name="planning-assignment" />Úthlutað á áætlun
...
## <a name="item-dimensions" />Vöruvíddir
...
## <a name="item-attributes" />Vörueigindir
...
### <a name="specific-attributes" />Tilgreindir eiginleikar
...
### <a name="non-specific-attributes" />Ótilgreindar eigindir
...
## <a name="order-to-order-links" />Tenglar á milli pantana
...
## <a name="planning-flexibility" />Sveigjanleiki áætlunar
...
## <a name="order-planning" />Áætlun pöntunar
...
## <a name="finite-loading" />Takmarkað álag
