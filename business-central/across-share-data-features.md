...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central"></a><a name="sharing-business-data-from-business-central"></a>Deiling viðskiptagagna úr Business Central
...
## <a name="copying-a-link"></a><a name="copying-a-link"></a>Afrita tengil
...
### <a name="modify-the-page-link"></a><a name="modify-the-page-link"></a>Breyta tengli síðunnar
...
### <a name="about-filtered-lists"></a><a name="about-filtered-lists"></a>Um síaða lista
...
## <a name="sharing-to-teams"></a><a name="sharing-to-teams"></a>Deila með Teams
...
## <a name="sharing-through-onedrive"></a><a name="sharing-through-onedrive"></a>Samnýting með OneDrive
...
## <a name="opening-in-excel"></a><a name="opening-in-excel"></a>Opna í Excel
...
## <a name="sharing-rows-or-tables"></a><a name="sharing-rows-or-tables"></a>Deila röðum eða töflum
