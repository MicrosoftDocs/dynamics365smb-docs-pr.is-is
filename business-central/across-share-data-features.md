...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central" />Deiling viðskiptagagna úr Business Central
...
## <a name="copying-a-link" />Afrita tengil
...
### <a name="modify-the-page-link" />Breyta tengli síðunnar
...
### <a name="about-filtered-lists" />Um síaða lista
...
## <a name="sharing-to-teams" />Deila með Teams
...
## <a name="sharing-through-onedrive" />Samnýting með OneDrive
...
## <a name="opening-in-excel" />Opna í Excel
...
## <a name="sharing-rows-or-tables" />Deila röðum eða töflum
