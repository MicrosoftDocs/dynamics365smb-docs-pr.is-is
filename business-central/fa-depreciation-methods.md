...
## <a name="db1sl-depreciation"></a>HA1/LL afskrift
...
### <a name="example---db1-sl-depreciation"></a>Dæmi - DB1-LL afskrift
...
## <a name="half-year-convention-depreciation"></a>Afskriftir hálfs árs
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a>Dæmi - HLF1/LL afskriftir af hálfsársaðferð
...
## <a name="duplicate-entries-to-other-depreciation-books"></a>Afrita færslur í aðrar afskriftabækur
...
## <a name="manual-depreciation"></a>Handvirk afskrift
