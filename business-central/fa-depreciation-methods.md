...
* Notendaskilgreind  
  ...
  Skilgreinið eigin afskriftaraðferð með því að nota Afskriftatöflur. Til að fræðast meira um jöfnun á afskriftaraðferð sem notandi skilgreinir er farið í að  [Setja upp notandaskilgreinda afskriftaraðferð](fa-how-setup-user-defined-depreciation-method.md).
* Handvirkt  
...
> [!NOTE]
> Ef einhverjar af afskriftaraðferðum fyrir afskriftir eru notaðar og keyra á afskriftir í mörg ár þarf að keyra afskriftir hvers árs sérstaklega. Ef verið er að keyra afskriftir fyrir allt tímabilið frá kaupdegi til loka Síðasta reikningsárs eða Síðasta bókhaldstímabils, er líklegt að niðurstöðurnar verði rangar. Til dæmis gæti verið æskilegt að keyra hann í mörg ár ef eldri gögn hafa verið lesin inn og raunverulegar kaupdagsetningar eru notaðar fyrir eignirnar og eiga að ná upp í uppsafnaðar afskriftir. Í aðferðum fyrir minnkandi stöðu skal  [!INCLUDE [prod_short](includes/prod_short.md)]  Reikna út leyfðar afskriftir á ári, sem hefjast á skráðu bókfærðu virði hvers árs. Það er ekki hægt að gera margra ára afskriftir í einu skrefi.
>
