...
## <a name="what-data-is-migrated" />Hvaða gögn eru flutt?

Eftirfarandi gögn eru flutt fyrir hverja einingu:

### <a name="customers" />Viðskiptavinir
...
### <a name="chart-of-accounts" />Bókhaldslykill
...
## <a name="file-size-requirements" />Kröfur um skráarstærð
...
## <a name="to-migrate-data" />Til að flytja gögn
...
## <a name="viewing-the-status-of-the-migration" />Skoðun stöðu á flutningi
...
## <a name="how-to-avoid-double-posting" />Hvernig á að koma í veg fyrir tvíbókun
...
## <a name="correcting-errors" />Leiðrétting villna
...
## <a name="verifying-data-after-migrating" />Staðfesting gagna eftir flutning
...
## <a name="stopping-data-migration" />Stöðvun gagnaflutnings
