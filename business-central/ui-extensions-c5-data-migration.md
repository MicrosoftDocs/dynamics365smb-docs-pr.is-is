...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>C5-gagnaflutningsviðbótin
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Hvaða gögn eru flutt?

Eftirfarandi gögn eru flutt fyrir hverja einingu:

### <a name="customers"></a><a name="customers"></a><a name="customers"></a>Viðskiptavinir
...
### <a name="vendors"></a><a name="vendors"></a><a name="vendors"></a>Lánardrottnar
...
### <a name="items"></a><a name="items"></a><a name="items"></a>Birgðir
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Bókhaldslykill
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a><a name="file-size-requirements"></a>Kröfur um skráarstærð
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a><a name="to-migrate-data"></a>Til að flytja gögn
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Skoðun stöðu á flutningi
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Hvernig á að koma í veg fyrir tvíbókun
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a><a name="correcting-errors"></a>Leiðrétting villna
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Staðfesting gagna eftir flutning
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Stöðvun gagnaflutnings
