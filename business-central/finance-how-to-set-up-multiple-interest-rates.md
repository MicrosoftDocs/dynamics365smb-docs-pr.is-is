...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Setja upp marga vexti fyrir seinkaða greiðslu
...
## <a name="to-set-up-multiple-interest-rates" />Uppsetning á mörgum vöxtum
