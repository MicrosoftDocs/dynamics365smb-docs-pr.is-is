...
---
# <a name="use-resources-for-projects"></a>Nota tilföng fyrir verk
...
## <a name="to-assign-resources-to-projects"></a>Forða úthlutað á verk
...
## <a name="to-record-resource-usage-for-a-project"></a>Til að skrá notkun forða fyrir verk
