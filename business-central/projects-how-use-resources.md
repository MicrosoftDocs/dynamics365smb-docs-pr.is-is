...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Nota tilföng fyrir verk
...
## <a name="to-assign-resources-to-jobs" />Forða úthlutað á verk
...
## <a name="to-record-resource-usage-for-a-job" />Til að skrá notkun forða fyrir verk
...
## <a name="to-adjust-resource-prices" />Til að leiðrétta forðaverð
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Til að fá verðbreytingatillögur forða út frá fyrirliggjandi öðru verði
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Búa til verðbreytingatillögur forða út frá stöðluðu verði:
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Til að fá verðbreytingatillögur forða út frá öðru verði
