...
# <a name="manage-and-reconcile-your-bank-accounts"></a>Stjórna og stemma af bankareikninga
...
Áður en hægt er að hafa umsjón með bankareikningum í [!INCLUDE[prod_short](includes/prod_short.md)] þarf að setja hvern bankareikning upp sem bankareikningsspjald. Þar að auki þarf að setja upp rafrænar þjónustu sem má nota fyrir innflutning bankayfirlits og útflutning greiðsluskrár. Nánari upplýsingar er að finna í [Uppsetning bankaþjónustu](bank-setup-banking.md).
