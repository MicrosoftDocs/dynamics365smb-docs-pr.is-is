...
# <a name="troubleshooting-and-correcting-dimensions" />Úrræðaleit og víddarleiðrétting
...
## <a name="troubleshooting-dimensions-errors" />Úrræðaleita víddarvillur
...
## <a name="changing-dimension-assignments-after-posting" />Breyta víddarúthlutunum eftir bókun
...
### <a name="setting-up-dimension-corrections" />Uppsetning víddarleiðréttinga
...
### <a name="correcting-a-dimension" />Vídd leiðrétt
...
### <a name="validating-dimension-corrections" />Víddarleiðréttingar staðfestar
...
### <a name="undoing-a-correction" />Leiðrétting afturkölluð
...
### <a name="dimension-corrections-on-large-data-sets" />Víddarleiðréttingar á stórum gagnasöfnum
...
### <a name="use-analysis-views-with-dimension-corrections" />Nota greiningaryfirlit og víddarleiðréttingar
...
### <a name="viewing-historical-dimension-corrections" />Ferill víddarleiðréttinga skoðaður

Ef fjárhagsfærsla hefur verið leiðrétt er hægt að kanna breytinguna með því að nota aðgerðina **Ferill víddarleiðréttinga**.

### <a name="handling-incomplete-corrections" />Afgreiðsla ólokinna leiðréttinga
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Nota kostnaðarbókhald með leiðréttum fjárhagsfærslum
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/dimensions-dynamics-365-business-central/)
