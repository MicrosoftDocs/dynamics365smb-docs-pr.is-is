...
# <a name="troubleshoot-and-correct-dimensions"></a>Úrræðaleit og leiðrétta víddir
...
### <a name="set-up-dimension-corrections"></a>Setja upp víddaleiðréttingar
...
### <a name="correct-a-dimension"></a>Leiðrétta vídd
...
### <a name="validate-dimension-corrections"></a>Staðfesta víddaleiðréttingar
...
### <a name="handle-incomplete-corrections"></a>Meðhöndla ófullnægjandi leiðréttingar
