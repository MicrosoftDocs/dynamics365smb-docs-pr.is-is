...
ms.author: edupont
---
# <a name="revalue-fixed-assets" />Endurmeta eignir
...
## <a name="to-post-an-appreciation-from-the-fixed-asset-gl-journal" />Bóka uppfærslu úr fjárhagsbók eigna
...
## <a name="to-post-a-write-down-from-the-fixed-asset-gl-journal" />Bóka niðurfærsla úr fjárhagsbók eigna
...
## <a name="to-perform-general-revaluation-of-fixed-assets" />Framkvæma almennt endurmat eigna
...
## <a name="to-post-additional-acquisition-costs" />Bókun Viðbótarkaupverðs
...
### <a name="example---posting-additional-acquisition-costs" />Dæmi - bókun viðbótar stofnkostnaðar
...
## <a name="see-related-microsoft-trainingtrainingpathsmanage-advanced-fixed-assets-transactions" />Sjá tengda [Microsoft þjálfun](/training/paths/manage-advanced-fixed-assets-transactions/)
