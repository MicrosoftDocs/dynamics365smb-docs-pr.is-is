...
Þegar birgðir hafa verið settar upp er hægt að stjórna ýmsum ferlum sem tengjast birgðafærslum. Nánari upplýsingar eru í [Vinna með yfirlit yfir birgðir](inventory-manage-inventory.md) og [vöruhúsakerfi](design-details-warehouse-management.md).
...
| Stofna birgðaspjöld fyrir birgðir, utanbirgðavörur eða þjónustuvörur sem notandi verslar með. |[Skrá nýjar vörur](inventory-how-register-new-items.md) |
...
|Setja upp margar mælieiningar (UOM) fyrir vöru sem hægt er að nota sem aðra mælieiningu, til dæmis í sölu-, innkaupa- eða framleiðslufærslum.|[Setja upp mælieiningu vara](inventory-how-setup-units-of-measure.md)|
