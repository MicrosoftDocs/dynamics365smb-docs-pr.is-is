...
ms.author: edupont
---
# <a name="correct-prepayments"></a><a name="correct-prepayments"></a><a name="correct-prepayments"></a>Leiðrétta fyrirframgreiðslur
...
## <a name="to-correct-a-prepayment"></a><a name="to-correct-a-prepayment"></a><a name="to-correct-a-prepayment"></a>Til að leiðrétta fyrirframgreiðslu:
