...
ms.locfileid: "3528614"
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="eaacd-104">Breyta áætlunartillögum í myndrænu yfirliti</span><span class="sxs-lookup"><span data-stu-id="eaacd-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="eaacd-105">Dæmigerð verkþáttaáætlun er til að breyta eða bæta við línum áætlunarvinnublaðs til að breyta þeim birgðapöntunum sem lagðar eru til áður þær eru færðar inn með því að keyra aðgerðina **Framkvæma aðgerðarboð**.</span><span class="sxs-lookup"><span data-stu-id="eaacd-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="eaacd-106">Í stað þess að gera þetta í áætlunarvinnublaðinu er notað myndrænt yfirlit.</span><span class="sxs-lookup"><span data-stu-id="eaacd-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="eaacd-107">Þetta er hins vegar ekki stutt eins og er í [!INCLUDE[prodshort](includes/prodshort.md)].</span><span class="sxs-lookup"><span data-stu-id="eaacd-107">However, this is currently not supported in [!INCLUDE[prodshort](includes/prodshort.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="eaacd-108">Sjá einnig</span><span class="sxs-lookup"><span data-stu-id="eaacd-108">See Also</span></span>

[<span data-ttu-id="eaacd-109">Áætlun</span><span class="sxs-lookup"><span data-stu-id="eaacd-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="eaacd-110">Uppsetning framleiðslu</span><span class="sxs-lookup"><span data-stu-id="eaacd-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="eaacd-111">Framleiðsla</span><span class="sxs-lookup"><span data-stu-id="eaacd-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="eaacd-112">Birgðir</span><span class="sxs-lookup"><span data-stu-id="eaacd-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="eaacd-113">Innkaup</span><span class="sxs-lookup"><span data-stu-id="eaacd-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="eaacd-114">Hönnunarupplýsingar: framboðsáætlun</span><span class="sxs-lookup"><span data-stu-id="eaacd-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="eaacd-115">Uppsetning bestu venja: Framboðsáætlun</span><span class="sxs-lookup"><span data-stu-id="eaacd-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="eaacd-116">[Unnið með [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="eaacd-116">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>
