...
## <a name="approve-or-reject-an-incoming-document"></a>Samþykkja eða hafna innsendu skjali
...
## <a name="create-an-incoming-document-record-by-taking-a-photo"></a>Búa til færslu skjals á innleið með því að taka mynd
...
## <a name="attach-an-image-to-an-incoming-document-record-by-taking-a-photo"></a>Hengja mynd við skjalafærslu á innleið með því að taka ljósmynd
...
## <a name="create-an-incoming-document-record-manually"></a>Stofna færslu skjals á innleið handvirkt
