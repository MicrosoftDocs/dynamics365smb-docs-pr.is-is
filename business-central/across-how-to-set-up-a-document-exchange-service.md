...
ms.author: edupont
---
# <a name="set-up-a-document-exchange-service" />Setja upp skjalaskiptaþjónustu
...
## <a name="connecting-with-trading-partners" />Tenging við viðskiptafélaga
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift" />Að tengjast við forrit Business Central Integration í Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service" />Að tengjast við skjalaskiptaþjónustu
...
## <a name="settings-for-business-central-on-premises" />Stillingar fyrir Business Central á staðnum
...
## <a name="see-related-microsoft-trainingtrainingmoduleselectronic-documents-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/electronic-documents-dynamics-365-business-central/)
