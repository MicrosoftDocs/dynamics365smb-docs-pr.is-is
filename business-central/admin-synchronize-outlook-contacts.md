...
Þú setur upp hvernig þú vilt samstilla tengiliði með Outlook á síðunni **Uppsetning Exchange-samstillingar** í [!INCLUDE[prod_short](includes/prod_short.md)]. Sem forsenda, verður notandaforstillingin þín í [!INCLUDE[prod_short](includes/prod_short.md)] að tilgreina Microsoft 365 netfangið þitt. Þú getur athugað þessa stillingu í hlutanum **Microsoft 365 Sannvottun** í notandaforstillingu þinni í listanum **Notendur**. 
