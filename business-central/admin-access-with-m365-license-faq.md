...
---
# <a name="access-with-microsoft-365-licenses-faq"></a>Aðgangur með Microsoft 365 leyfisfjárfyrirmælum
...
### <a name="can-i-proactively-configure-different-starting-permissions-for-different-groups-of-users"></a>Get ég grunnstillt mismunandi upphafsheimildir fyrir mismunandi hópa notenda?
...
### <a name="can-i-proactively-configure-permissions-profiles-and-settings-for-individual-users-before-they-sign-in"></a>Get ég grunnstillt heimildir, forstillingar og stillingar einstakra notenda áður en þeir skrá sig inn?
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to"></a>Eftir innskráningu notanda, get ég breytt hvaða hlutum þeir hafa aðgang að?
...
### <a name="how-do-i-prevent-access-to-sensitive-tables"></a>Hvernig hindra ég aðgang að viðkvæmum töflum?
...
### <a name="instead-of-customizing-the-license-configuration-can-i-customize-a-user-group"></a>Í stað þess að sérstilla leyfisskilgreininguna, get ég sérstillt notendahóp?
...
### <a name="when-a-business-central-user-shares-a-record-in-teams-do-they-grant-new-permissions"></a>Þegar Business Central notandi deilir færslu í Teymi veitir hann nýjar heimildir?
...
### <a name="does-this-feature-support-row-level-security"></a>Styður þessi aðgerð öryggi á línustigi?
...
### <a name="if-i-configure-permissions-that-include-write-access-will-users-be-able-to-write-in-teams"></a>Ef ég grunnstilli heimildir sem innihalda ritaðgang geta notendur skrifað í Teymi?
...
### <a name="why-is-the-setting-to-enable-access-not-available-for-my-environment"></a>Hvers vegna er stillingin til að gera aðgang óvirkan fyrir umhverfið mitt?
...
### <a name="can-i-access-business-central-on-premises-with-microsoft-365-licenses"></a>Get ég nálgast Business Central á húsnæði með Microsoft 365 leyfi?
...
### <a name="what-is-the-employee-profile"></a>Hvað er forstilling starfsmanns?
...
### <a name="what-is-the-teams-users-user-group"></a>Hver er notendaflokkur teymisnotendanna?
...
### <a name="do-users-that-only-have-a-microsoft-365-license-show-up-in-the-users-list-in-business-central"></a>Birtast notendur sem aðeins hafa Microsoft 365 leyfi á notendalistanum í Business Central?
...
### <a name="does-this-feature-work-for-embed-isv-solutions"></a>Virkar þessi eiginleiki fyrir ígræddar ISV lausnir?
...
### <a name="can-a-customer-use-this-feature-if-they-dont-have-business-central"></a>Getur viðskiptavinur notað þessa aðgerð ef hann er ekki með Business Central?
...
### <a name="how-does-this-help-me-manage-subscription-costs-in-my-organization"></a>Hvernig hjálpar þetta mér að stýra áskriftarkostnaði innan fyrirtækisins?
...
### <a name="does-this-work-with-microsoft-365-trials-and-business-central-trials"></a>Virkar þetta með Microsoft 365 prufur og Business Central réttarhöld?
...
### <a name="the-list-of-licenses-in-business-central-shows-a-microsoft-365-license-whats-that"></a>Listi yfir leyfi í Business Central sýnir Microsoft 365 leyfi. Hvað er þetta?
...
### <a name="do-i-need-to-acquire-a-new-type-of-microsoft-365-license-for-this-feature-to-work"></a>Þarf ég að fá nýja tegund af Microsoft 365 leyfi fyrir þessa aðgerð til að vinna?
...
### <a name="how-do-i-find-out-which-users-have-only-a-microsoft-365-license"></a>Hvernig kemst ég að því hvaða notendur hafa aðeins Microsoft 365 leyfi?
...
### <a name="how-do-i-filter-the-users-list-in-business-central-to-see-users-that-only-have-a-microsoft-365-license"></a>Hvernig afmarka ég notendalistann í Business Central til að sjá notendur sem hafa aðeins Microsoft 365 leyfi?
...
### <a name="what-about-users-that-have-both-a-microsoft-365-license-and-a-business-central-license"></a>Hvað með notendur sem hafa bæði Microsoft 365 leyfi og Business Central leyfi?
...
### <a name="is-this-licensing-related-to-the-business-central-team-member-license"></a>Er þessi leyfisveiting tengd meðlimur Business Central Team?
...
### <a name="does-business-central-enforce-any-of-the-constraints"></a>Framfylgir Business Central einhverjum hömlunum?
...
### <a name="can-i-access-records-on-teams-for-ios-and-teams-for-android"></a>Get ég fengið aðgang að færslum í Teymi fyrir iOS og Teymi fyrir Android?
...
### <a name="how-do-users-change-their-personal-settings-in-my-settings"></a>Hvernig breyta notendur persónulegum stillingum sínum í Mínar stillingar?
...
### <a name="what-determines-the-choice-of-language-when-you-sign-in-for-the-first-time"></a>Hvað ræður vali á tungumáli þegar notandi skráir sig inn í fyrsta skipti?
...
### <a name="why-cant-i-activate-some-of-the-colored-links-in-tabs-and-card-details"></a>Af hverju get ég ekki virkjað nokkra af lituðu tenglunum í flipum og kortaupplýsingum?
...
### <a name="why-cant-i-activate-page-notification-actions"></a>Hvers vegna get ég ekki virkjað tilkynningaaðgerðir á síðunni?
...
### <a name="if-i-cant-filter-will-i-still-see-a-filtered-list-that-was-created-by-others"></a>Ef ég get ekki afmarkað, sé ég samt afmarkaðan lista sem var búinn til af öðrum?
