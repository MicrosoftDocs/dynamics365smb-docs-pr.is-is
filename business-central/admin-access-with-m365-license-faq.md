...
### <a name="can-i-proactively-configure-different-starting-permissions-for-different-groups-of-users" />Get ég tekið þátt í að skilgreina mismunandi upphafsheimildir fyrir mismunandi flokka notenda?
...
### <a name="can-i-proactively-configure-permissions-profiles-and-settings-for-individual-users-before-they-sign-in" />Get ég tekið þátt í að skilgreina heimildir, forstillingar og stillingar fyrir einstaka notendur áður en þeir skrá sig inn?
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to" />Eftir að notandi skráir sig inn, get ég skipt um hvaða hluti þeir hafa aðgang að?
...
### <a name="how-do-i-prevent-access-to-sensitive-tables" />Hvernig er best að hindra aðgang að viðkvæmum töflum?
...
### <a name="instead-of-customizing-the-license-configuration-can-i-customize-a-user-group" />Í stað þess að sérsníða Leyfiskafbrigðið get ég sérsniðið notendaflokk?
...
### <a name="when-a-business-central-user-shares-a-record-in-teams-do-they-grant-new-permissions" />Þegar Seðlabanki í miðborg deilir færslu í teymum, veita þeir nýjar heimildir?
...
### <a name="does-this-feature-support-row-level-security" />Styður þessi eiginleiki línustigið öryggi?
...
### <a name="if-i-configure-permissions-that-include-write-access-will-users-be-able-to-write-in-teams" />Ef ég Skilgreini heimildir sem fela í sér skrifaðgang geta notendur skrifað í teymum?
...
### <a name="why-is-the-setting-to-enable-access-not-available-for-my-environment" />Af hverju er stillingin til að virkja aðgang ekki tiltæka fyrir umhverfið mitt?
...
### <a name="what-is-the-employee-profile" />Hvað er Starfsmatsniðs?
...
### <a name="what-is-the-teams-users-user-group" />Hvað er hópurinn notendaflokkur notenda?
...
### <a name="does-this-feature-work-for-embed-isv-solutions" />Virkar þessi eiginleiki fyrir innstýringu á ÓHS lausnum?

Já. Notendur með aðeins  Microsoft 365  leyfi geta einnig nálgast færslur í umhverfi sem keyra undir *. bc.dynamics.com léni.

## [Leyfi](#tab/license)

### <a name="can-a-customer-use-this-feature-if-they-dont-have-business-central" />Getur viðskiptavinur notað þennan eiginleika ef þeir eru ekki miðsvæðis í viðskiptum?
...
### <a name="how-does-this-help-me-manage-subscription-costs-in-my-organization" />Hvernig hjálpar þetta mér að stjórna áskriftarkostnaði í fyrirtækinu mínu?
...
### <a name="is-this-licensing-related-to-the-business-central-team-member-license" />Er leyfisveiting tengd starfsemi miðlægu teymis starfsleyfi?
...
### <a name="does-business-central-enforce-any-of-the-constraints" />Hefur seðlabankinn framfylgt einhverju af hömlunum?
...
### <a name="can-i-access-records-on-teams-for-ios-and-teams-for-android" />Get ég nálgast færslur á teymum fyrir  iOS  og teyma Android?
...
### <a name="how-do-users-change-their-personal-settings-in-my-settings" />Hvernig breyta notendur persónulegum stillingum sínum í stillingum mínum?
...
### <a name="what-determines-the-choice-of-language-when-you-sign-in-for-the-first-time" />Hvað ákvarðar val tungumálsins við innskráningu í fyrsta sinn?
...
### <a name="why-cant-i-activate-some-of-the-colored-links-in-tabs-and-card-details" />Hvers vegna get ég ekki virkjað einhverja litaða tengla í flipum og kortaupplýsingum?
...
### <a name="why-cant-i-activate-page-notification-actions" />Af hverju er ekki hægt að virkja síðutilkynningaraðgerðir?
...
### <a name="if-i-cant-filter-will-i-still-see-a-filtered-list-that-was-created-by-others" />Ef ég get ekki afmarkað, mun ég enn sjá afmarkaðan lista sem var búinn til af öðrum?
