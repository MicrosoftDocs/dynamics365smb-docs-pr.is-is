...
# <a name="troubleshooting-accessing-camera-and-location" />Úrræðaleit: aðgangur að myndavél og staðsetningu
...
## <a name="device-must-have-camera-and-location-capabilities" />Tækið verður að vera með myndavél og staðsetningareiginleika
...
## <a name="access-permissions-not-enabled" />Aðgangsheimild ekki virk
...
## <a name="web-client-connection-not-secure" />Tenging vefbiðlara er ekki örugg
...
## <a name="work-with-virtualization-technologies" />Vinna með sýndartækni
...
## <a name="antivirus-software" />Vírusvarnarhugbúnaður
