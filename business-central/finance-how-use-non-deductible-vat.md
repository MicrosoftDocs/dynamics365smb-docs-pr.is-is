...
## <a name="create-a-purchase-invoice-with-non-deductible-vat" />Stofna innkaupareikning með ófrádráttarbæran virðisaukaskatt
...
## <a name="create-a-purchase-order-with-non-deductible-vat" />Stofna innkaupapöntun með ófrádráttarbæran virðisaukaskatt
...
## <a name="adjust-rounded-vat-amounts-before-document-posting" />Leiðrétta slétta VSK-upphæðir fyrir bókun skjals
