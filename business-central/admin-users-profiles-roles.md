...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Stjórna notandasíðum
...
## <a name="page-customization"></a><a name="page-customization"></a>Sérsnið síðna
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>Forstilling stofnuð
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>Til að afrita forstillingu
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>Til að breyta forstillingu
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>Úthlutun forstillinga á notanda
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>Til að skilgreina notandastillingar fyrir forstillingu
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>Til að virkja forstillingu
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a>Flytja út forstillingar
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a>Flytja inn forstillingar
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>Til að eyða forstillingu
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>Til að eyða öllum sérstillingum sem notandi gerði
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>Til að eyða sérstillingum fyrir tilteknar síður
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Stjórna lotum notenda
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/users-security-dynamics-365-business-central/)
