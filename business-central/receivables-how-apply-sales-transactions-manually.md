...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries" />Afstemma greiðslur viðskiptavinar með inngreiðslubók eða úr færslum í viðskiptamannabók
...
## <a name="to-fill-and-post-a-cash-receipt-journal" />Til að fylla út og bóka inngreiðslubók:
...
## <a name="to-apply-a-payment-to-a-single-customer-ledger-entry" />Greiðsla jöfnuð við eina viðskiptamannsfærslu
...
## <a name="to-apply-a-payment-to-multiple-customer-ledger-entries" />Greiðsla jöfnuð við margar viðskiptamannafærslu:
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Inngreiðslubók** og velja síðan viðkomandi tengil.
2. Velja skal aðgerðina **Breyta færslubók**.
3. Í fyrstu bókarlínunni eru ritaðar viðeigandi upplýsingar um færsluna sem á að jafna.
4. Í reitnum **Tegund fylgiskjals** er valið **Greiðsla**.
...
## <a name="to-apply-a-credit-memo-to-a-single-customer-ledger-entry" />Kreditreikningur jafnaður við eina viðskiptamannsfærslu:
...
## <a name="to-apply-a-credit-memo-to-multiple-customer-ledger-entries" />Kreditreikningur jafnaður við margar viðskiptamannafærslur:
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Sölukreditreikningar** og velja síðan viðkomandi tengil.
2. Opna skal viðeigandi sölukreditreikning.
...
## <a name="to-apply-posted-customer-ledger-entries" />Bókaðar viðskiptamannafærslur jafnaðar:
...
## <a name="to-apply-customer-ledger-entries-in-different-currencies-to-one-another" />Viðskiptamannafærslur jafnaðar hver við aðra í mismunandi gjaldmiðlum:
...
## <a name="to-correct-an-application-of-customer-entries" />Til að leiðrétta jöfnun á færslum viðskiptamanns
