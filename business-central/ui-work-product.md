...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Vinna með [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Ábendingar og góð ráð
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Tenglar til að fá frekari upplýsingar
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Farið um Business Central
Hér er stutt myndband um hvernig á að komast um í [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Tölvuvafri valinn
...
## <a name="action-bars"></a><a name="action-bars"></a>Aðgerðaslár
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/work-pro-data-dynamics-365-business-central/)
