...
## <a name="links-to-learn-more" />Tenglar til að fá frekari upplýsingar
...
## <a name="getting-around-in-business-central" />Farið um Business Central
Hér er stutt myndband um hvernig á að komast um í [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser" />Tölvuvafri valinn
...
## <a name="action-bars" />Aðgerðaslár
