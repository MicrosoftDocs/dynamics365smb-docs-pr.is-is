---
title: Fáðu Business Central í farsímanum þínum (inniheldur myndskeið)
description: 'Þessi grein lýsir ýmsum leiðum sem þú getur skoðað og breytt Business Central gögnum þínum, sent Excel og fleira í símanum eða spjaldtölvunni.'
author: jswymer
...
# <a name="getting-business-central-on-your-mobile-device"></a>Að fá Business Central í farsímanum þínum
...
3. Færið inn notendanafn og lykilorð sem var búið til þegar notandi skráði sig í [!INCLUDE[prod_short](includes/prod_short.md)] og farið eftir leiðbeiningum á skjánum.
     ...
     [!INCLUDE [prod_short](includes/prod_short.md)] Ef þú hefur fleiri en eitt framleiðsluumhverfi verður þú beðinn að velja umhverfið sem þú vilt fá aðgang að (krefst Þess að Business Central 2020 útgáfubylgju 2 og síðar).
