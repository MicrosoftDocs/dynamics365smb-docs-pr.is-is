...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />Grunnstilling OneDrive samþættingar við Business Central á staðnum
...
## <a name="a-nameregisterapparegister-an-app-in-azure-ad-for-onedrive-integration" /><a name="registerapp"></a>Skráðu forrit í Azure AD fyrir OneDrive samþættingu
...
## <a name="a-nameurlaget-your-onedrive-url" /><a name="url"></a>Fá OneDrive vefslóðina

[!INCLUDE[onedrive-url](includes/onedrive-url.md)]

## <a name="set-up-the-onedrive-connection-in-version-21-and-later" />Setja upp OneDrive tengingu í útgáfu 21 og nýrri
...
### <a name="run-onedrive-setup" />Keyra OneDrive uppsetningu
...
## <a name="set-up-the-connection-in-includeprodshortincludesprodshortmd-version-19-and-20" />Setja upp tenginguna í [!INCLUDE[prod_short](includes/prod_short.md)] útgáfu 19 og 20
...
## <a name="after-upgrade-to-version-21" />Eftir uppfærslu í útgáfu 21
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Skipt úr eldra SharePoint yfir í nýja OneDrive samþættingu
...
### <a name="a-nameonedrivesetupmigrationaabout-switching-to-the-new-onedrive-integration" /><a name="onedrivesetupmigration"></a>Um skiptingu yfir í nýju OneDrive samþættinguna
...
#### <a name="how-the-changes-affect-the-integration" />Hvernig breytingarnar hafa áhrif á samþættinguna
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Keyrðu OneDrive uppsetningu til að skipta yfir í nýju OneDrive samþættinguna
