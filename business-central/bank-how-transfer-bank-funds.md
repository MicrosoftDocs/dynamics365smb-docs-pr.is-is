...
ms.author: edupont
---
# <a name="transfer-bank-funds" />Flytja bankainnstæður
...
## <a name="to-post-a-transfer-between-bank-accounts-with-the-same-currency-code" />Millifærslur af einum bankareikningi á annan með sama gjaldmiðilskóða
...
## <a name="to-post-a-transfer-between-bank-accounts-with-different-currency-codes" />Færslur milli bankareikninga bókaðar með gjaldmiðilskótum
