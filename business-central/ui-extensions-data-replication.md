...
ms.locfileid: "3076381"
---
# <a name="intelligent-cloud-extensions-for-cloud-migration"></a>Snjallskýsviðbætur fyrir flutningi í skýi

Þessi viðbót mun tengja gögnin þín úr [!INCLUDE [prodshort](includes/prodshort.md)] innanhúss við [!INCLUDE [prodshort](includes/prodshort.md)] á netinu í þeim tilgangi að yfirfæra lausnina í skýið.  
...
Ef þú ert að nota Dynamics SL skaltu ná í viðbæturnar **Snjallskýsgrunnsviðbót**, **Microsoft Dynamics SL-snjallský** og **Microsoft Dynamics SL-ferlissnjalllisti** og keyra svo **Uppsetningu skýjaflutnings** leiðbeiningar um uppsetningu með hjálp.  
