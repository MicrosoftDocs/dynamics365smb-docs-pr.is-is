...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Hönnunarupplýsingar: Þekkt vandamál birgðajöfnunar
...
## <a name="symptoms-of-the-issue" />Einkenni vandamálsins
...
## <a name="basics-of-item-application" />Grunnatriði birgðajöfnunar
...
### <a name="quantity-application" />Magnjöfnun
...
### <a name="cost-application" />Jöfnun kostnaðar
...
## <a name="illustration-of-a-basic-cost-flow" />Skýringarmynd af grunnkostnaðarflæði
...
## <a name="reasons-for-the-issue" />Ástæður fyrir vandamálinu
...
## <a name="identifying-the-issue" />Auðkenna vandann
...
## <a name="workaround-for-the-issue" />Hjáleið á vandanum
