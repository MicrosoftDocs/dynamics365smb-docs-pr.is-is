...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Hönnunarupplýsingar: Þekkt vandamál birgðajöfnunar
...
## <a name="symptoms-of-the-issue"></a><a name="symptoms-of-the-issue"></a>Einkenni vandamálsins
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Grunnatriði birgðajöfnunar
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Magnjöfnun
...
### <a name="cost-application"></a><a name="cost-application"></a>Jöfnun kostnaðar
...
## <a name="illustration-of-a-basic-cost-flow"></a><a name="illustration-of-a-basic-cost-flow"></a>Skýringarmynd af grunnkostnaðarflæði
...
## <a name="reasons-for-the-issue"></a><a name="reasons-for-the-issue"></a>Ástæður fyrir vandamálinu
...
## <a name="identifying-the-issue"></a><a name="identifying-the-issue"></a>Auðkenna vandann
...
## <a name="workaround-for-the-issue"></a><a name="workaround-for-the-issue"></a>Hjáleið á vandanum
