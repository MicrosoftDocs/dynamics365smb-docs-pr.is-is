...
---
# <a name="set-up-vendor-bank-accounts"></a><a name="set-up-vendor-bank-accounts"></a>Uppsetning lánardrottnabankareikninga
...
## <a name="add-or-edit-a-vendor-bank-account"></a><a name="add-or-edit-a-vendor-bank-account"></a>Bæta við eða breyta bankareikningi lánardrottins
...
## <a name="set-up-a-preferred-vendor-bank-account"></a><a name="set-up-a-preferred-vendor-bank-account"></a>Setja upp æskilegan bankareikning lánardrottins
