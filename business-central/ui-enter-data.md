...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a>Gagnainnfærsla
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Vinna með breytanlega reiti
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Reitargildi breytt
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Hraða gagnaskráningu með flýtifærslu
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>Hvernig flýtifærsla virkar
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Ábendingar og góð ráð
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>Til að breyta reitum flýtifærslu
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a>Áskildir reitir
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Finna gögn um leið og ritað er
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>Afrita og líma reiti og línur
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a>Síun á línuatriðum
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Fókus settur á línuatriði
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>Kveikja eða slökkva á fókus
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Fjölvinnsla þvert á margar síður
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Magn slegið inn eftir útreikningum
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Neikvæðar tölur er færðar inn
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Dagsetning og tími færð inn
...
### <a name="entering-dates"></a><a name="entering-dates"></a>Dagsetningar færðar inn
...
## <a name="entering-times"></a><a name="entering-times"></a>Tími færður inn
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Sláðu inn sameinaða dagsetningar og tíma

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration"></a><a name="entering-duration"></a>Færið inn tímalengd
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Að stilla skiltákn tugabrots sem á að nota með talnalyklaborðum
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/explore-modify-info-dynamics-365-business-central/)
