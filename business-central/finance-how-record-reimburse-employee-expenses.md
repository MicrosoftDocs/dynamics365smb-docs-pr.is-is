---
title: Skrá og endurgreiða kostnað starfsmanns
...
# <a name="record-and-reimburse-employees-expenses"></a>Skrá og endurgreiða kostnað starfsmanns
...
[!INCLUDE [prod_short](includes/prod_short.md)] er nógu sveigjanlegt til að henta mörgum mismunandi leiðum. Nákvæm reikningsnúmer sem á að nota fer eftir grunnstillingu og vinnslu fyrirtækisins.  
