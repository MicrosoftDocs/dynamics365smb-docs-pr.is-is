...
ms.author: bholtorf
---
# <a name="set-up-a-sequence-of-workflow-users" />Setja upp röð notenda verkflæðis
...
## <a name="to-set-up-a-workflow-user-group" />Notendaflokkur verkflæðis settur upp
