...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Unnið með fjárhagstímabil og fjárhagsár
...
## <a name="creating-a-new-fiscal-year" />Stofna nýtt fjárhagsár

Hægt er að búa til mörg reikningstímabil saman með runuvinnslunni **Búa til reikningsár** eða handvirkt.

### <a name="how-to-create-accounting-periods-in-bulk" />Hvernig á að búa til reikningstímabil í magni
...
### <a name="how-to-create-accounting-periods-manually" />Hvernig á að stofna reikningstímabil handvirkt
...
## <a name="closing-a-fiscal-year" />Lokun fjárhagsárs
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Bókun færslna á lokað fjárhagsár
