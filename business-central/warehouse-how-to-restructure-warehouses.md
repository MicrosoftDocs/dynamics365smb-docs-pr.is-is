...
ms.author: edupont
---
# <a name="restructure-warehouses" />Endurskipulagning vöruhúsa
...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />Til að endurskipuleggja einfalt vöruhús sem notar aðeins hólf
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />Til að endurskipuleggja ítarvöruhús sem notar stýrðan frágang og tínslu
...
## <a name="to-delete-a-bin" />Hólfi eytt:
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />Hólf endurnefnt og hólfkóta breytt í öllum færslum
