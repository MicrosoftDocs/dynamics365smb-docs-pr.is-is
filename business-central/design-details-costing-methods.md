---
title: Aðferðir við kostnaðarútreikning hönnunar
...
---
# <a name="design-details-costing-methods"></a>Hönnunarupplýsingar: aðferðir við kostnaðarútreikning
...
|--|--|--|
| FIFO | Kostnaðarverð vöru er raunvirði sérhverrar innhreyfingar vörunnar, valið samkvæmt FIFO-reglunni.<br /><br /> Verðmætamat birgða gerir ráð fyrir að fyrstu vörurnar sem settar eru í birgðir séu seldar fyrst. | Í umhverfi fyrirtækja þar sem vörukostnaður er stöðugt.<br /><br /> (Þegar verð hækkar sýnir efnahagsreikningurinn hærra virði. Þetta þýðir að skattaskuldir aukast, en möguleikar til að fá lánsfé aukast.<br /><br /> Notið með vörum með takmarkaðan endingartíma, þar sem elstu vörurnar þarf að selja áður en þær fara fram yfir síðasta söludag. |
| LIFO | Kostnaðarverð vöru er raunvirði sérhverrar innhreyfingar vörunnar, valin samkvæmt LIFO-reglunni.<br /><br /> Verðmætamat birgða gerir ráð fyrir að síðustu vörurnar sem settar eru í birgðir séu seldar fyrst. | Óheimilt í mörgum löndum, þar sem það getur verið notað til að minnka hagnað.<br /><br /> (Þegar verð hækkar, lækkar virðið á rekstarreikningnum. Þetta þýðir að skattaskuldir minnka, en möguleikar til að fá lánsfé rýrna. |
| Meðaltal | Kostnaðarverð vöru er reiknað sem meðaleiningaverð vara á hverjum tímapunkti eftir innkaup.<br /><br /> Verðmætamat birgða gerir ráð fyrir að allar birgðir séu seldar samtímis. | Í umhverfi fyrirtækja þar sem vörukostnaður er óstöðugur.<br /><br /> Þegar birgðum er blandað saman eða blandað saman og ekki er hægt að skipta þeim út, t.d. efnum. |
...
| Staðlað | Kostnaðarverð vöru er forstillt samkvæmt áætlun.<br /><br /> Þegar raunkostnaður er innleystur síðar, verður að breyta staðlaða kostnaðarverðinu í raunkostnaðinn, í gegnum fráviksgildi. | Þar sem kostnaðarstýring er mikilvæg.<br /><br /> Í endurtekingaframleiðslu, til að meta kostnaðinn á beinu efni, beinni framleiðslu og sameiginlegs kostnaðar.<br /><br /> Þar sem agi og starfsfólk er til að viðhalda stöðlum. |
...
Aðferð kostnaðarútreiknings eru mismunandi í því hvernig þeir meta birgðaminnkun og hvort þær nota raunkostnað eða staðalkostnað vörubirgðir sem grunn matsins. Eftirfarandi tafla útskýrir mismunandi einkenni. (LIFO-aðferðin er undanskilin þar sem hún er svipuð FIFO-aðferðinni.)  
<!--Old  table
...
- **Sérstakt**  
    ...
    Fyrir vörur sem nota **aðferð kostnaðarútreiknings** er birgðaminnkun metin samkvæmt birgðaaukningunni sem fasta jöfnunin tengir hana við.  
