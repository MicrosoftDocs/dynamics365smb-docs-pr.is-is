...
ms.author: edupont
---
# <a name="cross-dock-items" />Hjáskipa vörur
...
## <a name="cross-dock-bins-and-zones" />Hjáskipunarhólf og svæði
...
## <a name="cross-dock-select-lines-for-a-receipt" />Hjáskipunarlínur fyrir kvittun
...
## <a name="about-the-put-away-worksheet-page" />Um frágang vinnublaðs
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />Vöruhúsið sett upp fyrir hjáskipun
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities" />Vörum hjáskipað án þess að skoða tækifærin:
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities" />Vörur hjáskipaðar eftir að tækifæri hafa verið skoðuð:
1.  Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Vöruhúsamóttökur** og velja síðan viðkomandi tengil.  
2.  Stofna vöruhúsamóttöku fyrir vöru sem hefur borist og er til dæmis hægt að hjáskipa. Frekari upplýsingar eru í [Móttaka vara](warehouse-how-receive-items.md).  
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Hjáskipunarvörur skoðaðar í afhendingum eða tínsluvinnublaði
