...
ms.author: bholtorf
---
# <a name="report-selection-for-documents-in-business-central" />Skýrsluval fyrir skjöl í Business Central
...
## <a name="available-report-selections" />Skýrsluval í boði
...
## <a name="example-report-selection-for-sales-documents" />Dæmi: Skýrsluval fyrir söluskjöl
