...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status" />Þjónustupöntunarstaða og viðgerðarstaða
...
## <a name="specifying-service-order-status-for-repair-status" />Þjónustupöntunarstaða tilgreind fyrir viðgerðarstöðu
