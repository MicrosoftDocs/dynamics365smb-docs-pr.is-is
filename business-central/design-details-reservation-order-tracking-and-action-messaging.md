...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Hönnunarupplýsingar: Pöntun, pöntunarrakning og stöðuboð
...
## <a name="reservation"></a><a name="reservation"></a><a name="reservation"></a>Frátekning
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Mótbókun í frátekningu
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a><a name="manual-reservation"></a>Handvirk frátekning
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a><a name="automatic-reservations"></a>Sjálfvirkar frátekningar
...
## <a name="order-tracking"></a><a name="order-tracking"></a><a name="order-tracking"></a>Rakning pöntunar
...
### <a name="the-order-network"></a><a name="the-order-network"></a><a name="the-order-network"></a>Pöntunarnetið
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Mótbókun í pöntunarrakningu
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Dæmi: Pöntunarrakning í sölu, framleiðsla og flutningur
...
### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Færslunúmer 8 og 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Færslunúmer 10
...
### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Færslunúmer 8 og 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Færslunúmer 12 til 16
...
### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Færslunúmer 21 og 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a><a name="action-messaging"></a>Aðgerðarboð
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Rakning pöntunar og áætlun
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Áætlunarkerfi samanborið við Pöntunarrakningu og Aðgerðarboð
