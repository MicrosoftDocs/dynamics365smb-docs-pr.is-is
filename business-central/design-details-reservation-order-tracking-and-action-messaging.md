...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Hönnunarupplýsingar: Pöntun, pöntunarrakning og stöðuboð
...
### <a name="offsetting-in-reservations" />Mótbókun í frátekningu
...
### <a name="manual-reservation" />Handvirk frátekning
...
### <a name="automatic-reservations" />Sjálfvirkar frátekningar
...
## <a name="order-tracking" />Rakning pöntunar
...
### <a name="the-order-network" />Pöntunarnetið
...
### <a name="offsetting-in-order-tracking" />Mótbókun í pöntunarrakningu
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Dæmi: Pöntunarrakning í sölu, framleiðsla og flutningur
...
## <a name="action-messaging" />Aðgerðarboð
...
## <a name="order-tracking-and-planning" />Rakning pöntunar og áætlun
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />Áætlunarkerfi samanborið við Pöntunarrakningu og Aðgerðarboð
