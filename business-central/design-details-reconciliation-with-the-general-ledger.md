...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger"></a><a name="design-details-reconciliation-with-the-general-ledger"></a>Hönnunarupplýsingar: afstemming í fjárhagur
...
## <a name="post-inventory-cost-to-gl-batch-job"></a><a name="post-inventory-cost-to-gl-batch-job"></a>Keyrslan Bóka birgðakostnað á fjárhag
...
## <a name="automatic-cost-posting"></a><a name="automatic-cost-posting"></a>Sjálfvirk kostnaðarbókun
...
## <a name="account-types"></a><a name="account-types"></a>Gerðir reikninga
