...
Einnig er hægt að skoða fræðslumyndböndin okkar, ásamt fullt af öðru efni, á YouTube-spilunarlistanum sem var búinn til fyrir [!INCLUDE[prod_short](includes/prod_short.md)]. Til að skoða myndböndin skal [smella hér](https://go.microsoft.com/fwlink/?linkid=851533).
