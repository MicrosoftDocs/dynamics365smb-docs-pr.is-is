...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically"></a><a name="reconcile-payments-that-cannot-be-applied-automatically"></a>Afstemma greiðslur sem ekki er hægt að nota sjálfkrafa
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically"></a><a name="to-reconcile-payments-that-cannot-be-applied-automatically"></a>Að afstemma greiðslur sem ekki er hægt að afstemma sjálfkrafa
