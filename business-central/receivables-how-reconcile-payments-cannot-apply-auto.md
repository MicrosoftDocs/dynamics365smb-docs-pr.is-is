...
---
# <a name="reconcile-payments-that-cant-be-applied-automatically"></a>Stemma af greiðslur sem ekki er hægt að jafna sjálfvirkt
...
## <a name="to-reconcile-payments-that-cant-be-applied-automatically"></a>Til að stemma af greiðslur sem ekki er hægt að jafna sjálfvirkt
