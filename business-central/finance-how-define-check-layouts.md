...
ms.author: edupont
---
# <a name="select-a-check-layout" />Velja útlit ávísunar
...
## <a name="to-select-a-check-layout" />Útlit ávísunar valið
...
## <a name="use-micr-and-security-fonts" />Nota MICR og öryggisletur
...
### <a name="secure-font-specifications" />Lýsingar á öruggu letri
