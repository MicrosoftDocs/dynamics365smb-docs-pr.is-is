...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Velja útlit ávísunar
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Útlit ávísunar valið
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>Nota MICR og öryggisletur
...
### <a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a>MICR E-13B lýsingar
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a>Skiltákn
...
### <a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a>MICR CMC-7 lýsingar
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Skiltákn
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Lýsingar á öruggu letri
