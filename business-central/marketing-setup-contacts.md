...
## <a name="to-assign-industry-groups-to-a-contact"></a> Starfsgreinahópum úthlutað á tengilið
...
## <a name="to-define-a-contacts-alternate-address"></a>Að skilgreina annað aðsetur tengiliðar
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a>Starfsábyrgðum úthlutað á tengiliði:
...
## <a name="to-assign-organizational-levels-to-a-contact"></a>Að úthluta skipulagsstigum til tengiliðs
...
## <a name="to-assign-web-sources-to-a-contact"></a>Að úthluta veftengingum á einstakling
...
## <a name="to-assign-business-relations-to-a-contact"></a> Til að úthluta viðskiptatengslum á tengilið
