...
# <a name="set-up-stockkeeping-units"></a><a name="set-up-stockkeeping-units"></a>Setja upp birgðahaldseiningar
...
## <a name="to-set-up-a-stockkeeping-unit"></a><a name="to-set-up-a-stockkeeping-unit"></a>Uppsetning birgðaeininga
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/control-inventory-multiple-locations/)
