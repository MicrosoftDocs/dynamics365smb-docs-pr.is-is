...
ms.author: edupont
---
# <a name="about-item-types"></a><a name="about-item-types"></a><a name="about-item-types"></a>Um vörutegundir
...
## <a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a>Kostnaðaraðferðir fyrir vörutegundir
...
## <a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a>Vörulistar og þjónustuvörur
