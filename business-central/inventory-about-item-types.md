...
ms.author: edupont
---
# <a name="about-item-types" />Um vörutegundir
...
## <a name="costing-methods-for-types-of-items" />Kostnaðaraðferðir fyrir vörutegundir
...
## <a name="catalog-and-service-items" />Vörulistar og þjónustuvörur
