...
ms.author: jswymer
---
# <a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a>Umsjón með ástæðu aðgangs að gagnagrunni
...
## <a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a>Breyta ástæðu fyrir aðgangi að gagnagrunni
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/deploy-configure-dynamics-365-business-central/)
