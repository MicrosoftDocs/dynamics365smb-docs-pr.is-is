...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Vinna við þjónustuverk
...
## <a name="to-work-on-a-service-task" />Unnið við þjónustuverkhluta:
...
## <a name="to-register-service-operations" />Skráning þjónustuaðgerða
...
## <a name="to-register-spare-parts" />Varahlutir skráðir
...
## <a name="to-register-spare-parts-from-a-service-order" />Til að skrá varahluti úr þjónustupöntun
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Skipta um þjónustuvöru eða þjónustuvöruíhlut
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Svartíma fyrir þjónustuvörulínu breytt:
...
## <a name="to-register-faultresolution-codes" />Skráning bilana- og úrlausnarkóta
