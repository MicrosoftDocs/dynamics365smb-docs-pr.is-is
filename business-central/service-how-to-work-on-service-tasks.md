...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Vinna við þjónustuverk
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Unnið við þjónustuverkhluta:
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Skráning þjónustuaðgerða
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Varahlutir skráðir
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Til að skrá varahluti úr þjónustupöntun
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Skipta um þjónustuvöru eða þjónustuvöruíhlut
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Svartíma fyrir þjónustuvörulínu breytt:
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Skráning bilana- og úrlausnarkóta
