...
description: Nota skal víddir til að flokka færslur, eins og eftir deild eða verki, svo hægt sé að rekja og greina gögn á auðveldari hátt til að stuðla að betri ákvarðanatöku í viðskiptum.
author: edupont04
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
