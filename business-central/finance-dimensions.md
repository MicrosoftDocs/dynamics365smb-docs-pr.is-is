---
title: Vinna með víddir til að rekja og greina gögn
description: 'Nota víddir til að flokka færslur, t.d. eftir deild eða verkefni, svo að auðvelt sé að rekja og greina gögn til að hjálpa til við að taka góðar viðskiptaákvarðanir.'
author: brentholtorf
ms.author: bholtorf
...
## <a name="set-up-dimensions"></a>Setja upp víddir
...
* **Altækar víddir** eru notaðar sem afmarkanir, t.d. á skýrslur, runuvinnslur og XMLports. Aðeins er hægt að nota tvær altækar víddir svo að velja víddir sem oft á að nota.
...
> [!NOTE]
> Sjálfgefinn víddarforgangur opnast fyrir aðstæður í sölu og innkaupum sem ætlunin er að vekja sérstaka athygli á. Þegar sjálfgefinn víddarforgangur er notaður í sölu- og innkaupaskjölum [!INCLUDE [prod_short](includes/prod_short.md)]  er víddirnar í hausnum alltaf teknar með í reikninginn þegar kemur frá viðskiptamanni eða lánardrottni. Þetta á við um víddir sem eru sjálfgefnar eða sjálfgefnar og á sérstaklega við þegar sjálfgefnar víddir eru notaðar í birgðageymslum og vörum en ekki á viðskiptamenn eða lánardrottna.
>
> **Dæmi**
>
> Dæmi er um eftirfarandi víddarstillingar:
>
> * Viðskiptamaður án sjálfgefinna vídda
> * Vara með ADM sem víddargildi fyrir deildarvíddina
> * Birgðageymsla með FRAML sem víddargildi víddina DEILD
> * Forgangur sjálfgefinnar víddar er stilltur sem Viðskiptamaður > Vara > Birgðageymsla
>
> Þegar nýtt fylgiskjal er stofnað í þessu dæmi eru víddir notaðar á eftirfarandi hátt:
>
> * Ef nýtt skjal er stofnað og birgðageymslu bætt við verður sjálfgefið gildi fyrir nýjar línur FRAML. Þegar línum með vörum er bætt við verður FRAML [!INCLUDE [prod_short](includes/prod_short.md)]  haldið áfram vegna þess að það kemur úr haus skjalsins.
>
> * Ef nýtt skjal er stofnað og vörum með víddargildi ADM bætt við og birgðageymsla tilgreind í haus skjalsins [!INCLUDE [prod_short](includes/prod_short.md)]  er spurt hvort skrifa eigi yfir línurnar sem fyrir eru vegna þess að misræmi verður.
>
> Mælt er með því að prófa sjálfgefna víddauppsetningu, víddarforgang og röðina þar sem gögn eru færð inn í fylgiskjöl.  
...
3. Fylla þarf út línu fyrir hverja nýja vídd sem á að setja upp. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
...
Til að forðast að bóka færslur með mótsagnarkenndum eða óviðkomandi víddum er hægt að loka eða takmarka tilteknar samsetningar tveggja vídda. Lokuð víddarsamsetning þýðir að ekki er hægt að bóka báðar víddir í sömu færslu án tillits til þess hvað víddargildin eru. Á hinn bóginn þýðir takmörkuð víddarsamsetning að hægt að bóka báðar víddirnar í sömu færsluna en aðeins fyrir ákveðnar samsetningar víddargilda.
...
[Fjármál](finance.md)    
[Greining gagna eftir víddum](bi-how-analyze-data-dimension.md)    
