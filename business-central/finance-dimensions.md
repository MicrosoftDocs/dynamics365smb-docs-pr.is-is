...
---
# <a name="work-with-dimensions" />Vinna með víddir
...
## <a name="analyzing-by-dimensions" />Greining eftir víddum
...
## <a name="dimension-sets" />Víddasamstæður
...
## <a name="setting-up-dimensions" />Uppsetning vídda
...
### <a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts" />Til að setja upp sjálfgefnar víddir fyrir viðskiptavini, lánardrottna, og aðra reikninga
...
### <a name="to-set-up-default-dimension-priorities" />Að setja upp sjálfgefinn víddarforgang
...
### <a name="to-set-up-dimension-combinations" />Að setja upp samsettar víddir
...
### <a name="to-set-up-global-and-shortcut-dimensions" />Að setja upp altækar víddir og flýtivísanir í víddir
...
#### <a name="to-change-global-dimensions" />Að breyta altækum víddum
...
### <a name="example-of-dimension-setup" />Dæmi um uppsetningu víddar
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times" />Fá yfirlit um víddir sem eru notaðar oftar en einu sinni
...
## <a name="use-dimensions" />Nota víddir
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages" />Að skoða altækar víddir á fjárhagsfærslusíðum
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/dimensions-dynamics-365-business-central/index)
