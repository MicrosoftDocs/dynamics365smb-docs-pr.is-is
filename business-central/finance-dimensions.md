...
5. Til að staðfesta leiðréttinguna skal velja **Staðfesta víddarbreytingar**. Frekari upplýsingar er að finna í [Víddarleiðréttingar staðfestar](finance-dimensions.md#validating-dimension-corrections).
6. Veljið **Keyra**.
...
Annaðhvort er hægt að keyra leiðréttingu strax eða tímasetja hana fram í tímann. Ef leiðréttingar eru gerðar á stóru gagnasafni er mælt með því að áætla keyrsluna utan vinnutíma. Frekari upplýsingar er að finna í [Víddarleiðréttingar á stórum gagnasöfnum](finance-dimensions.md#dimension-corrections-on-large-data-sets).
