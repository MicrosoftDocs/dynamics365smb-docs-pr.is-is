...
ms.author: edupont
---
# <a name="create-bin-contents" />Stofna innihald hólfs
...
## <a name="to-create-bin-content-manually" />Stofna Innihald hólfs handvirkt
...
## <a name="to-create-bin-content-with-a-worksheet" />Stofna Innihald hólfs með vinnublaði
