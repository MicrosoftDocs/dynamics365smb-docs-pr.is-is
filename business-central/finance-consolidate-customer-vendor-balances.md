...
ms.author: bholtorf
---
# <a name="consolidate-balances-for-a-company-that-is-a-customer-and-a-vendor" />Sameina stöður fyrir fyrirtæki sem er viðskiptamaður og lánardrottinn
...
## <a name="link-an-existing-customer-and-vendor-company-thorough-a-contact" />Tengja fyrirliggjandi fyrirtæki viðskiptamanns og lánardrottins í gegnum tengilið
...
## <a name="create-a-vendor-from-a-customer-or-vice-versa" />Stofnaðu lánardrottinn úr viðskiptamanni eða öfugt
...
## <a name="create-a-new-customer-or-vendor-and-link-them-through-a-vendor-or-customer-contact" />Stofna nýjan viðskiptamann eða lánardrottin og tengja þá í gegnum tengilið lánardrottins eða viðskiptamanns
...
## <a name="to-consolidate-the-customer-and-vendor-balances-for-a-contact-company" />Að sameina stöður viðskiptamanns og lánardrottins fyrir fyrirtæki tengiliðar
...
## <a name="handling-duplicates" />Meðhöndlun tvítekninga
