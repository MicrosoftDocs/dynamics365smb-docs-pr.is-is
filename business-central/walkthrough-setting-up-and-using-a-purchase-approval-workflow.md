...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Kynning: Uppsetning og notkun á samþykktarverkflæði innkaupa
...
### <a name="setting-up-approval-users" />Setja upp notendur samþykktar
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Til að setja upp þig sjálfan og Alicia sem notendur samþykki
...
### <a name="setting-up-notifications" />Tilkynningar settar upp
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Til að setja upp hvernig og hvenær þú færð tilkynningu
...
## <a name="creating-the-approval-workflow" />Samþykktarverkflæðið stofnað
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Til að stofnaog virkja samþykktarverkflæði innkaupapöntunar
...
## <a name="use-the-approval-workflow" />Nota samþykktarverkflæðið
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Til að óska eftir samþykki á innkaupapöntun, sem Alicia
...
### <a name="to-approve-the-purchase-order-as-sean" />Til að samþykkja innkaupapöntun, sem Sean
