---
title: Tilgreindu færslutímabil
...
ms.author: bholtorf
---
# <a name="specify-posting-periods"></a>Tilgreindu færslutímabil
...
> [!NOTE]  
> Þessi bókunartímabil eiga við um fyrirtækið og alla notendur. Til að leyfa undantekningum er hægt að skilgreina mismunandi pósttímabil fyrir tiltekna notendur á síðunni **Uppsetning notanda**. Þessar færslutímar eru umfram þau sem tilgreind eru á síðunni **Uppsetning aðalbókar**. Fyrir frekari upplýsingar, sjá [Til að setja upp tímatakmarkanir fyrir notendur](ui-define-granular-permissions.md#to-set-up-time-constraints-for-users).

## <a name="video-guidance"></a>Vídeó leiðsögn

Þegar þú ert að loka uppgjörstímabili gætirðu viljað koma í veg fyrir að nýjar færslur berist eða leyfa aðeins ákveðnum aðilum að bóka færslur. Eftirfarandi myndband sýnir hvernig á að stjórna því hvenær og hverjir geta bókað færslur í aðalbókina þína.
