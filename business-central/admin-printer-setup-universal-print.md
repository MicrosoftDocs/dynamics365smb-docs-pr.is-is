...
# <a name="set-up-universal-print-printers" />Setja upp Universal PRINT prentarar
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Setja upp Universal PRINT og prentarar í Microsoft Azure
...
## <a name="add-printers-in-business-central-online" />Bæta við prenturum í viðskiptum miðsvæðis á netinu
...
## <a name="add-printers-in-business-central-on-premises" />Bæta við prenturum í atvinnuhúsnæði miðsvæðis innanhúss
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Tengjast alhliða prentun í fyrsta sinn
...
## <a name="common-problems-and-resolutions" />Algeng vandamál og úrlausnir
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />Þú hefur ekki aðgang að prentaranum \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />Villa varð við að sækja prentara sem voru samnýtt.
