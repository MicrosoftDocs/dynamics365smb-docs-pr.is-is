...
# <a name="set-up-universal-print-printers"></a>Setja upp alhliða prentara
...
- Alhliða prentun:
  ...
  - Notandi er með hlutverkin **Prentarastjóri**  (eða prentarastjóri) og **hlutverk altæks kerfisstjóra** í Azure.

    Ef stjórna á Alhliða prentun verður reikningurinn að hafa **kerfisstjóra**  (eða prentarastjóra) og **hlutverk altæks kerfisstjóra** í Microsoft Entra kenni. Þessi hlutverk eru aðeins nauðsynleg til að stjórna skýjaprentun. Ekki er krafist þeirra af fólki sem settur er upp og prentararnir komnir úr [!INCLUDE[prod_short](includes/prod_short.md)].
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure"></a>Setja upp alhliða prentun og prentara í Microsoft Azure
...
5. Samnýta prentarana með notendum.
    ...
    > [!TIP]
    > Alltaf er hægt að bæta við eða fjarlægja notendur síðar. Frekari upplýsingar eru í [Prentheimildir](/universal-print/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
## <a name="add-printers-in-business-central-online"></a>Bæta við prenturum í Business Central á netinu
...
## <a name="add-printers-in-business-central-on-premises"></a>Bæta við prenturum í Business Central innanhúss
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time"></a>Tengjast alhliða prentun í fyrsta skipti
...
4.  **Velja skal tengilinn Heimila Azure Services** .
...
### <a name="you-dont-have-access-to-the-printer-your-printer"></a>Notandi hefur ekki aðgang að prentaranum \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you"></a>Villa varð við að sækja prentara sem samnýttir voru.
