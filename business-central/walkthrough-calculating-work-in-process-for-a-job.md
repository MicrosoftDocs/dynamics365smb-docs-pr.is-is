...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job" />Kynning: Útreikningur á VÍV fyrir verk
...
## <a name="calculating-wip" />Útreikningur á VÍV
...
### <a name="to-calculate-wip" />Útreikningur VÍV
...
### <a name="to-review-wip-warnings" />Til að fara yfir viðvaranir VÍV
...
### <a name="to-recalculate-wip" />VÍV endurreiknað
...
## <a name="posting-wip-to-general-ledger" />VÍV bókað í fjárhag

 Nú þegar Tricia hefur reiknað út VÍV fyrir þessa vinnslu er hægt að bóka það í fjárhag.  

### <a name="to-post-wip-to-general-ledger" />VÍV bókað í fjárhag
...
## <a name="reversing-a-wip-posting" />Bakfærsla VÍV-bókunar
...
### <a name="to-reverse-a-wip-posting" />Bakfærsla VÍV-bókunar
...
## <a name="see-related-microsoft-trainingtrainingpathscalculate-post-job-wip" />Sjá tengda [Microsoft þjálfun](/training/paths/calculate-post-job-wip/)
