...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Uppsetning eignarviðhalds
...
## <a name="to-set-up-general-maintenance-information" />Uppsetning almennra viðhaldsupplýsinga:
...
## <a name="to-set-up-maintenance-codes" />Uppsetning viðhaldskóta
...
## <a name="to-set-up-maintenance-expense-accounts" />Uppsetning reikninga viðhaldskostnaðar
