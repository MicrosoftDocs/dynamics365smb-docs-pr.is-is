...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Uppsetning eignarviðhalds
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Uppsetning almennra viðhaldsupplýsinga:
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Uppsetning viðhaldskóta
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Uppsetning reikninga viðhaldskostnaðar
