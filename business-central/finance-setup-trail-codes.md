...
ms.author: edupont
---
# <a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a><a name="setting-up-source-codes-and-reason-codes-for-audit-trails"></a>Uppsetning upprunakóða og ástæðukóða fyrir endurskoðunarslóðir
...
## <a name="define-source-codes"></a><a name="define-source-codes"></a><a name="define-source-codes"></a>Skilgreina upprunakóða
...
### <a name="to-define-source-codes"></a><a name="to-define-source-codes"></a><a name="to-define-source-codes"></a>Upprunakóðar skilgreindir:
...
## <a name="change-source-codes"></a><a name="change-source-codes"></a><a name="change-source-codes"></a>Breyta upprunakóðum

Hugsanlega þarf að breyta upprunakóða. Til dæmis ef notandi vill breyta upprunakóða *FHFBOK* í *FBK*.

### <a name="to-change-source-codes"></a><a name="to-change-source-codes"></a><a name="to-change-source-codes"></a>Upprunakóðum breytt:
...
## <a name="define-reason-codes"></a><a name="define-reason-codes"></a><a name="define-reason-codes"></a>Skilgreina ástæðukóða
...
### <a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a><a name="to-set-up-reason-codes"></a>Uppsetning ástæðukóða
...
### <a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a><a name="to-assign-reason-codes-to-journal-templates"></a>Ástæðukóðum úthlutað á færslubókarkeyrslur:
...
### <a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a><a name="to-use-reason-codes-on-sales-and-purchase-documents"></a>Nota ástæðukóða á sölu- og innkaupaskjöl
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/set-up-financial-management-dynamics-365-business-central/)
