...
# <a name="add-marketing-text-to-items" />Bæta markaðstexta við vörur
...
### <a name="create-first-draft-with-copilot" />Búa til fyrstu drög með Copilot
...
### <a name="review-edit-and-save-text" />Yfirfara, breyta og vista texta
...
### <a name="improve-and-tailor-text-suggestions" />Bæta og sníða tillögur að texta
...
## <a name="create-marketing-text-from-scratch" />Búa til markaðstexta frá grunni
