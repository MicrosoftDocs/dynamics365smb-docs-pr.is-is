...
---
# <a name="manage-the-intercompany-inbox-and-outbox" />Stjórna millifyrirtækja innhólfsfærslur og úthólfsfærslur
...
## <a name="organizing-the-inbox" />Innhólfinu raðað
...
### <a name="transaction-source" />Uppruni færslu
...
#### <a name="created-by-intercompany-partner" />Stofnað af samstæðufélaga
...
#### <a name="returned-from-intercompany-partner" />Skilað frá samstæðufélaga
...
## <a name="recreating-inbox-entries" />Endurbúa innhólfsfærslur
...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period" />Fá yfirlit yfir færslur milli fyrirtækja á tímabili
...
## <a name="import-intercompany-transactions-from-a-file" />Flytja færslur milli fyrirtækja inn úr skrá
...
## <a name="process-incoming-intercompany-transactions" />Vinna úr innsendum samstæðufærslum
...
## <a name="to-process-outgoing-intercompany-transactions" />Vinna færslur milli fyrirtækja á útleið
...
## <a name="recreate-intercompany-inbox-transactions" />Endurgera færslur í MF-innhólfi
