...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-" />Segja upp áskrift að eða fjarlægja [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing--from-your-app-launcher" />Fjarlægja [!INCLUDE[prod_short](includes/prod_short.md)] úr forritavalmynd þinni
