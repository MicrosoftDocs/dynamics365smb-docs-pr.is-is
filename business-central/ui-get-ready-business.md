...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Undirbúðu þig fyrir viðskiptin
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Fróðlegar ábendingar og leiðsagnir
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Heimasíður fyrir ákveðin hlutverk
...
## <a name="company-information"></a><a name="company-information"></a><a name="company-information"></a>Fyrirtækið
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Bæta við notendum og heimildum
...
## <a name="product-help"></a><a name="product-help"></a><a name="product-help"></a>Hjálp fyrir afurð
...
### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Setja upp fyrirtæki í [!INCLUDE[prod_short](includes/prod_short.md)]
