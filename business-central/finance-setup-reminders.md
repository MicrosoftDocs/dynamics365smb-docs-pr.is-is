...
description: Setja upp Business Central svo hægt sé að senda áminningar um greiðslur sem gjaldfallnar og bæta við gjöldum eða gjöldum vegna frestsins.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
---
# <a name="set-up-reminder-terms-and-levels"></a>Setja upp áminningarskilmála og stig

Hægt er að nota áminningar til að láta viðskiptamenn vita um gjaldfallnar upphæðir og að biðja um greiðslu. [!INCLUDE [reminder-terms](includes/reminder-terms.md)]
