...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Setja upp skilmála og stig innheimtubréfa
...
## <a name="reminder-terms"></a><a name="reminder-terms"></a>Skilmálar innheimtubréfa
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>Skilmálar innheimtubréfs settir upp
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Stig innheimtubréfa
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Stig innheimtubréfa sett upp
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/send-reminders-dynamics-365-business-central/)
