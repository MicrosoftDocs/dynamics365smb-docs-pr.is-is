...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos" />Bóka þjónustupantanir og kreditreikninga
...
## <a name="to-post-a-service-order" />Þjónustupantanir bókaðar:
...
## <a name="to-batch-post-service-orders" />Þjónustupantanir fjöldabókaðar:
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") táknið, fara í **Þjónustupantanir** og svo velja viðeigandi tengil.  
...
## <a name="to-post-a-service-credit-memo" />Þjónustukreditreikningar bókaðir:
...
## <a name="to-post-consumption-from-a-service-order" />Að bóka notkun úr þjónustupöntun:
...
## <a name="to-post-shipments-from-service-orders" />Bókun afhendinga úr þjónustupöntunum:
...
## <a name="to-undo-posted-consumption" />Afturkalla bókaða notkun
...
## <a name="to-post-service-lines" />Þjónustulínur bókaðar:
