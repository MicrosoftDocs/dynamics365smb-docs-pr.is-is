...
## <a name="testing-strategies"></a>Aðferðir við prófanir
...
### <a name="shopify-sandbox-and-business-central-sandbox"></a>Shopify Sandkassi og atvinnuhúsnæði Mið-sandkassann
...
### <a name="shopify-sandbox-and-business-central-production"></a>Shopify Sandkassi og rekstur Miðbæjarframleiðsla
...
### <a name="shopify-production-and-business-central-sandbox"></a>Shopify framleiðsla og rekstur Aðalbox sandkassan
...
## <a name="see-related-microsoft-training"></a>Sjá tengda  [Microsoft-þjálfun](/training/paths/use-shopify-connector-dynamics-365-business-central/)
