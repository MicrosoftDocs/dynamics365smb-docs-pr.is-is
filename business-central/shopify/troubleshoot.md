...
### Hafa umsjón með gögnum um færsluskráningu
...
## Staðfestu og virkjaðu heimildir til að gera HTTP beiðnir í umhverfi sem ekki er framleiðslu
...
### Villa: Söluhausinn er ekki til. Auðkennisreitir og gildi: Document Type='Quote',No.='YOUR SHOPIFY STORE'
...
### Villa: Gen. Strætó. Bókunarhópur verður að hafa gildi í Viðskiptavinur: 'YOUR SHOPIFY STORE'. Það getur ekki verið núll eða tómt
...
### Villa: Ekki er virkt að flytja inn gögn í Shopify verslunina þína. Opnaðu verslunarkortið til að virkja hann
...
### Villa: Innri villa. Það lítur út fyrir að eitthvað hafi farið úrskeiðis á endanum okkar. Auðkenni beiðni: XXXXXXX-XXXX-XXXX-XXXX-XXXX
...
### [{"message":"Aðgangi hafnað fyrir FIELD reit.","locations":[{"line":0,"column":0}],"path":["path"],"extensions":{"code":"ACCESS_DENIED","documentation":https://shopify.dev/api/usage/access-scopes}}]
