...
# <a name="synchronize-and-fulfill-sales-orders" />Samræma og uppfylla sölupantanir
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Setja innflutning pantana á Shopify Verslunarkortið
...
### <a name="shipment-method-mapping" />Vörpun afhendingarmáta
...
### <a name="location-mapping" />Vörpun staðsetningar
...
## <a name="run-the-order-synchronization" />Keyra samstillingu pöntunar
...
## <a name="review-imported-orders" />Yfirfara innfluttar pantanir
...
## <a name="create-sales-documents-in-business-central" />Stofna söluskjöl í Business Central
...
### <a name="to-create-sales-documents" />Til að búa til söluskjöl
...
### <a name="manage-missing-customers" />Vinna með viðskiptavini sem vantar
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Hvernig tengillinn velur hvaða viðskiptavin á að nota
...
### <a name="different-processing-rules-for-orders" />Mismunandi vinnslureglur fyrir pantanir
...
### <a name="impact-of-order-editing" />Áhrif pöntunarbreytinga
...
## <a name="synchronize-shipments-to-shopify" />Samstilla sendingar við Shopify
...
### <a name="shipping-agents-and-tracking-url" />Flutningsaðilar og rakningarvefslóð
...
## <a name="returns-and-refunds" />Skilagreinar og endurgreiðsla
