...
# <a name="synchronize-customers" />Samstilla viðskiptavini
...
## <a name="important-settings-when-importing-customers-from-shopify" />Mikilvægar stillingar við innflutning viðskiptamanna úr Shopify
...
### <a name="customer-template-per-country" />Sniðmát viðskiptamanns eftir landi
...
3. Í sumum tilfellum er Sniðmátskóti  **viðskiptamanns sem**  skilgreindur er fyrir land ekki nægur til að tryggja rétta skattaútreikninga (til dæmis fyrir lönd með VSK). Í þessu tilviki gæti þar með  **skattsvæði**  verið gagnleg viðbót.
...
## <a name="export-customers-to-shopify" />Flytja út viðskiptamenn í Shopify
...
### <a name="populate-customer-information-in-shopify" />Fylltu út upplýsingar um viðskiptamann í Shopify
...
## <a name="sync-customers" />Samstilla viðskiptamenn
