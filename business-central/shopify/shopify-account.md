...
# <a name="create-and-set-up-a-shopify-account" />Stofna og setja upp  Shopify  lykil
...
## <a name="trial-end-user" />Próftími (notandi á enda)
...
## <a name="development-store" />Þróunarsjóður
