...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Walkthrough: setja upp og nota  Shopify  tengibúnað
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Tengja Viðskiptamiðað  Shopify  við verkstæðið
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Walkthrough: Byrjaðu að selja vörur á netinu
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Walkthrough: Bjóddu viðskiptavinum þínum upp á nýja netverslun
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Walkfrom: Fine Tuning the Item Management

### <a name="scenario-2"></a><a name="scenario-2"></a>Aðstæður
...
### <a name="steps-2"></a><a name="steps-2"></a>Skref
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Walkthrough: flytja inn vörur úr Shopify

### <a name="scenario-3"></a><a name="scenario-3"></a>Aðstæður
...
### <a name="steps-3"></a><a name="steps-3"></a>Skref
...
#### <a name="prepare-data"></a><a name="prepare-data"></a>Undirbúa gögn
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Keyra samstillingu
