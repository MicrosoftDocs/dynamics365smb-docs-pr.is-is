...
# <a name="run-tasks-in-the-background" />Keyra verk í bakgrunni
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Keyra verk í bakgrunni fyrir tiltekna verslun
...
## <a name="to-schedule-recurring-tasks" />Að tímasetja endurtekin verk
