...
ms.author: edupont
---
# <a name="about-production-orders"></a><a name="about-production-orders"></a>Um framleiðslupantanir
...
## <a name="production-order-creation"></a><a name="production-order-creation"></a>Stofnun framleiðslupantana
...
## <a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a>Takmarkanir á stofnun Framleiðslupantana
...
## <a name="production-order-status"></a><a name="production-order-status"></a>Staða framleiðslupöntunar
...
### <a name="simulated-production-order"></a><a name="simulated-production-order"></a>Hermd framleiðslupöntun
...
### <a name="planned-production-order"></a><a name="planned-production-order"></a>Áætluð framleiðslupöntun
...
### <a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a>Fastáætluð framleiðslupöntun
...
### <a name="released-production-order"></a><a name="released-production-order"></a>Útgefin framleiðslupöntun
...
### <a name="finished-production-order"></a><a name="finished-production-order"></a>Fullunnin framleiðslupöntun
...
## <a name="production-order-execution"></a><a name="production-order-execution"></a>Framkvæmd framleiðslupantana
...
### <a name="material-consumption"></a><a name="material-consumption"></a>Efnisnotkun
...
### <a name="production-output"></a><a name="production-output"></a>Framleiðslufrálag
...
### <a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a>Notkun og Frálag bókuð
...
### <a name="production-journal"></a><a name="production-journal"></a>Framleiðslubók
