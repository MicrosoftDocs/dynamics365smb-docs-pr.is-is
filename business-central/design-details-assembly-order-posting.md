...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting" />Hönnunarupplýsingar: Bókun samsetningarpöntunar
...
## <a name="posting-sequence" />Bókunarröð
...
## <a name="cost-adjustment" />Leiðrétta kostnað
...
### <a name="performing-the-adjustment" />Leiðrétting
...
## <a name="assembly-costs-are-always-actual" />Samsetningarkostnaður er alltaf raunverulegur
...
## <a name="assemble-to-order" />Samsetning til pöntunar
...
### <a name="posting-dates" />Bókunardagsetningar
