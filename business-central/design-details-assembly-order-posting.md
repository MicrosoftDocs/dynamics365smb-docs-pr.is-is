...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Hönnunarupplýsingar: Bókun samsetningarpöntunar
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a><a name="posting-sequence"></a>Bókunarröð
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a><a name="cost-adjustment"></a>Leiðrétta kostnað
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Leiðrétting
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a><a name="assemble-to-order"></a>Samsetning til pöntunar
...
### <a name="posting-dates"></a><a name="posting-dates"></a><a name="posting-dates"></a>Bókunardagsetningar
