...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Skilgreina notandaverk
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Stjórnun notendaverkefna
...
>
> Hægt er að tengja við hvaða síðu sem er, en ekki er hægt að tengja við einstakar færslur, hafðu því lýsinguna eins skýra og hægt er, t.d. skrifa „Líttu á viðskiptamann nr. 10000 og gakktu úr skugga um að hann sé ekki með gjaldfallnar greiðslur.“.

### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Notandaverkefni sótt
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Eyða notendaverkefnum
