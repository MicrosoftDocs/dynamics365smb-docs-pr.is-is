...
ms.author: edupont
---
# <a name="define-user-tasks" />Skilgreina notandaverk
...
## <a name="managing-user-tasks" />Stjórnun notendaverkefna
...
### <a name="picking-up-user-tasks" />Notandaverkefni sótt
...
### <a name="deleting-user-tasks" />Eyða notendaverkefnum
