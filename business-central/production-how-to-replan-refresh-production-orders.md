...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Enduráætla eða uppfæra framleiðslupantanir beint
...
## <a name="to-replan-a-production-order" />Enduráætla Framleiðslupöntun
...
## <a name="to-refresh-a-production-order" />Framleiðslupöntun endurnýjuð
