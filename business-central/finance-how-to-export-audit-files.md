...
# <a name="audit-file-export" />Útflutningur endurskoðunarskráar
...
## <a name="set-up-audit-file-export" />Setja upp útflutning endurskoðunarskráa
...
## <a name="provide-the-gl-account-mapping-for-audit-file-export" />Kveða á um vörpun fjárhagsreikningsins fyrir útflutning endurskoðunarskráa
...
## <a name="export-the-audit-file" />Flytja út endurskoðunarskrána
