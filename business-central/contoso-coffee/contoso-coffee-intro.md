...
# <a name="introduction-to-contoso-coffee-demo-data" />Kynning á sýnigögnum Contoso Coffee
...
## <a name="set-up-contoso-coffee-data" />Setja upp Contoso Coffee gögn
...
## <a name="manufacturing-scenarios" />Framleiðsluaðstæður
...
## <a name="warehousing-scenarios" />Vöruhúsaaðstæður
