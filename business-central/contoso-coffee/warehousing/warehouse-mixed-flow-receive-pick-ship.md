...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations" />Vasaljós á inn-og útrennsli í Blönduðum Vöruhúsaleiðingum
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations" />Flæði á útleið: tiltekt og sendingu í ítarlegum Vöruhúsafbrigðum
