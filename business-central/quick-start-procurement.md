...
# <a name="procurement-quick-start"></a><a name="procurement-quick-start"></a><a name="procurement-quick-start"></a>Stuttur leiðarvísir um innkaup
...
## <a name="set-up-vendors"></a><a name="set-up-vendors"></a><a name="set-up-vendors"></a>Setja upp lánardrottna
...
### <a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a>Setja upp nýjan lánardrottin
...
## <a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a>Stofna nýjar innkaupapantanir
...
### <a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a>Til að búa til innkaupapöntun
...
## <a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a>Stofna innkaupareikning
...
### <a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a>Hvernig á að stofna og bóka innkaupareikning
