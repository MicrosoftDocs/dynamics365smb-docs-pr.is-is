...
# <a name="procurement-quick-start" />Stuttur leiðarvísir um innkaup
...
## <a name="set-up-vendors" />Setja upp lánardrottna
...
### <a name="set-up-a-new-vendor" />Setja upp nýjan lánardrottin
...
## <a name="create-new-purchase-orders" />Stofna nýjar innkaupapantanir
...
### <a name="to-create-a-purchase-order" />Til að búa til innkaupapöntun
...
## <a name="create-a-purchase-invoice" />Stofna innkaupareikning
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Hvernig á að stofna og bóka innkaupareikning
