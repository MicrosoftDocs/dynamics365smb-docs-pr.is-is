...
3. Veldu aðgerðina **Vörutilvísanir**.
     ...
     Ef aðgerðin **Vörutilvísanir** finnst ekki skal velja að skoða fleiri valkosti og finna hana síðan í **Tengd vara** > **·**.
...
4. Í vörutilvísunarnúmerinu er fært inn **númer vörunnar.** reitnum skal velja viðeigandi vörutilvísun og síðan velja hnappinn **Í lagi**.
