...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a>Úrræðaleita tengigetu fyrir Business Central
...
## <a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a>Hefja athugun á tengigetu
...
## <a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a>Grunntenging við internetið
...
## <a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a>Hleðsla á CDN-úrræðum
...
## <a name="user-authentication"></a><a name="user-authentication"></a>Sannvottun notanda
...
## <a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a>Uppgötvun um umhverfi Business Central
...
## <a name="application-service-connectivity"></a><a name="application-service-connectivity"></a>Tengigeta hugbúnaðarþjónustu
...
## <a name="web-server-connectivity"></a><a name="web-server-connectivity"></a>Tengigeta vefþjóns
...
## <a name="service-health-status"></a><a name="service-health-status"></a>Ástand þjónustu
