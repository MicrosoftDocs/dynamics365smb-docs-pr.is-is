...
---
# <a name="monitor-project-progress-and-performance"></a>Fylgst með framvindu og afköstum
...
## <a name="create-a-project-wip-method"></a>Búa til VÍV-aðferð fyrir verk
...
### <a name="define-a-wip-method-for-a-project-task"></a>Skilgreina VÍV aðferð fyrir verk
...
## <a name="calculate-and-post-project-completion-entries"></a>Reikna út og bóka verklokafærslur
...
## <a name="view-project-ledger-entries"></a>Verkfærslur skoðaðar
