...
---
# <a name="monitor-job-progress-and-performance" />Fylgst með framvindu og afköstum
...
## <a name="create-a-job-wip-method" />Búa til VÍV-aðferð fyrir verk
...
## <a name="define-a-wip-method-for-a-job" />Skilgreina VÍV aðferð fyrir verk
...
### <a name="define-a-wip-method-for-a-job-task" />Skilgreina VÍV aðferð fyrir verk
...
## <a name="calculate-wip" />Reikna VÍV
...
## <a name="calculate-and-post-job-completion-entries" />Reikna út og bóka verklokafærslur
...
## <a name="view-job-ledger-entries" />Verkfærslur skoðaðar
