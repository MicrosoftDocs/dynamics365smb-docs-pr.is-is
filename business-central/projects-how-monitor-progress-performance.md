...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Fylgst með framvindu og afköstum
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Búa til VÍV-aðferð fyrir verk
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Skilgreina VÍV aðferð fyrir verk
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Skilgreina VÍV aðferð fyrir verk
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a><a name="calculate-wip"></a>Reikna VÍV
...
## <a name="post-wip"></a><a name="post-wip"></a><a name="post-wip"></a>Bóka VÍV
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Reikna út og bóka verklokafærslur
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Verkfærslur skoðaðar
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Finna tengda [Microsoft-þjálfun](/training/paths/calculate-post-job-wip/)
