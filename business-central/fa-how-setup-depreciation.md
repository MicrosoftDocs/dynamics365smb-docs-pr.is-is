...
# <a name="set-up-fixed-asset-depreciation" />Setja upp eignaafskriftir
...
## <a name="to-create-a-depreciation-book" />Stofna afskriftabók
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />Úthluta afskriftabók á eign.
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />Til að tengja afskriftabók við margar eignir með keyrslu
...
## <a name="to-set-up-depreciation-posting-types" />Uppsetning bókunartegundir afskrifta:
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />Uppsetning Sjálfgefinna sniðmáta og -keyrslna fyrir afskriftir eigna.
