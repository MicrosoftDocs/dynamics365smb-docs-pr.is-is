...
ms.author: bholtorf
---
# <a name="finding-pages-and-information-with-tell-me" />Finndu síður og upplýsingar með Viðmótsleit
...
## <a name="find-an-action-on-the-current-page" />Finna aðgerð á núverandi síðu
...
## <a name="find-a-page-or-a-task" />Finna síðu eða verkefni
...
## <a name="find-a-report-or-archived-information" />Finna skýrslu eða safnvistaðar upplýsingar
...
## <a name="find-information-in-the-help" />Finna upplýsingar í hjálpinni
...
## <a name="get-more-functionality-from-apps" />Fáðu meiri virkni úr forritum
...
## <a name="search-for-data" />Leita að gögnum
...
## <a name="questions" />Einhverjar spurningar?
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/user-interface-dynamics-365-business-central/index)
