...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a>Sækja innbót Business Central fyrir Excel
...
### <a name="about-the-add-in"></a><a name="about-the-add-in"></a>Um innbótina
...
### <a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a>Um uppsetningu sem stjórnandi
...
### <a name="switching-from-individual-acquisition-to-centralized-deployment-or-the-other-way-around"></a><a name="switching-from-individual-acquisition-to-centralized-deployment-or-the-other-way-around"></a><a name="switch"></a>Skipt úr einstaklingsbundinni uppsetningu í miðlæga innleiðingu eða öfugt
...
## <a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a>Undirbúningur (aðeins á staðnum)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a>Setja upp innbótina með miðlægri innleiðingu
...
### <a name="before-you-begin"></a><a name="before-you-begin"></a>Áður en hafist er handa
...
### <a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a>Setja upp miðlæga innleiðingu innbótarinnar
...
## <a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="install"></a>Einstaklingsbundin uppsetning: Setja upp innbótina handvirkt til eigin nota
...
### <a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a>Skilgreina tengingu Business Central
...
## <a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a>Undirbúa tæki og netkerfi fyrir Excel-innbótina
