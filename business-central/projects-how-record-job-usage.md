...
---
# <a name="record-consumption-or-usage-for-jobs" />Skrá neyslu eða notkun fyrir verk
...
## <a name="to-record-usage-for-a-job-planning-line-of-type-budget" />Til að skrá notkun fyrir verkáætlunarlínu af gerðinni Áætlun
...
## <a name="to-create-job-journal-lines-manually" />Til að búa til verkbókarlínur handvirkt
...
## <a name="to-view-job-usage-estimates-and-post-updates" />Til að skoða áætlanir um verknotkun og bóka uppfærslur
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-job" />Stofna tínsluskjöl birgða og vöruhúss fyrir verk
...
## <a name="to-review-planning-lines-for-a-job-ledger-entry" />Til að fara yfir áætlunarlínur verkfærslu
