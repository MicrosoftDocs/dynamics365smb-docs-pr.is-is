...
---
# <a name="record-consumption-or-usage-for-projects"></a>Skrá neyslu eða notkun fyrir verk
...
## <a name="to-create-project-journal-lines-manually"></a>Til að búa til verkbókarlínur handvirkt
...
## <a name="to-view-project-usage-estimates-and-post-updates"></a>Til að skoða áætlanir um verknotkun og bóka uppfærslur
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-project"></a>Stofna tínsluskjöl birgða og vöruhúss fyrir verk
...
## <a name="to-review-planning-lines-for-a-project-ledger-entry"></a>Til að fara yfir áætlunarlínur verkfærslu
