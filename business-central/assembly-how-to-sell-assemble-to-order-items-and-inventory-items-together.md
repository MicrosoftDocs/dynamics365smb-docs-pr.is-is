...
---
# <a name="sell-assemble-to-order-items-and-inventory-items-together" />Selja vörur sem eru settar saman í pöntun og birgðavörur saman
...
## <a name="to-sell-assemble-to-order-items-and-inventory-items-together" />Til að selja vörur sem eru settar saman í pöntun og birgðavörur saman
