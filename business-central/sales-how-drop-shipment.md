...
ms.author: edupont
---
# <a name="make-drop-shipments" />Beinar sendingar
...
## <a name="to-create-a-sales-order-for-drop-shipment" />Sölupöntun fyrir beina afhendingu búin til
...
## <a name="to-create-the-purchase-order-for-drop-shipment" />Innkaupapöntunin stofnuð fyrir beina sendingu
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments" />Að stofna margar innkaupapantanir fyrir beinar sendingar
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order" />Til að skoða tengda innkaupapöntunina úr sölupöntuninni
...
## <a name="to-post-a-drop-shipment" />Til að bóka beina afhendingu
