...
---
# <a name="archive-documents" />Safnvista skjöl
...
## <a name="to-set-up-automatic-document-archiving" />Setja upp sjálfvirka safnvistun
...
## <a name="to-manually-archive-a-sales-order" />Til að Skjalfæra sölupöntun handvirkt
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Að endurheimta óbókaða sölupöntun úr skjalasafninu
...
## <a name="to-delete-archived-sales-orders" />Eyða safnvistuðum sölupöntunum
