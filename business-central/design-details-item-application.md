...
ms.author: edupont
---
# <a name="design-details-item-application" />Hönnunarupplýsingar: umsókn vöru
...
## <a name="inventory-increase" />Birgðaaukning
...
## <a name="inventory-decrease" />Birgðaminnkun
...
## <a name="fixed-application" />Fastar jafnanir
...
### <a name="example--fixed-application-in-purchase-return" />Dæmi – Föst Jöfnun við innkaupaskil
...
### <a name="example--fixed-application-with-average-cost" />Dæmi – Föst jöfnun með meðalkostnaði
...
### <a name="example--fixed-application-in-sales-return" />Dæmi – Föst Jöfnun við söluskil
...
## <a name="transfer-application" />Jöfnun millifærslu
...
### <a name="example--average-costing-method" />Dæmi – Aðferð meðalkostn.útreiknings
...
### <a name="example--standard-costing-method" />Dæmi staðalaðferð kostnaðarútreiknings
...
## <a name="reapplication" />Endurjöfnun
