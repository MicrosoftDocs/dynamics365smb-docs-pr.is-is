...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a><a name="design-details-item-application"></a>Hönnunarupplýsingar: umsókn vöru
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Birgðaaukning
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Birgðaminnkun
...
## <a name="fixed-application"></a><a name="fixed-application"></a><a name="fixed-application"></a>Fastar jafnanir
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Dæmi – Föst Jöfnun við innkaupaskil
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Dæmi – Föst jöfnun með meðalkostnaði
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Dæmi – Föst Jöfnun við söluskil
...
## <a name="transfer-application"></a><a name="transfer-application"></a><a name="transfer-application"></a>Jöfnun millifærslu
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Dæmi – Aðferð meðalkostn.útreiknings
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Dæmi staðalaðferð kostnaðarútreiknings
...
## <a name="reapplication"></a><a name="reapplication"></a><a name="reapplication"></a>Endurjöfnun
