...
---
# <a name="understanding-assemble-to-order-and-assemble-to-stock"></a><a name="understanding-assemble-to-order-and-assemble-to-stock"></a>Skilja hvernig skal setja saman í pöntun eða setja saman í birgðir
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a>Setja saman til að panta
...
## <a name="assemble-to-stock"></a><a name="assemble-to-stock"></a>Setja saman á lager
...
## <a name="combination-scenarios"></a><a name="combination-scenarios"></a>Samsetning atburðarásar
