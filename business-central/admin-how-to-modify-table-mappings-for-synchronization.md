...
## <a name="mapping-integration-tables"></a>Sameining taflna vörpun
...
### <a name="strategies-for-auto-resolving-conflicts"></a>Aðferðir við sjálfvirka úrlausn árekstra
...
### <a name="handle-differences-in-field-values"></a>Meðhöndla mismun á svæðisgildum
...
### <a name="handle-missing-option-values"></a>Afgreiðsla á valgildum sem vantar
...
## <a name="couple-records"></a>Par færslur
...
## <a name="filter-records-and-rows"></a>Sía færslur og línur
