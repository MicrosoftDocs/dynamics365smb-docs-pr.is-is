...
> [!TIP]
> Það getur reynst gagnlegt að sérsníða síðuna **Sniðmát starfsmanns** þegar þú stofnar sniðmát. Þú gætir til dæmis viljað bæta reit sem er ekki sýndur við síðuna. Nánari upplýsingar eru í [Sérstilla vinnusvæðið](ui-personalization-user.md#start-personalizing-by-using-the-personalization-mode).
...
4. Á síðunni **Velja mynd til að hlaða** upp skal gera eitt af eftirfarandi skrefum til að hlaða upp myndaskránni:
