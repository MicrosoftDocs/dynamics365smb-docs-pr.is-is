...
ms.author: edupont
---
# <a name="register-employees" />Skrá starfsmenn
...
## <a name="adding-new-employees" />Nýjum starfsmönnum bætt við
...
## <a name="to-set-up-an-employee" />Uppsetning starfsmanns
...
## <a name="to-insert-a-picture-of-an-employee" />Setja inn mynd af starfsmanni.
...
## <a name="to-register-various-information-about-an-employee" />Skrá ýmsar upplýsingar um starfsmann
