...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a>Flokka vörur
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Að búa til vöruflokka
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Að úthluta vöruflokki á vöru.
