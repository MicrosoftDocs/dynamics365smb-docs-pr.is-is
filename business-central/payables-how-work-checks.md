...
ms.author: edupont
---
# <a name="make-check-payments" />Framkvæma ávísanagreiðslur
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check" />Til að greiða reikning lánardrottins með vélfærðum tékka
...
## <a name="to-cancel-printed-checks-that-are-not-posted" />Til að ógilda prentaðan tékka sem ekki eru bókaðar
...
## <a name="to-void-checks" />Tékkar ógiltir:
...
## <a name="to-view-a-summary-of-posted-checks" />Til að skoða samantekt bókaðra tékka
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-checks-dynamics-365-business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/use-checks-dynamics-365-business-central/)
