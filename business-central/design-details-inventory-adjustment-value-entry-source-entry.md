...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Bókunardagsetning fyrir virðisfærslu leiðréttingar í samanburði við upprunafærsluna
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Aðstæður endurmats
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>Að prófa aðstæðurnar
...
### <a name="conclusion"></a><a name="conclusion"></a><a name="conclusion"></a>Niðurstaða
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Aðstæður kostnaðarauka
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>Að prófa aðstæðurnar
