...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Bókunardagsetning fyrir virðisfærslu leiðréttingar í samanburði við upprunafærsluna
...
## <a name="revaluation-scenario" />Aðstæður endurmats
