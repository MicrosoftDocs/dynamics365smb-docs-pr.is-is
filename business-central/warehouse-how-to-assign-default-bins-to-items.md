...
ms.author: edupont
---
# <a name="assign-default-bins-to-items"></a><a name="assign-default-bins-to-items"></a>Sjálfgefin hólf tengd vörum
...
## <a name="to-assign-a-default-bin-to-an-item"></a><a name="to-assign-a-default-bin-to-an-item"></a>Að úthluta vöru sjálfgefnu hólfi
...
## <a name="to-change-the-default-bin-for-an-item"></a><a name="to-change-the-default-bin-for-an-item"></a>Skipt um sjálfgefið hólf vöru
