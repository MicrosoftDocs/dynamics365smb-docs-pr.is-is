...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Gera áætlanir um nýja eftirspurn pöntun fyrir pöntun
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>Til að gera áætlun fyrir nýja framleiðslupöntunareftirspurn
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>Áætlað fyrir alla nýja eftirspurn
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>Framboðspantanir gerðar
