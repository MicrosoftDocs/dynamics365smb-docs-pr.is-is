...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order" />Gera áætlanir um nýja eftirspurn pöntun fyrir pöntun
...
## <a name="to-plan-for-new-production-order-demand" />Til að gera áætlun fyrir nýja framleiðslupöntunareftirspurn
...
## <a name="to-plan-for-any-new-demand" />Áætlað fyrir alla nýja eftirspurn
...
## <a name="to-make-supply-orders" />Framboðspantanir gerðar
