...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory"></a><a name="design-details-integration-with-inventory"></a>Hönnunarupplýsingar: Sameining með birgðum
...
## <a name="physical-inventory"></a><a name="physical-inventory"></a>Efnislegar birgðir
...
## <a name="warehouse-adjustments-to-the-item-ledger"></a><a name="warehouse-adjustments-to-the-item-ledger"></a>Vöruhúsaleiðréttingar í birgðahöfuðbók
