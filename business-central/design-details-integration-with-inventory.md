...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Hönnunarupplýsingar: Sameining með birgðum
...
## <a name="physical-inventory" />Efnislegar birgðir
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Vöruhúsaleiðréttingar í birgðahöfuðbók
