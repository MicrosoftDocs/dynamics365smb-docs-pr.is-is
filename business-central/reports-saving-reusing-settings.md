...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Stjórna vistuðum stillingum fyrir skýrslur og runuvinnslur
...
## <a name="manage-saved-settings" />Stjórna vistuðum stillingum
...
## <a name="create-or-modify-saved-settings-for-all-users" />Stofna eða breyta vistuðum stillingum fyrir alla notendur
