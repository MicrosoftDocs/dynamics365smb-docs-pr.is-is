...
Fyrirtæki sem nota [!INCLUDE[prod_long](includes/prod_long.md)] geta fengið tæknilega aðstoð við öll atriði sem þau geta upplifað. Í þessari grein sýnum við þér eftirfarandi upplýsingar og margar aðrar [!INCLUDE[prod_short](includes/prod_short.md)] ábendingar um notkun:
...
- Notaðu <kbd>Ctrl</kbd>+<kbd>F1</kbd> flýtivísunina hvaðan sem er
...
Söluaðilinn [!INCLUDE[prod_short](includes/prod_short.md)] aðstoðar þig við tæknilega aðstoð. Þessi hluti auðveldar þér að hafa samband endursöluaðilann þinn ef hann hefur sent inn samskiptaupplýsingar fyrir notendaþjónustu. Ef félaginn [!INCLUDE[prod_short](includes/prod_short.md)] leysir þá ekki vandamálið hækkar hann stuðningsmiða með Microsoft.  
...
Efnisyfirlitið inniheldur hóp efnis sem lýsir staðbundnum aðgerðum [fyrir](about-localization.md) löndin/svæðin sem Microsoft styður. Ef þú sérð landið eða svæðið ekki skráð þar er það líklega vegna þess að landið eða svæðið er staðfært af samstarfsaðila. Nánari upplýsingar um [lands-/svæðisbundið til ráðstöfunar og studd tungumál](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations).  
