...
Stofnanir sem nota [!INCLUDE[prod_long](includes/prod_long.md)] geta fengið tæknilega aðstoð við öll vandamál sem þau kunna að upplifa. Í þessari grein sýnum við þér eftirfarandi upplýsingar og margar aðrar ráðleggingar um hvernig á að nota [!INCLUDE[prod_short](includes/prod_short.md)]:

- Lærðu hvernig á að [taka af bannlista](#in-product-tips)  
- Lærðu hvar á að [fræðast meira](#help-pane)    
- Lærðu hvernig þú finnur [tækniupplýsingarnar](#help--support-page) þú þarft til að senda inn stuðningsbeiðni    

## <a name="in-product-tips"></a>Ábendingar í vörunni

[!INCLUDE [ua-get-help](includes/ua-get-help.md)] Þessir tenglar geta einnig nálgast efni frá öðrum vefsíðum, svo sem vefsíðum veitenda hvaða forrita sem er hluti af [!INCLUDE [prod_short](includes/prod_short.md)] þínum.  

## <a name="help-pane"></a>Hjálparsvæði

[!INCLUDE [2022_releasewave1](includes/2022_releasewave1.md)]

Í [!INCLUDE [prod_short](includes/prod_short.md)], veitir valmyndaratriði hjálpar (spurningamerkið efst í hægra horninu) þér aðgang að hjálparsvæðinu þar sem er auðveldara að finna svör við spurningum þínum. Hjálparsvæðið er með mismunandi efni, eftir því hvernig þú opnar það. Eftirfarandi listi lýsir spjöldunum sem eru alltaf eða næstum alltaf til staðar:  
...
- Veldu tengilinn *Frekari upplýsingar* í ábendingu fyrir reit

  Eftirfarandi spjaldi er bætt við hjálparsvæðið:

  - Ábending reitsins
- Veldu tengilinn *Frekari upplýsingar* vegna ábendingar fyrir aðgerð
- Veldu hjálparvalmyndina (spurningamerkið efst í hægra horninu)
- Notaðu <kbd>Ctrl</kbd>+<kbd>F1</kbd> flýtilykla hvar sem er
...
Notið leitarreitinn efst í hjálparsvæðinu til að leita að leiðsögn um hvernig á að nota vöruna, innbyggða möguleika og tiltækar þjálfunareiningar. Glugginn sýnir fimm eða fleiri tengla með stuttri lýsingu eftir því hvert leitarskilyrðið er. Veldu tengil eða fínstilltu leitarskilyrðið. Þegar þú velur tengil opnast markgreinin í nýjum vafraflipa. Þú getur valið að taka vafraflipann úr tengingu svo þú getir skoðað viðeigandi upplýsingar hlið við hlið með [!INCLUDE [prod_short](includes/prod_short.md)]. Glugginn helst opinn á meðan þú flettir í gegnum [!INCLUDE [prod_short](includes/prod_short.md)] þannig að efnið sem þú leitaðir að helst sýnilegt.  
...
- [Finna svör](#find-answers)  
- [Hjálp](#product-help)  
- [Samfélag](#community)  
- [Blogg](#blog)  
- [Væntanlegir eiginleikar](#capabilities-coming-soon)  
- [Gera meira með prufuútgáfunni](#do-more-with-your-trial)  
- [Senda ábendingu](#give-feedback)  
- [Úrræðaleit](#troubleshooting)  
- [Tilkynna vandamál](#report-a-problem)  
- [Stuðningstengiliðir](#support-contacts)  
...
Kaflinn **Finna það** veitir tengla á algengustu staðina til að finna svör við spurningum þínum. Tenglarnir flokkast niður í fjóra flokka og eru útskýrðir í eftirfarandi undirköflum.  [!INCLUDE[prod_short](includes/prod_short.md)] félagi þinn getur stillt suma tenglana og þar af leiðandi getur hegðunin verið aðeins öðruvísi.  
...
- Hjálp um síðuna sem þú varst að skoða í [!INCLUDE[prod_short](includes/prod_short.md)]  
  ...
  Þessi tengill er myndaður sjálfkrafa. Ef [!INCLUDE[prod_short](includes/prod_short.md)] finnur ekki viðeigandi tengil birtist [lendingarsíðan á Microsoft Learn](index.yml) fyrir sjálfgefna útgáfu af [!INCLUDE[prod_short](includes/prod_short.md)] . Ef til dæmis síðan var hluti af forriti sem bætti ekki vörpun samhengishjálpar við [!INCLUDE[prod_short](includes/prod_short.md)], fer *Fræðslutengillinn* sjálfgefið inn á lendingarsíðuna.  
...
Á [Business Central samfélagsspjallinu](https://community.dynamics.com/forums/thread/?groupid=e78817ab-a926-4d31-96cc-aef040a4eb04) geturðu sent inn spurningu og lært af öðrum [!INCLUDE[prod_short](includes/prod_short.md)] samfélagsmeðlimum. Samstarfsaðilar og starfsfólk Microsoft taka þátt í umræðunni.  
...
Til að aðstoða þig eða samstarfsaðila þinn við úrræðaleit getur þú kveikt á viðbótarskráningu í hlutanum **Tilkynna vandamál**. Þú getur síðan greint auka fjarmælinguna í stjórnunarmiðstöðinni eða Application Insights, til dæmis.  
...
### <a name="report-a-problem"></a>Tilkynna vandamál
 ...
 [!INCLUDE[prod_short](includes/prod_short.md)] endursöluaðili þinn hjálpar þér með tæknilega aðstoð. Þessi hluti auðveldar þér að hafa samband endursöluaðilann þinn ef hann hefur sent inn samskiptaupplýsingar fyrir notendaþjónustu. Ef [!INCLUDE[prod_short](includes/prod_short.md)] félagi þinn getur ekki leyst vandamálið, þá útvegar hann stuðningsmiða hjá Microsoft.  
...
> [!NOTE]
> Með [!INCLUDE[prod_short](includes/prod_short.md)] á netinu er hlutinn **Tilkynna um vandamál** aðeins í boði ef þú hefur greitt fyrir [!INCLUDE[prod_short](includes/prod_short.md)] áskrift. Ef þú hefur skráð þig fyrir prufuáskrift og hefur ekki enn keypt [!INCLUDE[prod_short](includes/prod_short.md)] þá hefur þú ekki endursöluaðila og getur ekki haft samband við þjónustudeild Microsoft. Hægt er að finna [!INCLUDE[prod_short](includes/prod_short.md)]-samstarfsaðila á síðunni [Ég er að leit að úrlausnaraðila](https://go.microsoft.com/fwlink/?linkid=2038145). Nánari upplýsingar er að finna í [Hvernig finn ég endursöluaðila?](/dynamics365/business-central/across-faq#how-do-i-find-a-reselling-partner).  
>
...
Hlutinn **Tilkynna um vandamál** birtir netfang eða tengil til að þú getir haft samband við einstakling eða hóp þjónustuvers. Ef þú ert [!INCLUDE[prod_short](includes/prod_short.md)] endursöluaðili fyrir leigjanda, geturðu sett upp viðeigandi tengiliðaupplýsingar fyrir þjónustu í stjórnunarmiðstöðinni. Frekari upplýsingar er að finna í [Skilgreining á þjónustuupplifun](/dynamics365/business-central/dev-itpro/technical-support#configuring-the-support-experience) í stjórnunarefni.  

Til að gera maka þínum viðvart um vandamál skaltu velja hlekkinn til að annað hvort senda tölvupóst eða opna stuðningssíðu þeirra í nýjum vafraflipa. Þú getur síðan bætt við tækniupplýsingunum um Microsoft Entra leigandann þinn í kaflanum **Úrræðaleit**  og öllum öðrum upplýsingum sem þér finnst viðeigandi.  
...
Stórt samfélag samstarfsaðila framlengir og sérsníður grunnútgáfuna af [!INCLUDE [prod_short](includes/prod_short.md)]. Hver samstarfsaðili og margir viðskiptavinir setja upp sína eigin hjálp á eigin vefsvæðum. En þú getur alltaf farið á [Dynamics 365 Business Central skjölin](index.yml) síðuna til að læra meira. Þessi síða hýsir mismunandi gerðir af efni, svo sem eftirfarandi efni:

- [Hugmyndalegt efni um virkni fyrirtækja](welcome.md)  
...
[Þessi hluti](welcome.md) af Microsoft Learn hýsir efni frá Microsoft sem táknar *Frekari upplýsingar* stoð í notendaaðstoðarlíkaninu. Að hluta til ætlar efnið *Frekari upplýsingar*  að svara þeim spurningum sem notendaviðmótið getur ekki svarað, eins og eftirfarandi lista:

- Hvar passar þessi síða inn í stærra verkflæðið?  
- Hvað gerist svo?  
- Hvaða annar valkostur er í boði?  

Innan úr vörunni geturðu nálgast þetta efni annað hvort í gegnum *Frekari upplýsingar* tengilinn í verkfæraráðleggingum og kennsluráðum, eða með því að nota <kbd>Ctrl</kbd>+<kbd>F1</kbd> flýtilykla.  

Leiðsöguborðið sýnir efnisyfirlitið sem flokkar greinar eftir viðskiptasvæði. Til dæmis, ef þú lest greinina [Kaupa vörur fyrir sölu](purchasing-how-purchase-products-sale.md) og síðan sýnir efnisyfirlitið þér að einnig sé til grein sem heitir [Leiðrétta eða afturkalla ógreidda innkaupareikninga](purchasing-how-correct-cancel-unpaid-purchase-invoices.md). Báðar greinarnar eru í flokknum sem kallast *Innkaup*, sem fléttar saman greinar sem tengjast innkaupaeiningunni í [!INCLUDE [prod_short](includes/prod_short.md)].  

Efnisyfirlitið inniheldur hóp af efni sem lýsir [staðbundinni virkni](about-localization.md) fyrir löndin/svæðin sem Microsoft styður. Ef þú sérð ekki landið þitt eða svæði skráð þar er það líklega vegna þess að landið þitt eða svæði er staðbundið af maka. Frekari upplýsingar eru á [Aðgengi á landi/svæði og studd tungumál](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations).  

Efni staðbundinna aðgerða lýsir möguleikunum í [!INCLUDE [prod_short](includes/prod_short.md)] sem geta hjálpað þér að fylgja studdum markaði, t.d. skattaskýrslum og öðrum skýrslum. Í sumum tilfellum er munurinn á sjálfgefna útgáfunni og tilteknu lands-/svæðisútgáfu ósýnilegur notendum. Í öðrum tilvikum verða notendur að setja upp skýrslugerð eða rafræna reikningsfærslu á sérstakan hátt. Ef ekki er hægt að finna lýsingu á tilteknum hnappi eða aðgerð í almenna hlutanum er vonandi hægt að finna hana í hlutanum *Staðbundin virkni*.  
...
- Nota reitinn **Afmarka eftir titli** í efnisyfirlitinu vinstra megin á vefsvæðinu
  ...
  Með þessum hætti er hægt að afmarka eftir orðum sem notuð eru í titlum hinna ýmsu greina. Til dæmis geturðu skrifað *reikningur* og síðan valið einn af tenglunum sem boðið er upp á, t.d. [Setja upp sléttun reiknings](finance-set-up-invoice-rounding.md) eða [Stofna fyrirframgreiðslureikninga](finance-how-to-create-prepayment-invoices.md).  

  Fyrir neðan hvern tengil er hægt að sjá hvar þessi grein er í efnisyfirlitinu. Þannig getur þú auðveldlega séð hvort greinin er í innkaupahlutanum eða hlutanum fyrir staðbundna virkni Ástralíu sem dæmi.  
...
Efnið er heimilað á ensku og birt á vefslóðum með *en-us* sem tungumálakóðann. Þegar nýjar upplýsingar eru birtar á ensku eru þær sendar til þýðinga á studd tungumál. Í sumum tilfellum geturðu ekki lesið þetta nýja efni á þínu eigin tungumáli í allt að fjórar vikur, en í flestum tilfellum tekur það ekki nema viku eða tvær. Þú getur alltaf skoðað nýjustu upplýsingarnar með því að skipta yfir í tungumálið *en-us*.  

Fyrir hvert tungumál er efnisyfirlitið þýtt, en efnið í *Staðbundin virkni* hlutanum er á ensku nema fyrir landið eða svæðið sem samsvarar núverandi tungumáli. Til dæmis í dönsku útgáfunni af Microsoft Learn (`https://learn.microsoft.com/da-dk/dynamics365/business-central/`) er hægt að sjá færslur fyrir ástralska staðbundna virkni á dönsku í efnisyfirlitinu, en greinarnar eru á ensku. Aðeins greinarnar fyrir danska staðbundna virkni eru þýddar á dönsku.  

### <a name="recommended-content"></a>Ráðlagt efni

Á Microsoft Learn sýnir hver grein glugga með tenglum á aðrar greinar. Hlutinn **Ráðlagt efni** er sjálfkrafa búinn til samkvæmt því hvernig hver grein er notuð með hinum hluta svæðisins. Tenglarnir eru ekki fastir og breytast með tímanum.
...
Ef [!INCLUDE [prod_short](includes/prod_short.md)] inniheldur virkni sem Microsoft býður ekki upp á, þá býður þjónustuaðili þessarar virkni einnig upp á efnið *Frekari upplýsingar* á eigin vefsvæði. Þú getur nálgast þetta efni á sama hátt og í sjálfgefna útgáfu af [!INCLUDE [prod_short](includes/prod_short.md)], svo sem með því að nota <kbd>Ctrl</kbd>+<kbd>F1</kbd>  flýtilykla.  
...
[Skildu eftir okkur álit](/dynamics365/get-started/feedback)  
[Bloggfærsla: Finndu réttu úrræðin og gefðu endurgjöf](https://community.dynamics.com/blogs/post/?postid=22e164ac-b804-4ac9-9e57-3e8c4fd24cbd)  
...
[Microsoft Learn svæði](/training/dynamics365/business-central?WT.mc_id=dyn365bc_landingpage-docs)  
