...
---
# <a name="use-item-charges-to-account-for-additional-trade-costs"></a>Notaðu vörugjöld til að gera grein fyrir auka viðskiptakostnaði
...
## <a name="handle-item-charges-for-partial-receipts"></a>Meðhöndla vörugjöld fyrir hlutakvittanir
