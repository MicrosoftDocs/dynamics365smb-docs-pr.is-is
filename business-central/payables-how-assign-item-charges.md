...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs" />Nota kostnaðarauka til að gera grein fyrir viðbótar viðskiptakostnaði
...
## <a name="to-set-up-item-charge-numbers" />Uppsetning kostnaðaraukanúmera
...
## <a name="to-assign-an-item-charge-directly-to-the-purchase-invoice-for-the-item" />Að úthluta kostnaðarauka beint til innkaupareiknings fyrir vöruna
...
## <a name="to-assign-an-item-charge-from-a-separate-invoice-to-the-purchase-invoice-for-the-item" />Að úthluta kostnaðarauka frá öðrum reikningi til innkaupareiknings fyrir vöruna
...
## <a name="handle-item-charges-for-partial-receipts" />Annast kostnaðarauka fyrir innhreyfingar að hluta
...
## <a name="see-related-microsoft-trainingtrainingmodulespost-purchase-item-charges-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
