...
# <a name="work-with-catalog-items" />Vinna með vörulistaatriði
...
## <a name="create-a-catalog-item" />Búa til vörulistaatriði
...
## <a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering" />Tilgreindu hvernig númerum vörulistaatriða er breytt í eigin númer
...
## <a name="convert-a-catalog-item-to-a-normal-item" />Breyta vörulistaatriði í venjulegt atriði
...
## <a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item" />Að selja vörulistavöru og umbreyta henni í venjuleg atriði
