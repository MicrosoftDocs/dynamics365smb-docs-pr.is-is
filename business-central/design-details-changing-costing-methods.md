...
# <a name="design-details-change-the-costing-method-for-items" />Hönnunarupplýsingar: Breyta kostnaðarútreikningi fyrir vörur
...
## <a name="about-costing-methods" />Um aðferðir kostnaðarútreikninga
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Nota samsetningarpantanir til að breyta úthlutunum á aðferðum kostnaðarútreikninga
...
### <a name="define-a-default-costing-method" />Skilgreina sjálfgefna aðferð kostnaðarútreiknings
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />Gera grein fyrir vörunum sem breyta á aðferð kostnaðarútreiknings fyrir og númera þær aftur
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Búa til nýjar vörur með gömlu talnaröðinni og afrita aðalgögnin í runu
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Afrita handvirkt tengd aðalgögn úr upprunalegri vöru í nýju vöruna
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />Ákvarða birgðamagnið sem á að færa frá upprunalegu vörunni og yfir á nýju vöruna
...
### <a name="transfer-the-inventory-to-the-new-item" />Flytja birgðir yfir í nýju vöruna
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Meðhöndla birgðamagnið sem er úthlutað samkvæmt eftirspurn
...
### <a name="block-the-original-item-from-further-use" />Útiloka upprunalega vöru frá frekari notkun
