...
## Um aðferðir kostnaðarútreikninga
...
## Nota samsetningarpantanir til að breyta úthlutunum á aðferðum kostnaðarútreikninga
...
### Skilgreina sjálfgefna aðferð kostnaðarútreiknings
...
### Gera grein fyrir vörunum sem breyta á aðferð kostnaðarútreiknings fyrir og númera þær aftur
...
### Búa til nýjar vörur með gömlu talnaröðinni og afrita aðalgögnin í runu
...
### Afrita handvirkt tengd aðalgögn úr upprunalegri vöru í nýju vöruna
...
|Verk |Verð verks |Athuga hvort verkverð eru skilgreind fyrir upphaflegu vöruna og flytja þessi gögn yfir á nýju vöruna. Þessar upplýsingar eru tiltækar á síðunni **Verkspjald** í **verkupplýsingar – Fjöldi verðhluta** á **upplýsingakassasvæðinu**. |
...
### Ákvarða birgðamagnið sem á að færa frá upprunalegu vörunni og yfir á nýju vöruna
...
### Flytja birgðir yfir í nýju vöruna
...
### Meðhöndla birgðamagnið sem er úthlutað samkvæmt eftirspurn
...
### Útiloka upprunalega vöru frá frekari notkun
