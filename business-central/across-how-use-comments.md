...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Bæta við athugasemdum við kort og skjöl
...
## <a name="to-add-a-comments-to-an-item-card" />Til að bæta athugasemdum við birgðaspjald
