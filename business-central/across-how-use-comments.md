...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents"></a><a name="add-comments-to-cards-and-documents"></a>Bæta við athugasemdum við kort og skjöl
...
## <a name="to-add-a-comments-to-an-item-card"></a><a name="to-add-a-comments-to-an-item-card"></a>Til að bæta athugasemdum við birgðaspjald
