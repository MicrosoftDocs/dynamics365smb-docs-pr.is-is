...
## <a name="to-sign-up-for-the-trial" />Að skrá sig fyrir prufuútgáfu

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try" />Hvað á að prófa
...
## <a name="get-started-with-a-subscription" />Hafist handa með áskrift
