...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Yfirlit yfir vöruhúsastjórnun
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Líkan að efnislegu vöruhúsi
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a>Staðsetningar og hólfa
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Hillur og hólf
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Dæmigert verkflæði vöruhúss
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Hugtök sem tengjast vöruhúsastjórnun

### <a name="complexity-levels"></a><a name="complexity-levels"></a>Flækjustig
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a>Vöruhús flæðir
...
### <a name="basic-documents"></a><a name="basic-documents"></a>Grunnskjöl
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a>Ítarleg skjöl
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a>Síður og stillingar

Í þessum hluta er lýst hugmyndavinnu á bak við helstu síður og stillingar fyrir vöruhúsnæði.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Hólf og hólf að innihaldi
...
#### <a name="bin-type"></a><a name="bin-type"></a>Tegund hólfs
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a>Hólfaflokkun
...
#### <a name="bin-setup"></a><a name="bin-setup"></a>Uppsetning hólfs
...
#### <a name="zone"></a><a name="zone"></a>Svæði
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a>Vöruhúsaflokkur
...
#### <a name="location"></a><a name="location"></a>Birgðageymsla
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>Fyrst útrunnið fyrst út
...
#### <a name="put-away-template"></a><a name="put-away-template"></a>Frágangssniðmát
