...
# <a name="warehouse-management-overview" />Yfirlit yfir vöruhúsastjórnun
...
## <a name="modeling-the-physical-warehouse" />Líkan að efnislegu vöruhúsi
...
### <a name="locations-and-bins" />Staðsetningar og hólfa
...
### <a name="shelves-and-bins" />Hillur og hólf
...
## <a name="typical-warehouse-workflow" />Dæmigert verkflæði vöruhúss
...
## <a name="terminology-related-to-warehouse-management" />Hugtök sem tengjast vöruhúsastjórnun

### <a name="complexity-levels" />Flækjustig
...
### <a name="warehouse-flows" />Vöruhús flæðir
...
### <a name="basic-documents" />Grunnskjöl
...
### <a name="advanced-documents" />Ítarleg skjöl
...
### <a name="pages-and-settings" />Síður og stillingar

Í þessum hluta er lýst hugmyndavinnu á bak við helstu síður og stillingar fyrir vöruhúsnæði.

#### <a name="bins-and-bin-content" />Hólf og hólf að innihaldi
...
#### <a name="bin-ranking" />Hólfaflokkun
...
#### <a name="bin-setup" />Uppsetning hólfs
...
#### <a name="warehouse-class" />Vöruhúsaflokkur
...
#### <a name="first-expired-first-out" />Fyrst útrunnið fyrst út
...
#### <a name="put-away-template" />Frágangssniðmát
