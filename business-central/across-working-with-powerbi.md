...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Vinna með Power BI Skýrslur í [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="get-started"></a><a name="get-started"></a><a name="get-started"></a>Hefjast handa
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Skráning Power BI
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Tengjast við Power BI - aðeins einu sinni
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a><a name="from--on-premises"></a>Fyrir [!INCLUDE [prod_short](includes/prod_short.md)] á staðnum
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Vinna með Power BI skýrslur

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Sýna skýrslur á listasíðum
...
### <a name="switch-reports"></a><a name="switch-reports"></a><a name="switch-reports"></a>Skipta í aðra skýrslu
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a><a name="get-more-reports"></a>Fá fleiri skýrslur
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Stjórna og breyta skýrslum
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Hlaða upp skýrslum
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Ekki er hægt að sjá skýrslur á síðu skýrsluvals á listasíðunni
