...
ms.author: andreipa
---
# <a name="schedule-jobs-for-adjusting-and-reconciling-inventory-cost-with-the-general-ledger" />Áætla vinnslur fyrir leiðréttingu og afstemmingu birgðakostnaðar með fjárhag
...
## <a name="move-the-task-of-adjusting-item-costs-to-the-background-with-the-help-of-assisted-setup" />Færa verk vegna leiðréttingar á kostnaði vöru í bakgrunninn með aðstoð hjálparuppsetningar
...
## <a name="to-create-a-job-queue-entry-for-adjusting-and-reconciling-inventory-cost-manually" />Að stofna færslu verkraðar til að leiðrétta og afstemma birgðakostnað handvirkt
