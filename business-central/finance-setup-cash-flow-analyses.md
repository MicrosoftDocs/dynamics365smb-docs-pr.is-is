...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis" />Setja upp sjóðstreymisgreiningu
...
## <a name="the-cash-cycle-and-income--expense-charts" />Gröf ferils bundins reiðufés og tekjur og útgjöld
...
## <a name="set-up-the-cash-flow-chart" />Setja upp sjóðstreymirit
...
## <a name="set-up-cash-flow-forecasts" />Uppsetning sjóðsstreymisspáa
...
#### <a name="receivables" />Viðskiptakröfur
...
#### <a name="payables" />Viðskiptaskuldir
