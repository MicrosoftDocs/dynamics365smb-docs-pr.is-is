...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Hönnunarupplýsingar: staða framleiðslupöntunar
...
## <a name="posting-structure"></a><a name="posting-structure"></a>Bókunaruppbygging
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Afkastagetubókun
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a>Kostnaður framleiðslupöntunar
