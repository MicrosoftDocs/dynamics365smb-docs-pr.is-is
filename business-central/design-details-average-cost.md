...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Hönnunarupplýsingar: Meðalkostnaður
...
## <a name="setting-up-average-cost-calculation" />Setja upp meðalkostnaðrverðútreikning
...
## <a name="calculating-average-cost" />Meðalkostnaður reiknaður
...
### <a name="example-average-cost-period--day" />Dæmi Tímabil meðalinnk.verðs = Dagur
...
### <a name="example-average-cost-period--month" />Dæmi Tímabil meðalinnk.verðs = mánuður
...
## <a name="setting-the-valuation-date" />Dagsetning virðismats ákveðin
...
## <a name="recalculating-average-cost" />Meðalkostnaður reiknaður
...
### <a name="example-of-recalculated-average-cost" />Dæmi um Endurútgefið meðalinnkaupsverð
