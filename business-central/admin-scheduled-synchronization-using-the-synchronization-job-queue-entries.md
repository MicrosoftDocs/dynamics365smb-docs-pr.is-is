...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse"></a><a name="scheduling-a-synchronization-between-business-central-and-dataverse"></a>Áætla samstillingu milli Business Central og Dataverse
...
## <a name="default-synchronization-job-queue-entries"></a><a name="default-synchronization-job-queue-entries"></a>Sjálfgefnar færslur vinnsluraðar vinnslu
...
## <a name="synchronization-process"></a><a name="synchronization-process"></a>Samstillingarferli
...
## <a name="about-inactivity-timeouts"></a><a name="about-inactivity-timeouts"></a>Um tímafrekari tímalóvirkni
...
## <a name="to-view-the-synchronization-job-log"></a><a name="to-view-the-synchronization-job-log"></a>Til að skoða kladda samstillingarverks
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings"></a><a name="to-view-the-synchronization-job-log-from-the-table-mappings"></a>Til að skoða kladda samstillingarverks úr töfluvörpunum
...
## <a name="to-view-the-synchronization-error-log"></a><a name="to-view-the-synchronization-error-log"></a>Til að skoða villukladda samstillingar
