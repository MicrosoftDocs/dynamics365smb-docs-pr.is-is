...
1.  Velja skal táknið ![Leit að síðu eða skýrslu](media/ui-search/search_small.png "Leit að síðu eða skýrslu táknið"), slá inn **Uppsetning spurningalisti** og velja svo viðeigandi tengil.  
