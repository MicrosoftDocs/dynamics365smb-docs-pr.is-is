---
title: Setja upp verðmætamat og kostnaðarútreikning birgða
...
|Tryggja að áætlaður kostnaður sé bókaður á fjárhagur til að sjá af bráðabirgðafjárhagsreikningum mat á upphæðum sem gjaldfalið er og kostnaði varanna í viðskiptum áður en þær eru reikningsfærðar.|Reiturinn **Áætluð kostnaðarbókun í fjárhag** á síðunni **Uppsetning birgða**|  
...
[Uppsetning bestu venja: Aðferð kostnaðarútreiknings](setup-best-practices-costing-method.md)    
[Upplýsingar um hönnun: Birgðakostnaður](design-details-inventory-costing.md)    
[Upplýsingar um hönnun: Aðferð kostnaðarútreiknings breytt fyrir vörur](design-details-changing-costing-methods.md)    
