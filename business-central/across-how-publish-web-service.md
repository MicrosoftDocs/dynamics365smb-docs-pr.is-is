...
ms.author: edupont
---
# <a name="publish-a-web-service" />Birta vefþjónustu
...
## <a name="creating-and-publishing-a-web-service" />Vefþjónusta stofnuð og gefin út

Eftirfarandi skref skýra hvernig vefþjónusta er búin til og gefin út.  

### <a name="to-create-and-publish-a-web-service" />Til að stofna og gefa út vefþjónustu
...
### <a name="to-verify-the-availability-of-a-web-service" />Til að staðfesta aðgengi að vefþjónustu
