...
# <a name="control-access-to-business-central-using-security-groups" />Stjórna aðgangi að starfrækslu miðsvæðis með öryggisflokkum
...
## <a name="business-central-online-and-on-premises" />Viðskipti miðsvæðis á netinu og innanhúss
...
## <a name="add-a-security-group-in-business-central" />Bæta við öryggishokk í miðborg fyrirtækja
...
### <a name="assign-permissions-to-a-security-group" />Úthluta heimildum til öryggisflokks
...
## <a name="review-the-permissions-in-a-security-group" />Farið yfir heimildir í öryggisflokki
...
## <a name="security-groups-and-user-groups" />Öryggisflokkar og notendaflokkar
...
### <a name="optional-convert-user-groups-to-permission-sets" />Valfrjálst: umbreyta notendaflokkum í heimildasöfn
