...
ms.reviewer: jswymer
---
# <a name="view-and-edit-in-excel-from-business-central"></a>Skoða og breyta í Excel úr Business Central
...
### <a name="work-across-environments-and-companies"></a>Vinna í öllum umhverfum og fyrirtækjum
...
### <a name="limits-when-using-excel-for-the-web"></a>Takmarkanir á notkun á Excel fyrir vefinn
