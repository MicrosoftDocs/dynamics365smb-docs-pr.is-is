...
ms.author: bholtorf
---
# <a name="upgrading-an-integration-with-dynamics-365-sales" />Uppfærsla samþættingar við Dynamics 365 Sales
...
## <a name="to-upgrade-your-connection-to-use-dataverse" />Tenging uppfærð til að nota Dataverse
