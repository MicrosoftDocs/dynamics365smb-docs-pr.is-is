...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Setja upp kaupendur
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Innkaupaaðilar settir upp
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Lánardrottnum úthlutað innkaupaaðilar:
