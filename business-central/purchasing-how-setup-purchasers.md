...
ms.author: edupont
---
# <a name="set-up-purchasers" />Setja upp kaupendur
...
## <a name="to-set-up-purchasers" />Innkaupaaðilar settir upp
...
## <a name="to-assign-purchasers-to-vendors" />Lánardrottnum úthlutað innkaupaaðilar:
