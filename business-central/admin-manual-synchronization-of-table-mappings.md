...
# <a name="manually-synchronize-table-mappings" />Samstilla töfluvarpanir handvirkt
...
## <a name="run-a-full-synchronization" />Keyra fulla samstillingu
...
### <a name="to-run-a-full-synchronization" />Að keyra fulla samstillingu
...
## <a name="synchronizing-all-modified-records" />Samstilling á öllum breyttum færslum
...
### <a name="to-synchronize-data-for-all-tables" />Til að samstilla gögn fyrir allar töflur
...
## <a name="synchronize-individual-table-mappings" />Samstilla stakar töfluvarpanir
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />Að samstilla færslur fyrir vörpun samþættingartöflu
