...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises" />Setja upp tengilið samkeyrslu við Outlook sem er í Innanhússmiðstöð
...
## <a name="set-up-contact-sync" />Setja upp samkeyrslu tengiliðar
