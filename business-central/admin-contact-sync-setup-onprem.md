...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises"></a><a name="set-up-contact-sync-with-outlook-for-business-central-on-premises"></a>Setja upp tengilið samkeyrslu við Outlook sem er í Innanhússmiðstöð
...
## <a name="set-up-contact-sync"></a><a name="set-up-contact-sync"></a>Setja upp samkeyrslu tengiliðar
