...
ms.author: edupont
---
# <a name="design-details-warehouse-setup"></a><a name="design-details-warehouse-setup"></a><a name="design-details-warehouse-setup"></a>Hönnunarupplýsingar uppsetningvöruhúss
...
## <a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a>Hólf og Innihald hólfs
...
## <a name="class"></a><a name="class"></a><a name="class"></a>Flokkur
...
[vöruhúsastjórnun hönnunarupplýsingar: framboð í vöruhúsi](design-details-availability-in-the-warehouse.md)
