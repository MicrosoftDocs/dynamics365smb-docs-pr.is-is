...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot"></a>Yfirlit um markaðstexta AI-vara (Forskoðun) með Copilot

[!INCLUDE[ai-preview](includes/ai-preview.md)]

Þessi grein gefur yfirlit yfir rafknúinn möguleika sem Copilot er í Viðskiptamiðinu.

## <a name="what-is-ai-powered-item-marketing-text-with-copilot"></a>Hvað er AI-knúinn markaðssetning Text með Copilot?
...
## <a name="current-limitations"></a>Gildandi takmarkanir
