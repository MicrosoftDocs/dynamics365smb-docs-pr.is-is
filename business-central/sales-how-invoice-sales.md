...
ms.author: edupont
---
# <a name="invoice-sales"></a><a name="invoice-sales"></a>Reikningsfæra sölur
...
## <a name="create-sales-invoices"></a><a name="create-sales-invoices"></a>Stofna sölureikninga
...
### <a name="to-create-a-sales-invoice"></a><a name="to-create-a-sales-invoice"></a>Sölureikningar búnir til:
...
### <a name="calculating-invoice-discounts-on-sales"></a><a name="calculating-invoice-discounts-on-sales"></a>Reikna reikningsafslátt á sölu
...
## <a name="registering-payments"></a><a name="registering-payments"></a>Skrá greiðslur
...
## <a name="external-document-numbers"></a><a name="external-document-numbers"></a>Númer ytri skjala

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/modules/invoicing-customers-dynamics-365-business-central/index).
