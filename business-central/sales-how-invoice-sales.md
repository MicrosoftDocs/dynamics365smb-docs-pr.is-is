...
ms.author: edupont
---
# <a name="invoice-sales" />Reikningsfæra sölur
...
## <a name="create-sales-invoices" />Stofna sölureikninga
...
### <a name="to-create-a-sales-invoice" />Sölureikningar búnir til:
...
## <a name="registering-payments" />Skrá greiðslur
...
## <a name="external-document-numbers" />Númer ytri skjala

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/invoicing-customers-dynamics-365-business-central/index).
