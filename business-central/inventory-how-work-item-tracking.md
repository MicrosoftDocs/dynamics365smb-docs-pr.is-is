...
ms.author: edupont
---
# <a name="track-items-with-serial-lot-and-package-numbers" />Rekja vörur með rað-, lotu- og pakkanúmerum
...
## <a name="item-tracking-availability" />Vörurakning til ráðstöfunar
...
## <a name="to-assign-serial-or-lot-numbers-during-an-inbound-transaction" />Úthlutun rað- eða lotunúmera á færslur á leið inn.
...
### <a name="to-handle-serial-and-lot-numbers-when-getting-receipt-lines-from-a-purchase-invoice" />Meðhöndla rað- og lotunúmer þegar móttökulínur eru sóttar úr innkaupareikningi
...
## <a name="to-assign-a-serial-or-lot-number-during-an-outbound-transaction" />Úthlutun rað- eða lotunúmera vegna færslna á leið út.
...
### <a name="to-select-from-existing-serial-or-lot-numbers" />Valið úr tiltækum rað- og lotunúmerum
...
### <a name="to-assign-new-serial-or-lot-numbers" />Til að úthluta nýjum rað- eða lotunúmerum
...
### <a name="assign-tracking-numbers-on-source-documents" />Úthluta rakningarnúmerum í upprunaskjölum
...
## <a name="to-handle-serial-and-lot-numbers-on-transfer-orders" />Hvernig á að meðhöndla rað- og lotunúmer í millifærslupöntunum
...
## <a name="to-record-additional-serial-or-lot-number-information" />Skráning viðbótarupplýsinga um rað- og lotunúmer
...
## <a name="to-modify-existing-serial-or-lot-number-information" />Breyta fyrirliggjandi upplýsingum um rað- og lotunúmer
...
## <a name="to-reclassify-serial-or-lot-numbers" />Endurflokka rað- eða lotunúmer
