...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Breyta grundvallarstillingum
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Hlutverk
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Breyta hlutverki
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Fyrirtæki
...
## <a name="work-date"></a><a name="work-date"></a><a name="work-date"></a>Vinnudagur
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Ábending um vinnudagsetningu
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Svæði
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Tungumál
...
## <a name="time-zone"></a><a name="time-zone"></a>Tímabelti
...
## <a name="notifications"></a><a name="notifications"></a>Tilkynningar
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Kennsluábendingar
