...
---
# <a name="walkthrough-set-up-and-invoicing-sales-prepayments"></a>Kynning: Uppsetning og reikningsfærsla fyrirframgreiðslna fyrir sölu
...
5. Tvær sölulínur eru fylltar út með eftirfarandi upplýsingum.  
    ...
    Fyrirframgreiðslureitirnir í sölulínunni eru sjálfgefið faldir. Til að birta reitina verður þú að sérsníða síðuna. Nánari upplýsingar er að finna  [í til að ræsa sérsníða síðu í gegnum fylgiritið](ui-personalization-user.md#start-personalizing-by-using-the-personalization-mode).
