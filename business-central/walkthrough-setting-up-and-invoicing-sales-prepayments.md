...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Kynning: Uppsetning og reikningsfærsla fyrirframgreiðslna fyrir sölu
...
## <a name="set-up-prepayments" />Uppsetning fyrirframgreiðslu
...
### <a name="to-set-up-number-series-for-prepayments" />Uppsetning númeraraða fyrir fyrirframgreiðslur
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Frysting afhendinga vegna ógreiddra fyrirframgreiðslna
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Úthlutun sjálfgefins hlutfalls fyrirframgreiðslu á viðskiptamenn og vörur
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Til að tilgreina lykil fyrir sölufyrirframgreiðslur í alm. bókunargrunni
...
## <a name="create-an-order-that-requires-a-prepayment" />Stofna pöntun sem þarf fyrirframgreiðslu
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Stofnun sölupöntunar með fyrirframgreiðslu
...
## <a name="create-a-prepayment-invoice" />Stofna fyrirframgreiðslureikning
...
### <a name="to-create-a-prepayment-invoice" />Stofnun fyrirframgreiðslureiknings
...
## <a name="create-an-additional-prepayment-invoice" />Stofna annan fyrirframgreiðslureikning
...
### <a name="to-create-an-additional-prepayment-invoice" />Stofnun annars fyrirframgreiðslureiknings
...
## <a name="apply-the-prepayments" />Jafna fyrirframgreiðslu
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Jöfnun greiðslu við fyrirframgreiðslureikninga
...
## <a name="invoice-the-remaining-amount" />Reikningsfæra eftirstandandi upphæð
...
### <a name="to-invoice-the-remaining-amount" />Reikningsfærsla eftirstandandi upphæðar
...
## <a name="update-the-status-of-prepaid-orders-and-invoices-automatically" />Uppfæra stöðu fyrirframgreiddra pantana og reikninga sjálfkrafa
...
## <a name="see-related-microsoft-trainingtrainingmodulesprepayment-invoices-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/prepayment-invoices-dynamics-365-business-central/)
