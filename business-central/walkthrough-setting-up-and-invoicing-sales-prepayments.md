...
---
# <a name="walkthrough-set-up-and-invoicing-sales-prepayments"></a>Kynning: Uppsetning og reikningsfærsla fyrirframgreiðslna sölu
...
5. Tvær sölulínur eru fylltar út með eftirfarandi upplýsingum.  
    ...
    Fyrirframgreiðslureitirnir í sölulínunni eru sjálfgefið faldir. Ef birta á reitina verður að sérstilla síðuna. Nánari upplýsingar [eru í Til að byrja að sérstilla síðu með borðanum](ui-personalization-user.md#start-personalizing-by-using-the-personalization-mode) Sérstilling.
...
## <a name="apply-the-prepayments"></a>Nota fyrirframgreiðslur
