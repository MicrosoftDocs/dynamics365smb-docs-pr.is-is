...
# <a name="work-with-word-layouts"></a><a name="work-with-word-layouts"></a>Vinna með Word-útlit
...
## <a name="embedding-fonts-in-word-layouts-for-consistency"></a><a name="embedding-fonts-in-word-layouts-for-consistency"></a>Innfelling leturgerða í Word Layouts fyrir samræmi
...
## <a name="adding-data-fields"></a><a name="adding-data-fields"></a>Bæta við gagnareitum
...
### <a name="to-open-the-custom-xml-part-for-the-report-in-word"></a><a name="to-open-the-custom-xml-part-for-the-report-in-word"></a><a name="OpenXMLPart"></a>Til að opna sérsniðinn XML-hluta fyrir skýrsluna í Word
...
### <a name="to-add-a-label-or-data-field"></a><a name="to-add-a-label-or-data-field"></a>Til að bæta við merki eða gagnareit
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list"></a><a name="to-add-repeating-rows-of-data-fields-to-create-a-list"></a>Til að bæta við endurteknum línum gagnareita til að búa til lista
...
## <a name="adding-image-fields"></a><a name="adding-image-fields"></a>Bæta við myndareitum
...
### <a name="to-add-an-image"></a><a name="to-add-an-image"></a>Til að bæta við mynd
...
## <a name="removing-label-and-data-fields"></a><a name="removing-label-and-data-fields"></a><a name="RemoveField"></a> Merkja- og gagnareitir fjarlægðir
...
### <a name="to-remove-a-label-or-data-field"></a><a name="to-remove-a-label-or-data-field"></a>Til að fjarlægja merki eða gagnareit
...
## <a name="custom-xml-part-overview"></a><a name="custom-xml-part-overview"></a>Sérsniðinn XML-hluti yfirlit
...
### <a name="xml-structure-of-custom-xml-part"></a><a name="xml-structure-of-custom-xml-part"></a>XML bygging sérsniðins XML-hluta
...
### <a name="custom-xml-part-in-word"></a><a name="custom-xml-part-in-word"></a>Sérsniðinn XML-hluti í Word
