...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />Um áætlunaraðgerðir
...
## <a name="demand-and-supply" />Eftirspurn og Framboð
...
## <a name="planning-calculation" />Áætlunarútreikningur
...
## <a name="planning-with-manual-transfer-orders" />Áætlað með handvirkum millifærslupöntunum
...
## <a name="other-important-planning-fields" />Önnur mikilvæg áætlunarsvið
...
## <a name="planning-worksheets-and-requisition-worksheets" />Áætlunarvinnublöð og vinnublöð innkaupatillagna
...
### <a name="requisition-worksheet" />Innkaupatillögublað
...
## <a name="see-related-microsoft-trainingtrainingmodulesplan-items-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/plan-items-dynamics-365-business-central/)
