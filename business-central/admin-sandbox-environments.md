...
ms.author: solsen
---
# <a name="sandbox-environments-in-"></a><a name="sandbox-environments-in-"></a>Sandkassaumhverfi í [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="advanced-user-experience"></a><a name="advanced-user-experience"></a>Ítarleg notendaupplifun
...
### <a name="complete-sample-data"></a><a name="complete-sample-data"></a>Ljúka sýnigögnum
...
## <a name="designer"></a><a name="designer"></a>Hönnuður
