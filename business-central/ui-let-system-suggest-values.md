...
## <a name="the-suggest-balancing-amount-check-box-on-the-general-journal-batches-page" />Gátreiturinn **Leggja til Upphæð Mótreiknings** á síðunni **færslubókarkeyrsla**
...
### <a name="to-have-the-amount-field-on-balancing-general-journal-lines-filled-automatically" />Til að láta í **Upphæð** reitinn á færslubókarlínur fyllast út sjálfkrafa
...
## <a name="the-automatically-fill-date-received-field-on-the-payment-registration-page" />Reiturinn **Dagsetning móttöku fyllt út sjálfkrafa** á síðunni **Skráning greiðslna** glugga
...
### <a name="to-have-the-date-received-field-on-the-payment-registration-page-filled-automatically" />Til að láta fylla sjálfkrafa inn í reitinn **Gögn móttekin** á síðunni **Skráning greiðslu**
