...
description: Fræðast um hvernig á að setja upp eiginleika Intrastat-skýrslugerðar og hvernig eigi að tilkynna viðskipti við fyrirtæki í öðrum ESB-löndum/svæðum.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
## Áskilin og valfrjáls uppsetning
...
* **Upprunaland**: Nota skal tveggja stafa ISO-alfakóta fyrir landið/svæðið þar sem varan var fengin eða framleidd. Ef varan var framleidd í fleiri en einu landi/svæði er landið/svæðið upprunaland síðasta landið þar sem unnið var verulega.
* **VSK-númer samstarfsaðila í aðildarríkinu þar sem innflutningur fer fram**: Þetta er VSK-númer samstarfsaðila í aðildarríkinu þar sem innflutningur fer fram. VSK-kennið er einnig notað í skiptum við útflutningsgögn innan ESB-aðildarríkjanna og gerir aðildarríkjum kleift að úthluta mótteknum gögnum til innflutningsfyrirtækis í eigin landi/svæði. Tilkynningarskyldar vörur verða að tilgreina VSK-númer fyrirtækis sem taldi fram til tolls vegna vörukaupa í aðildarríkinu þar sem innflutningur fer fram.
...
* **Komu-/brottfararstaðir: Þeir eru notaðir** til að tilgreina birgðageymslur þar sem vörur eru afhentar eða mótteknar til eða frá öðrum löndum/svæðum. Heathrow flugstöðin er dæmi um komu-brottfararstað. Komu/brottfararstaði er hægt að færa inn í sölu- og innkaupskjöl á flýtiflipanum **Erlend viðskipti**. Þessar upplýsingar verða einnig afritaðar úr birgðafærslum þegar Intrastatbók er stofnuð.  

### Uppsetning Intrastat-sniðmáts og keyrslna.
...
### Til að setja upp hvaða Intrastat skýrslureitir eru nauðsynlegir

Í sumum löndum/svæðum, svo sem Spáni og Bretlandi, krefjast yfirvöld þess að Intrastat-skýrslur innihaldi til dæmis afhendingarmáta vegna innkaupa eða einhver önnur gildi þegar sala er yfir ákveðnum þröskuldi. Á síðunni **Uppsetning Intrastat** getur þú valið að gera **Uppsetning Instrastat-gátlista** til að stilla áskilda reiti á síðunni **Intrastatbók**.
...
### Til að breyta Intrastat-bókarlínum
...
### Senda Intrastat-skýrslu á eyðublaði eða sem skrá
...
## Endurskipuleggja Intrastatbækur
...
Í mörgum löndum/svæðum koma tolla- og skattayfirvöld á 8 stafa vörukóta fyrir ýmsar vörur. Ef birgðafærslur eiga að fela í sér nauðsynlegar upplýsingar þegar kerfið flytur þær í intrastatbókarlínu verða upplýsingar um tollflokk að hafa verið færðar inn á síðun **Tollflokkar**. Finna skal kóða þeirra vörutegunda sem fyrirtæki notanda verslar með og færa þá inn í gluggann **Tollflokkar**.
