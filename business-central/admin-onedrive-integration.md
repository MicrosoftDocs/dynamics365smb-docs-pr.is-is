...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Stjórnun OneDrive samþættingar við Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Grunnstilla OneDrive fyrir samþættingu við Business Central
...
### <a name="managing-privacy" />Umsjón með persónuvernd
...
## <a name="configure-business-central" />Grunnstilla Business Central
...
### <a name="about-multiple-environments" />Um mörg umhverfi
...
### <a name="configure-onedrive-using-onedrive-setup" />Stilla OneDrive með OneDrive uppsetningu
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Skipt yfir í nýja OneDrive samþættingu eftir uppfærslu
...
## <a name="governance" />Stjórnunarhættir
