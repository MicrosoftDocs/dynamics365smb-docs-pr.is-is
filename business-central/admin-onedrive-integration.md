...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central"></a><a name="managing-onedrive-integration-with-business-central"></a>Stjórnun OneDrive samþættingar við Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central"></a><a name="configure-onedrive-for-integration-with-business-central"></a>Grunnstilla OneDrive fyrir samþættingu við Business Central
...
### <a name="managing-privacy"></a><a name="managing-privacy"></a>Umsjón með persónuvernd
...
## <a name="configure-business-central"></a><a name="configure-business-central"></a>Grunnstilla Business Central
...
### <a name="about-multiple-environments"></a><a name="about-multiple-environments"></a>Um mörg umhverfi
...
### <a name="configure-onedrive-using-onedrive-setup"></a><a name="configure-onedrive-using-onedrive-setup"></a>Stilla OneDrive með OneDrive uppsetningu
...
### <a name="switching-to-new-onedrive-integration-after-upgrade"></a><a name="switching-to-new-onedrive-integration-after-upgrade"></a>Skipt yfir í nýja OneDrive samþættingu eftir uppfærslu
...
## <a name="restoring-onedrive-and-"></a><a name="restoring-onedrive-and-"></a>Að endurheimta OneDrive og [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="governance"></a><a name="governance"></a>Stjórnunarhættir
