...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Kynning: Rað-/lotunúmerarakning
...
### <a name="to-create-the-items" />Þjónustuvörur stofnaðar:
...
### <a name="to-purchase-components" />Til að kaupa íhluti
...
### <a name="to-produce-end-items" />Til að framleiða lokavörur
...
### <a name="to-sell-the-end-items" />Til að selja lokavörurnar
...
## <a name="tracing-from-usage-to-origin" />Rekja frá notkun til uppruna
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Til að komast að því hvaða lota innihélt gölluðu grindina og hvaðan hún kom
...
## <a name="tracing-from-origin-to-usage" />Rekja frá uppruna til notkunar
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Til að finna alla notkun á gölluðu lotunni
...
## <a name="finding-all-records-of-a-seriallot-number" />Finna allar skrár rað-/lotunúmers
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-serial-lot-numbers" />Sjá tengda [Microsoft þjálfun](/training/paths/use-serial-lot-numbers/)
