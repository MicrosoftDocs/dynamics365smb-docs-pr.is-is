...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a>Kynning: Rað-/lotunúmerarakning
...
### <a name="to-create-the-items"></a><a name="to-create-the-items"></a>Þjónustuvörur stofnaðar:
...
### <a name="to-purchase-components"></a><a name="to-purchase-components"></a>Til að kaupa íhluti
...
### <a name="to-produce-end-items"></a><a name="to-produce-end-items"></a>Til að framleiða lokavörur
...
### <a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a>Til að selja lokavörurnar
...
## <a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a>Rekja frá notkun til uppruna
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a>Til að komast að því hvaða lota innihélt gölluðu grindina og hvaðan hún kom
...
## <a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a>Rekja frá uppruna til notkunar
...
### <a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a>Til að finna alla notkun á gölluðu lotunni
...
## <a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a>Finna allar skrár rað-/lotunúmers
...
### <a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a>Til að finna öll tilfelli LOTA1 í skrám sem eftir á að bóka, svo sem opnum pöntunum
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/use-serial-lot-numbers/)
