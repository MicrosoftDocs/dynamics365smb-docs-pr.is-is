...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Setja upp litaðan vísi á bunka fyrir fyrirtækið eða einstaka notendur
...
### <a name="to-set-up-colored-indicators-on-cues" />Til að setja upp litaða vísa í bendingum
