...
ms.author: edupont
---
# <a name="view-the-availability-of-items" />Skoða tiltækileika vöru
...
## <a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped" />Að skoða tiltækileika vöru samkvæmt því hvenær hún berst eða verður afgreidd
...
## <a name="to-view-the-availability-of-an-item-in-different-periods" />Að skoða tiltækileika vöru á mismunandi tímabilum
...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored" />Að skoða tiltækileika vöru eftir staðsetningunni sem hún er geymd á
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored" />Að skoða tiltækileika allra vara eftir staðsetningunni sem þær eru geymdar á
...
## <a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms" />Að skoða framboð vöru eftir notkun hennar í samsetningu eða uppskrifta
...
### <a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent" />Til að skoða framboð vöru samkvæmt eftirspurn fyrir yfireiningu hennar
...
## <a name="to-view-the-availability-of-an-item-by-its-units-of-measure" />Til að skoða framboð vöru eftir mælieiningum hennar
...
## <a name="to-view-the-availability-of-an-item-by-its-variants" />Til að skoða framboð vöru eftir afbrigðum hennar
...
## <a name="assembly-availability-page" />Síðan „Samsetningarráðstöfun“
