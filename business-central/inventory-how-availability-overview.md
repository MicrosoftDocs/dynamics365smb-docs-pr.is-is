---
title: Fá yfirlit yfir ráðstöfunarmagn
...
---
# <a name="view-the-availability-of-items"></a>Skoða vörur til ráðstöfunar
...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-its-stored"></a>Til að skoða tiltæka vöru á þeim staðum þar sem hún er geymd
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-theyre-stored"></a>Til að skoða tiltækar allar vörur eftir staðsetningunni þar sem þær eru geymdar
...
## <a name="assembly-availability-page"></a>Síðuna Samsetning til ráðstöfunar
