...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations" />Kynning: Móttaka og Frágangur í ítarlegri grunngerð vöruhúss
...
## <a name="reviewing-the-white-location-setup" />Farið yfir HVÍTU birgðageymsluuppsetninguna

Uppsetning síðunnar **Birgðageymsluspjald** skilgreinir vöruhúsaflæði fyrirtækisins.  

### <a name="to-review-the-location-setup" />Til að fara yfir uppsetningu birgðageymslunnar
...
## <a name="creating-the-purchase-orders" />Stofna innkaupapantanirnar

Innkaupapantanir eru algengustu tegundir af upprunaskjölum á innleið.  

### <a name="to-create-the-purchase-orders" />Innkaupapantanir stofnaðar
...
## <a name="putting-the-items-away" />Vörufrágangur
...
### <a name="to-put-the-items-away" />Til að ganga frá vörunum
