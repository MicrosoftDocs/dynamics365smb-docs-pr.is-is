...
## <a name="use-rights" />Notkunarréttindi
...
 
### <a name="client-access" />Aðgangur biðlara
...
### <a name="data-access" />Gagnaheimildir
...
### <a name="use-of-objects" />Notkun hluta
...
## <a name="simplified-user-interface" />Einfaldara notendaviðmót
...
### <a name="requirements-to-enable-access" />Kröfur til að virkja aðgang

- [!INCLUDE [prod_short](includes/prod_short.md)] á netinu (SaaS).

- Umhverfi verður að vera verkvangsútgáfa 21.1 eða nýrri.

### <a name="requirements-for-individual-users-to-access-data-in-teams" />Kröfur fyrir einstaka notendur til að fá aðgang að gögnum í Teams
