...
---
# <a name="register-new-items" /><a name="register-new-items"></a>Skrá nýjar vörur
...
## <a name="to-create-a-new-item-card" /><a name="to-create-a-new-item-card"></a>Að búa til nýtt vöruspjald
...
### <a name="to-save-the-item-card-as-a-template" /><a name="to-save-the-item-card-as-a-template"></a>Til að vista birgðaspjald sem sniðmát
...
### <a name="items-used-in-production-orders" /><a name="items-used-in-production-orders"></a>Vörur notaðar í framleiðslupöntunum
...
## <a name="to-set-up-multiple-vendors-for-an-item" /><a name="to-set-up-multiple-vendors-for-an-item"></a>Margir lánardrottnar settir upp fyrir vörur
...
## <a name="set-up-item-substitutions" /><a name="set-up-item-substitutions"></a>Setja upp staðgengilsvörur
...
### <a name="to-make-an-item-substitution" /><a name="to-make-an-item-substitution"></a>Til að búa til staðgengilsvöru:
...
## <a name="categories-attributes-and-variants" /><a name="categories-attributes-and-variants"></a>Flokkar, eigindir og afbrigði

[!INCLUDE[inventory_variant](includes/inventory_variant.md)]

Frekari upplýsingar um afbrigði er að finna í [Stjórna afurðarafbrigðum](inventory-item-variants.md).  

## <a name="deleting-item-cards" /><a name="deleting-item-cards"></a>Eyða birgðaspjöldum
...
## <a name="manage-inventory-in-warehouses" /><a name="manage-inventory-in-warehouses"></a>Stjórna birgðum í vöruhúsum
...
## <a name="planning" /><a name="planning"></a>Áætlun
