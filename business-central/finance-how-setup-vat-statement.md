...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names" />Setja upp sniðmát VSK-yfirlits og heiti VSK-yfirlits
...
## <a name="to-define-a-vat-statement" />Að skilgreina VSK-yfirlit
...
## <a name="to-preview-the-vat-statement" />Til að forskoða virðisaukaskattsyfirlitið
