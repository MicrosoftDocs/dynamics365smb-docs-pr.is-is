...
## <a name="xbrl-comprises-the-following-components"></a>XBRL samanstendur af eftirfarandi hlutum
...
## <a name="set-up-xbrl-lines"></a>Etja upp XBRL línur
...
## <a name="import-an-xbrl-taxonomy"></a>Flytja inn XBRL-flokkun
...
4. Til að flytja skemað inn skal á **XBRL-skemasíðunni** velja aðgerðina **Flytja inn** og gera svo eitt af eftirfarandi skrefum til að hlaða upp skránni:

   [!INCLUDE[file-upload](includes/file-upload.md)]
5. Til að flytja inn tenglagrunninn **á XBRL-skemasíðunni** skal velja aðgerðina **Tenglagrunnur** og gera síðan eitt af eftirfarandi skrefum til að hlaða upp skránni:
...
5. Velja skal viðeigandi tenglagrunn eða velja <kbd>Ctrl</kbd>+<kbd>N</kbd> fyrir nýja línu, velja tegund tenglagrunns og setja inn lýsingu.  
