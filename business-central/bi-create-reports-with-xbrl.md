...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Stofna skýrslur með XBRL
...
## <a name="extensible-business-reporting-language"></a><a name="extensible-business-reporting-language"></a>eXtensible Business Reporting Language (XML-miðað tölvumál fyrir viðskiptaskýrslugerð)
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL samanstendur af eftirfarandi hlutum
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Lagskiptar flokkanir
...
## <a name="linkbases"></a><a name="linkbases"></a>Tenglagrunnar
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Etja upp XBRL línur
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Flytja inn XBRL-flokkun
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Uppfæra XBRL-flokkun
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Sjá tengda þjálfun á [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
