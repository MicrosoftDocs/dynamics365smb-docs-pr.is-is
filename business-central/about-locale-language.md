...
[!INCLUDE[d365fin](includes/d365fin_md.md)] er í boði á fjölda markaða og tungumála um allan heim. Á mörkuðum þar sem [!INCLUDE[d365fin](includes/d365fin_md.md)] er í boði er hægt að aðstoða fyrirtæki með eftirlitsskyldar aðgerðir með eftirlitseiginleikum. [!INCLUDE[d365fin](includes/d365fin_md.md)] getur birst á mismunandi tungumálum og þú getur skipt um tungumál sem textar birtast á, og breytingin á sér stað strax, um leið og þú hefur verið skráð(ur) út og inn aftur. Stillingin á við þig en ekki alla aðra í fyrirtækinu.  
