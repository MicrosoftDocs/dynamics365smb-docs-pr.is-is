...
ms.author: edupont
---
# <a name="process-sales-return-orders" />Vinna söluvöruskilapantanir
...
## <a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents" />Stofna skilapöntun sölu byggða á einu eða fleiri bókuðu söluskjali
...
## <a name="to-create-a-replacement-sales-order-from-a-sales-return-order" />Stofnuð sölupöntun fyrir skiptuvöru úr söluskilapöntun
...
## <a name="to-create-return-related-documents-from-a-sales-return-order" />Stofna skilatengd skjöl fyrir söluvöruskilapöntun
...
## <a name="to-create-a-restock-charge" />Stofnað endurkaupagjald
