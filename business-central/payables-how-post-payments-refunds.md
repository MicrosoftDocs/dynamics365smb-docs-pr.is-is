...
ms.author: edupont
---
# <a name="record-payments-and-refunds-in-the-payment-journal" />Skrá greiðslur og endurgreiðslur í greiðslubókina
...
## <a name="to-make-payments-in-the-payment-journal" />Til að greiða í greiðslubók
...
## <a name="to-issue-a-refund-check" />Gefa út endurgreiðsluávísun
