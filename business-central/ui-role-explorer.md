...
# <a name="finding-pages-with-the-role-explorer" />Að finna síður með hlutverkaleit
...
## <a name="open-the-role-explorer" />Opnið hlutverkaleitina
...
## <a name="navigate-features" />Flettieiginleikar
...
## <a name="search-for-features" />Leita að eiginleikum
...
## <a name="explore-other-roles" />Kanna önnur hlutverk
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Stækka og minnka hnúta í hlutverkaleitinni
