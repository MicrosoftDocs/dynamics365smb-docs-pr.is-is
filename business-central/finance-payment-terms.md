...
ms.author: edupont
---
# <a name="set-up-payment-terms"></a><a name="set-up-payment-terms"></a>Setja upp greiðsluskilmála
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>Greiðsluskilmálar settir upp
