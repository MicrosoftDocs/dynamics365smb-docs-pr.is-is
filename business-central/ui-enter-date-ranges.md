...
# <a name="work-with-calendar-dates-and-times" />Vinna með dagsetningar og tíma í dagatali
...
## <a name="check-your-region-and-language-settings" />Athugaðu svæði og tungumálastillingar
...
### <a name="picking-dates-from-the-calendar" />Velja dagsetningar úr dagatalinu
...
### <a name="day-week-year-pattern" />Dagur\-vika\-ár mynstur
...
### <a name="digit-patterns" />Tölustafamynstur
...
### <a name="work-date" />Vinnudagsetning
...
### <a name="closing-date" />Lokunardagsetning
...
## <a name="use-date-formulas" />Nota dagsetningarformúlur
...
## <a name="entering-combined-dates-and-times" />Slá inn sameinaða dagsetningar og tíma
...
## <a name="see-related-microsoft-trainingtrainingmodulesexplore-modify-info-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/explore-modify-info-dynamics-365-business-central/)
