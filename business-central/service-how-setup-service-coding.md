...
# <a name="set-up-standard-service-codes" />Setja upp staðlaða þjónustukóða
...
## <a name="to-set-up-a-standard-service-code" />Uppsetning staðlaðra þjónustukóta
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Stöðluðum þjónustukóta úthlutað til þjónustuvöruhóps
