...
ms.author: edupont
---
# <a name="batch-post-output-and-run-times" />Fjöldabóka frálag og keyrslutíma
...
## <a name="to-post-output-quantities-andor-register-run-times-for-one-or-more-production-order-lines" />Að bóka frálagsmagn og/eða skrá keyrslutíma fyrir eina eða fleiri framleiðslupantanalínur
