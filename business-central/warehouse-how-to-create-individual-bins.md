...
ms.author: edupont
---
# <a name="create-bins" />Stofna hólf
...
## <a name="to-create-a-bin-from-the-location-card" />Hólf stofnaða af birgðageymsluspjaldinu:
...
### <a name="the-dedicated-field" />Sérnýttur reitur
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Stök hólf stofnuð á Hólfastofnunarvinnublaði:
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Hólf stofnuð sjálfvirkt á vinnublaði hólfastofnunar
