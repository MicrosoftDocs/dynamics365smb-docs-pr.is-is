...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Uppsetning kostnaðarbókhalds

Áður en byrjað er að vinna með kostnaðarbókhald þarf að framkvæma uppsetningarverkefni.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Stöður milli kostnaðartegundar , kostnaðarstaðar og kostnaðarliðar
...
## <a name="setting-up-cost-types" />Uppsetning kostnaðargerða
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Til að flytja bókhaldslykil fjárhags yfir í kostnaðargerðir.
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Til að setja upp nýjar kostnaðargerðir á síðunni Myndrit fyrir kostnaðargerðir
...
### <a name="to-update-cost-types" />Til að uppfæra kostnaðargerðir
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Skilgreining á venslum milli kostnaðargerða og fjárhagsreikninga
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Tengsl milli fjárhagsreiknings og kostnaðartegunda
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Kostnaðartegundir án tengsla við fjárhag
...
## <a name="setting-up-cost-centers" />Uppsetning kostnaðarstaða
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Til að flytja víddargildi í fjárhag í myndrit yfir í kostnaðarstaði
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Til að stofna nýja kostnaðarstaði á síðunni Myndrit fyrir kostnaðarstaði
...
## <a name="setting-up-cost-objects" />Uppsetning kostnaðarhluta
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Til að flytja víddargildi úr fjárhag í kostnaðarhluti
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Til að stofna nýja kostnaðarhluti á síðunni myndrit fyrir kostnaðarliði
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Skilgreining kostnaðarstaði og kostnaðarhluti fyrir bókhaldslykil
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Skilgreining sjálfgefin víddargildi fyrir fjárhagslykla
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Skilgreining á víddargildi fyrir sameiginlegan kostnað og beinan kostnað
...
## <a name="see-related-microsoft-trainingtrainingmodulescost-accounting-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/cost-accounting-dynamics-365-business-central/)
