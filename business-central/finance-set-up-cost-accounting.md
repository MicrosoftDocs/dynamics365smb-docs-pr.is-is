---
title: Setja upp kostnaðarbókhald
...
# Setja upp kostnaðarbókhald

Áður en byrjað er að vinna með kostnaðarbókhald þarf að framkvæma uppsetningarverkefni.

## Staða milli Kostnaðartegundar, Kostnaðarstaðar og Kostnaðarhlutar
...
### Til að flytja bókhaldslykil fjárhags yfir í kostnaðargerðir.
...
### Til að setja upp nýjar kostnaðargerðir á síðunni Myndrit fyrir kostnaðargerðir
...
### Til að uppfæra kostnaðargerðir
...
## Skilgreining á venslum milli kostnaðargerða og fjárhagsreikninga
...
### Tengsl milli fjárhagsreiknings og kostnaðartegunda
...
### Kostnaðartegundir án tengsla við fjárhag
...
Hægt er að velja **Uppfæra kostnaðarreikn. Víddaaðgerðir til að uppfæra víddir** kostnaðarbókhalds.
...
### Til að stofna nýja kostnaðarstaði á síðunni Myndrit fyrir kostnaðarstaði
...
### Til að stofna nýja kostnaðarhluti á síðunni myndrit fyrir kostnaðarliði
...
## Skilgreining kostnaðarstaði og kostnaðarhluti fyrir bókhaldslykil
...
> [!NOTE]  
>  Til að ganga úr skugga um að fyrirfram skilgreind kostnaðarstöð og kostnaðarhlutur sem settur er upp í fjárhagur flytjist sjálfkrafa yfir í kostnaðarbókhald skal velja **gátreitinn Kanna fjárhagsbókanir á síðunni** Uppsetning **kostnaðarbókhalds** .
