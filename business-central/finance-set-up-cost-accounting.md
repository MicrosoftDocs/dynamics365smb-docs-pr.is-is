...
# <a name="set-up-cost-accounting"></a>Setja upp kostnaðarbókhald

Áður en byrjað er að vinna með kostnaðarbókhald þarf að framkvæma uppsetningarverkefni.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a>Staða milli Kostnaðartegundar, Kostnaðarstaðar og Kostnaðarhlutar
...
## <a name="set-up-cost-types"></a>Setja upp tegundir kostnaðar
