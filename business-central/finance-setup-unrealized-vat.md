...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Uppsetning óinnleyst virðisaukaskatts fyrir reiðufé
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />Nota fjárhagsreikninga fyrir óinnleystan virðisaukaskatt
