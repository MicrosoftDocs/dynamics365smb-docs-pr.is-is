...
## <a name="minimum-permissions-for-user-accounts-in-includecrmmdincludescrmmdmd"></a>Lágmarksheimildir fyrir notendareikninga í [!INCLUDE[crm_md](includes/crm_md.md)]
