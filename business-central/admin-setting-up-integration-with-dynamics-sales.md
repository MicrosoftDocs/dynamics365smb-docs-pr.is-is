...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse" />Uppsetning á notendareikningum fyrir samþættingu við Microsoft Dataverse
...
## <a name="set-up-the-administrator-user-account" />Setja upp notandareikning stjórnanda
...
## <a name="permissions-and-security-roles-for-user-accounts-in-includeprodshortincludescdslongmdmd" />Heimildir og öryggishlutverk fyrir notandareikninga í [!INCLUDE[prod_short](includes/cds_long_md.md)]
