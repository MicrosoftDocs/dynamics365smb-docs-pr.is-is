...
ms.author: edupont
---
# <a name="sales"></a><a name="sales"></a><a name="sales"></a>Sölur
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/sell-items-services-dynamics-365-business-central/).
