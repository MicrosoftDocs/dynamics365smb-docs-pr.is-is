...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Flytja, skipta upp eða sameina eignir
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />Að færa eign í aðra deild
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />Til að skipta eign í þremur eignir
...
## <a name="to-combine-two-fixed-assets-into-one" />Sameina tvær eignir í eina
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />Skoða breytt bókfært afskriftarvirði vegna endurflokkunar eigna.
