...
Að veita viðskiptamönnum þjónustu er mikilvægur hluti fyrirtækjareksturs, og getur hún verið uppspretta ánægju og tryggðar þeirra, auk þess að skapa fyrirtækinu tekjur. Hins vegar er stjórnun og rakning þjónustu ekki alltaf auðveld og [!INCLUDE[prod_short](includes/prod_short.md)] býður upp á verkfæri til að hjálpa. Þessi verkfæri eru hönnuð til að styðja við viðgerðarverkstæði og þjónustuaðgerðir á vettvanga og styðja dæmigerðar aðstæður fyrir þessi fyrirtæki:
...
|**Til að**|**Sjá**|  
|------------|-------------|  
|Setja upp þjónustustjórnun, þ.m.t. bilunarkóta, vátryggingar, sjálfgefin skjöl og sniðmát.|[Þjónustustýring sett upp](service-setup-service.md)|  
