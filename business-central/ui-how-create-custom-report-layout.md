...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(Eldra) Búa til og breyta sérsniðnum skýrsluútlitum
...
## <a name="create-a-custom-layout" />Búa til sérsniðið útlit
...
## <a name="a-namemodifycustomlayoutamodifying-a-custom-layout" /><a name="ModifyCustomLayout"></a>Breyta sérsniðnu útliti
...
### <a name="modify-a-custom-layout" />Breyta sérsniðnu útliti
