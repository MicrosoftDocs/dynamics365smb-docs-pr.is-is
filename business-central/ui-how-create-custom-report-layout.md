...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts"></a><a name="legacy-create-and-modify-custom-report-layouts"></a>(Eldra) Búa til og breyta sérsniðnum skýrsluútlitum
...
## <a name="create-a-custom-layout"></a><a name="create-a-custom-layout"></a>Búa til sérsniðið útlit
...
## <a name="modifying-a-custom-layout"></a><a name="modifying-a-custom-layout"></a><a name="ModifyCustomLayout"></a>Breyta sérsniðnu útliti
...
### <a name="modify-a-custom-layout"></a><a name="modify-a-custom-layout"></a>Breyta sérsniðnu útliti
