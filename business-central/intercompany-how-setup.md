...
---
# <a name="set-up-intercompany-transactions" />Setja upp samstæðufærslur
...
## <a name="overview-of-the-steps-to-get-started" />Yfirlit yfir skrefin til að komast af stað
...
## <a name="set-up-a-synchronization-partner" />Setja upp samstillingarfélaga
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Setja upp bókhaldslykla milli fyrirtækja
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Flytja inn bókhaldslykil eða flytja út eða út
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Varpa bókhaldslykli milli fyrirtækja á bókhaldslykil fyrirtækisins
...
## <a name="set-up-intercompany-dimensions" />Setja upp samstæðuvíddir
...
### <a name="import-or-export-intercompany-dimensions" />Flytja inn eða út víddir fyrirtækja
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Varpa víddum milli fyrirtækja á víddir fyrirtækisins
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Setja upp færslubókarsniðmát og keyrslur innan samstæðu
...
## <a name="set-up-a-company-for-intercompany-transactions" />Setja upp fyrirtæki fyrir færslur innan samstæðu
...
## <a name="set-up-intercompany-partners" />Setja upp samstæðufélaga
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Setja upp samstæðufélaga sem viðskiptavini og lánardrottna
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Setja upp sjálfgefna fjárhagslykla MF-félaga innan samstæðu
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Sjálfvirk samþykkt færslna frá samstæðufélögum
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Tilgreina Bankareikningar sem á að nota fyrir samstæðufélaga
...
## <a name="troubleshoot-your-intercompany-setup" />Úrræðaleit vegna samstæðuuppsetningar
