...
# <a name="sales-quick-start" />Stuttur leiðarvísir um sölu
...
## <a name="set-up-items-to-sell" />Setja upp vörur til að selja
...
### <a name="set-up-a-new-item" />Setja upp nýtt atriði
...
## <a name="set-up-customers" />Viðskiptamenn settir upp
...
### <a name="set-up-a-new-customer" />Setja upp nýjan viðskiptamann
...
## <a name="create-a-sales-order" />Stofna sölupöntun
...
### <a name="to-create-a-sales-order" />Sölupöntun stofnuð
...
## <a name="create-a-sales-invoice" />Búa til sölureikning
...
### <a name="to-create-and-post-a-sales-invoice" />Að stofna og bóka sölureikning
