...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Yfirlit yfir víddasamstæðufærslur
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Víddasamstæðufærslur
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 víddarstjórnun
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a><a name="performance-improvement"></a>Bætt afköst
