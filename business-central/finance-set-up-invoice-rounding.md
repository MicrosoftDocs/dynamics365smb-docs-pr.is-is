...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Uppsetning sléttunargerðar reikninga
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Uppsetning fjárhagsreikninga fyrir sléttunarmismun reikninga
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Uppsetning fjárhagsreikninga fyrir sléttunarmismun reikninga
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Uppsetning sléttunar fyrir erlendan og staðbundinn gjaldmiðil
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Uppsetning sléttunar fyrir erlendan gjaldmiðil
...
### <a name="to-set-up-rounding-for-your-local-currency" />Uppsetning sléttunar fyrir þinn staðbundna gjaldmiðil
...
## <a name="activate-the-invoice-rounding-function" />Virkja aðgerðina fyrir reikningssléttun
