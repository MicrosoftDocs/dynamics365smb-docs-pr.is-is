---
title: Setja upp reikningssléttun
...
---
# <a name="set-up-invoice-rounding"></a>Setja upp reikningssléttun
...
* Tilgreina fjárhagsreikningana sem sléttunarmismunur er bókaður í.  
...
Ef nota á sjálfvirka sléttun reiknings þarf að setja upp fjárhagsreikning eða reikninga þar sem sléttunarmismunur er bókaður. Áður en það er hægt þarf að setja upp VSK-vörubókunarflokka. Nánari upplýsingar um það eru í [Setja upp VSK](finance-setup-vat.md).  
...
3. Velja skal bókunarflokka fyrir sléttaðar upphæðir í reitunum **Söluskattur vörubókunarflokkur** eða **VSK vörubókunarflokkur**, út frá því hvort notaður er VSK eða söluskattur. Setja þarf upp nýjan flokkskóta til að nota við reikningssléttun.
