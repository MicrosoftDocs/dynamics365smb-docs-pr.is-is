...
ms.author: bholtorf
---
# <a name="allocate-costs-to-intercompany-partners" />Úthluta kostnaði til millifyrirtækjafélaga
...
## <a name="to-allocate-costs-using-an-intercompany-general-journal" />Að úthluta kostnaði með MF-færslubók
...
## <a name="to-allocate-costs-using-a-purchase-document" />Að úthluta kostnaði með innkaupaskjali
...
## <a name="to-send-the-allocated-costs-to-intercompany-partners" />Að senda úthlutaðan kostnað til millifyrirtækjafélaga
...
## <a name="calculating-vat-for-cost-distributions" />Útreikningur virðisaukaskatts fyrir kostnaðardreifingar
