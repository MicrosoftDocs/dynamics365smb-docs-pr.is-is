...
# <a name="setting-up-troubleshooting-for-service-items" />Setja upp úrræðaleit fyrir þjónustuvörur
...
## <a name="to-set-up-troubleshooting-guidelines" />Uppsetning leiðbeininga við úrræðaleit
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Úthluta leiðbeiningum úrræðaleitar til íhluta, þjónustuvara eða þjónustuvöruflokka
