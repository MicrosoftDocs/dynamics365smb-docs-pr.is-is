---
title: Reglur um sjálfvirka jöfnun greiðslna
...
|**Númer fylgiskjals/Gildisskjals nr. Jafningi**|Tilgreinir hvort texti á færslubókarlínu greiðsluafstemmingar þarf að samsvara gildinu í reitnum **Nr. fylgiskjals** eða reitnum **Númer ytra skjals** á opnu færslunni áður en jöfnunarreglan verður notuð til að jafna sjálfvirkt greiðslu við opnu færsluna.|
|**Fjöldi færslna innan upphæðarvikmarka sem fundust**|Tilgreinir hversu margar færslur fyrir viðskiptamann eða lánardrottin þurfa að samsvara upphæðinni með greiðsluvikmörkum áður en jöfnunarreglan verður notuð til að jafna sjálfvirkt greiðslu við opnu færsluna.|
...
| Áreiðanleiki samsvörunar | Forgangur | Samsvörun fannst fyrir tengdan aðila | Samsvörun Fylgiskjalsnr./ytra fylgiskjalsnr. | Fjöldi færslna innan vikmarka upphæðar fannst |
|------------------|----------|-----------------------|--------------------------------|--------------------------------|
| Mikill             | 1        | Öll                 | Já - margt                 | Ein niðurstaða                      |
| Mikill             | 2        | Öll                 | Já - margt                 | Margar niðurstöður               |
