...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Hönnunarupplýsingar: birgðabókun
...
### <a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a>Birgðafærslur (1)
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Birgðajöfnunarfærslur (1)
...
### <a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a>Birgðafærslur (2)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Birgðajöfnunarfærslur (2)
...
### <a name="value-entries-3"></a><a name="value-entries-3"></a>Virðisfærslur (3)
...
### <a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a>Fjárhagsfærslur (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Tengslafærslur í fjárhag - tengslatafla fjárhagsbirgðabókar (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Samsetning og framleiðslubókun
