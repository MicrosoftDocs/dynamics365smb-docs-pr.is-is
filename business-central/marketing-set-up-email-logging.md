...
### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online"></a>Setja upp almennar möppur og reglur fyrir innskráningu tölvupósts Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Næst tengir þú [!INCLUDE[prod_short](includes/prod_short.md)] við Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online"></a>Setja upp samnýtt pósthólf og reglur um innskráningu tölvupósts Exchange Online
...
## <a name="set-up--to-log-email-messages"></a>Setja upp [!INCLUDE[prod_short](includes/prod_short.md)] til að skrá tölvupóstskeyti
...
## <a name="view-email-message-exchanges-in-the-interaction-log"></a>Skoða póstskipti í samskiptakladda
...
## <a name="connect-on-premises-versions-to-microsoft-exchange"></a>Tengjast útgáfum innanhúss við Microsoft Exchange
...
### <a name="to-register-an-application-in-microsoft-entra-id-for-connecting-from-business-central-to-exchange-online"></a>Til að skrá forrit í Microsoft Entra kenni til tengingar frá Business Central til Exchange Online
