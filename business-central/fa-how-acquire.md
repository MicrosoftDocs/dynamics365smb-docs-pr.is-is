...
ms.author: edupont
---
# <a name="acquire-fixed-assets" />Komast yfir eignir
...
## <a name="to-create-a-fixed-asset-and-acquire-it-automatically" />Stofna eign og komast yfir hana sjálfkrafa
...
## <a name="to-set-up-a-component-list-for-a-main-asset" />Uppsetning íhlutalista fyrir aðaleignir:
...
## <a name="to-post-a-fixed-asset-acquisition-manually-with-the-fixed-asset-gl-journal" />Bókun eignakaupa handvirkt með fjárhagsbók eigna.
...
## <a name="to-cancel-an-acquisition-cost-posting-for-one-fixed-asset" />Ógilding bókunar kaupverðs fyrir eina eign
...
## <a name="to-post-the-salvage-value-together-with-the-acquisition-cost" />Bóka hrakvirði með kaupverði.
