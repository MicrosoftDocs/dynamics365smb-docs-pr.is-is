...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Flýtivísun á lyklaborði-PC Only
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Fletta & Velja raðir
...
#### <a name="copy--paste"></a><a name="copy--paste"></a>Afrita & líma
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a>Leit, sía, & raða
...
#### <a name="quick-entry"></a><a name="quick-entry"></a>Snögg færsla
...
##### <a name="report-preview"></a><a name="report-preview"></a>Forskoðun skýrslu

|Velja skal þessa lykla|Til að gera þetta|
|-|-|
|<kbd>CTRL</kbd>+<kbd>heim</kbd>/<kbd>endir</kbd>|Fara á fyrstu/síðustu síðu|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a>Talnagrind
