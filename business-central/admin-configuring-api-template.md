...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a>Grunnstilla API-sniðmát
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>Uppsetning sniðmátseiningar
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>Úthluta sniðmátinu á API
