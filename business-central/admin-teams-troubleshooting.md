...
## <a name="unable-to-sign-in-to-the-share-to-teams-window"></a>Ekki er hægt að skrá sig inn í gluggann Samnýta í teymi
...
## <a name="others-see-a-different-sorting-or-column-layout-than-what-the-tab-author-sees"></a>Aðrir sjá aðra röðun eða dálkauppsetningu en það sem flipahöfundurinn sér
