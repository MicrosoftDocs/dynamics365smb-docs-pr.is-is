...
## <a name="the-sign-in-link-doesnt-work" />Innskráningartengillinn virkar ekki
...
## <a name="the-settings-page-is-empty" />Stillingasíðan er tóm
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />Ég skipti um fyrirtæki en það virtist ekki virka
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />Villan „Eitthvað fór úrskeiðis“ þegar leitað var að tengiliðum
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />„API fyrir tengilið/samantekt tengiliða finnst ekki“ villa við leit að tengiliðum
...
## <a name="none-of-my-links-expand-into-a-card" />Enginn af tenglunum mínum stækkar í spjald
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Tengillinn minn víkkar stundum ekki í spjald
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />Upplýsingaglugginn opnast en sýnir villu áður en upplýsingar eru sýndar
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />Vandamál kom upp með myndavélina eða staðsetningar í Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams sýnir ýmis tungumál fyrir mín spjöld og upplýsingar spjalds
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />Ég breytti reit í upplýsingaglugganum, en breytingin vistaðist ekki
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />Nýr reitur birtist í forritavalmyndinni. Hvernig fjarlægi ég þetta?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Afrita texta í glugganum Deila með Teams
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Get ekki skráð mig inn í gluggann Deila með Teams
...
## <a name="my-cards-no-longer-have-a-popout-button" />Spjöldin mín eru ekki lengur með sprettihnapp
...
## <a name="cant-pin-a-card-to-tab" />Ekki er hægt að festa spjald á flipa
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Einhver bætti við flipa en flipinn birtist ekki hjá mér
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />Aðrir sjá aðra röðun eða dálkaútlit en það sem höfundur flipans sér
