...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Setja upp forða fyrir verkefni
...
## <a name="to-set-up-a-resource" />að setja upp forða
...
## <a name="to-set-up-a-resource-group" />Að setja upp forðaflokk
...
## <a name="to-set-capacity-for-a-resource" />Að setja upp afkastagetu fyrir forða
...
## <a name="to-set-up-alternate-resource-costs" />Til að setja upp annan forðakostnað
...
## <a name="to-set-up-alternate-resource-prices" />Til að setja upp annað forðaverð
