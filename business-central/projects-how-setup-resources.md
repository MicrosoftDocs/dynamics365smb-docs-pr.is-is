...
ms.author: edupont
---
# <a name="set-up-resources-for-projects"></a><a name="set-up-resources-for-projects"></a>Setja upp forða fyrir verkefni
...
## <a name="to-set-up-a-resource"></a><a name="to-set-up-a-resource"></a>að setja upp forða
...
## <a name="to-set-up-a-resource-group"></a><a name="to-set-up-a-resource-group"></a>Að setja upp forðaflokk
...
## <a name="to-set-capacity-for-a-resource"></a><a name="to-set-capacity-for-a-resource"></a>Að setja upp afkastagetu fyrir forða
...
## <a name="to-set-up-alternate-resource-costs"></a><a name="to-set-up-alternate-resource-costs"></a>Til að setja upp annan forðakostnað
...
## <a name="to-set-up-alternate-resource-prices"></a><a name="to-set-up-alternate-resource-prices"></a>Til að setja upp annað forðaverð
