...
ms.author: solsen
---
# <a name="preview-posting-results"></a><a name="preview-posting-results"></a><a name="preview-posting-results"></a>Forskoða Bókunarniðurstöður
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a>forskoða fjárhagsfærslurnar sem verða til úr bókun á innkaupareikningi
