...
ms.author: edupont
---
# <a name="work-with-production-families" />Vinna með framleiðslusamsafn
...
## <a name="to-set-up-a-production-family" />Uppsetning framleiðslusamsafns
...
## <a name="to-produce-based-on-a-production-family" />Framleiðsla byggt á framleiðslusamsafni
