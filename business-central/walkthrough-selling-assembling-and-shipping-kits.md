...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits" />Kynning: Selja, setja saman og afhenda sett
...
### <a name="setting-up-assembly-items" />Uppsetning Samsetningaríhlutir.
...
### <a name="selling-customized-assembly-items" />Sala sérsniðinna samsetningaríhluta
...
### <a name="planning-for-assembly-items" />Áætlun fyrir samsetningaríhluti
...
### <a name="assembling-items" />Samsetning á vörum
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order" />Afhenda Samsetningarvörur úr Birgðir og Sett saman í pöntun
...
## <a name="prepare-sample-data" />Undirbúa sýnigögn
...
### <a name="creating-the-assembly-items" />Stofnun samsetningarvöru
...
### <a name="selling-the-assembly-items" />Sala samsetningaríhluta
...
### <a name="planning-for-the-unavailable-ats-items" />Áætlanir fyrir ótiltækar ATS-vörur
...
### <a name="assembling-and-shipping-the-first-ato-quantity" />Samsetning og afhending fyrsta ATO magns
...
### <a name="assembling-and-recording-the-second-ato-quantity" />Samsetning og skráning seinna ATO magns
...
### <a name="assembling-the-ats-quantity" />Samsetning ATS magns
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order" />Afhenda Eftirstandandi vörur, að hluta til úr birgðir og að hluta til úr sett saman í pöntun
