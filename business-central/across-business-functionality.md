...
[!INCLUDE[prod_short](includes/prod_short.md)] felur í sér staðlaðar grunnstillingar á flestum viðskiptaferlum en hægt er að breyta stillingum í samræmi við þarfir fyrirtækisins. Frá Mitt hlutverk er hægt að fá aðgang að uppsetningarleiðbeiningum sem hjálpa þér að stilla ákveðnar aðstæður og bæta eiginleikum við [!INCLUDE[prod_short](includes/prod_short.md)]. Nokkur svið viðskiptavirkni verður að setja upp handvirkt. Business [Central fljótlega byrja](quick-start-business-central.md) greinar hjálpa þér að taka fyrstu skrefin í átt að því að gera [!INCLUDE [prod_short](includes/prod_short.md)] þitt eigið. Frekari upplýsingar er að finna á [Setja upp [!INCLUDE[prod_short](includes/prod_short.md)]](setup.md).
...
|Stofna verkefni og tímasetja forða fyrir verkefni, vinna með verkáætlanir, fylgjast með framvindu og rekja vinnutíma véla og starfsmanna.|[Verkefnastjórnun](projects-manage-projects.md)|
|Skipuleggja eignirnar þínar, tryggðu réttar reglulegar afskriftir og fylgstu með kostnaði við viðhald.|[Eignir](fa-manage.md)|
|Vinna með og styðja við sölutilraunir og einbeita sér að viðskiptamönnum og tengiliðum sem ná til.|[Umsjón með venslum](marketing-relationship-management.md)|
...
|Setja upp og nota verkflæði sem tengja verk frá mismunandi notendum eða af kerfinu, t.d. sjálfvirk bókun. Beiðni og samþykki styrks til að stofna eða bóka skjöl eru dæmigerð verkflæðisskref.|[Verkflæði](across-workflow.md)|
