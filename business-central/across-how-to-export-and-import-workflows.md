...
ms.author: edupont
---
# <a name="export-and-import-approval-workflows" />Flytja samþykktarverkflæði inn og út
...
## <a name="export-a-workflow" />Flytja út verkflæði
...
## <a name="import-a-workflow" />Glytja inn verkflæði
