...
---
# <a name="use-automated-data-capture-systems-adcs" />Nota sjálfvirkt gagnatökukerfi (ADCS)
...
## <a name="to-enable-web-services-for-adcs" />Til að virkja vefþjónustu fyrir ADCS

Tila ð nota sjálfvirkt gagnatökukerfi þarf að virkja ADCS-vefþjónustu.  

## <a name="to-enable-and-publish-the-adcs-web-service" />Til að virkja og birta ADCS-vefþjónustuna
...
## <a name="to-set-up-a-warehouse-to-use-adcs" />að setja vöruhús upp fyrir notkun ADCS
...
## <a name="to-specify-an-item-to-use-adcs" />Tilgreina vöru til að nota ADCS
...
## <a name="to-add-an-adcs-user" />Til að bæta við ADCS notanda
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user" />Til að tilgreina að starfsmaður vöruhúss sé ADCS notandi
...
## <a name="to-create-and-customize-miniforms" />Hvernig á að búa til og sérsníða smáglugga
...
### <a name="to-create-a-miniform-for-adcs" />Til að búa til smáglugga fyrir ADCS
...
### <a name="to-customize-miniform-functions" />Til að sérsníða aðgerðir smáglugga
