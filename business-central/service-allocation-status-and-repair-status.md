...
ms.author: bholtorf
---
# <a name="allocation-status-and-repair-status-of-service-items" />Úthlutunarstaða og viðgerðarstaða
...
## <a name="changing-repair-status" />Viðgerðarstöðu breytt
...
## <a name="converting-service-quotes-to-service-orders" />Þjónustutilboði breytt í þjónustupöntun
...
## <a name="canceling-allocations" />Hætt við úthlutanir
...
## <a name="reallocating-an-active-allocation-entry" />Endurúthluta virkri úthlutnarfærslu
...
## <a name="reallocating-a-service-item" />Endurúthlutun þjónustuvöru
