...
# <a name="set-up-pricing-and-additional-costs-for-services" />Setja upp verðlagningu og aukakostnað fyrir þjónustu
...
## <a name="to-set-up-a-service-price-group" />Uppsetning þjónustuverðflokka
...
## <a name="to-set-up-a-service-price-adjustment-group" />Uppsetning þjónustuverðleiðréttingarflokka
...
## <a name="to-set-up-additional-costs-for-services" />Setja upp  aukakostnað fyrir þjónustu
...
### <a name="to-set-up-service-costs" />Setja upp þjónustukostnað
...
### <a name="to-specify-a-default-cost-for-service-orders" />Tilgreina sjálfgefinn kostnaðar vegna þjónustupantana
