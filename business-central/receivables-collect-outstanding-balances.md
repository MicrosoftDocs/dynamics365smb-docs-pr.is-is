...
ms.author: edupont
---
# <a name="collect-outstanding-balances"></a><a name="collect-outstanding-balances"></a>Innheimta útistandandi skuldir
...
## <a name="statements"></a><a name="statements"></a>Yfirlit
...
### <a name="to-send-the-customer-statement-report"></a><a name="to-send-the-customer-statement-report"></a>Til að senda yfirlitsskýrslu viðskiptamanns
...
## <a name="reminders"></a><a name="reminders"></a>Innheimtubréf

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges"></a><a name="finance-charges"></a>Vextir
...
### <a name="to-create-a-finance-charge-memo-manually"></a><a name="to-create-a-finance-charge-memo-manually"></a>Vaxtareikningar stofnaðir handvirkt:
...
### <a name="to-update-finance-charge-memo-texts"></a><a name="to-update-finance-charge-memo-texts"></a>Vaxtatexti uppfærður
...
### <a name="to-issue-finance-charge-memos"></a><a name="to-issue-finance-charge-memos"></a>Vaxtareikningar sendir út
...
### <a name="to-cancel-an-issued-finance-charge-memo"></a><a name="to-cancel-an-issued-finance-charge-memo"></a>Til að hætta við útgefinn vaxtareikning
...
### <a name="to-view-reminder-and-finance-charge-entries"></a><a name="to-view-reminder-and-finance-charge-entries"></a>Innheimtubréfa- og vaxtafærslur skoðaðar:
...
## <a name="multiple-interest-rates"></a><a name="multiple-interest-rates"></a>Margir vextir
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Sjá tengda [Microsoft þjálfun](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/)
