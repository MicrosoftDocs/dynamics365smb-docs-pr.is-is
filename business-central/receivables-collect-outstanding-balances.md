...
## <a name="reminders"></a>Áminningar

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges"></a>Vaxtagjöld
...
Þegar innheimtubréf er sent bóka færslurnar eftir því sem var tilgreint á síðunni **Vaxtaskilmálar** . Þessi lýsing ákvarðar hvort vextir og/eða viðbótargjöld bóka á reikning viðskiptamanns og fjárhag. Stillingar á síðunni **Bókunarflokkar viðskiptamanna** ákvarða reikningana sem vextir eða gjöld bóka á.
