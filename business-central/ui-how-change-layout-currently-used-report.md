...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Eldra) Velja útlit sem skýrslan notar
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />Til að breyta því hvaða skýrsluútlit á að nota fyrir skýrslu eða skjal
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />Til að breyta sérsniðnu útliti fyrir útlit skýrslu
