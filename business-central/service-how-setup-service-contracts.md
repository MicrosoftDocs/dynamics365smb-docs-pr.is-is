...
# <a name="set-up-service-contracts" />Setja upp þjónustusamninga
...
## <a name="to-set-up-a-service-contract-group" />Uppsetning þjónustusamningsflokka
...
## <a name="to-set-up-a-service-contract-account-group" />Uppsetning reikningsflokkaþjónustusamninga
...
## <a name="to-set-up-a-contract-template" />Uppsetning samningssniðmáts
...
## <a name="to-set-up-a-customer-template" />Uppsetning sniðmáts viðskiptamanns
