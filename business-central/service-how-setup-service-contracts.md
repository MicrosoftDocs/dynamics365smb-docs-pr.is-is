...
## Uppsetning reikningsflokkaþjónustusamninga  
...
3. Í reitnum **númer** er fært inn númer fyrir samningur sniðmát.  
     ...
     Hafi númeraröð fyrir samningssniðmát verið sett upp á síðunni **Þjónustukerfisgrunnur** er einnig hægt að velja <kbd>færslulykilinn</kbd> til að færa inn næsta tiltæka samningssniðmátsnúmer. Hinir reitirnir eru fylltir út, ef það á við.  
