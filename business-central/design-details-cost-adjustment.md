...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Hönnunarupplýsingar: kostnaðarleiðrétting
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Borin kennsl á leiðréttingu
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a>Birgðajöfnunarfærsla
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Færslustig meðalkostnaðarleiðréttingar
...
### <a name="order-level"></a><a name="order-level"></a>Pöntunarstig
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Handvirk samanborið við sjálfvirka kostnaðarleiðréttingu
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Leiðrétta kostnað - Birgðafærslur
...
#### <a name="value-entries-1"></a><a name="value-entries-1"></a>Virðisfærslur (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Tengslafærslur í fjárhag - tengslatafla fjárhagsbirgðabókar (1)
...
#### <a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a>Fjárhagsfærslur (1)
...
#### <a name="value-entries-2"></a><a name="value-entries-2"></a>Virðisfærslur (2)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Tengslafærslur í fjárhag - tengslatafla fjárhagsbirgðabókar (2)
...
#### <a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a>Fjárhagsfærslur (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Sjálfvirk kostnaðarleiðrétting
...
### <a name="example-1"></a><a name="example-1"></a>Dæmi
