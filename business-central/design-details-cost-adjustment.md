...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Hönnunarupplýsingar: kostnaðarleiðrétting
...
## <a name="detecting-the-adjustment" />Borin kennsl á leiðréttingu
...
### <a name="item-application-entry" />Birgðajöfnunarfærsla
...
### <a name="average-cost-adjustment-entry-point" />Færslustig meðalkostnaðarleiðréttingar
...
### <a name="order-level" />Pöntunarstig
...
## <a name="manual-versus-automatic-cost-adjustment" />Handvirk samanborið við sjálfvirka kostnaðarleiðréttingu
...
## <a name="adjust-cost---item-entries-batch-job" />Leiðrétta kostnað - Birgðafærslur
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1" />Tengslafærslur í fjárhag - tengslatafla fjárhagsbirgðabókar (1)
...
#### <a name="general-ledger-entries-1" />Fjárhagsfærslur (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2" />Tengslafærslur í fjárhag - tengslatafla fjárhagsbirgðabókar (2)
...
#### <a name="general-ledger-entries-2" />Fjárhagsfærslur (2)
...
## <a name="automatic-cost-adjustment" />Sjálfvirk kostnaðarleiðrétting
