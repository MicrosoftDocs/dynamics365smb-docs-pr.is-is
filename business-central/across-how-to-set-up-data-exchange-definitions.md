...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Setja upp skilgreiningar gagnaskipta
...
## <a name="create-a-data-exchange-definition" />Stofna gagnaskiptaskilgreiningu
...
## <a name="transformation-rules" />Umbreytingarreglur
...
### <a name="tip-for-developers-example-of-the-custom-option" />Ábending til þróunaraðila: Dæmi um sérstillta valkosti
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Flytja út gagnaskiptaskilgreiningu sem XML-skrá til afnota fyrir aðra
...
## <a name="import-an-existing-data-exchange-definition" />Flytja inn fyrirliggjandi gagnaskiptaskilgreiningu
