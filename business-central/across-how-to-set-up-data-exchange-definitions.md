...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions"></a><a name="set-up-data-exchange-definitions"></a><a name="set-up-data-exchange-definitions"></a>Setja upp skilgreiningar gagnaskipta
...
Venjulega eru gagnaskiptaskilgreiningar settar upp á síðunni **Gagnaskiptaskilgreining**. Til að uppfæra gengi gjaldmiðla er hins vegar fljótlegra að nota þjónustu fyrir gengi gjaldmiðils. Frekari upplýsingar er að finna í [Uppfæra gengi gjaldmiðla](finance-how-update-currencies.md#to-set-up-a-currency-exchange-rate-service).
...
## <a name="create-a-data-exchange-definition"></a><a name="create-a-data-exchange-definition"></a><a name="create-a-data-exchange-definition"></a>Stofna gagnaskiptaskilgreiningu
...
### <a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name=formatlinescolumns></a>Að lýsa sniði lína og dálka í skrá
...
### <a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name=mapfields></a>Að tengja dálka í gagnaskránni við reiti í [!INCLUDE[prod_short](includes/prod_short.md)]
...
Frá og með 2022 útgáfutímabili 2 er einnig hægt að flokka eftir hvaða reit sem er, nota lykilvísi til að raða niðurstöðum og nýju umbreytingagerðirnar **Sléttun** og **Uppfletting reits**.
...
## <a name="transformation-rules"></a><a name="transformation-rules"></a><a name="transformation-rules"></a>Umbreytingarreglur
...
### <a name="tip-for-developers-example-of-the-custom-option"></a><a name="tip-for-developers-example-of-the-custom-option"></a><a name="tip-for-developers-example-of-the-custom-option"></a>Ábending til þróunaraðila: Dæmi um sérstillta valkosti
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others"></a><a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others"></a><a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others"></a>Flytja út gagnaskiptaskilgreiningu sem XML-skrá til afnota fyrir aðra
...
## <a name="import-an-existing-data-exchange-definition"></a><a name="import-an-existing-data-exchange-definition"></a><a name="import-an-existing-data-exchange-definition"></a>Flytja inn fyrirliggjandi gagnaskiptaskilgreiningu
