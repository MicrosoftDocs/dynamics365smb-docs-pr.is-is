...
ms.author: edupont
---
# <a name="incoming-documents"></a><a name="incoming-documents"></a>Fylgiskjöl á innleið
...
## <a name="usage-scenario"></a><a name="usage-scenario"></a>Notkunarsvið
...
## <a name="incoming-document-features"></a><a name="incoming-document-features"></a>Eiginleikar skjals á innleið
