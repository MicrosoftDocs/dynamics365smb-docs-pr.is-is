...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a><a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a>Breyta árlegri upphæð þjónustusamnings eða samningstilboðs
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a>Árlegri upphæð þjónustusamnings eða samningstilboðs breytt:
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts"></a><a name="distributing-differences-between-new-and-calculated-annual-amounts"></a>Dreifing mismunar milli nýrrar og reiknaðrar árlegrar upphæðar
...
### <a name="even-distribution"></a><a name="even-distribution"></a>Jöfn dreifing
...
### <a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a>Drefing byggð á línuupphæð
...
### <a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a>Dreifing byggð á framlegð
...
#### <a name="example-2"></a><a name="example-2"></a>Dæmi
Gátreiturinn **Heimila ójafnaðar upphæðir** er ekki valinn í þjónustusamningnum sem inniheldur þrjár samningslínur með þessum upplýsingum.  
