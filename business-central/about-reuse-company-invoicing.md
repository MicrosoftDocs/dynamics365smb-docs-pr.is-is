...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Nota sama Microsoft 365-reikninginn í [!INCLUDE[prod_short](includes/prod_long.md)] og Microsoft Invoicing
...
## <a name="workaround"></a><a name="workaround"></a>Hjáleið
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Til að endurnefna fyrirtækið þitt
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a>Hvað með gögnin mín?
