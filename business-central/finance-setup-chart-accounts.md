...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts" />Setja upp eða breyta bókhaldslyklum
...
## <a name="add-or-change-accounts" />Bæta við eða breyta reikningum
...
## <a name="delete-accounts" />Eyða reikningum
...
## <a name="block-deletion-of-gl-accounts" />Útiloka eyðingu fjárhagsreikninga
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/chart-accounts-dynamics-365-business-central/index)
