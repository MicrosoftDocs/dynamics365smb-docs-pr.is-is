...
ms.author: jswymer
---
# <a name="closing-the-books"></a><a name="closing-the-books"></a><a name="closing-the-books"></a>Bókum lokað
...
## <a name="closing-book-process"></a><a name="closing-book-process"></a><a name="closing-book-process"></a>Ferli þess að loka bókum
...
## <a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a><a name="what-happens-when-you-close"></a>Hvað gerist þegar lokað er
