...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Vinna með standandi sölupantanir eða standandi innkaupapantanir
...
## <a name="to-create-a-blanket-sales-order" />Til að búa til standandi sölupöntun.
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Stofnun sölupöntunar úr standandi sölupöntun
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />Til að skoða stöðu standandi sölupöntunar:
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Hvernig á að skoða óbókaðar og bókaðar línur standandi sölupöntunar
