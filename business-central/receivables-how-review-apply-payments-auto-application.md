---
title: Skoða og jafna greiðslur handvirkt eftir sjálfvirka jöfnun
...
---
# <a name="review-and-apply-payments-manually-after-automatic-application"></a>Skoða og jafna greiðslur handvirkt eftir sjálfvirka jöfnun
...
Leiðrétting hagnaðar og taps sem krafist er vegna umreiknings gjaldmiðla er ekki sjálfkrafa unnin með [!INCLUDE[prod_short](includes/prod_short.md)].
...
7. Til að jafna hluta greiðslu við eina eða fleiri opnar færslur sem ekki eru til í gagnagrunninum skal stofna nýja línu undir línunni fyrir sama reikning. Í reitnum **Jöfnuð upphæð** skal færa inn upphæðina sem jafna á í nýju línuna, og leiðrétta síðan reitinn **Jöfnuð Upphæð** á línunni sem fyrir var.
