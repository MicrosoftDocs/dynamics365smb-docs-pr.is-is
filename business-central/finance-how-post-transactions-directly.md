...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Bóka færslu beint í Fjárhag
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Að bóka færslu beint í fjárhagsreikning
