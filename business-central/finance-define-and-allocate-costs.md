...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Skilgreina og úthluta kostnaði
...
## <a name="setting-up-allocation-source-and-targets" />Uppsetning uppruna og markhópa úthlutanna
...
### <a name="to-set-up-cost-allocations" />Til að setja upp kostnaðarúthlutanir
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Uppsetning afmarkanir fyrir Kvik úthlutunargrunnar.
...
### <a name="setting-filters" />Afmarkanir stilltar
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />Til að skilgreina PROD kostnaðarstað úthlutunarveitu á flýtiflipanum Almennt
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Til að skilgreina kostnaðarhluti úthlutunarmarks á flýtiflipanum Línur
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />Til að skilgreina kvikar úthlutanir sem byggja á vörum sem seldar voru á síðasta ári
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/allocate-costs-dynamics-365-business-central/)
