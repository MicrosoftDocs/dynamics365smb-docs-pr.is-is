...
ms.author: edupont
---
# <a name="add-companies-to-your-company-hub" />Bæta fyrirtækjum við fyrirtækjamiðstöðina
...
## <a name="environment-links" />Umhverfistenglar
...
## <a name="load-companies" />Hlaða fyrirtæki
