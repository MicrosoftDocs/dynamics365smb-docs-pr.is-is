...
# <a name="report-vat-to-tax-authorities" />Senda VSK skýrslu inn til skattayfirvalda
...
### <a name="submit-an-ec-sales-list-report" />Senda inn EB-söluyfirlitsskýrslu
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />Til að tengjast vefþjónustu skattayfirvalda býður
...
### <a name="to-set-up-vat-return-periods" />Að setja upp tímabil VSK-skila
...
## <a name="to-prepare-and-submit-a-vat-report" />Undirbúa og senda inn VSK-skýrslu
...
### <a name="vat-return-statuses" />Skilastöður VSK
...
## <a name="viewing-communications-with-your-tax-authority" />Skoða samskipti við skattayfirvöld
...
## <a name="submitting-vat-reports-manually" />Sendir inn VSK-skýrsla handvirkt
...
## <a name="vat-settlement" />VSK-uppgjör
...
## <a name="configuring-your-own-vat-reports" />Grunnstilla þínar eigin VSK skýrslur
