...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Senda VSK skýrslu inn til skattayfirvalda
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Um EC söluyfirlitsskýrslu
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Senda inn EB-söluyfirlitsskýrslu

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>Um skýrsluna um VSK skil
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Til að tengjast vefþjónustu skattayfirvalda býður
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Að setja upp VSK-skýrslur í [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Að setja upp tímabil VSK-skila
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Undirbúa og senda inn VSK-skýrslu
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Skilastöður VSK

Skil á VSK geta haft mismunandi stöður eins og lýst er í eftirfarandi töflu.

| Staða | Description |
|------------|-------------------------|
| Opinn | Þegar nýtt VSK-skil er stofnað. Hægt er að  **keyra aðgerðina leggja til línur** . Ef þörf er á að leiðrétta gildi er hægt að keyra  **aðgerðina leggja til línur**  aftur. Ekki er hægt að senda VSK-framtali sem hefur þessa stöðu. |
| Losað | Stöðunni verður breytt þegar úttektaraðgerðin  **er notuð** . [!INCLUDE[prod_short](includes/prod_short.md)] sýnir  **flýtiflipann villur og viðvaranir** . Ekki er hægt að breyta eða nota aðgerðir til að  **leggja til línur** . Til að gera breytingar þarf að opna aftur á VSK-reikning. |
| Hafnað | Ef inngjöfin heppnaðist ekki (til dæmis ef Sannvottun mistókst) breytist staðan í  **hafnað**. Ekki er hægt að opna aftur VSK-skil sem hefur þessa stöðu. |
| Sent inn | VSK-skilin eru send með því  **að nota senda**  aðgerðina eða eru merkt inn með því að nota merkið sem innsenda  **á**  aðgerðina. |
| Samþykkt | VSK-skilin hafa þessa stöðu ef skýrslan er merkt sem samþykkið með því að  **nota merkið sem samþykkta**  aðgerð.  **Ef VSK-vöruskilaskýrslan**  er merkt sem  **Samþykkt** er hægt að  **keyra útreiknað og bóka VSK-uppgjör** . |

## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Skoða samskipti við skattayfirvöld
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Sendir inn VSK-skýrsla handvirkt
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a><a name="vat-settlement"></a>VSK-uppgjör
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Grunnstilla þínar eigin VSK skýrslur
