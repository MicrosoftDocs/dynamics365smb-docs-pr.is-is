...
description: Læra að útbúa skýrslur sem sýna VSK af sölu á tímabili eða frá sölu og innkaupum og senda skýrsluna til skattyfirvalda.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
Þegar skattyfirvöld fara yfir skýrsluna sendir hann tengiliði fyrirtækisins tölvupóst. Í [!INCLUDE[prod_short](includes/prod_short.md)] er tengiliðurinn tiltekinn á síðunni **Upplýsingar um fyrirtækið**. Áður en þú sendir inn skýrsluna skaltu vera viss um að tengiliður hafi verið valinn.  
...
Ef fyrirtækið er ekki í Bretlandi skal nota **síðuna Tímabil** VSK-vöruskila til að setja upp tímasett VSK-skil. Ef fyrirtækið þitt er staðsett í Bretlandi, sjá [Tax Digital á Bretlandi](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md).  
...
1. Veldu ![Ljósapera sem opnar eiginleika Viðmótsleitar 3.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") Táknmynd, slá inn **ESB-sölulista** eða **VSK-vöruskil** og velja síðan viðeigandi tengja.  
