...
## <a name="to-create-a-permission-set"></a>Til að stofna heimildasamstæðu
...
## <a name="to-set-up-time-constraints-for-users"></a>Uppsetning tímatakmarkana fyrir notendur
