...
# <a name="assign-permissions-to-users-and-groups" />Úthluta leyfum til notenda og hópa
...
## <a name="to-create-a-permission-set" />Til að stofna heimildasamstæðu
...
### <a name="example---indirect-permission" />Dæmi - Óbein heimild
...
### <a name="to-add-other-permission-sets" />Til að bæta við öðrum heimildasettum
...
## <a name="to-copy-a-permission-set" />Til að afrita heimildasamstæðu
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Að stofna eða breyta heimildum með skráning við aðgerðir þínar
...
### <a name="to-export-and-import-a-permission-set" />Til að flytja út og flytja inn heimildasamstæðu
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Til að fjarlægja úreltar heimildir úr öllum heimildasamstæðum

Á síðunni **Heimildasamstæður** skal velja aðgerðina **Fjarlægja úreltar heimildir**.

## <a name="to-set-up-time-constraints-for-users" />Uppsetning tímatakmarkana fyrir notendur
...
## <a name="to-manage-permissions-through-user-groups" />Að stjórna heimildum í gegnum notendaflokka
...
### <a name="to-add-users-to-a-user-group" />Til að bæta notendum í notendahóp
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Til að afrita notendaflokk og öll heimildarsöfn
...
### <a name="to-assign-permission-sets-to-user-groups" />Til að úthluta leyfishópum á notendahópa
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Til að úthluta heimildasamstæðu á síðunni **Heimildasamstæða eftir notendahópum**
...
## <a name="to-assign-permission-sets-to-users" />Til að úthluta heimildasamstæðu á notendur
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Til að úthluta heimildasamstæðu á notendakorti
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Til að úthluta heimildasamstæðu á síðunni Heimildasamstæða eftir notanda
...
## <a name="to-get-an-overview-of-a-users-permissions" />Fá yfirlit yfir heimildir notanda
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Öryggissíur takmarka aðgang notanda að tilteknum færslum í töflu
...
## <a name="viewing-permission-changes-telemetry" />Skoða fjarmælingar heimildabreytinga
...
## <a name="delegated-admin-users" />Úthlutaðir stjórnendur
