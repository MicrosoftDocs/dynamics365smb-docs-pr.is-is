...
## Hefja sérstillingu á síðu með borðanum **Sérstilla**
...
## <a name="Actions"></a>Sérstilla aðgerðastiku og valmyndir
...
### Til að fjarlægja, fela og sýna aðgerðir og aðgerðaflokka
...
### Til að færa aðgerðir og aðgerðahópa
