...
ms.author: edupont
---
# <a name="suggest-vendor-payments" />Greiðslutillögur til lánardr.
...
## <a name="to-use-the-suggest-vendor-payments-function" />nota aðgerðina Greiðslutillögur til lánardrottna
...
## <a name="to-insert-the-due-date-as-posting-date-on-payment-journal-lines" />Setja inn skiladag sem bókunardagsetningu á greiðslubókarlínum
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/suggest-vendor-payments-dynamics-365-business-central/)
