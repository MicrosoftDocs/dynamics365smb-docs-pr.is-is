...
4. Velja hnappinn **Í lagi**. [!INCLUDE[prod_short](includes/prod_short.md)] töflum eru bætt við vinnublaðið. Hver færsla í listanum er með línugerðina **Tafla**.  
...
2.  Veljið aðgerðina **Gagnagrunnsgögn**.  
     ...
     [!INCLUDE[prod_short](includes/prod_short.md)] fyrir síðuna sem við á opnast.  
