...
ms.author: edupont
---
# <a name="why-a-page-is-locked-from-personalization"></a><a name="why-a-page-is-locked-from-personalization"></a>Af hverju er síða læst og því ekki hægt að sérsníða hana
...
## <a name="locked-from-personalizing"></a><a name="locked-from-personalizing"></a>Læst fyrir sérstillingar
...
### <a name="unlocking-the-page"></a><a name="unlocking-the-page"></a>Síða aflæst
...
## <a name="blocked-from-personalizing"></a><a name="blocked-from-personalizing"></a>Lokað fyrir sérstillingar
