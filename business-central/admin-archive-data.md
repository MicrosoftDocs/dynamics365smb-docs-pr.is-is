...
# <a name="the-data-archive-extension" />Viðbót gagnasafns
...
## <a name="start-archiving-data" />Hefja safnvistun gagna
...
## <a name="storage-considerations" />Hvað þarf að hafa í huga varðandi geymslu
