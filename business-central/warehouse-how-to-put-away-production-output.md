...
---
# <a name="put-away-production-or-assembly-output" />Ganga frá framleiðslu eða samsetningarfrálagi
...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />Að ganga frá framleiðsluúttaki með birgðafrágangi
...
### <a name="to-create-the-inbound-warehouse-request" />Stofna innleiðarbeiðni í vöruhúsi:
...
### <a name="to-put-output-away-with-an-inventory-put-away" />Gengið frá frálagi með Birgðafrágangi
...
## <a name="to-put-assembly-and-production-output-away-in-advanced-warehouse-configurations" />Að ganga frá samsetningu og framleiðsluúttaki í ítarlegum vöruhúsagrunnstillingum
