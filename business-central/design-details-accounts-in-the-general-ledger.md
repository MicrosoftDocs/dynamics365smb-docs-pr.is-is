...
ms.author: edupont
---
# <a name="design-details-accounts-in-the-general-ledger" />Hönnunarupplýsingar: reikningar í fjárhagur
...
## <a name="from-the-inventory-ledger" />Úr fjárhag birgða
...
## <a name="from-the-capacity-ledger" />Úr Afkastabók
...
## <a name="calculating-the-amount-to-post-to-the-general-ledger" />Útreikning á fjárhæð bóka á fjárhag
