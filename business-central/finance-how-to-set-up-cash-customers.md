...
ms.author: edupont
---
# <a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a>Uppsetning staðgreiðsluviðskiptamanna
...
## <a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a>Uppsetning staðgreiðsluviðskiptamanna
