---
title: Samnýting Business Central færslna í Microsoft Teams
...
# <a name="sharing-business-central-records-and-page-links-in-microsoft-teams"></a>Samnýting Business Central færslna og síðutengla í Microsoft Teams
...
5. Límið tengilinn (slóðina) í skilaboðagluggann þar sem skrifuð eru skilaboð.
    ...
    > [!NOTE]
    > Það fer eftir því hvort þú ert Business Central útgáfa, í fyrsta skipti sem þú límir tengil inn í samtal, getur þú verið beðinn að skrá þig inn [!INCLUDE [prod_short](includes/prod_short.md)] í og gefa samþykki fyrir forritinu til að sækja gögn. Fylgdu leiðbeiningunum á skjánum. Þú þarft aðeins að gera þetta skref einu sinni.
...
5. Í skilaboðaglugganum er tengill á síðuna. Ef [!INCLUDE [prod_short](includes/prod_short.md)] forritið fyrir Team er uppsett mun spjald fyrir tengdu færsluna eða síðuna einnig birtast í upplýsingareitnum.
