...
description: Læra að skipta vöruhúsaaðgerðalínum ef tiltæk afkastageta í hólfi sem lögð er til nægir ekki.
author: brentholtorf
ms.author: bholtorf
...
Eftirfarandi ferli á við um eftirfarandi vöruhúsaskjöl:
...
3. Á flýtiflipanum **Línur** skal velja aðgerðina **Aðgerðir**, velja aðgerðina **Aðgerðir** og loks velja aðgerðina **Skipta línu**. Ný lína birtist. Línan er afrit af upphaflegu línunni nema að í reitnum **Magn til afgreiðslu** er magnið sem var fjarlægt úr upphaflegu línunni.  
4. Úthluta hólfi og ef notaður er beinn frágangur og tínsla, svæði eða halda áfram að skipta línunni eftir þörfum þar til fundist hafa viðeigandi hólf fyrir allt magnið.  
