...
# <a name="allocate-resources"></a><a name="allocate-resources"></a>Úthluta forða
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes"></a><a name="to-see-an-overview-of-service-orders-and-service-quotes"></a>Yfirlit þjónustupantana/þjónustutilboða skoðað
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a><a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a>Forða úthlutað út frá forða eða forðaflokki til ráðstöfunar
...
## <a name="to-allocate-a-resource-using-a-service-order"></a><a name="to-allocate-a-resource-using-a-service-order"></a>Forða úthlutað út frá þjónustupöntun:
...
## <a name="to-reallocate-resources-on-a-service-order"></a><a name="to-reallocate-resources-on-a-service-order"></a>Forða endurúthlutað á þjónustupöntun
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board"></a><a name="to-reallocate-a-resource-using-the-dispatch-board"></a>Forða endurúthlutað út frá afgreiðslustöð
...
## <a name="to-register-resource-hours"></a><a name="to-register-resource-hours"></a>Forðastundir skráðar
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order"></a><a name="to-assign-a-resource-to-all-service-items-in-an-order"></a>Úthlutun forða til allrar þjónustuvöru í pöntun
...
## <a name="to-cancel-an-allocation"></a><a name="to-cancel-an-allocation"></a>Hætt við úthlutanir:
