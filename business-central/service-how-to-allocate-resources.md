...
# <a name="allocate-resources"></a><a name="allocate-resources"></a><a name="allocate-resources"></a>Úthluta forða
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes"></a><a name="to-see-an-overview-of-service-orders-and-service-quotes"></a><a name="to-see-an-overview-of-service-orders-and-service-quotes"></a>Yfirlit þjónustupantana/þjónustutilboða skoðað
...
3. Til að fá lista yfir skjöl sem innihalda þjónustuverk er tilteknum forða eða forðaflokki úthlutað  **í afmörkunarreitunum**  forðatafla  **og**  Forðaflokkur og velja  <kbd>ENTER</kbd>.  
4. Til að fá lista yfir skjöl með tiltekinni svardagsetningu eða svardagsetningum innan ákveðins dagsetningatímabils, skal fylla út reitinn Afmörkun  **svardagsetningar og velja**  Færa inn  <kbd>.</kbd>  
5. Ef fá á lista yfir fylgiskjöl með tiltekinni úthlutunarstöðu eða stöðu skjals skal fylla út  **reitinn Úthlutunarafmörkun/staða**  og velja  <kbd>Færa inn</kbd>.  
6. Til að fá lista yfir skjöl sem tilheyra tilteknum samningi, viðskiptamanni eða svæði skal fylla út  **reitinn Afmörkun samningssíu/viðskiptamanns/svæðis**  og velja  <kbd>Færa inn</kbd>.  
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a><a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a><a name="to-allocate-a-resource-using-resource-or-resource-group-availability"></a>Forða úthlutað út frá forða eða forðaflokki til ráðstöfunar
...
## <a name="to-allocate-a-resource-using-a-service-order"></a><a name="to-allocate-a-resource-using-a-service-order"></a><a name="to-allocate-a-resource-using-a-service-order"></a>Forða úthlutað út frá þjónustupöntun:
...
## <a name="to-reallocate-resources-on-a-service-order"></a><a name="to-reallocate-resources-on-a-service-order"></a><a name="to-reallocate-resources-on-a-service-order"></a>Forða endurúthlutað á þjónustupöntun
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board"></a><a name="to-reallocate-a-resource-using-the-dispatch-board"></a><a name="to-reallocate-a-resource-using-the-dispatch-board"></a>Forða endurúthlutað út frá afgreiðslustöð
...
6. Veljið  <kbd>Færa inn</kbd>. Svarglugginn **Ástæður endurúthlutunarfærslu** opnast og spyr hvort endurúthluta eigi þessari færslu. Fyllið út reitinn **Ástæðukóti** ef það á við og veljið hnappinn **Í lagi** til að staðfesta endurúthlutun.  
...
## <a name="to-register-resource-hours"></a><a name="to-register-resource-hours"></a><a name="to-register-resource-hours"></a>Forðastundir skráðar
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order"></a><a name="to-assign-a-resource-to-all-service-items-in-an-order"></a><a name="to-assign-a-resource-to-all-service-items-in-an-order"></a>Úthlutun forða til allrar þjónustuvöru í pöntun
...
## <a name="to-cancel-an-allocation"></a><a name="to-cancel-an-allocation"></a><a name="to-cancel-an-allocation"></a>Hætt við úthlutanir:
