...
# <a name="allocate-resources" />Úthluta forða
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes" />Yfirlit þjónustupantana/þjónustutilboða skoðað
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability" />Forða úthlutað út frá forða eða forðaflokki til ráðstöfunar
...
## <a name="to-allocate-a-resource-using-a-service-order" />Forða úthlutað út frá þjónustupöntun:
...
## <a name="to-reallocate-resources-on-a-service-order" />Forða endurúthlutað á þjónustupöntun
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board" />Forða endurúthlutað út frá afgreiðslustöð
...
## <a name="to-register-resource-hours" />Forðastundir skráðar
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order" />Úthlutun forða til allrar þjónustuvöru í pöntun
...
## <a name="to-cancel-an-allocation" />Hætt við úthlutanir:
