...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Flytja vörur í ítarlegar Vöruhúsaskilgreiningar sem nota beinan frágang og tínslu
...
## <a name="warehouse-movement-worksheet" />Vinnublað vöruhúsahreyfinga

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />Til að færa vörur með vöruhúsahreyfingarvinnublaðinu
...
### <a name="to-register-the-warehouse-movement" />Vöruhúsahreyfingin skráð
...
## <a name="internal-pick" />Innanhússtínslu

### <a name="to-create-an-internal-pick" />Að búa til Innahússtínslur
...
### <a name="to-register-the-warehouse-pick" />Vöruhúsatínsla skráð
...
## <a name="internal-put-away" />Frágangur innanhúss

### <a name="to-create-an-internal-put-away" />Stofna innanhússfrágang
...
### <a name="to-register-the-warehouse-put-away" />Frágangur vöruhúss skráður
...
## <a name="to-register-a-movement-that-has-already-happened" />Að skrá hreyfingu sem þegar hefur gerst
