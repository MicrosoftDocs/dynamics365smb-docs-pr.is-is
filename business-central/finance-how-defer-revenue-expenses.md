...
ms.author: edupont
---
# <a name="defer-revenues-and-expenses" />Fresta tekjum og öðrum útgjöldum
...
## <a name="to-set-up-a-gl-account-for-deferral" />Verð sett upp fyrir fjárhagsreikning verks:
...
## <a name="to-set-up-a-deferral-template" />Uppsetning sniðmáts viðskiptamanns
...
## <a name="to-assign-a-deferral-template-to-an-item" />Til að úthluta sérþekkingarkóða á vöru
...
## <a name="to-change-a-deferral-schedule-from-a-sales-invoice" />Til að breyta tímaáætlun deferral úr sölureikningi
...
## <a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger" />Til að forskoða hvernig deferred tekjur eða útgjöld verða bókaðar í fjárhag.
...
## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report" />Til að skoða bókaðar deferrals í skýrslunni Deferral yfirlit Yfir Sölu
...
## <a name="to-specify-a-period-in-which-to-allow-deferral-posting" />Tilgreina tímabil þar sem heimilt er að bóka frestun
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics--business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/processing-invoices-dynamics-365-business-central/)
