...
# <a name="consolidating-financial-data-from-multiple-companies" />Steypa saman fjárhagsgögnum frá mörgum fyrirtækjum
...
## <a name="use-the-consolidated-trial-balance-report" />Nota skýrsluna staða Prófstöðu samstæðunnar
...
## <a name="consolidate-data" />Gögnum steypt saman
...
### <a name="to-test-the-data-before-you-consolidate" />Gagnaprófun fyrir samsteypu
...
### <a name="run-the-consolidation" />Keyra samstæðu
...
## <a name="eliminate-repeated-transactions" />Taka út endurteknar færslur
...
## <a name="export-and-import-consolidated-data-between-databases" />Að flytja út og flytja inn sameinuð gögn milli gagnagrunna
