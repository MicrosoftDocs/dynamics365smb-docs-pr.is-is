...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Setja upp verð og afslætti
...
## <a name="setting-up-prices-and-discounts" />Uppsetning verðs og afsláttar
...
## <a name="about-price-lists" />Um verðlista
...
## <a name="set-up-prices" />Setja upp verð
...
## <a name="work-with-invoice-discounts-and-service-charges" />Vinna með afslætti Sölureiknings og Þjónustugjöld
...
## <a name="calculating-the-best-price" />Reikna út besta verðið
...
## <a name="see-related-microsoft-trainingtrainingmodulescustomer-discounts-dynamics-365-business-central" />Sjá tengda [Microsoft þjálfun](/training/modules/customer-discounts-dynamics-365-business-central/)
