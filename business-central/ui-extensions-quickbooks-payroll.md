...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension" />QuickBooks-viðbótin fyrir innflutning á launaskrá
...
## <a name="steps-to-import-payroll-data" />Skref til að flytja inn launagögn
