...
ms.author: jswymer
---
# <a name="working-with-rdlc-layouts"></a><a name="working-with-rdlc-layouts"></a>Vinna með RDLC-útlit
...
## <a name="required-tools"></a><a name="required-tools"></a>Nauðsynleg verkfæri
...
## <a name="create-and-modify-rdlc-layouts"></a><a name="create-and-modify-rdlc-layouts"></a>Stofna og breyta RDLC-útlitum
