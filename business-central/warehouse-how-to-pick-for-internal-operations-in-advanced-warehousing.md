...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Tínsla fyrir framleiðslu, samsetningu eða verk í ítarlegum vöruhúsastillingum
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Vörur tínslur til framleiðslupöntunar, samsetningarpöntun, vinnsla
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Birgðaveiðaíhlutir í ítarlegri samskipan vöruhúss
