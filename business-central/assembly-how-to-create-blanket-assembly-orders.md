...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Búa til standandi samsetningarpantanir
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Til að stofna standandi samsetningarpöntun fyrir samsetningu\-í\-vörupöntun
