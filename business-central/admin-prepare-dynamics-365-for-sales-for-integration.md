...
## <a name="integration-settings-that-are-specific-to-a--integration"></a>Stillingar samþættingar sem eiga sérstaklega við um [!INCLUDE[crm_md](includes/crm_md.md)]-samþættingu
