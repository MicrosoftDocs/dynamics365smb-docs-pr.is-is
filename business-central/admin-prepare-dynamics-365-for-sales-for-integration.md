...
## <a name="integrate-through-dataverse"></a>Samþætta í gegnum Dataverse
...
## <a name="integration-settings-that-are-specific-to-a--integration"></a>Samþættingarstillingar sem eru sértækar fyrir [!INCLUDE[crm_md](includes/crm_md.md)] samþættingu
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales"></a>Heimildir og öryggishlutverk fyrir notendareikninga í sölu
...
### <a name="connection-settings-in-the-setup-guide"></a>Tengistillingar í uppsetningarhandbókinni
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page"></a>Tengistillingar á síðunni Microsoft Dynamics 365 Connection Setup
...
### <a name="single-and-bi-directional-synchronization-of-sales-orders"></a>Einstök og tvíátta samstilling sölupantana
...
### <a name="standard-sales-entity-mapping-for-synchronization"></a>Venjuleg kortlagning sölueiningar fyrir samstillingu
...
## <a name="synchronize-items-and-resources-with-products-with-different-units-of-measure"></a>Samstilltu hluti og tilföng við vörur með mismunandi mælieiningar
...
### <a name="map-items-and-resources-to-products"></a>Kortaðu hluti og tilföng við vörur
...
### <a name="synchronization-jobs-for-a-sales-integration"></a>Samstillingarstörf fyrir sölusamþættingu
...
### <a name="default-synchronization-job-queue-entries"></a>Sjálfgefin færslur í vinnuröð fyrir samstillingu
...
## <a name="connect-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018"></a>Tengstu við staðbundnar útgáfur af Business Central 2019 útgáfubylgju 1 og Microsoft Dynamics NAV 2018
...
### <a name="connect-business-central-2019-release-wave-1-and-dynamics-nav-2018"></a>Connect Business Central 2019 útgáfubylgja 1 og Dynamics NAV 2018
