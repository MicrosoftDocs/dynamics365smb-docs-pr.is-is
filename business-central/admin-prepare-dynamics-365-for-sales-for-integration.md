...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Samþætting við Dynamics 365 Sales
...
## <a name="integrating-through-dataverse" />Samþætting í gegnum Dataverse
...
### <a name="connection-settings-in-the-setup-guide" />Tengingarstillingar í uppsetningarleiðbeiningum
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Stillingar tengingar á Uppsetning tengingar  Microsoft Dynamics 365
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Stöðluð einingavörpun Sales fyrir samstillingu
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Vörur og tilföng samstillt við afurðir með öðrum mælieiningum
...
### <a name="mapping-items-and-resources-to-products" />Varpa vörum og tilföngum í afurðir
...
### <a name="synchronization-jobs-for-a-sales-integration" />Samstillingarverk fyrir samþættingu Sales
...
### <a name="default-synchronization-job-queue-entries" />Sjálfgefnar Verkraðarfærslur samstillingar
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Tenging við staðbundnar útgáfur af Business Central 2019 útgáfutímabil 1 og Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Til að tengja Business Central 2019 útgáfutímabil 1 og Dynamics NAV 2018
