---
title: Stemma af greiðslur með sjálfvirkri jöfnun
...
9. Til að breyta handvirkri jöfnun skaltu velja færslubókarlínuna og svo skaltu velja **Jafna handvirkt** til að endurskoða, endurjafna eða jafna greiðsluna handvirkt á síðunni **greiðslujafnanir**. Nánari upplýsingar eru í [Skoða eða jafna greiðslur eftir sjálfvirka umsókn](receivables-how-review-apply-payments-auto-application.md).

10. Veljið ójafnaða greiðslubókarlínu fyrir ítrekaða inngreiðslu eða kostnað, eins og kaup bensín á bíl, og veljið síðan **Varpa texta á reikning** aðgerðina. Nánari upplýsingar eru [í Varpa texta um endurteknar greiðslur á reikninga fyrir sjálfvirka afstemmingu](receivables-how-map-text-recurring-payments-accounts-auto-reconcilliation.md).
...
12. Þegar ekki þarf að yfirfara fleiri línur og reiturinn **Mismunur** er auður í öllum línum skal velja aðgerðina **Bóka** og síðan velja einn af eftirfarandi valkostum:
    ...
    - **Bóka aðeins greiðslur** - Til að bóka greiðslurnar sem jafnaðar, en skilja tengdar færslur í höfuðbók bankareiknings eftir opnar. Þess krafist að bankareikningur sé stemmdur af sérstaklega, til dæmis: Nánari upplýsingar [eru í Afstemda bankareikninga](bank-how-reconcile-bank-accounts-separately.md).
