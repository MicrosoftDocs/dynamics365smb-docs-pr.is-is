...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Kynning: Framkvæmd söluherferðar
...
## <a name="setting-up-a-campaign" />Uppsetning herferðar
...
### <a name="to-set-up-a-campaign" />Uppsetning herferðar
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Stofnun hluta með viðeigandi tengiliðum
...
### <a name="to-save-your-segmentation-criteria" />Til að vista hlutaviðmiðin
...
## <a name="mining-the-data" />Gagnaskoðun
...
### <a name="to-remove-contacts-from-the-segment" />Tengiliðir fjarlægðir úr hluta
...
### <a name="to-bring-back-the-removed-contacts" />Til að sækja fjarlægða tengiliði
...
## <a name="linking-a-segment-to-a-campaign" />Hluti tengdur við herferð
...
### <a name="to-link-a-segment-to-the-campaign" />Tenging hluta við herferð
...
## <a name="sending-letters-and-email-messages-to-contacts" />Sending bréfa og tölvupósts til tengiliða
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Til að nota hluta til að senda bréf á tengilið
...
### <a name="to-send-an-email-message-to-a-contact" />Til að senda tölvupóstskeyti á tengilið
...
## <a name="registering-campaign-responses" />Skráning svara við herferð
...
### <a name="to-register-campaign-responses" />Skráning svara við herferð
