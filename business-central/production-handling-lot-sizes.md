...
# <a name="handling-lot-sizes-in-production" />Stjórna lotustærð í framleiðslu
...
## <a name="units-of-measure-in-production-bill-of-materials" />Mælieining í framleiðsluuppskrift
...
## <a name="lot-size-on-routing-lines" />Lotustærð í leiðarlínum
...
## <a name="lot-sizes-for-items-and-stockkeeping-units" />Lotustærðir fyrir vörur og birgðahaldseiningar
...
## <a name="lot-size-on-item-and-stockkeeping-units" />Lotustærð á vörum og birgðahaldseiningum
