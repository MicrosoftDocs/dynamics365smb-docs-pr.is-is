...
ms.author: edupont
---
# <a name="set-up-base-calendars"></a><a name="set-up-base-calendars"></a>Setja upp grunndagatöl
...
## <a name="to-set-up-a-base-calendar"></a><a name="to-set-up-a-base-calendar"></a>Uppsetning grunndagatals
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Útreikn. afhendingartíma
...
## <a name="to-customize-a-calendar"></a><a name="to-customize-a-calendar"></a>Dagatal sérsniðið:
...
## <a name="to-assign-a-base-calendar"></a><a name="to-assign-a-base-calendar"></a>Úthlutun grunndagatals
