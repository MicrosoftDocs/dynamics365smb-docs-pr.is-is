...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Setja upp grunndagatöl
...
## <a name="to-set-up-a-base-calendar" />Uppsetning grunndagatals
...
## <a name="lead-time-calculation" />Útreikn. afhendingartíma
...
## <a name="to-customize-a-calendar" />Dagatal sérsniðið:
...
## <a name="to-assign-a-base-calendar" />Úthlutun grunndagatals
