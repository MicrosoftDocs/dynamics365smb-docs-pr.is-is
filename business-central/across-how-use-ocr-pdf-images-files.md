...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />Nota OCR til að breyta PDF og myndaskrám í rafræn skjöl
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />Til að senda PDF eða myndaskrá til OCR þjónustu frá síðunni Skjöl á innleið
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />Til að senda PDF eða myndaskrá til OCR þjónustu með tölvupósti
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />Til að taka á móti viðkomandi rafrænt skjal frá OCR-þjónusta
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Stofna innkaupareikning út frá rafræna skjalinu mótteknu úr OCR
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />Til að varpa texta á tiltekinn lánardrottinn, fjárhag eða bankareikning
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Hvernig á að: Meðhöndla villur við móttöku rafrænna skjala
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />Þjálfa OCR-þjónustu til að forðast villur
