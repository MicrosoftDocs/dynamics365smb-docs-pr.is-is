...
ms.author: edupont
---
# <a name="run-full-planning-mps-or-mrp"></a><a name="run-full-planning-mps-or-mrp"></a>Keyra fulla áætlunargerð, MPS eða MRP
...
## <a name="methods-for-generating-a-plan"></a><a name="methods-for-generating-a-plan"></a>Aðferðir við stofnun áætlunar
...
## <a name="to-calculate-the-planning-worksheet"></a><a name="to-calculate-the-planning-worksheet"></a>Til að reikna áætlunarvinnublað:
...
## <a name="to-perform-action-messages"></a><a name="to-perform-action-messages"></a>Til að framkvæma aðgerðaboð
...
## <a name="action-messages"></a><a name="action-messages"></a>Aðgerðarboð
