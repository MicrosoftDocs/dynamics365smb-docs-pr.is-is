...
# <a name="switching-to-another-company-or-environment" />Skipta yfir í annað fyrirtæki eða umhverfi
...
## <a name="about-companies-and-environments" />Um fyrirtæki og umhverfi
...
## <a name="features-for-switching-company-or-environment" />Eiginleikar til að skipta um fyrirtæki eða umhverfi
...
## <a name="use-the-company-switcher" />Nota fyrirtækjaskipti
...
## <a name="use-the-app-launcher" />Nota forritavalmyndina
...
-->
## <a name="use-my-settings" />Nota mínar stillingar
...
## <a name="use-company-hub" />Nota fyrirtækjamiðstöð
