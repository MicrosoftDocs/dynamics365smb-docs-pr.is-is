...
## <a name="accountant-role-center" />Endurskoðandi Mitt hlutverk
...
## <a name="company-hub" />Fyrirtækjamiðstöð
...
#### <a name="to-add-your-accountant-as-a-guest-user" />Til að bæta endurskoðandanum sem gestanotanda
...
#### <a name="to-add-the-accountant-to-the-right-company" />Að bæta endurskoðandanum við rétt fyrirtæki
