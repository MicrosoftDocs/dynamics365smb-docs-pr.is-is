...
### <a name="determining-the-projected-inventory-level"></a>Ákvarða áætlað birgðastig
...
## <a name="stay-below-the-overflow-level"></a>Vertu undir yfirfallsmörkum
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a>Stofna áætlunarlínu með viðvörun um yfirflæði
...
#### <a name="composing-the-warning-message"></a>Að búa til viðvörunarskilaboð
