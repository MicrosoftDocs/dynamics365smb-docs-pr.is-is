...
---
# <a name="design-details-handling-reordering-policies" />Hönnunarupplýsingar: Meðhöndlun endurpöntunarstefnur
...
## <a name="the-role-of-the-reorder-point" />Hlutverk endurpöntunarmarks
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point" />Eftirlit með áætluðu birgðastigi og endurpöntunarmarki
...
### <a name="projected-inventory" />Áætlaðar birgðir
...
### <a name="projected-available-inventory" />Áætlaðar tiltækar birgðir
...
### <a name="time-buckets" />Tímarammar
...
### <a name="determining-the-projected-inventory-level" />Ákvarða áætlað birgðastig
...
## <a name="the-role-of-the-time-bucket" />Hlutverk tímarammans
...
## <a name="stay-below-the-overflow-level" />Vertu undir yfirfallsmörkum
...
### <a name="calculating-the-overflow-level" />Útreikningur á yfirflæðisstigi

Yfirflæðisstigið er reiknað á mismunandi vegu eftir endurpöntunarstefnu.  

#### <a name="maximum-qty" />Hámarksmagn
...
#### <a name="fixed-reorder-qty" />Fast endurpöntunarmagn
...
#### <a name="order-multiple" />Fjöldapanta
...
### <a name="creating-the-planning-line-with-an-overflow-warning" />Stofna áætlunarlínu með viðvörun um yfirflæði
...
#### <a name="calculating-the-planning-line-quantity" />Útreikningur á magni áætlunarlínu
...
#### <a name="defining-the-action-message-type" />Skilgreina tegund aðgerðaboða
...
#### <a name="composing-the-warning-message" />Að búa til viðvörunarskilaboð
...
### <a name="example-scenario" />Dæmi um atburðarás
...
#### <a name="item-setup" />Vöruuppsetning
...
#### <a name="situation-before-sales-decrease" />Staða fyrir söluminnkun
...
#### <a name="situation-after-sales-decrease" />Staða eftir söluminnkun
...
#### <a name="resulting-planning-lines" />Áætlunarlínur sem leiða
...
## <a name="handling-projected-negative-inventory" />Meðhöndlun áætlaðra neikvæðra birgða
...
## <a name="reordering-policies" />Endurpöntunarstefnur
...
### <a name="fixed-reorder-quantity" />Fast Endurpöntunarmagn
...
#### <a name="calculated-per-time-bucket" />Reiknaður fyrir hvern tímaramma
...
#### <a name="creates-only-necessary-supply" />Skapar aðeins nauðsynlegt framboð
...
#### <a name="combines-with-order-modifiers" />Sameinar með pöntunarbreyti
...
#### <a name="combines-with-calendars" />Sameinar við dagatöl
...
#### <a name="shouldnt-be-used-with-forecasts" />Ætti ekki að nota með spám
...
#### <a name="must-not-be-used-with-reservations" />Má ekki nota með frátekningum
...
### <a name="maximum-quantity" />Hámarksmagn
...
#### <a name="calculate-per-time-bucket" />Reikna á tímaramma
...
#### <a name="combine-with-order-modifiers" />Sameina við pöntunarbreyti
...
### <a name="combine-with-calendars" />Sameina við dagatöl
...
#### <a name="order-to-order-links-and-past-due-dates" />Tenglar til pöntunartengla og eldri Gjalddagar
...
### <a name="lot-for-lot" />Lota fyrir lotu
