...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Hönnunarupplýsingar: Meðhöndlun endurpöntunarstefnur
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>Hlutverk endurpöntunarmarks
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Eftirlit með áætluðu birgðastigi og endurpöntunarmarki
...
### <a name="projected-inventory"></a><a name="projected-inventory"></a><a name="projected-inventory"></a>Áætlaðar birgðir
...
### <a name="projected-available-inventory"></a><a name="projected-available-inventory"></a><a name="projected-available-inventory"></a>Áætlaðar tiltækar birgðir
...
### <a name="time-buckets"></a><a name="time-buckets"></a><a name="time-buckets"></a>Tímarammar
...
### <a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a>Ákvarða áætlað birgðastig
...
## <a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a>Hlutverk tímarammans
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Vertu undir yfirfallsmörkum
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Útreikningur á yfirflæðisstigi

Yfirflæðisstigið er reiknað á mismunandi vegu eftir endurpöntunarstefnu.  

#### <a name="maximum-qty"></a><a name="maximum-qty"></a><a name="maximum-qty"></a>Hámarksmagn
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Fast endurpöntunarmagn
...
#### <a name="order-multiple"></a><a name="order-multiple"></a><a name="order-multiple"></a>Fjöldapanta
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a>Stofna áætlunarlínu með viðvörun um yfirflæði
...
#### <a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a>Útreikningur á magni áætlunarlínu
...
#### <a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a>Skilgreina tegund aðgerðaboða
...
#### <a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a>Að búa til viðvörunarskilaboð
...
### <a name="example-scenario"></a><a name="example-scenario"></a><a name="example-scenario"></a>Dæmi um atburðarás
...
#### <a name="item-setup"></a><a name="item-setup"></a><a name="item-setup"></a>Vöruuppsetning
...
#### <a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a>Staða fyrir söluminnkun
...
#### <a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a>Staða eftir söluminnkun
...
#### <a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a>Áætlunarlínur sem leiða
...
## <a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a>Meðhöndlun áætlaðra neikvæðra birgða
...
## <a name="reordering-policies"></a><a name="reordering-policies"></a><a name="reordering-policies"></a>Endurpöntunarstefnur
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Fast Endurpöntunarmagn
...
#### <a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a>Reiknaður fyrir hvern tímaramma
...
#### <a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a>Skapar aðeins nauðsynlegt framboð
...
#### <a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a>Sameinar með pöntunarbreyti
...
#### <a name="combines-with-calendars"></a><a name="combines-with-calendars"></a><a name="combines-with-calendars"></a>Sameinar við dagatöl
...
#### <a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a>Ætti ekki að nota með spám
...
#### <a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a>Má ekki nota með frátekningum
...
### <a name="maximum-quantity"></a><a name="maximum-quantity"></a><a name="maximum-quantity"></a>Hámarksmagn
...
#### <a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a>Reikna á tímaramma
...
#### <a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a>Sameina við pöntunarbreyti
...
### <a name="combine-with-calendars"></a><a name="combine-with-calendars"></a><a name="combine-with-calendars"></a>Sameina við dagatöl
...
### <a name="order"></a><a name="order"></a><a name="order"></a>Pöntun
...
#### <a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a>Tenglar til pöntunartengla og eldri Gjalddagar
...
### <a name="lot-for-lot"></a><a name="lot-for-lot"></a><a name="lot-for-lot"></a>Lota fyrir lotu
