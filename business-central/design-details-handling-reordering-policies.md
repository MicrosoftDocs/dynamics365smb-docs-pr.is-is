...
### <a name="determining-the-projected-inventory-level"></a>Ákvörðun áætlaðs birgðastigs
...
## <a name="stay-below-the-overflow-level"></a>Halda sig undir yfirfallsmörkum
...
### <a name="calculating-the-overflow-level"></a>Útreikningur yfirflæðisstigs
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a>Áætlunarlínan stofnuð með yfirflæðisviðvörun
...
#### <a name="calculating-the-planning-line-quantity"></a>Magn áætlunarlínunnar reiknað
...
#### <a name="defining-the-action-message-type"></a>Skilgreining á gerð aðgerðaboða
...
#### <a name="composing-the-warning-message"></a>Semja viðvörunarskilaboðin
...
### <a name="example-scenario"></a>Dæmi um atburðarás
...
#### <a name="resulting-planning-lines"></a>Áætlunarlínur sem leiða
...
#### <a name="calculated-per-time-bucket"></a>Reiknaður fyrir hvern tímaramma
...
#### <a name="creates-only-necessary-supply"></a>Skapar aðeins nauðsynlegt framboð
...
#### <a name="combines-with-order-modifiers"></a>Sameinar með pöntunarbreyti
...
#### <a name="combines-with-calendars"></a>Sameinar við dagatöl
...
#### <a name="must-not-be-used-with-reservations"></a>Má ekki nota með frátekningum
...
#### <a name="calculate-per-time-bucket"></a>Reikna á tímaramma
...
#### <a name="combine-with-order-modifiers"></a>Sameina við pöntunarbreyti
...
### <a name="combine-with-calendars"></a>Sameina við dagatöl
...
#### <a name="order-to-order-links-and-past-due-dates"></a>Tenglar til pöntunartengla og eldri Gjalddagar
