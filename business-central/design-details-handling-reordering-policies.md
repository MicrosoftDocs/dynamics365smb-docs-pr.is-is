...
---
# <a name="design-details-handling-reordering-policies"></a>Upplýsingar um hönnun: Meðhöndlun endurpöntunarstefnu
...
#### <a name="situation-before-a-sales-decrease"></a>Aðstæður fyrir söluminnkun
