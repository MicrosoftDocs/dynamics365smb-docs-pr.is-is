...
---
# <a name="invoice-projects"></a>Reikningsfærsla verka
...
## <a name="to-create-multiple-project-sales-invoices"></a>Að búa til marga sölureikninga verks
...
## <a name="to-create-and-post-project-sales-invoice-from-project-planning-lines"></a>Að búa til og bóka sölureikninga verks úr verkáætlunarlínum
