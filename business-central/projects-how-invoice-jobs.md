...
ms.author: edupont
---
# <a name="invoice-jobs" />Reikningsfærsla verka
...
## <a name="to-create-multiple-job-sales-invoices" />Að búa til marga sölureikninga verks
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines" />Að búa til og bóka sölureikninga verks úr verkáætlunarlínum
