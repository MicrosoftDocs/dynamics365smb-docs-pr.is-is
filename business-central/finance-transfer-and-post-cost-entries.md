...
ms.author: edupont
---
# <a name="transferring-and-posting-cost-entries" />Flytja og bóka kostnaðarfærslur
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries" />Skilyrði til að millifærslu fjárhagsfærslna í kostnaðarfærslur
...
## <a name="transferring-general-ledger-entries-to-cost-entries" />Flytja fjárhagsfærslur í kostnaðarfærslur
...
### <a name="to-prepare-the-transfer" />Til að undirbúa færsluna
...
### <a name="to-transfer-general-ledger-entries-to-cost-entries" />Til að færa fjárhagsfærslur yfir í kostnaðarfærslur
...
## <a name="automatic-transfer-and-combined-entries" />Sjálfvirkur flutningur og færslur sameinaðar
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries" />Niðurstöður millifærslu fjárhagsfærslna yfir í kostnaðarfærslur
...
### <a name="general-ledger-entries" />Fjárhagsfærslur
...
### <a name="cost-entries" />Kostnaðarfærslur
...
### <a name="cost-register" />Kostnaðarskráning
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/transfer-gl-entries-dynamics-365-business-central/)
