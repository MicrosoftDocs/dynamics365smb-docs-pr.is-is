---
title: Flutningur og bókun kostnaðarfærslna
...
Fjárhagur færslur eru ekki fluttar ef:  

- Færslurnar hafa víddargildi sem samsvara ekki kostnaðarstöð eða kostnaðarhlut.  
- Færslurnar hafa upphæð núll.  
- Færslurnar hafa fjárhagsreikning sem hefur verið eytt.  
- Færslurnar hafa fjárhagur reikning sem er ekki af tegundinni **Rekstrarreikningur**.  
- Færslurnar eru með fjárhagur reikning sem ekki hefur verið úthlutað kostnaðartegund.  
