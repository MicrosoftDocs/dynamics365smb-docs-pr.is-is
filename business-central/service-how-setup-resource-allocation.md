...
# <a name="set-up-resource-allocation" />Setja upp forðaúthlutun
...
## <a name="to-set-up-skills" />Uppsetning á hæfni
...
## <a name="to-assign-skills-to-service-items-and-resources" />Úthluta hæfni til þjónustuvöru og tilfanga
...
## <a name="to-set-up-zones" />Setja upp svæði
...
## <a name="to-assign-zones-to-customers-and-resources" />Úthluta svæðum til viðskiptamanna og tilfanga
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen" />Tilgreina hvað á að sýna þegar tilfang er valið
...
## <a name="to-update-resource-capacity" />Uppfæra Forðageta
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />Uppfæra hæfni fyrir vörur, þjónustuvörur, eða þjónustuvöruflokka
