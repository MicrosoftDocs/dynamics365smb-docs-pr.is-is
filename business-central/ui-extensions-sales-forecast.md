...
# <a name="the-sales-and-inventory-forecast-extension" />Spá um sölu og birgðir viðbótina
...
## <a name="setting-up-forecasting" />Spáruppsetning
...
## <a name="use-the-forecasts" />Nota spár
...
### <a name="data-required-for-forecast" />Gögn eru nauðsynleg fyrir forspá
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Búa til og nota eigin forspárþjónustu á netinu fyrir sölu- og birgðaspá
