...
## <a name="keyboard-shortcuts-in-lists" />Flýtivísanir í listum
...
## <a name="keyboard-shortcuts-in-cards-and-documents" />Flýtilyklar í spjöldum og skjölum
...
## <a name="keyboard-shortcuts-in-date-fields" />Flýtilyklar í gagnareitum
...
## <a name="access-keys-for-action-bar-and-navigation-menu" />Aðgangslyklar fyrir aðgerðrein og Navigation valmynd
