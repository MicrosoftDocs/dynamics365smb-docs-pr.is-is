...
# <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Flýtivísanir
...
## <a name="overview"></a><a name="overview"></a>Yfirlit
...
## <a name="general-keyboard-shortcuts"></a><a name="general-keyboard-shortcuts"></a><a name="Keyboard"></a> Almennar flýtivísanir
...
## <a name="keyboard-shortcuts-in-lists"></a><a name="keyboard-shortcuts-in-lists"></a>Flýtivísanir í listum
...
-->
### <a name="general"></a><a name="general"></a>Almennt
...
### <a name="navigating-between-rows-and-columns"></a><a name="navigating-between-rows-and-columns"></a><a name="navigateshortcuts"></a>Flett milli raða og dálka
...
### <a name="selecting-copying-and-pasting"></a><a name="selecting-copying-and-pasting"></a><a name="CopyRows"></a>Val, afritun og líming
...
### <a name="searching-and-filtering-lists"></a><a name="searching-and-filtering-lists"></a><a name="KeyboardFilter"></a>Leit og síun lista
...
## <a name="keyboard-shortcuts-in-cards-and-documents"></a><a name="keyboard-shortcuts-in-cards-and-documents"></a>Flýtilyklar í spjöldum og skjölum
...
## <a name="quick-entry-shortcuts-for-fields"></a><a name="quick-entry-shortcuts-for-fields"></a><a name="QuickEntry"></a>Flýtileiðir flýtifærslu fyrir reiti
...
## <a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="calendarshortcuts"></a> Flýtivísanir í dagatalinu (Dagsetningarval)
...
## <a name="keyboard-shortcuts-in-date-fields"></a><a name="keyboard-shortcuts-in-date-fields"></a>Flýtilyklar í gagnareitum
...
## <a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="reportpreviewshortcuts"></a>Flýtivísanir í forskoðun skýrslu
...
## <a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="zoomshortcuts"></a>Flýtilyklar fyrir aukinn eða minnkaðan aðdrátt
...
## <a name="keyboard-shortcuts-for-role-explorer"></a><a name="keyboard-shortcuts-for-role-explorer"></a><a name="roleexplorer"></a>Flýtilyklar fyrir Hlutverkaleit
...
## <a name="numeric-keypad-shortcuts"></a><a name="numeric-keypad-shortcuts"></a><a name="keypad"></a> Flýtileiðir talnaborðs
...
## <a name="access-keys-for-action-bar-and-navigation-menu"></a><a name="access-keys-for-action-bar-and-navigation-menu"></a>Aðgangslyklar fyrir aðgerðrein og Navigation valmynd
