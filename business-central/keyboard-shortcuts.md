...
|<kbd>Alt</kbd>+<kbd>Q</kbd><br /><br />(<kbd>Ctrl</kbd>+<kbd>valkostur</kbd>+<kbd>Q</kbd>)|Opnaðu gluggann **Viðmótsleið**. Frekari upplýsingar er að finna í [Finna síður og upplýsingar með „Segðu mér“](ui-search.md).|
...
|<kbd>Alt</kbd>+<kbd>hægri ör</kbd>|Fletta upp viðbótarupplýsingum eða undirliggjandi gildum fyrir reit sem inniheldur ![AssistEdit](media/assist-edit-icon.png "AssistEdit hnappur"). hnappur. Notað þegar venjulegur fellilistahnappur (<kbd>Alt</kbd>+<kbd>Down Arrow</kbd>) í sama reit er notaður í öðrum tilgangi.|
|<kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>vakt</kbd>+<kbd>C</kbd>|Birta upplýsingar í merki fyrirtækis. Byrjað er á Business Central 2022 útgáfubylgju 2 (útgáfa 21, þessi flýtivísun er ekki lengur studd í stað <kbd>Ctrl</kbd>+<kbd>O</kbd>. |
...
|<kbd>Y</kbd> og <kbd>N</kbd>|Ræsa hnappana **Já** og **Nei** í svargluggum. Raunlyklar eru breytilegir eftir því hvaða tungumál er tilgreint í **Mínar stillingar**. Til dæmis má velja <kbd>J</kbd> til að ræsa hnappinn **Ja** þegar þýska er notuð.|
...
| Þessir lyklar eru valdir<br />(í macOS) | Til að gera þetta í listayfirliti | Til að gera þetta í reitayfirliti |
|--|--|--|
| <kbd>Ctrl-heimili</kbd>+<kbd></kbd><br /><br />(<kbd>Fn</kbd>+<kbd>Ctrl</kbd>+<kbd>Vinstri ör</kbd>) | Veldu fyrstu röðina í listanum; fókusinn helst í sama dálknum. | Fara yfir í fyrsta reit í fyrstu röð. |
| <kbd>Ctrl-lok</kbd>+<kbd></kbd><br /><br />(<kbd>Fn</kbd>+<kbd>Ctrl</kbd>+<kbd>Hægri ör</kbd>) | Veldu síðustu röðina í listanum; fókusinn helst í sama dálknum. | Fara í síðasta reitinn í síðustu línunni. |
| <kbd>Heim</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>vinstri ör</kbd>) | Fara í fyrsta reitinn í línunni. | Fara í fyrsta svæðið í línunni. |
| <kbd>Endir</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>hægri ör</kbd>) | Færðu í síðasta reitinn í röðinni. | Fara í síðasta reitinn í línunni. |
...
| <kbd>Síða upp</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>upp ör</kbd>) | Skruna til að birta samstæðuraðir fyrir ofan núverandi línur í yfirliti. | Skrunar til að birta hóp flísa fyrir ofan núverandi flísar í yfirliti. |
| <kbd>Síða niður</kbd><br /><br />(<kbd>Fn</kbd>+<kbd>niðurör</kbd>) | Skruna til að birta samstæðuraðir fyrir neðan núverandi línur í yfirliti. | Skruna til að birta hóp flísa fyrir neðan núverandi flísar í yfirliti. |
...
|Þessir lyklar eru valdir<br />(í macOS)|Til að gera þetta í listayfirliti |Til að gera þetta í reitayfirliti |
|--------------------------------|--------------------------|--------------------------|
|<kbd>Ctrl</kbd>+Smella<br /><br />(<kbd>Cmd</kbd>+Smellt)|Stækka valið af línum til að hafa með línuna sem var smellt á.|Á ekki við.|
|<kbd>Shift</kbd>+Smella|Stækka valið af línum til að hafa með línuna sem var smellt á og allar línurnar á milli.<br /><br />Hægt er að nota þetta eftir notkun <kbd>Ctrl</kbd>+<kbd>Uppör</kbd> eða <kbd>Ctrl-niðurör</kbd>+<kbd></kbd> til að stækka valið.|Á ekki við.|
...
|<kbd>Ctrl</kbd>+<kbd>niðurör</kbd><br /><br />(<kbd>Ctrl</kbd>+<kbd>Cmd niðurör</kbd>+<kbd></kbd>)|Færið áhersluna á línuna fyrir neðan og hafið áfram núverandi línu valda.|Á ekki við.|
|<kbd>Ctrl-bilsstika</kbd>+<kbd></kbd><br /><br />(<kbd>Ctrl</kbd>+<kbd>Cmd</kbd>+bil)|Stækkið valið af línum til að hafa með línu sem áherslan er á.<br /><br />Hægt er að nota þetta eftir notkun <kbd>Ctrl</kbd>+<kbd>Uppör</kbd> eða <kbd>Ctrl-niðurör</kbd>+<kbd></kbd> til að stækka valið.|Á ekki við.|
|<kbd>Ctrl</kbd>+<kbd>A</kbd>|Velja allar línur.|Á ekki við.|
|<kbd>Ctrl</kbd>+<kbd>C</kbd><br /><br />Ég býð<kbd>upp</kbd>+<kbd>á 1000.000.</kbd>|Afritaðu valdar raðirnar yfir á klippiborðið.|Já, en aðeins fyrir einn valinn reit.|
|<kbd>Ctrl</kbd>+<kbd>V</kbd><br /><br />Ég biđst<kbd>afsléttingar.</kbd>+<kbd></kbd>|Límdu valdar raðir úr klippiborðinu inn í núverandi síðu eða ytri skjal, eins og Microsoft Excel eða Outlook tölvupóst. Þú getur aðeins gert þetta í breytanlegum listum.|Á ekki við.|
...
|<kbd>Vaktasíða</kbd>+<kbd>upp</kbd><br /><br />(<kbd>Vakt</kbd>+<kbd>Fn</kbd>+<kbd>upp ör</kbd>)|Stækkið valið af línum til að hafa með allar sýnilegar línur fyrir ofan núverandi val af línum.|Á ekki við.|
...
|<kbd>Vakt</kbd>+<kbd>Alt</kbd>+<kbd>F3</kbd>|Opnaðu afmörkunarsvæðið og bættu afmörkun við valinn dálk í listanum. Áhersla er lögð á nýja síureitinn sem leyfir að byrja að slá inn síuviðmiðin strax.<br /><br /> Þetta gerir það sama og að velja **Sía** úr dálkahausnum.<br /><br />Ef afmörkun er þegar til í reitnum er nýrri afmörkun bætt við. |
...
|<kbd>Alt</kbd>+<kbd>F6</kbd>|Fella saman/stækka fyrir gildandi flýtiflipa<kbd></kbd> eða hluta (undirsíðu).|
...
|<kbd>Alt</kbd>+<kbd>Vakt</kbd>+<kbd>V</kbd> |Opnið núverandi spjald eða skjal í nýjum glugga. Frekari upplýsingar er að finna í [Fjölvinnsla þvert á margar síður](ui-enter-data.md#multitasking-across-multiple-pages).|
...
|<kbd>F6</kbd>|Færa á næsta flýtiflipa<kbd></kbd> eða hluta (undirsíða).|
...
|<kbd>Vakt</kbd>+<kbd>F6</kbd>|Færa á fyrri flýtiflipa<kbd></kbd> eða hluta (undirsíðu).|
...
Eftirfarandi flýtileiðir eiga við um eiginleika flýtifærslu í spjöldum, skjölum og listasíðum. Ekki er hægt að nota flýtivísanirnar þegar listinn er í reitayfirlitinu. Nánari upplýsingar um flýtifærslu er að finna í [Hröðun gagnaskráningu með flýtifærslu](ui-enter-data.md#QuickEntry).

|Þessir lyklar eru valdir<br />(í macOS)|Til að gera þetta|Athugasemdir|
|--------------------------------|----------|-------|
...
|<kbd>Ctrl-heimili</kbd>+<kbd></kbd><br /><br />(<kbd>Cmd heimili</kbd>+<kbd>)</kbd>|Fara í núverandi mánuð, núverandi dag.|
...
|<kbd>Ctrl</kbd>+<kbd>upp ör</kbd><br /><br />(<kbd>Ör upp á cmd</kbd>+<kbd>upp</kbd>)|Fara í fyrri viku, sama vikudag.|
|<kbd>Ctrl</kbd>+<kbd>niðurör</kbd><br /><br />(<kbd>Ör niður</kbd>+<kbd>með CMD</kbd>)|Fara í næstu viku, sama vikudag.|
|<kbd>Færa inn</kbd>|Velja áhersludaginn.|
|<kbd>Ctrl-lok</kbd>+<kbd></kbd><br /><br />(<kbd>Cmd lok</kbd>+<kbd></kbd>)|Loka dagatalinu og eyða núverandi dagsetningu.|
...
|<kbd>Ctrl</kbd>+<kbd>0</kbd> (núll)<br /><br />Ég sé<kbd>ekki eftir neinu</kbd>+<kbd>.</kbd>|Passar allri síðunni á síðunni. |
|<kbd>Ctrl-heimili</kbd>+<kbd></kbd><br /><br />(<kbd>Cmd heimili</kbd>+<kbd>)</kbd>|Fara á fyrstu síðu skýrslunnar.|
|<kbd>Ctrl-lok</kbd>+<kbd></kbd><br /><br />(<kbd>Cmd lok</kbd>+<kbd></kbd>)|Fara á síðustu síðu skýrslunnar.|
...
Aðgangslyklar eru flýtivísanir sem velja ákveðnar aðgerðir á aðgerðastikunni og yfirlitsvalmyndinni og gera notanda kleift að fletta í gegnum aðgerðir til að komast á síðuna sem óskað er eftir. Aðgangslyklar eru í boði í Business Central vefbiðlaranum og líkjast aðgangslyklum í Excel og Word Online.  
...
![Mynd sem sýnir aðgangslykla á listasíðu viðskiptamanns.](media/access-keys.png) 
