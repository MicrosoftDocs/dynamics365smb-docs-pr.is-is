...
ms.author: bholtorf
---
# <a name="work-with-responsibility-centers" />Vinna með ábyrgðarstöðvar
...
## <a name="to-set-up-a-responsibility-center" />Uppsetning ábyrgðarstöðva
...
## <a name="to-assign-responsibility-centers-to-users" />Að úthluta ábyrgðarstöðvum til notenda:
