...
ms.author: edupont
---
# <a name="manage-job-supplies" />Stjórna verkbirgðum
...
## <a name="to-purchase-items-or-services-for-a-job" />Að kaupa vörur eða þjónustu fyrir verk
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Til að skoða virði innkaupa fyrir verk
...
## <a name="to-post-a-job-related-expense" />Til að bóka verktengdan kostnað
