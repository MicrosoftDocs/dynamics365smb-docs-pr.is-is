...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Stjórna verkbirgðum
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Að kaupa vörur eða þjónustu fyrir verk
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Til að skoða virði innkaupa fyrir verk
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Til að bóka verktengdan kostnað
