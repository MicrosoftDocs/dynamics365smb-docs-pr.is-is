...
ms.author: bholtorf
---
# <a name="onedrive-for-business-faq" />Algengar spurningar um OneDrive for Business
...
## <a name="is-onedrive-the-same-as-sharepoint-for-storing-files" />Er OneDrive sama og SharePoint fyrir varðveislu skráa?
...
## <a name="are-all-onedrive-for-business-plans-supported" />Er allar áskriftarleiðir OneDrive for Business studdar?
...
## <a name="where-can-i-see-onedrive-service-health" />Hvar get ég séð OneDrive Service Health?
...
## <a name="how-does-this-work-in-an-organization-with-multiple-environments" />Hvernig virkar þetta í fyrirtæki með mörgum umhverfum?
...
## <a name="weve-changed-company-name-what-happens-to-my-previous-files" />Við höfum breytt heiti fyrirtækis. Hvað verður um gömlu skrárnar mínar?
...
## <a name="i-want-to-open-files-in-sharepoint-instead-how-do-i-do-this" />Í staðinn vil ég opna skrár í SharePoint. Hvernig geri ég það?
...
## <a name="how-do-i-turn-off-integration-to-onedrive" />Hvernig slekk ég á samþættingu í OneDrive?
...
## <a name="should-i-use-the-sharepoint-connection-setup-page-to-connect-to-sharepoint" />Ætti ég að nota SharePoint uppsetningarsíðu tengingar til að tengjast við SharePoint?
...
## <a name="will-microsoft-continue-to-improve-the-integration-to-onedrive" />Heldur Microsoft áfram að bæta samþættinguna í OneDrive?
...
### <a name="business-central-cant-find-my-onedrive" />Business Central finnur ekki OneDrive
...
### <a name="im-having-problems-sharing-from-outlook" />Ég á í vandræðum með að deila úr Outlook
...
### <a name="actions-open-in-onedrive-and-share-are-missing" />Það vantar aðgerðirnar opna í OneDrive og deila
