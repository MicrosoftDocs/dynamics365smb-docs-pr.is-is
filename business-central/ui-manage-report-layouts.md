...
* Sérstilla útlit
  ...
  Sérsniðin útlit eru einnig útlit sem notendur búa til. Munurinn er sá að þessi útlit eru búin til á eldri síðunni **Sérsniðin skýrsluútlit** og þau geta bara verið af Word- eða RDLC-gerðinni. Þó að samt sé hægt að búa til sérsniðin útlit er verið að setja þau í hag í þágu notendaskilgreindra útlita (sjá að ofan).
