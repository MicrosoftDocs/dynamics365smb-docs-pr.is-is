...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Yfirlit yfir skýrslu- og skjalaútlit
...
## <a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a>Útlitsgerðir
...
### <a name="external"></a><a name="external"></a><a name="external"></a>Ytri
...
## <a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a>Útlitsupprunar
