...
* Sérstilla útlit
  ...
  Sérsniðin útlit eru einnig útlit sem notendur búa til. Munurinn er sá að þessi útlit eru búin til á eldri síðunni **Sérsniðin skýrsluútlit** og þau geta bara verið af Word- eða RDLC-gerðinni. Þó að þú getir samt búið til sérsniðnar útlit, þá er verið að hætta þeim í áföngum í þágu notendaskilgreindra útlita (sjá hér að ofan).
