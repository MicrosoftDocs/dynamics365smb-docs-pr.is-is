...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-manually" />Kynning: Handvirk áætlun birgða
...
## <a name="setting-up-the-sample-data" />Uppsetning sýnigagna
...
## <a name="use-the-order-planning-page" />Nota síðuna Pantanaáætlun
...
### <a name="to-use-the-order-planning-page" />Að nota síðuna „Pantanaáætlun“
...
## <a name="planning-a-purchase-order-to-fulfill-component-demand" />Innkaupapöntun áætluð til að uppfylla eftirspurn íhluta
 Í þessu ferli er stofnuð innkaupapöntun fyrir íhluti sem þarf til framleiðslunnar.  

### <a name="to-plan-a-purchase-order-to-fulfill-component-need-in-production" />Til að áætla innkaupapöntun til að uppfylla þörf á íhlutum fyrir framleiðslu
...
## <a name="planning-a-transfer-order-to-fulfill-sales-demand" />Millifærslupöntun áætluð til að uppfylla eftirspurn sölu
...
### <a name="to-plan-a-transfer-order-to-fulfill-sales-demand" />Áætlun um millifærslupöntun til að uppfylla eftirspurn sölu
...
## <a name="planning-a-multilevel-production-order-to-fulfill-sales-demand" />Margþrepa millifærslupöntun áætluð til að uppfylla eftirspurn sölu
...
### <a name="to-plan-multilevel-production-to-fulfill-sales-demand" />Að áætla margra þrepa framleiðslu til að uppfylla eftirspurn sölu
...
### <a name="to-plan-a-specific-production-order" />Til að áætla sérstaka röð framleiðslupöntunar
