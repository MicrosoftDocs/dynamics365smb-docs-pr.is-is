...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Vinna með þjónustusamninga og þjónustusamningstilboð
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>Að stofna þjónustusamning eða þjónustusamningstilboð:
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>Þjónustusamningstilboði breytt í þjónustusamning:
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Til að búa til Samningsþjónustukreditreikninga
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Uppfærsla og mat á samningum
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Samningslínum bætt við þjónustusamning eða samningstilboð:
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>Samningslínur fjarlægðar
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Kostnaður og gildi þjónustulínu
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Samningsafslætti bætt við þjónustusamningstilboð
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>Skipt um eiganda þjónustusamninga:
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>Til að uppfæra verð þjónustusamninga
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Bókun fyrirframgreiddra samningsfærslna
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Breyting á þjónustusamningsstöðu
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>Afturköllun þjónustusamnings:
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Skráning þjónustusamning eða samningstilboðs
