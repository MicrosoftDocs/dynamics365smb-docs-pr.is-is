...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Vinna með þjónustusamninga og þjónustusamningstilboð
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />Að stofna þjónustusamning eða þjónustusamningstilboð:
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />Þjónustusamningstilboði breytt í þjónustusamning:
...
## <a name="to-create-contract-service-credit-memos" />Til að búa til Samningsþjónustukreditreikninga
...
## <a name="updating-and-evaluating-contracts" />Uppfærsla og mat á samningum
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />Samningslínum bætt við þjónustusamning eða samningstilboð:
...
## <a name="to-remove-contract-lines" />Samningslínur fjarlægðar
...
## <a name="service-line-cost-and-value" />Kostnaður og gildi þjónustulínu
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />Samningsafslætti bætt við þjónustusamningstilboð
...
## <a name="to-change-the-owner-of-a-service-contract" />Skipt um eiganda þjónustusamninga:
...
## <a name="to-update-a-service-contract-price" />Til að uppfæra verð þjónustusamninga
...
## <a name="to-post-prepaid-contract-entries" />Bókun fyrirframgreiddra samningsfærslna
...
## <a name="changing-the-service-contract-status" />Breyting á þjónustusamningsstöðu
...
## <a name="to-cancel-a-service-contract" />Afturköllun þjónustusamnings:
...
## <a name="filing-a-service-contract-or-contract-quote" />Skráning þjónustusamning eða samningstilboðs
