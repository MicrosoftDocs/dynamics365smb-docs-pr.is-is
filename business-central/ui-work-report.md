...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Keyra og prenta skýrslur
...
## <a name="specifying-the-data-to-include-in-a-report" />Tilgreina gögnin sem eiga að vera í skýrslu
...
## <a name="previewing-a-report" />Forskoða skýrslu
...
### <a name="work-with-the-preview" />Vinna með forskoðunina
...
## <a name="saving-a-report-to-a-file" />Skýrsla vistuð í skrá
...
### <a name="manage-scheduled-recurring-reports" />Stjórna tímasettum endurteknum skýrslum
...
### <a name="printing-reports-in-thai" />Býr til skýrslu í Thai
...
## <a name="switching-the-report-layout" />Skipt um skýrsluútlit
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Breyta tungumáli og sniði talna, dagsetninga og tíma
...
## <a name="advanced-options" />Ítarlegir valkostir
