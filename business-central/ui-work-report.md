...
ms.author: jswymer
---
# <a name="run-and-print-reports"></a><a name="run-and-print-reports"></a><a name="run-and-print-reports"></a>Keyra og prenta skýrslur
...
## <a name="get-started"></a><a name="get-started"></a><a name="get-started"></a>Hafist handa
...
## <a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Sjálfgefin gildi notuð&mdash;fyrirframskilgreindar stillingar
...
## <a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a>Tilgreina gögnin sem eiga að vera í skýrslu
...
## <a name="previewing-a-report"></a><a name="previewing-a-report"></a><a name="previewing-a-report"></a>Forskoða skýrslu
...
### <a name="work-with-the-preview"></a><a name="work-with-the-preview"></a><a name="work-with-the-preview"></a>Vinna með forskoðunina
...
## <a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a>Skýrsla vistuð í skrá
...
## <a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Skýrsla tímasett á að keyra síðar eða reglubundið
...
### <a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a>Stjórna tímasettum endurteknum skýrslum
...
## <a name="printing-a-report"></a><a name="printing-a-report"></a><a name="printing-a-report"></a><a name="PrintReport"></a>Prenta skýrslu
...
### <a name="printer"></a><a name="printer"></a><a name="printer"></a><a name="Printer"></a>Prentari
...
### <a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a>Býr til skýrslu í Thai
...
## <a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a>Skipt um skýrsluútlit
...
## <a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a>Breyta tungumáli og sniði talna, dagsetninga og tíma
...
## <a name="advanced-options"></a><a name="advanced-options"></a><a name="advanced-options"></a>Ítarlegir valkostir
