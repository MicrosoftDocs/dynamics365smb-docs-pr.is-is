...
- Velja texta
    ...
    Þú getur afritað texta úr skýrslu og svo límt hann eitthvert annað, eins og á síðu í [!INCLUDE[prod_short](includes/prod_short.md)] eða Microsoft Word. Ef þú notar til dæmis mús, þá heldurðu inni vinstri músarhnappnum þar sem þú vilt byrja. Færðu svo músina til til að velja eitt eða fleiri orð, setningar eða málsgreinar. Smelltu svo á hægri músarhnappinn og veldu **Afrita**. Nú geturðu límt valinn texta þar sem þú vilt hafa hann.
- Fletta skjali

    Hægt er að færa sjáanlega svæði skýrslunnar í hvaða átt sem er til að skoða önnur svæði skýrslunnar. Fletting er gagnleg þegar þú hefur aukið aðdrátt til að sjá smáatriði. Ef þú notar til dæmis músina heldurðu inni vinstri músarhnappnum hvar sem er á skýrslunni og hreyfir svo músina til að velja skýrsluhluta.
