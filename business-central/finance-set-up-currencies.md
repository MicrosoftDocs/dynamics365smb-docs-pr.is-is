...
ms.author: edupont
---
# <a name="set-up-currencies" />Uppsetning gjaldmiðla
...
## <a name="currencies" /><a name="curr"></a>Gjaldmiðlar
...
### <a name="available-currency-functions" />Tiltækar aðgerðir gjaldmiðla
...
## <a name="lcy-and-other-currencies" />SGM og aðrir gjaldmiðlar

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Sléttun gjaldmiðla
...
### <a name="unit-amount-rounding" />Sléttun einingaupphæða
...
### <a name="amount-rounding" />Sléttun upphæða
...
## <a name="general-ledger-accounts" />Fjárhagsreikningar
...
## <a name="see-related-microsoft-training" />Sjá tengda [Microsoft þjálfun](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
