...
Notið ytri þjónusta til að fá nýjasta gengi gjaldmiðils í gluggann **Gjaldmiðlar**. Fyrir frekari upplýsingar, sjá [Til að setja upp gjaldeyrisþjónustu](finance-how-update-currencies.md#set-up-a-currency-exchange-rate-service).  

[!INCLUDE [finance-currencies-lcy](includes/finance-currencies-lcy-note.md)]

## <a name="curr"></a>Gjaldmiðlar
...
|**Hám. VSK-mismunur leyfður**|Leyfileg hámarksupphæð vegna virðisaukaskattsmismunar í þessum gjaldmiðli. Fyrir frekari upplýsingar, sjá [Leiðrétta virðisaukaskattsupphæðir handvirkt á sölu- og innkaupaskjölum](finance-work-with-vat.md#correcting-vat-amounts-manually-on-sales-and-purchase-documents). Þessi reitur er kannski ekki sýnilegur sjálfkrafa. Hægt er að sækja hana með því að sérstilla síðuna.|
