...
---
# <a name="design-details-balancing-supply-and-demand" />Hönnun lýsingar: Jafnvægisframboð og eftirspurn
...
## <a name="supply-and-demand" />Framboð og eftirspurn
...
## <a name="the-concept-of-balancing-in-brief" />Hugtakið jafnvægislíkan, í stuttu máli
...
## <a name="process-orders-before-the-planning-start-date" />Vinna pantanir á undan upphafsdegi áætlunar
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period" />Rað-og lotunúmer og röð tengla sem undanþegnir eru frá fyrra tímabili
...
## <a name="load-inventory-profiles" />Sækja birgðaforstillingar
...
### <a name="item-dimensions-are-separated" />Vöruvíddir eru aðskildar
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level" />Raf-og lotunúmer eru hlaðin eftir tilgreiningu stiga
...
### <a name="order-to-order-links-are-never-broken" />Pöntunartenglar til að panta eru aldrei brotnir
...
### <a name="component-need-is-loaded-according-to-production-order-changes" />Íhlutaþörf er hlaðin í samræmi við breytingar á framleiðslupöntun
...
### <a name="consume-safety-stock" />Nota öryggisbirgðir
...
### <a name="forecast-demand-is-reduced-by-sales-orders" />Spáreftirspurn er minnkuð með sölupöntunum
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders" />Eftirspurn eftir standandi pöntun er minnkuð í sölupöntunum
...
## <a name="prioritize-orders" />Forgangsraða pöntunum
...
### <a name="priorities-on-the-demand-side" />Forgangskröfur á kröfuhlið
...
### <a name="priorities-on-the-supply-side" />Forgangur á framboðsmegin
...
### <a name="priority-related-to-the-state-of-supply-and-demand" />Forgangsröðun tengd ástandi framboðs og eftirspurnar
...
## <a name="balancing-supply-with-demand" />Jafnvægisframboð með eftirspurn
...
### <a name="rules-for-actions-for-supply-events" />Reglur um aðgerðir vegna framboðsatvika
...
### <a name="determine-the-supply-quantity" />Ákvarðað framboðsmagn
...
### <a name="order-tracking-links-during-planning" />Panta rakningartengla við áætlanagerð
...
## <a name="close-balanced-supply-and-demand" />Náið jafnvægi framboðs og eftirspurnar
...
### <a name="create-the-planning-line-suggested-action" />Stofna áætlunarlínuna (leiðbeinandi aðgerð)
