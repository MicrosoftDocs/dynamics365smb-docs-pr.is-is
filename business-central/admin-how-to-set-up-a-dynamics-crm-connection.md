...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Tengjast við Microsoft Dataverse
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Nota hjálparleiðbeiningar fyrir uppsetningu Dataverse tengingar
...
### <a name="to-create-or-maintain-the-connection-manually" />Að stofna eða vinna með tengingu handvirkt
...
## <a name="customize-the-match-based-coupling" />Aðlögun að sambyggðum festingum
...
### <a name="view-the-results-of-the-coupling-job" />Skoða niðurstöður tengingarverksins
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Uppfæra tengingar úr Viðskiptamiðinu miðlægt til að nota sannvottun vottorða sem byggð er á
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Til að uppfæra nettengingu við Business Central til að nota auðkenningu með skilríkjum
...
## <a name="connecting-on-premises-versions" />Tengja PN-útgáfur innanhúss
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Til að skrá forrit í Azure AD fyrir tengingu úr Business Central í Dataverse
