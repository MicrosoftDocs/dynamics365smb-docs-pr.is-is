...
> [!NOTE]
> Til að setja upp Miðstýrða virkjun verður teymareikningurinn að hafa að minnsta kosti hlutverkið [Teams Administrator](/entra/identity/role-based-access-control/permissions-reference#teams-administrator] hlutverkið.
...
## Sýna eða fela færslugögn á spjöldum
...
2.  ![Veldu Stækkunarglerið sem opnar Tell Me eiginleikann.](media/ui-search/search_small.png "Segðu mér hvað þú vilt gera") Táknmynd, slá inn **spjaldstillingar** og velja síðan viðeigandi tengja. <!--Or, select [here](https://businesscentral.dynamics.com/?page=1833) to open the page directly.-->
