...
## <a name="in-microsoft-teams" />Eftir Microsoft Teams
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Setja upp Business Central-forritið með miðlægri innleiðingu
...
## <a name="managing-privacy-and-compliance" />Umsjón með persónuvernd og reglufylgni
...
### <a name="restricting-sharing-of-cards" />Takmörkun á deilingu spjalda
...
### <a name="responding-to-data-requests" />Bregðast við gagnabeiðnum
...
## <a name="show-or-hide-record-data-on-cards" />Sýna eða fela færslugögn á kortum
