...
ms.author: edupont
---
# <a name="local-functionality-in-"></a><a name="local-functionality-in-"></a>Staðbundin virkni í [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="local-functionality"></a><a name="local-functionality"></a>Staðbundin virkni
...
### <a name="other-countries"></a><a name="other-countries"></a>Önnur lönd
