...
---
# <a name="design-details-planning-parameters" />Hönnunarupplýsingar: áætlunarfæribreyta
...
## <a name="define-whether-the-item-is-planned" />Skilgreina hvort varan sé áætluð
...
## <a name="define-when-to-reorder" />Skilgreina hvenær á að endurpanta
...
## <a name="define-how-much-to-reorder" />Skilgreina hve mikið á að endurpanta
...
## <a name="optimize-when-and-how-much-to-reorder" />Fínstilling hvenær og hversu mikið aá endurpanta
...
## <a name="modify-the-supply-orders" />Breyta framboðspöntununum
...
## <a name="delimit-the-item" />Afmarka hlutinn
...
## <a name="use-low-level-codes-to-manage-derived-demand" />Nota kóða á lágu stigi til að stjórna afleiddri eftirspurn
