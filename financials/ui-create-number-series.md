...
description: "Lærðu hvernig á að búa til nýja númeraröð í Dynamics 365 for Financials."
documentationcenter: 
...
**Athugaðu**: Við mælum með að þú notir sömu númeraröðakóða eins og þú sérð skráð í glugga **nr. Röðarlista** í CRONUS sýningarfyrirtækinu. Codes eins og *P-INV +* gætu ekki skilað þér strax, en [!INCLUDE[d365fin](includes/d365fin_md.md)] hefur marga sjálfgefna stillingar sem eru háð þessum númeraröðakóðum.
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Númeraröð**, og velja síðan viðeigandi tengil.
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Sala**, og velja síðan viðeigandi tengil.
