...
<span data-ttu-id="2c70a-104">Almennar birgðaupplýsingar eru tilgreindar í glugganum **Birgðagrunnur**.</span><span class="sxs-lookup"><span data-stu-id="2c70a-104">You specify your general inventory setup in the **Inventory Setup** window.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="2c70a-110">Sjá einnig</span><span class="sxs-lookup"><span data-stu-id="2c70a-110">See Also</span></span>
[<span data-ttu-id="2c70a-111">Setja upp birgðir</span><span class="sxs-lookup"><span data-stu-id="2c70a-111">Set Up Inventory</span></span>](inventory-setup-inventory.md)  
[<span data-ttu-id="2c70a-112">Stjórna birgðum</span><span class="sxs-lookup"><span data-stu-id="2c70a-112">Manage Inventory</span></span>](inventory-manage-inventory.md)  
<span data-ttu-id="2c70a-113">[Unnið með [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="2c70a-113">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>  
<span data-ttu-id="2c70a-114">[Sérstillir þína [!INCLUDE[d365fin](includes/d365fin_md.md)] upplifun](ui-experiences.md).</span><span class="sxs-lookup"><span data-stu-id="2c70a-114">[Customizing Your [!INCLUDE[d365fin](includes/d365fin_md.md)] Experience](ui-experiences.md)</span></span>  
[<span data-ttu-id="2c70a-115">Almenn viðskiptavirkni</span><span class="sxs-lookup"><span data-stu-id="2c70a-115">General Business Functionality</span></span>](ui-across-business-areas.md)
