...
## <a name="unsubscribing-from-included365finincludesd365finmdmd-without-office-365"></a>Ljúka áskrift að [!INCLUDE[d365fin](includes/d365fin_md.md)] án Office 365
Ef þú skráðir þig fyrir [!INCLUDE[d365fin](includes/d365fin_md.md)] án þess að nota 365 viðskiptareikning hefur þú ekki stjórnandaréttindi að Office 365. Þess í stað þarf að afskrá með því að hafa samband við afskráningarteymi [!INCLUDE[d365fin](includes/d365fin_md.md)]. Eins og er verður þú að hafa samband við teymið með því að senda tölvupóst á cancel-madeira@microsoft.com. Þú verður að tiltaka heiti [!INCLUDE[d365fin](includes/d365fin_md.md)] leigjandans í skilaboðunum svo að við getum greint þig. Auðveldasta leiðin til að gera þetta er að afrita vefslóðina af [!INCLUDE[d365fin](includes/d365fin_md.md)] heimasíðunni þinni.  
