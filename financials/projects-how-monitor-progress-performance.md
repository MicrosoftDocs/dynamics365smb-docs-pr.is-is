---
title: "Hvernig á að: Fylgjast með framvindu verks og afköstum | Microsoft Docs"
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Verk - VÍV aðferð**, og velja síðan viðeigandi tengil.  
...
4. Til að gera þessa nýju aðferð sjálfvirka skal velja efst í hægra horni **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Uppsetning verka**, og velja síðan viðeigandi tengil.  
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Verk - Reikna VÍV**, og velja síðan viðeigandi tengil.  
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Verk - Bóka VÍV í fjárhag**, og velja síðan viðeigandi tengil.  
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Verk - skráningar**, og velja síðan viðeigandi tengil.
