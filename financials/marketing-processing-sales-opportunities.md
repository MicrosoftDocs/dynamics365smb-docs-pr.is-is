---
title: "Vinnsla sölutækifæra| Microsoft Docs"
description: "Lýsir vinnslu fyrir sölutækifæri í Financials"
...
| --- | --- |
| Alla sölumenn og tengiliði |Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Tækifæralisti**, og velja síðan viðeigandi tengil. |
| Tiltekin sölumaður |Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Sölumenn**, og velja síðan viðeigandi tengil. Veldu sölumaður, veldu aðgerðina **tækifæri**, og veldu síðan aðgerðina **listi**. |
| Tiltekinn tengilið |Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **tengiliðir**, og velja síðan viðeigandi tengil. Veldu tengilið úr listanum, og veldu svo aðgerðina **tækifæri**. |
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Eyða tækifærum**, og velja síðan viðeigandi tengil.
