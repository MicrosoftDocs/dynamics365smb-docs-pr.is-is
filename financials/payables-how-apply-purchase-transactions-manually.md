---
title: "Hvernig á að: Afstemma greiðslur á lánardrottna handvirkt | Microsoft Docs"
description: "Hvernig á að: Afstemma greiðslur á lánardrottna handvirkt "
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Greiðslubók**, og velja síðan viðeigandi tengil.
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Innkaupakreditreikningur**, og velja síðan viðeigandi tengil.
