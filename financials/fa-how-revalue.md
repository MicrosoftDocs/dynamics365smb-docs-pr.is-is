---
title: "Hvernig á að: Endurmeta eignir| Microsoft Docs"
description: "Lýsir því hvernig á að endurmeta og færa niður eign."
...
1. Efst í hægra horni skal velja **Leita að síðu eða skýrslu** táknið ![Leita að síðu eða skýrslu](media/ui-search/search_small.png "Leita að síðu eða skýrslu táknið"), færa **Vísitala eigna**, og velja síðan viðeigandi tengil.  
...
6. Athugaðu Stofnaðar færslur, og síðan valið **Bóka** aðgerð til að bóka bókina.
    ...
    **Ábending:** Ef vísitölurnar eru aðeins til sýnis er hægt að búa til sérstaka afskriftabók til að geyma þær í. Þá hafa þessar færslur ekki áhrif á aðrar afskriftabækur.
