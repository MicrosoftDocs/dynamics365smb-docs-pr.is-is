---
title: "Hvernig á að setja upp Envestnet Yodlee bankastreymisþjónustu|  Microsoft Docs"
description: "Hvernig á að: Setja upp Envestnet Yodlee bankastreymisþjónustu"
...
**Athugið:** Ef þú notar uppsetningaraðstoðina í Setja upp fyrirtæki, þá geta sum skrefin í ferlunum sem fylgja þar á eftir gerst sjálfvirkt þegar þú ert kominn í uppsetninguna fyrir bankareikning fyrirtækis. Nánari upplýsingar eru í [Velkomin(n) í [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)]](index.md).
...
2. Valinn er viðeigandi bankareikningur og síðan valið **stofna nýjan tengdan bankareikning**. **Stofnun tengla fyrir Bankareiknings ** opnast eftir smá stund.
    ...
    **Athugið**: Þessi gluggi sýnir raunverulegt vefsíðu fyrir Bankastreymisþjónustu Envestnet Yodlee. Hugtök og virkni í glugganum mega ekki vera þau sömu og í þessu efnisatriði.  
...
6. Bankastreymisþjónusta undirbýr að tengja fyrsta netbankareikning á tilgreindum banka í nýja bankareikninginn í [!INCLUDE[d365fin](includes/d365fin_md.md)].
    ...
    **Athugið**: Ef þú ert með fleiri en einn netbankareikning í bankanum, verður að stofna fleiri bankareikning í [!INCLUDE[d365fin](includes/d365fin_md.md)] fyrir þá. Sjá skref 8 til 10.  
