...
---
# <a name="users-profiles-and-role-centers-in-dynamics-365-for-financials"></a>Notendur, forstillingar og hlutverkamiðstöðvar í Dynamics 365 for Financials
...
Til að bæta notendum í [!INCLUDE[d365fin](includes/d365fin_md.md)], verður kerfisstjóri Office 365 í fyrirtækinu fyrst að stofna notendur í stjórnstöð Office 365. Nánari upplýsingar eru í [Hvernig á að: Vinna með notendur og heimildir](ui-how-users-permissions.md).  
